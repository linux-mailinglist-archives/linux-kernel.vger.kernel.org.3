...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B47CF4F8AD7
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Apr 2022 02:55:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232345AbiDGXcK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 Apr 2022 19:32:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41014 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232548AbiDGXcF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 Apr 2022 19:32:05 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 763911E8CC0
        for <linux-kernel@vger.kernel.org>; Thu,  7 Apr 2022 16:29:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1649374199; x=1680910199;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Qbw+ORF6hKRdHJ4EJkTVf1oDb6Oq33jc0FXpm0To81k=;
  b=lgkmgQllNc2wXhS4NrvlWYweQokzOdIDnZyD44Y4A9584kIy6gkpRUih
   3RUVh0ZYknm7dV/wlIAC3TBWkN31Si1SBGT/KyIbBzk48giVxPUMFz62Y
   DqeD8xH7GYYNNJoPlrnrjerlU/DAb2VGGGRRkdd5klPL7bU0vst/YDsqH
   S1zjyymby5fASbFJV9Q4RNoX2ltKYHu2c0c4g5CHLGaSv9y/PJCN7mtcU
   O5l1K+EbY9haU0N4YOw2OKs9RA39nMj+d/xz2ChkKY3xGebuAysDnUZwg
   yxoxjuwE1WPYQUWPqPCYIcaJmYtdpwbeJJSlej53Zbl/d+H7zDVRJ1qg7
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10310"; a="248992498"
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; 
   d="scan'208";a="248992498"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Apr 2022 16:29:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,242,1643702400"; 
   d="scan'208";a="589012705"
Received: from lkp-server02.sh.intel.com (HELO a44fdfb70b94) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 07 Apr 2022 16:29:56 -0700
Received: from kbuild by a44fdfb70b94 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1ncbZb-0005rh-Tp;
        Thu, 07 Apr 2022 23:29:55 +0000
Date:   Fri, 8 Apr 2022 07:29:09 +0800
From:   kernel test robot <lkp@intel.com>
To:     "Kirill A. Shutemov" <kirill.shutemov@linux.intel.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [kas:lam 6/10] arch/x86/kernel/traps.c:620:13: sparse: sparse:
 incorrect type in argument 1 (different address spaces)
Message-ID: <202204080745.1uX6b8Wd-lkp@intel.com>
MIME-Version: 1.0
...
config: x86_64-randconfig-s022 (https://download.01.org/0day-ci/archive/20220408/202204080745.1uX6b8Wd-lkp@intel.com/config)
...
vim +620 arch/x86/kernel/traps.c

59c1dcbed5b51c Jann Horn      2019-12-19  607  
b968e84b509da5 Peter Zijlstra 2021-09-17  608  static bool fixup_iopl_exception(struct pt_regs *regs)
b968e84b509da5 Peter Zijlstra 2021-09-17  609  {
b968e84b509da5 Peter Zijlstra 2021-09-17  610  	struct thread_struct *t = &current->thread;
b968e84b509da5 Peter Zijlstra 2021-09-17  611  	unsigned char byte;
b968e84b509da5 Peter Zijlstra 2021-09-17  612  	unsigned long ip;
b968e84b509da5 Peter Zijlstra 2021-09-17  613  
b968e84b509da5 Peter Zijlstra 2021-09-17  614  	if (!IS_ENABLED(CONFIG_X86_IOPL_IOPERM) || t->iopl_emul != 3)
b968e84b509da5 Peter Zijlstra 2021-09-17  615  		return false;
b968e84b509da5 Peter Zijlstra 2021-09-17  616  
b968e84b509da5 Peter Zijlstra 2021-09-17  617  	if (insn_get_effective_ip(regs, &ip))
b968e84b509da5 Peter Zijlstra 2021-09-17  618  		return false;
b968e84b509da5 Peter Zijlstra 2021-09-17  619  
b968e84b509da5 Peter Zijlstra 2021-09-17 @620  	if (get_user(byte, (const char __user *)ip))
b968e84b509da5 Peter Zijlstra 2021-09-17  621  		return false;
b968e84b509da5 Peter Zijlstra 2021-09-17  622  
b968e84b509da5 Peter Zijlstra 2021-09-17  623  	if (byte != 0xfa && byte != 0xfb)
b968e84b509da5 Peter Zijlstra 2021-09-17  624  		return false;
b968e84b509da5 Peter Zijlstra 2021-09-17  625  
b968e84b509da5 Peter Zijlstra 2021-09-17  626  	if (!t->iopl_warn && printk_ratelimit()) {
b968e84b509da5 Peter Zijlstra 2021-09-17  627  		pr_err("%s[%d] attempts to use CLI/STI, pretending it's a NOP, ip:%lx",
b968e84b509da5 Peter Zijlstra 2021-09-17  628  		       current->comm, task_pid_nr(current), ip);
b968e84b509da5 Peter Zijlstra 2021-09-17  629  		print_vma_addr(KERN_CONT " in ", ip);
b968e84b509da5 Peter Zijlstra 2021-09-17  630  		pr_cont("\n");
b968e84b509da5 Peter Zijlstra 2021-09-17  631  		t->iopl_warn = 1;
b968e84b509da5 Peter Zijlstra 2021-09-17  632  	}
b968e84b509da5 Peter Zijlstra 2021-09-17  633  
b968e84b509da5 Peter Zijlstra 2021-09-17  634  	regs->ip += 1;
b968e84b509da5 Peter Zijlstra 2021-09-17  635  	return true;
b968e84b509da5 Peter Zijlstra 2021-09-17  636  }
b968e84b509da5 Peter Zijlstra 2021-09-17  637  
