...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BFE1646FA7C
	for <lists+linux-kernel@lfdr.de>; Fri, 10 Dec 2021 06:35:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236812AbhLJFii (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 10 Dec 2021 00:38:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233259AbhLJFif (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 10 Dec 2021 00:38:35 -0500
Received: from mail-pg1-x535.google.com (mail-pg1-x535.google.com [IPv6:2607:f8b0:4864:20::535])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 475C9C061746
        for <linux-kernel@vger.kernel.org>; Thu,  9 Dec 2021 21:35:01 -0800 (PST)
Received: by mail-pg1-x535.google.com with SMTP id m15so7090326pgu.11
        for <linux-kernel@vger.kernel.org>; Thu, 09 Dec 2021 21:35:01 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:cc:subject:message-id:mime-version:content-disposition;
        bh=/5AIgCLPAMLqKDCfMmnVgA5kW3fSC0HQu6tRnS0xnJY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id:mime-version
         :content-disposition;
        bh=/5AIgCLPAMLqKDCfMmnVgA5kW3fSC0HQu6tRnS0xnJY=;
        b=
X-Gm-Message-State: AOAM530XNzOXLVZjPK+ts1EPcGZfqbCd8ikXDNfYACrhsqlwd0m+VU7n
        M2aHxvTVTg5EWvO/SM+74JkxQ8y6px0=
X-Google-Smtp-Source: ABdhPJxXKWRddjL3p37z5B2EYNUcBVZ6F15lIRY5c0JYvenGxa19qh7Ae9K+3HPYqBpVIxHN3XbGLw==
X-Received: by 2002:a62:8f93:0:b0:49f:ed44:54ac with SMTP id n141-20020a628f93000000b0049fed4454acmr16085423pfd.72.1639114500428;
        Thu, 09 Dec 2021 21:35:00 -0800 (PST)
Received: from google.com ([2620:15c:202:201:8a3d:b2f2:42a0:335a])
        by smtp.gmail.com with ESMTPSA id f7sm1538925pfv.89.2021.12.09.21.34.59
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 09 Dec 2021 21:34:59 -0800 (PST)
Date:   Thu, 9 Dec 2021 21:34:57 -0800
From:   Dmitry Torokhov <dmitry.torokhov@gmail.com>
To:     Luis Chamberlain <mcgrof@kernel.org>, Jessica Yu <jeyu@kernel.org>
Cc:     Kees Cook <keescook@chromium.org>, linux-kernel@vger.kernel.org
Subject: [PATCH v2] module: add in-kernel support for decompressing
Message-ID: <YbLnAeaKW4HdtRWL@google.com>
MIME-Version: 1.0
...
finit_module(). New MODULE_INIT_COMPRESSED_FILE flag indicates that the
...
index cd23faa163d1..38851916c2b8 100644
--- a/init/Kconfig
+++ b/init/Kconfig
@@ -2305,6 +2305,18 @@ config MODULE_COMPRESS_ZSTD
