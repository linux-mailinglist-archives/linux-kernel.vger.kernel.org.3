...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EC8A74E72BF
	for <lists+linux-kernel@lfdr.de>; Fri, 25 Mar 2022 13:09:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1358456AbiCYMKS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 25 Mar 2022 08:10:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57432 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345960AbiCYMKQ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 25 Mar 2022 08:10:16 -0400
Received: from szxga01-in.huawei.com (szxga01-in.huawei.com [45.249.212.187])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A27E94DF47
        for <linux-kernel@vger.kernel.org>; Fri, 25 Mar 2022 05:08:39 -0700 (PDT)
Received: from kwepemi100016.china.huawei.com (unknown [172.30.72.54])
        by szxga01-in.huawei.com (SkyGuard) with ESMTP id 4KQ1895x5pzcc1m;
        Fri, 25 Mar 2022 20:08:25 +0800 (CST)
Received: from kwepemm600016.china.huawei.com (7.193.23.20) by
 kwepemi100016.china.huawei.com (7.221.188.123) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2308.21; Fri, 25 Mar 2022 20:08:37 +0800
...
Message-ID: <5b77fceb-830f-2592-351e-4185fc8843f0@huawei.com>
Date:   Fri, 25 Mar 2022 20:08:36 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; rv:68.0) Gecko/20100101
 Thunderbird/68.2.2
MIME-Version: 1.0
In-Reply-To: <6089561f-039b-43b5-7a6b-43b00ce370f2@huawei.com>
...
Yes. I will add it on next version.
...
> 
I don't think so, driver needs to check whether filter mode is right
of each event, so driver should record and show what filter modes are
supported of each event.
...
> 
Here use "/" to separate each type, may be it is bette to use a space to separate them,
I will modify to space.
...
> why no ','?
> 
I think it doesn't matter, I will add it.
...
>> +    if (!eattr_filter) {
> 
> I might have said this before - I'm not sure why these need to be dynamically allocated. All the sizes seem fixed at compile time.
> 
Yes, the sizes is fixed. I just don't want to define a new array as big as hns3_pmu_events_attr[], and the only difference
between the new array and array hns3_pmu_events_attr[] is the attr.show() callback of each event.
...
> 
> why not inclusive? If I say that something is the minimum, it means inclusive. By definition, that is what minimum means.
> 
...
> 
> This is hard to read. And pmu_event->filter_support & HNS3_PMU_FILTER_SUPPORT_FUNC seems to be tested twice
> 
Ok.
...
> 
> I don't see what this is un-doing in this function. You should only un-do what is done in this function
> 
Ok, thanks.
...
> 
I don't understand here, can you explain in detail?
...
> 
The function hns3_pmu_probe() already exists, how about rename it as hns3_pmu_init_pmu()?
Just refer to PCIe PMU driver.
