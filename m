...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9C89A4CBB3D
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Mar 2022 11:24:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232311AbiCCKZb convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-kernel@lfdr.de>); Thu, 3 Mar 2022 05:25:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54922 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230135AbiCCKZ3 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Mar 2022 05:25:29 -0500
X-Greylist: delayed 82 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Thu, 03 Mar 2022 02:24:41 PST
Received: from aposti.net (aposti.net [89.234.176.197])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5ED35114767;
        Thu,  3 Mar 2022 02:24:41 -0800 (PST)
Date:   Thu, 03 Mar 2022 10:24:22 +0000
...
Message-Id: <MKZ58R.HRZ0OPP9BBC8@crapouillou.net>
...
Le jeu., mars 3 2022 at 09:08:31 +0100, Jiri Slaby <jslaby@suse.cz> a 
écrit :
> Currently, uart_console_write->putchar's second parameter (the
> character) is of type int. It makes little sense, provided 
> uart_console_write()
> accepts the input string as "const char *s" and passes its content -- 
> the
> characters -- to putchar(). So switch the character's type to unsigned
> char.
> 
> We don't use char as that is signed on some platforms. That would 
> cause
> troubles for drivers which (implicitly) cast the char to u16 when
> writing to the device. Sign extension would happen in that case and 
> the
> value written would be completely different to the provided char. DZ 
> is
...
> layer, which uses unsigned char in most places already. One exception 
> is
...
> @@ -434,7 +434,7 @@ static int goldfish_tty_remove(struct 
> platform_device *pdev)
>  }
> 
>  #ifdef CONFIG_GOLDFISH_TTY_EARLY_CONSOLE
> -static void gf_early_console_putchar(struct uart_port *port, int ch)
> +static void gf_early_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> +static void dcc_uart_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> -static void serial21285_console_putchar(struct uart_port *port, int 
> ch)
...
> +++ b/drivers/tty/serial/8250/8250_early.c
> @@ -86,7 +86,7 @@ static void serial8250_early_out(struct uart_port 
> *port, int offset, int value)
> 
...
> +++ b/drivers/tty/serial/8250/8250_ingenic.c
> @@ -52,7 +52,7 @@ static void early_out(struct uart_port *port, int 
...
> 
> -static void serial8250_console_putchar(struct uart_port *port, int 
> ch)
...
> +++ b/drivers/tty/serial/altera_jtaguart.c
> @@ -298,7 +298,7 @@ static struct altera_jtaguart 
> altera_jtaguart_ports[ALTERA_JTAGUART_MAXPORTS];
>  #if defined(CONFIG_SERIAL_ALTERA_JTAGUART_CONSOLE)
> 
>  #if defined(CONFIG_SERIAL_ALTERA_JTAGUART_CONSOLE_BYPASS)
> -static void altera_jtaguart_console_putc(struct uart_port *port, int 
> c)
...
>  	unsigned long flags;
> @@ -318,7 +318,7 @@ static void altera_jtaguart_console_putc(struct 
...
>  	unsigned long flags;
> 
> diff --git a/drivers/tty/serial/altera_uart.c 
> b/drivers/tty/serial/altera_uart.c
> index 64a352b40197..8b749ed557c6 100644
> --- a/drivers/tty/serial/altera_uart.c
> +++ b/drivers/tty/serial/altera_uart.c
> @@ -438,7 +438,7 @@ static struct altera_uart 
> altera_uart_ports[CONFIG_SERIAL_ALTERA_UART_MAXPORTS];
> 
>  #if defined(CONFIG_SERIAL_ALTERA_UART_CONSOLE)
> 
> -static void altera_uart_console_putc(struct uart_port *port, int c)
> +static void altera_uart_console_putc(struct uart_port *port, 
> unsigned char c)
>  {
...
> +static void pl010_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	unsigned int status;
> 
...
> +++ b/drivers/tty/serial/amba-pl011.c
> @@ -2255,7 +2255,7 @@ static struct uart_amba_port 
> *amba_ports[UART_NR];
> 
>  #ifdef CONFIG_SERIAL_AMBA_PL011_CONSOLE
> 
> -static void pl011_console_putchar(struct uart_port *port, int ch)
> +static void pl011_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
>  		cpu_relax();
> @@ -2487,7 +2487,7 @@ static void qdf2400_e44_early_write(struct 
> console *con, const char *s, unsigned
...
>  	while (readl(port->membase + UART01x_FR) & UART01x_FR_TXFF)
>  		cpu_relax();
> diff --git a/drivers/tty/serial/apbuart.c 
> b/drivers/tty/serial/apbuart.c
> index d8c937bdf3f9..9ef82d870ff2 100644
> --- a/drivers/tty/serial/apbuart.c
> +++ b/drivers/tty/serial/apbuart.c
> @@ -413,7 +413,7 @@ static void apbuart_flush_fifo(struct uart_port 
> *port)
> 
>  #ifdef CONFIG_SERIAL_GRLIB_GAISLER_APBUART_CONSOLE
> 
> -static void apbuart_console_putchar(struct uart_port *port, int ch)
> +static void apbuart_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	unsigned int status;
>  	do {
...
> +++ b/drivers/tty/serial/ar933x_uart.c
> @@ -613,7 +613,7 @@ static void ar933x_uart_wait_xmitr(struct 
> ar933x_uart_port *up)
>  	} while ((status & AR933X_UART_DATA_TX_CSR) == 0);
>  }
> 
> -static void ar933x_uart_console_putchar(struct uart_port *port, int 
> ch)
> +static void ar933x_uart_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> +++ b/drivers/tty/serial/arc_uart.c
> @@ -508,7 +508,7 @@ static int arc_serial_console_setup(struct 
> console *co, char *options)
>  	return uart_set_options(port, co, baud, parity, bits, flow);
>  }
> 
> -static void arc_serial_console_putchar(struct uart_port *port, int 
> ch)
...
> +++ b/drivers/tty/serial/atmel_serial.c
> @@ -2541,7 +2541,7 @@ static int atmel_init_port(struct 
> atmel_uart_port *atmel_port,
>  }
> 
>  #ifdef CONFIG_SERIAL_ATMEL_CONSOLE
> -static void atmel_console_putchar(struct uart_port *port, int ch)
> +static void atmel_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +static void bcm_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	wait_for_xmitr(port);
>  	bcm_uart_writel(port, ch, UART_FIFO_REG);
> diff --git a/drivers/tty/serial/clps711x.c 
...
> +static void dz_console_putchar(struct uart_port *uport, unsigned 
> char ch)
>  {
...
> +static void linflex_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	unsigned long cr;
> 
> @@ -578,7 +578,7 @@ static void linflex_console_putchar(struct 
> uart_port *port, int ch)
>  	}
>  }
> 
> -static void linflex_earlycon_putchar(struct uart_port *port, int ch)
> +static void linflex_earlycon_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
>  	unsigned long flags;
>  	char *ret;
...
> +static void lpuart_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +static void lpuart32_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> +static void imx_uart_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
>  	struct imx_port *sport = (struct imx_port *)port;
> 
> diff --git a/drivers/tty/serial/imx_earlycon.c 
...
>  		cpu_relax();
> diff --git a/drivers/tty/serial/ip22zilog.c 
> b/drivers/tty/serial/ip22zilog.c
> index f4dc5fe4ba92..655e64b26852 100644
> --- a/drivers/tty/serial/ip22zilog.c
> +++ b/drivers/tty/serial/ip22zilog.c
> @@ -990,7 +990,7 @@ static struct zilog_layout * __init get_zs(int 
> chip)
>  #define ZS_PUT_CHAR_MAX_DELAY	2000	/* 10 ms */
> 
>  #ifdef CONFIG_SERIAL_IP22_ZILOG_CONSOLE
> -static void ip22zilog_put_char(struct uart_port *port, int ch)
> +static void ip22zilog_put_char(struct uart_port *port, unsigned char 
> ch)
>  {
...
> +static void liteuart_putchar(struct uart_port *port, unsigned char 
> ch)
>  {
>  	while (litex_read8(port->membase + OFF_TXFULL))
>  		cpu_relax();
> diff --git a/drivers/tty/serial/lpc32xx_hs.c 
> b/drivers/tty/serial/lpc32xx_hs.c
> index 54437a087aa0..93140cac1ca1 100644
> --- a/drivers/tty/serial/lpc32xx_hs.c
> +++ b/drivers/tty/serial/lpc32xx_hs.c
> @@ -122,7 +122,7 @@ static void wait_for_xmit_ready(struct uart_port 
> *port)
>  	}
>  }
> 
> -static void lpc32xx_hsuart_console_putchar(struct uart_port *port, 
> int ch)
> +static void lpc32xx_hsuart_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> +++ b/drivers/tty/serial/meson_uart.c
> @@ -516,7 +516,7 @@ static void meson_uart_enable_tx_engine(struct 
> uart_port *port)
>  	writel(val, port->membase + AML_UART_CONTROL);
>  }
> 
> -static void meson_console_putchar(struct uart_port *port, int ch)
> +static void meson_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	if (!port->membase)
>  		return;
...
> +static void mlb_usio_console_putchar(struct uart_port *port, 
> unsigned char c)
>  {
>  	while (!(readb(port->membase + MLB_USIO_REG_SSR) & 
> MLB_USIO_SSR_TDRE))
>  		cpu_relax();
> diff --git a/drivers/tty/serial/mps2-uart.c 
...
> +static void mps2_early_putchar(struct uart_port *port, unsigned char 
> ch)
>  {
...
>  }
> 
> -static void mvebu_uart_console_putchar(struct uart_port *port, int 
> ch)
...
> +++ b/drivers/tty/serial/omap-serial.c
> @@ -1194,7 +1194,7 @@ static void omap_serial_early_out(struct 
> uart_port *port, int offset,
>  	writew(value, port->membase + offset);
>  }
> 
> -static void omap_serial_early_putc(struct uart_port *port, int c)
> +static void omap_serial_early_putc(struct uart_port *port, unsigned 
> char c)
>  {
>  	unsigned int status;
> 
> @@ -1238,7 +1238,7 @@ static struct uart_omap_port 
> *serial_omap_console_ports[OMAP_MAX_HSUART_PORTS];
> 
>  static struct uart_driver serial_omap_reg;
> 
> -static void serial_omap_console_putchar(struct uart_port *port, int 
> ch)
...
> +static void owl_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	if (!port->membase)
>  		return;
...
> +static void pch_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +static void pic32_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +static void pmz_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> @@ -619,7 +619,7 @@ static void wait_for_xmitr(struct uart_pxa_port 
> *up)
>  	}
>  }
> 
> -static void serial_pxa_console_putchar(struct uart_port *port, int 
> ch)
...
> +++ b/drivers/tty/serial/qcom_geni_serial.c
> @@ -397,7 +397,7 @@ static void qcom_geni_serial_poll_put_char(struct 
> uart_port *uport,
>  #endif
> 
...
> +static void rda_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	if (!port->membase)
>  		return;
...
> @@ -695,7 +695,7 @@ void __init sa1100_register_uart(int idx, int 
> port)
> 
> 
>  #ifdef CONFIG_SERIAL_SA1100_CONSOLE
> -static void sa1100_console_putchar(struct uart_port *port, int ch)
> +static void sa1100_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +++ b/drivers/tty/serial/samsung_tty.c
> @@ -2478,7 +2478,7 @@ static void s3c24xx_serial_put_poll_char(struct 
> uart_port *port,
>  #endif /* CONFIG_CONSOLE_POLL */
> 
>  static void
> -s3c24xx_serial_console_putchar(struct uart_port *port, int ch)
> +s3c24xx_serial_console_putchar(struct uart_port *port, unsigned char 
> ch)
>  {
>  	unsigned int ufcon = rd_regl(port, S3C2410_UFCON);
> 
> @@ -2965,7 +2965,7 @@ static void samsung_early_busyuart_fifo(struct 
> uart_port *port)
>  		;
>  }
> 
> -static void samsung_early_putc(struct uart_port *port, int c)
> +static void samsung_early_putc(struct uart_port *port, unsigned char 
> c)
>  {
...
> +static void sbd_console_putchar(struct uart_port *uport, unsigned 
> char ch)
>  {
...
> +static void sccnxp_console_putchar(struct uart_port *port, unsigned 
> char c)
>  {
>  	int tryes = 100000;
> 
...
> +++ b/drivers/tty/serial/serial_core.c
> @@ -1911,7 +1911,7 @@ static void uart_port_spin_lock_init(struct 
> uart_port *port)
>   */
...
> +++ b/drivers/tty/serial/serial_txx9.c
> @@ -876,7 +876,7 @@ static void __init 
> serial_txx9_register_ports(struct uart_driver *drv,
> 
>  #ifdef CONFIG_SERIAL_TXX9_CONSOLE
> 
> -static void serial_txx9_console_putchar(struct uart_port *port, int 
> ch)
> +static void serial_txx9_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
...
> @@ -2957,7 +2957,7 @@ static void sci_cleanup_single(struct sci_port 
> *port)
> 
>  #if defined(CONFIG_SERIAL_SH_SCI_CONSOLE) || \
>      defined(CONFIG_SERIAL_SH_SCI_EARLYCON)
> -static void serial_console_putchar(struct uart_port *port, int ch)
> +static void serial_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> @@ -756,7 +756,7 @@ static void sifive_serial_poll_put_char(struct 
> uart_port *port,
>   */
> 
>  #ifdef CONFIG_SERIAL_EARLYCON
> -static void early_sifive_serial_putc(struct uart_port *port, int c)
> +static void early_sifive_serial_putc(struct uart_port *port, 
> unsigned char c)
>  {
>  	while (__ssp_early_readl(port, SIFIVE_SERIAL_TXDATA_OFFS) &
>  	       SIFIVE_SERIAL_TXDATA_FULL_MASK)
> @@ -800,7 +800,7 @@ OF_EARLYCON_DECLARE(sifive, 
> "sifive,fu540-c000-uart0",
> 
>  static struct sifive_serial_port 
> *sifive_serial_console_ports[SIFIVE_SERIAL_MAX_PORTS];
> 
...
> +static void sprd_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	wait_for_xmitr(port);
...
> +static void asc_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +++ b/drivers/tty/serial/stm32-usart.c
> @@ -1641,7 +1641,7 @@ static int stm32_usart_serial_remove(struct 
> platform_device *pdev)
>  }
> 
>  #ifdef CONFIG_SERIAL_STM32_CONSOLE
> -static void stm32_usart_console_putchar(struct uart_port *port, int 
> ch)
> +static void stm32_usart_console_putchar(struct uart_port *port, 
> unsigned char ch)
>  {
>  	struct stm32_port *stm32_port = to_stm32_port(port);
>  	const struct stm32_usart_offsets *ofs = &stm32_port->info->ofs;
> diff --git a/drivers/tty/serial/sunplus-uart.c 
...
> 
> -static void sunplus_uart_console_putchar(struct uart_port *port, int 
> ch)
...
> +static void sunplus_uart_putc(struct uart_port *port, unsigned char 
> c)
>  {
>  	unsigned int val;
>  	int ret;
...
> +static void sunsab_console_putchar(struct uart_port *port, unsigned 
> char c)
>  {
...
> @@ -1281,7 +1281,7 @@ static void wait_for_xmitr(struct 
> uart_sunsu_port *up)
>  	}
>  }
> 
> -static void sunsu_console_putchar(struct uart_port *port, int ch)
> +static void sunsu_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	struct uart_sunsu_port *up =
>  		container_of(port, struct uart_sunsu_port, port);
> diff --git a/drivers/tty/serial/sunzilog.c 
...
> +static void sunzilog_putchar(struct uart_port *port, unsigned char 
> ch);
> 
...
> +++ b/drivers/tty/serial/uartlite.c
> @@ -482,7 +482,7 @@ static void ulite_console_wait_tx(struct 
> uart_port *port)
>  			 "timeout waiting for TX buffer empty\n");
>  }
> 
> -static void ulite_console_putchar(struct uart_port *port, int ch)
> +static void ulite_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
...
> +static void early_uartlite_putc(struct uart_port *port, unsigned 
> char c)
>  {
>  	/*
>  	 * Limit how many times we'll spin waiting for TX FIFO status.
> diff --git a/drivers/tty/serial/vr41xx_siu.c 
...
> +static void siu_console_putchar(struct uart_port *port, unsigned 
> char ch)
>  {
>  	wait_for_xmitr(port);
...
> +static void vt8500_console_putchar(struct uart_port *port, unsigned 
> char c)
>  {
>  	wait_for_xmitr(port);
...
> +static void zs_console_putchar(struct uart_port *uport, unsigned 
> char ch)
>  {
...
> @@ -399,7 +399,7 @@ int uart_set_options(struct uart_port *port, 
> struct console *co, int baud,
>  struct tty_driver *uart_console_device(struct console *co, int 
> *index);
>  void uart_console_write(struct uart_port *port, const char *s,
>  			unsigned int count,
> -			void (*putchar)(struct uart_port *, int));
