...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2922A514C79
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Apr 2022 16:13:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376910AbiD2OQj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Apr 2022 10:16:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376604AbiD2OQ0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Apr 2022 10:16:26 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id ECA4D1A836
        for <linux-kernel@vger.kernel.org>; Fri, 29 Apr 2022 07:13:07 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id AC4C61474;
        Fri, 29 Apr 2022 07:13:07 -0700 (PDT)
Received: from localhost.localdomain (FVFF7649Q05P.cambridge.arm.com [10.1.32.23])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 661383F774;
...
Subject: [PATCH v8 3/7] sched, drivers: Remove max param from effective_cpu_util()/sched_cpu_util()
Date:   Fri, 29 Apr 2022 15:11:44 +0100
Message-Id: <20220429141148.181816-4-vincent.donnefort@arm.com>
...
index 4e9e0d453a00..2d5ae9cac7f9 100644
--- a/kernel/sched/fair.c
+++ b/kernel/sched/fair.c
@@ -6729,12 +6729,11 @@ static long
...
@@ -6771,10 +6770,10 @@ compute_energy(struct task_struct *p, int dst_cpu, struct perf_domain *pd)
...
@@ -6783,12 +6782,12 @@ compute_energy(struct task_struct *p, int dst_cpu, struct perf_domain *pd)
...
index ea9365e1a24e..c33d4fc3c80d 100644
