...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 32741520B15
	for <lists+linux-kernel@lfdr.de>; Tue, 10 May 2022 04:17:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234581AbiEJCVY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 May 2022 22:21:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54318 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234562AbiEJCVV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 May 2022 22:21:21 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 01A6E8DDCC
        for <linux-kernel@vger.kernel.org>; Mon,  9 May 2022 19:17:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1652149045; x=1683685045;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=e90AbT5ccZFHf0ssFfdzFgC1clu1x/GDvwUJlTJ2vm0=;
  b=nS7krE3A94qhgN1MnY6wQHlJniz4kzatNzF/lwK4ONlaWjbpH3c7sDgR
   eeLLsTqRt+FTBQkVFwPio5NO6KGM/T7Z+Y0+Oao7ktotcUq3hhjmvwiin
   PIIGtJCgRj3EMpyIL8rBbWojHhYh9TYxn/rPuYima89zJnQlDed3MXquu
   KXNMqkNQUkhjrhv/2HU6SFyV0eu9w+0AfQs3AAFkYRgh3gmvvmmYlNYEL
   oU3aAhlKMn3+ue4q9FkCozuEk5MgCqYfxMZ5rBp7gvAtv5hNSkqfr3N+9
   m7VYjD9V+u7xIksV2kQ06dUIxJL8a8niDjRqaWEc5urtba5+zme4kLC6z
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10342"; a="249766105"
X-IronPort-AV: E=Sophos;i="5.91,213,1647327600"; 
   d="scan'208";a="249766105"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 May 2022 19:17:25 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.91,213,1647327600"; 
   d="scan'208";a="519515116"
Received: from lkp-server01.sh.intel.com (HELO 5056e131ad90) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 09 May 2022 19:17:23 -0700
Received: from kbuild by 5056e131ad90 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1noFRC-000HAz-Sm;
        Tue, 10 May 2022 02:17:22 +0000
Date:   Tue, 10 May 2022 10:16:56 +0800
...
Subject: [ammarfaizi2-block:dhowells/linux-fs/rxrpc-ringless 30/30]
 net/rxrpc/call_event.c:222:28: sparse: sparse: incorrect type in argument 1
 (different base types)
Message-ID: <202205101008.GElk2we1-lkp@intel.com>
MIME-Version: 1.0
...
config: arc-randconfig-s031-20220509 (https://download.01.org/0day-ci/archive/20220510/202205101008.GElk2we1-lkp@intel.com/config)
...
>> net/rxrpc/call_event.c:222:28: sparse: sparse: incorrect type in argument 1 (different base types) @@     expected unsigned int [usertype] val @@     got restricted __be32 [usertype] serial @@
   net/rxrpc/call_event.c:222:28: sparse:     expected unsigned int [usertype] val
   net/rxrpc/call_event.c:222:28: sparse:     got restricted __be32 [usertype] serial
   net/rxrpc/call_event.c:222:28: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:28: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:28: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:28: sparse: sparse: cast from restricted __be32
   ...
   net/rxrpc/call_event.c:222:53: sparse: sparse: incorrect type in argument 1 (different base types) @@     expected unsigned int [usertype] val @@     got restricted __be32 [usertype] serial @@
   net/rxrpc/call_event.c:222:53: sparse:     expected unsigned int [usertype] val
   net/rxrpc/call_event.c:222:53: sparse:     got restricted __be32 [usertype] serial
   net/rxrpc/call_event.c:222:53: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:53: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:53: sparse: sparse: cast from restricted __be32
   net/rxrpc/call_event.c:222:53: sparse: sparse: cast from restricted __be32
