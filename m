...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D09BB4BB27C
	for <lists+linux-kernel@lfdr.de>; Fri, 18 Feb 2022 07:36:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231608AbiBRGgZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 18 Feb 2022 01:36:25 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:59942 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231211AbiBRGgR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 18 Feb 2022 01:36:17 -0500
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1FA883D1D0
        for <linux-kernel@vger.kernel.org>; Thu, 17 Feb 2022 22:35:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1645166156; x=1676702156;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=8OpS+bFibqCl+RCXxAdvW1/mpNNEjJvHoiyu1Koq8Ug=;
  b=j8jrEFIaWupUmQ7loC548XO7j1ao+fdtBjoA9NUJ+Ic3mXaZk1FawTvL
   IEaYQXUCjBuXhyQN6pw50fNjkzNu3EUdBGU7+xVzFMUoM+TvU8weCw+Ut
   3/mVjB/PWlo69Vhbk0TnOXkHR60uHwPEMomNU9SorHjXF9WSZd/5JI2U2
   hoQeF1hQ7s9wVrfGGoOQc/mGTSCySTaVGa1TylCfzKfoLYBILJwfF5FJQ
   FVLh2cg/X9zKAhXyPKsWKHX2DFk0GZx5eOyvvrkRjelfsN8pvFQ+EXwVn
   jHZPFsZAK0/jCnUZFQU3kobZ3wduhlHzWYgmi6tSu/GydS4aGDcKxU2Qn
   g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10261"; a="250820601"
X-IronPort-AV: E=Sophos;i="5.88,378,1635231600"; 
   d="yaml'?scan'208";a="250820601"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Feb 2022 22:35:54 -0800
X-IronPort-AV: E=Sophos;i="5.88,378,1635231600"; 
   d="yaml'?scan'208";a="605460382"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Feb 2022 22:35:47 -0800
...
Content-Disposition: attachment; filename="config-5.17.0-rc2-00015-g237b4454014d"
...
commit'
	...
	export submit_id='620e7d088eb8ae50a8db9695'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-remap-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-237b4454014d3759acc6459eb329c5e3d551-20220218-20648-cts3pb-5.yaml'
	export id='b77cd01d9fd42ed946f29ebc423f1989b8a91865'
	...
	export need_kconfig=
	export commit='237b4454014d3759acc6459eb329c5e3d55113ed'
	export ucode='0xd000280'
	export bisect_dmesg=true
	export enqueue_time='2022-02-18 00:51:21 +0800'
	export _id='620e7d228eb8ae50a8db9697'
	export _rt='/result/stress-ng/memory-performance-100%-remap-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed'
	export user='lkp'
	...
	export branch='linux-review/Hugh-Dickins/mm-munlock-rework-of-mlock-munlock-page-handling/20220215-104421'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/stress-ng/memory-performance-100%-remap-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/3'
	export scheduler_version='/lkp/lkp/.src-20220217-223842'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/memory-performance-100%-remap-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/vmlinuz-5.17.0-rc2-00015-g237b4454014d
branch=linux-review/Hugh-Dickins/mm-munlock-rework-of-mlock-munlock-page-handling/20220215-104421
job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-remap-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-237b4454014d3759acc6459eb329c5e3d551-20220218-20648-cts3pb-5.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=237b4454014d3759acc6459eb329c5e3d55113ed
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/vmlinuz-5.17.0-rc2-00015-g237b4454014d'
	export dequeue_time='2022-02-18 00:57:20 +0800'
	export job_state='downgrade_ucode'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-remap-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-237b4454014d3759acc6459eb329c5e3d551-20220218-20648-cts3pb-5.cgz'
...
run_job()
{
	...
	run_test class='memory' test='remap' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='memory' test='remap' $LKP_SRC/stats/wrapper stress-ng
...
kconfig: x86_64-rhel-8.3
submit_id: 620e35e68eb8ae2756b1c0e4
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-remap-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-237b4454014d3759acc6459eb329c5e3d551-20220217-10070-15jk18c-2.yaml"
id: 51b4c9866b2eaa9835471bf94377a7ebf565c17c
...
ucode: '0xd000280'
bisect_dmesg: true
enqueue_time: 2022-02-17 19:47:50.818356313 +08:00
_id: 620e3b6c8eb8ae2756b1c0e6
_rt: "/result/stress-ng/memory-performance-100%-remap-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
...
result_root: "/result/stress-ng/memory-performance-100%-remap-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/0"
scheduler_version: "/lkp/lkp/.src-20220217-171907"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/vmlinuz-5.17.0-rc2-00015-g237b4454014d
- branch=linux-devel/devel-hourly-20220215-215339
- job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-remap-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-237b4454014d3759acc6459eb329c5e3d551-20220217-10070-15jk18c-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=237b4454014d3759acc6459eb329c5e3d55113ed
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/modules.cgz"
...
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/237b4454014d3759acc6459eb329c5e3d55113ed/vmlinuz-5.17.0-rc2-00015-g237b4454014d"
dequeue_time: 2022-02-17 20:16:56.271187361 +08:00
:#! /cephfs/db/releases/20220217171601/lkp-src/include/site/inn:
job_state: finished
loadavg: 51.42 22.96 8.54 1/1158 9664
start_time: '1645100299'
end_time: '1645100361'
version: "/lkp/lkp/.src-20220217-171949:848a26a9:499352d36"
