...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 23C005ABFD5
	for <lists+linux-kernel@lfdr.de>; Sat,  3 Sep 2022 18:39:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230247AbiICQie (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 3 Sep 2022 12:38:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58250 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229506AbiICQi1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 3 Sep 2022 12:38:27 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 48B0F543D2;
        Sat,  3 Sep 2022 09:38:25 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id CB72060A52;
        Sat,  3 Sep 2022 16:38:24 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 52F80C43470;
        Sat,  3 Sep 2022 16:38:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1662223104;
        bh=e5gxhSR7NWJOU3kqPri/F9JTmlvxuL7j/0tIey7mJG0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH 1/3] riscv: convert to generic entry
Date:   Sat,  3 Sep 2022 12:38:06 -0400
Message-Id: <20220903163808.1954131-2-guoren@kernel.org>
...
---
 ...
 14 files changed, 114 insertions(+), 281 deletions(-)
...
index 384a63b86420..4c842e94e8ea 100644
--- a/arch/riscv/include/asm/syscall.h
+++ b/arch/riscv/include/asm/syscall.h
@@ -74,5 +74,10 @@ static inline int syscall_get_arch(struct task_struct *task)
 #endif
 }
...
index 2ae8280ae475..7af3c64a4792 100644
--- a/arch/riscv/kernel/ptrace.c
+++ b/arch/riscv/kernel/ptrace.c
@@ -229,46 +229,6 @@ long arch_ptrace(struct task_struct *child, long request,
 	return ret;
 }
...
index 5a2de6b6f882..afc8c030c222 100644
--- a/arch/riscv/kernel/signal.c
+++ b/arch/riscv/kernel/signal.c
@@ -272,7 +272,7 @@ static void handle_signal(struct ksignal *ksig, struct pt_regs *regs)
...
@@ -309,21 +309,3 @@ static void do_signal(struct pt_regs *regs)
 	 */
