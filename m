...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3BFBC54AA71
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Jun 2022 09:22:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353221AbiFNHSP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Jun 2022 03:18:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56614 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1353851AbiFNHRn (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Jun 2022 03:17:43 -0400
Received: from mail-yw1-x1149.google.com (mail-yw1-x1149.google.com [IPv6:2607:f8b0:4864:20::1149])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4014922BDC
        for <linux-kernel@vger.kernel.org>; Tue, 14 Jun 2022 00:17:35 -0700 (PDT)
Received: by mail-yw1-x1149.google.com with SMTP id 00721157ae682-2fb7cb07885so18083687b3.23
        for <linux-kernel@vger.kernel.org>; Tue, 14 Jun 2022 00:17:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=1lOE5t8o2yeMc5iixSWBVChzMuc1vXrRk+ZMe6goKJE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1lOE5t8o2yeMc5iixSWBVChzMuc1vXrRk+ZMe6goKJE=;
        b=
X-Gm-Message-State: AJIora9nus30gNApyBK56ROknIp5o8lrfV7ZdOFShwpkiSvcbZrrenxZ
        UJUsDxjKvhTQ6ohgqzp2C4/Y4luBEUA=
X-Google-Smtp-Source: AGRyM1t5oE/Mv9V4B7jK8Iz8SSWC8NetooLsi8tRY2ePOd97qj6cK3Z+9aBcI9v/Tqco3zXyBmnLfSxfsjc=
X-Received: from yuzhao.bld.corp.google.com ([2620:15c:183:200:eaa7:1f3f:e74a:2a26])
 (user=yuzhao job=sendgmr) by 2002:a05:6902:905:b0:64a:2089:f487 with SMTP id
 bu5-20020a056902090500b0064a2089f487mr3628163ybb.202.1655191054835; Tue, 14
 Jun 2022 00:17:34 -0700 (PDT)
Date:   Tue, 14 Jun 2022 01:16:43 -0600
In-Reply-To: <20220614071650.206064-1-yuzhao@google.com>
Message-Id: <20220614071650.206064-7-yuzhao@google.com>
Mime-Version: 1.0
References: <20220614071650.206064-1-yuzhao@google.com>
X-Mailer: git-send-email 2.36.1.476.g0c4daa206d-goog
Subject: [PATCH v12 06/14] mm: multi-gen LRU: minimal implementation
...
index 4e09ff5b0947..8d09609cfb5e 100644
--- a/mm/swap.c
+++ b/mm/swap.c
...
index 1fcc0feed985..60019e7e1ad8 100644
--- a/mm/vmscan.c
+++ b/mm/vmscan.c
@@ -1273,9 +1273,11 @@ static int __remove_mapping(struct address_space *ma=
...
@@ -2675,6 +2677,9 @@ static void prepare_scan_count(pg_data_t *pgdat, stru=
ct scan_control *sc)
 	unsigned long file;
...
=20
 	/*
@@ -2998,6 +3003,17 @@ static bool can_age_anon_pages(struct pglist_data *p=
gdat,
  *                          shorthand helpers
  *************************************************************************=
*****/
...
@@ -3023,6 +3039,759 @@ static struct lruvec __maybe_unused *get_lruvec(str=
...
@@ -3078,6 +3857,11 @@ static void shrink_lruvec(struct lruvec *lruvec, str=
uct scan_control *sc)
 	struct blk_plug plug;
 	bool scan_adjusted;
=20
...
@@ -3582,6 +4366,9 @@ static void snapshot_refaults(struct mem_cgroup *targ=
...
@@ -3946,12 +4733,17 @@ unsigned long try_to_free_mem_cgroup_pages(struct m=
em_cgroup *memcg,
 }
 #endif
=20
...
+
 	if (!can_age_anon_pages(pgdat, sc))
 		return;
=20
@@ -4271,12 +5063,11 @@ static int balance_pgdat(pg_data_t *pgdat, int orde=
