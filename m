...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0797354AA6C
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Jun 2022 09:22:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1354383AbiFNHSe (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Jun 2022 03:18:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58214 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1351605AbiFNHSH (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Jun 2022 03:18:07 -0400
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ADA38289A6
        for <linux-kernel@vger.kernel.org>; Tue, 14 Jun 2022 00:17:41 -0700 (PDT)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-30ffc75d920so18693667b3.2
        for <linux-kernel@vger.kernel.org>; Tue, 14 Jun 2022 00:17:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=Q7v2T6X/zJiyIC3e0fkAJQtp/n0YUqwJeWrc2+y/27U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Q7v2T6X/zJiyIC3e0fkAJQtp/n0YUqwJeWrc2+y/27U=;
        b=
X-Gm-Message-State: AJIora+a0qNuENg7Wb3qjrj1YO0K/LHyfoSTrM1eZIj+hmzLWKlJFTfo
        bkT2XWqWRaomMyrNVHK10QjInBhmXu8=
X-Google-Smtp-Source: AGRyM1u8QD5Mt6U73k3XqxleHuNuTWhf6gB2Vo/ucy6mfcNSBAId9gUAk8cDSTwaaFfQgnuM6FPnKP9TYJM=
X-Received: from yuzhao.bld.corp.google.com ([2620:15c:183:200:eaa7:1f3f:e74a:2a26])
 (user=yuzhao job=sendgmr) by 2002:a25:bed0:0:b0:664:b4af:5bc9 with SMTP id
 k16-20020a25bed0000000b00664b4af5bc9mr3429706ybm.424.1655191060780; Tue, 14
 Jun 2022 00:17:40 -0700 (PDT)
Date:   Tue, 14 Jun 2022 01:16:47 -0600
In-Reply-To: <20220614071650.206064-1-yuzhao@google.com>
Message-Id: <20220614071650.206064-11-yuzhao@google.com>
Mime-Version: 1.0
References: <20220614071650.206064-1-yuzhao@google.com>
X-Mailer: git-send-email 2.36.1.476.g0c4daa206d-goog
Subject: [PATCH v12 10/14] mm: multi-gen LRU: kill switch
...
index 4746c4874795..2b6de7e38aa7 100644
--- a/mm/vmscan.c
+++ b/mm/vmscan.c
@@ -52,6 +52,7 @@
 #include <linux/psi.h>
...
*****
  ...
  *************************************************************************=
*****/
@@ -3888,7 +3897,8 @@ static void walk_pmd_range_locked(pud_t *pud, unsigne=
...
@@ -3986,10 +3996,12 @@ static void walk_pmd_range(pud_t *pud, unsigned lon=
...
+		}
 ...
 pmd + i))
 			continue;
@@ -4247,7 +4259,7 @@ static bool try_to_inc_max_seq(struct lruvec *lruvec,=
...
@@ -4968,6 +4980,211 @@ static void lru_gen_shrink_lruvec(struct lruvec *lr=
...
*****
  ...
  *************************************************************************=
*****/
@@ -4978,6 +5195,7 @@ void lru_gen_init_lruvec(struct lruvec *lruvec)
 	struct lru_gen_struct *lrugen =3D &lruvec->lrugen;
=20
...
@@ -5017,6 +5235,9 @@ static int __init init_lru_gen(void)
