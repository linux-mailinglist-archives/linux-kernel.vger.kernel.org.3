...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BCB65502605
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Apr 2022 09:11:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1350907AbiDOHNn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 Apr 2022 03:13:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35438 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1350900AbiDOHNl (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 Apr 2022 03:13:41 -0400
Received: from mail-io1-xd2d.google.com (mail-io1-xd2d.google.com [IPv6:2607:f8b0:4864:20::d2d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6DAB83702D
        for <linux-kernel@vger.kernel.org>; Fri, 15 Apr 2022 00:11:11 -0700 (PDT)
Received: by mail-io1-xd2d.google.com with SMTP id g21so7620575iom.13
        for <linux-kernel@vger.kernel.org>; Fri, 15 Apr 2022 00:11:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=kTARMajvLODzHYHdaQw6WLqF5wtBf8RiN7g15zWmoXw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=kTARMajvLODzHYHdaQw6WLqF5wtBf8RiN7g15zWmoXw=;
        b=
X-Gm-Message-State: AOAM533Zj92PvzDK8vVBpXMxiUu6pVxdeORe+c7gGTBcg8E79abCBWpk
        t32vdyrLZT9e2L1DvOZMrACt3Q==
X-Google-Smtp-Source: ABdhPJxBw2B2p2LhKvXe+ymBE+5tfkwNLNnLnC6FvOVN8ogzqKAJYtMjdOU4NvIq7Bl73XsdDa0CYg==
X-Received: by 2002:a05:6638:14d1:b0:326:307e:9a37 with SMTP id l17-20020a05663814d100b00326307e9a37mr2832663jak.175.1650006670554;
        Fri, 15 Apr 2022 00:11:10 -0700 (PDT)
Received: from google.com ([2620:15c:183:200:e02:decc:64d3:b1d3])
        by smtp.gmail.com with ESMTPSA id j9-20020a926e09000000b002c9f3388cd4sm2202548ilc.21.2022.04.15.00.11.09
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 15 Apr 2022 00:11:09 -0700 (PDT)
...
Message-ID: <YlkaiUopM5HKWEdX@google.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="1/r5SNa240cf00nL"
Content-Disposition: inline
In-Reply-To: <20220414121911.8bb89fc3681b13af1566d79c@linux-foundation.org>
...
#
CONFIG_CC_VERSION_TEXT="clang version google3-trunk (5d7e0a23c6f2051d4caf8f8c8821790c40b584be)"
...
CONFIG_CMDLINE="oops=panic panic=10 io_delay=0xed libata.allow_tpm=1 nmi_watchdog=panic tco_start=1 quiet slab_nomerge fb_tunnels=none firmware_class.path=/var/google/session acpi_enforce_resources=lax video=efifb:off hest_disable=1 erst_disable=1 bert_disable=1 eagerfpu=on kvm_amd.nested=0 kvm_intel.pml=0 debug_pagealloc=on"
