...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BDB8C4EAB84
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Mar 2022 12:42:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235323AbiC2Koa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 29 Mar 2022 06:44:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57426 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231955AbiC2Ko1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 29 Mar 2022 06:44:27 -0400
Received: from mail-lj1-x242.google.com (mail-lj1-x242.google.com [IPv6:2a00:1450:4864:20::242])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B19D5ECB10
        for <linux-kernel@vger.kernel.org>; Tue, 29 Mar 2022 03:42:40 -0700 (PDT)
Received: by mail-lj1-x242.google.com with SMTP id q5so22841751ljb.11
        for <linux-kernel@vger.kernel.org>; Tue, 29 Mar 2022 03:42:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=openvz-org.20210112.gappssmtp.com; s=20210112;
        h=subject:from:to:date:message-id:in-reply-to:references:user-agent
         :mime-version:content-transfer-encoding;
        bh=moKT/kE8xs3hk9szVGSGz1FPxswvkSfJJgpuu/WpJzc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=moKT/kE8xs3hk9szVGSGz1FPxswvkSfJJgpuu/WpJzc=;
        b=
X-Gm-Message-State: AOAM532u6trCb8VX2XLGIwFzrKgAr7X2ogbYtutV3XFOG1qoDVoJ3/oN
        XF9ruyQENQxquHyS+DTN3wBbhtE6a043GyA5xEU=
X-Google-Smtp-Source: ABdhPJyvImi8oopLEfXpEoXQlTARe5sHAL0WDGhMl5TyEwEqajJniiqRVo9XxODqIjbN0kDAgNWHFw==
X-Received: by 2002:a2e:580d:0:b0:24a:b9da:2d33 with SMTP id m13-20020a2e580d000000b0024ab9da2d33mr1994672ljb.376.1648550557677;
        Tue, 29 Mar 2022 03:42:37 -0700 (PDT)
Received: from [127.0.1.1] ([2.92.192.13])
        by smtp.gmail.com with ESMTPSA id br12-20020a056512400c00b0044a2c454ebcsm1949205lfb.27.2022.03.29.03.42.36
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 29 Mar 2022 03:42:37 -0700 (PDT)
Subject: [PATCH 3/4 v1.5] dm-qcow2: Introduce driver to create block devices
 over QCOW2 files
...
Date:   Tue, 29 Mar 2022 13:42:36 +0300
Message-ID: <164855032398.175386.3296056794747612227.stgit@pro>
...
v1.5: Fix 32-bit platform compilation problems (64-bit division,
      reported by kernel test robot <lkp@intel.com>).
      Replace to_bytes() with "<< SECTOR_SHIFT" since to_bytes()
      is unsigned long and it is not enough for 32-bit platforms.
      Select ZLIB_INFLATE instead of depends on ZLIB_INFLATE.
---
 drivers/md/Kconfig           |   17 
 drivers/md/Makefile          |    2 
 drivers/md/dm-qcow2-cmd.c    |  383 ++++
 drivers/md/dm-qcow2-map.c    | 4252 ++++++++++++++++++++++++++++++++++++++++++
 drivers/md/dm-qcow2-target.c | 1026 ++++++++++
 drivers/md/dm-qcow2.h        |  368 ++++
 6 files changed, 6048 insertions(+)
...
index b5ea378e66cb..88f206582b12 100644
...
new file mode 100644
index 000000000000..8d96ccfdda95
--- /dev/null
...
new file mode 100644
index 000000000000..c8d74020d958
--- /dev/null
