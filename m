...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CCF174EE5D7
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Apr 2022 03:54:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243889AbiDAB4g (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 31 Mar 2022 21:56:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48812 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233627AbiDAB4e (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 31 Mar 2022 21:56:34 -0400
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8F5111925A6
        for <linux-kernel@vger.kernel.org>; Thu, 31 Mar 2022 18:54:45 -0700 (PDT)
Received: from dggpemm500022.china.huawei.com (unknown [172.30.72.57])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4KV38v33NjzgYCn;
        Fri,  1 Apr 2022 09:53:03 +0800 (CST)
Received: from dggpemm500013.china.huawei.com (7.185.36.172) by
 dggpemm500022.china.huawei.com (7.185.36.162) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2308.21; Fri, 1 Apr 2022 09:54:43 +0800
...
CC:     <alexander.sverdlin@nokia.com>, <chenzhongjin@huawei.com>,
        <ardb@kernel.org>, <linus.walleij@linaro.org>, <nico@fluxnic.net>,
        <linux-arm-kernel@lists.infradead.org>,
        <linux-kernel@vger.kernel.org>
Subject: [PATCH v3] ARM: module: Add all unwind tables when load module
Date:   Fri, 1 Apr 2022 09:53:57 +0800
Message-ID: <20220401015357.127704-1-chenzhongjin@huawei.com>
...
---
Changes v2 -> v3:
- unwind "txtname" and add some blank, to make code clear.
...
index 549abcedf795..6c2cd7e56ae4 100644
