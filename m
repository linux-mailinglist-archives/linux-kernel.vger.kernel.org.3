...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 566C05A4E41
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Aug 2022 15:35:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230050AbiH2Nfp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 29 Aug 2022 09:35:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229909AbiH2Nfd (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 29 Aug 2022 09:35:33 -0400
Received: from xry111.site (xry111.site [89.208.246.23])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ECF065C95C
        for <linux-kernel@vger.kernel.org>; Mon, 29 Aug 2022 06:35:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=xry111.site;
        s=default; t=1661780130;
        bh=BJCBxUWKejGmzZrZS6QO1molGZ5Mm2lyPP2WX6zLhcA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=YKkmU3ntmfBf5eKxRqcbIlB0vYzdHikeD/OzjT4nIllmxeWPmWL4lzd6b0XwJmKES
         SV+QKQqMTUA0S65QCS887JSLKS4/6q0G+OtNhe5pWxU1XbJn7E43EmhIZq9g4wfOnu
         OsK4Rok8jqSgg7yCjwgoCF0CzqBM92wSdqa5HIeI=
Received: from xry111-x57s1.. (unknown [IPv6:240e:358:11dd:1900:dc73:854d:832e:5])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-384) server-digest SHA384)
        (Client did not present a certificate)
        (Authenticated sender: xry111@xry111.site)
        by xry111.site (Postfix) with ESMTPSA id 66BDD66905;
        Mon, 29 Aug 2022 09:35:21 -0400 (EDT)
...
Subject: [PATCH v6 5/6] LoongArch: Support PC-relative relocations in modules
Date:   Mon, 29 Aug 2022 21:31:45 +0800
Message-Id: <20220829133146.15236-6-xry111@xry111.site>
