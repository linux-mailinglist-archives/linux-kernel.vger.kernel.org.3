...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AB9684D1A3F
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Mar 2022 15:19:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347436AbiCHOTw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Mar 2022 09:19:52 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43576 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347427AbiCHOTt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Mar 2022 09:19:49 -0500
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id D0FC14B412
        for <linux-kernel@vger.kernel.org>; Tue,  8 Mar 2022 06:18:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1646749128;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=w1fUtPUjx0Z9Z9za5Q1IpqQcEaHtZcmSAPW3wql7Juk=;
        b=NrtOxq2RLWjQeu/c9NWux0i71/iJ1lkJqsEi3lscOtaxqmVpjtzTs2N+oTuUvOP6XmrCgG
        2leaH3pP2yVs0Vw39J9wnGJURA/z/XXu2yzq5cuRK5xvDFlCDFK+/KCafNjJpbtADmRIsP
        Z7C5aR66LdDJuvHxh4ZD93+pIPZ/E3Q=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-258-ZnLZ9B_VOyCA0jvYZzGWGw-1; Tue, 08 Mar 2022 09:18:44 -0500
X-MC-Unique: ZnLZ9B_VOyCA0jvYZzGWGw-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com [10.5.11.11])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 40FC8FC80;
        Tue,  8 Mar 2022 14:18:41 +0000 (UTC)
Received: from t480s.redhat.com (unknown [10.39.195.19])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 8DED67886E;
...
Subject: [PATCH v1 13/15] mm: support GUP-triggered unsharing of anonymous pages
Date:   Tue,  8 Mar 2022 15:14:35 +0100
Message-Id: <20220308141437.144919-14-david@redhat.com>
...
index 0e83c1551da3..617ed753996e 100644
--- a/mm/huge_memory.c
+++ b/mm/huge_memory.c
...
index e40d6b68e25a..7161f33aff9a 100644
--- a/mm/hugetlb.c
+++ b/mm/hugetlb.c
@@ -5139,15 +5139,16 @@ static void unmap_ref_private(struct mm_struct *mm, struct vm_area_struct *vma,
 }
...
@@ -5156,15 +5157,22 @@ static vm_fault_t hugetlb_cow(struct mm_struct *mm, struct vm_area_struct *vma,
...
@@ -5267,13 +5275,13 @@ static vm_fault_t hugetlb_cow(struct mm_struct *mm, struct vm_area_struct *vma,
...
+				make_huge_pte(vma, new_page, !unshare));
 		...
 		new_page = old_page;
@@ -5281,7 +5289,10 @@ static vm_fault_t hugetlb_cow(struct mm_struct *mm, struct vm_area_struct *vma,
 	spin_unlock(ptl);
...
+	 */
 	...
 	put_page(new_page);
@@ -5404,7 +5415,8 @@ static vm_fault_t hugetlb_no_page(struct mm_struct *mm,
 	/*
...
@@ -5530,7 +5542,7 @@ static vm_fault_t hugetlb_no_page(struct mm_struct *mm,
...
+		ret = hugetlb_wp(mm, vma, address, ptep, flags, page, ptl);
 	...
 	spin_unlock(ptl);
@@ -5660,14 +5672,15 @@ vm_fault_t hugetlb_fault(struct mm_struct *mm, struct vm_area_struct *vma,
 		goto out_mutex;
...
+	    !huge_pte_write(entry)) {
 		if (vma_needs_reservation(h, vma, haddr) < 0) {
 			ret = VM_FAULT_OOM;
 			goto out_mutex;
@@ -5682,12 +5695,12 @@ vm_fault_t hugetlb_fault(struct mm_struct *mm, struct vm_area_struct *vma,
...
+	 * hugetlb_wp() requires page locks of pte_page(entry) and
 	 ...
 	 */
@@ -5700,13 +5713,14 @@ vm_fault_t hugetlb_fault(struct mm_struct *mm, struct vm_area_struct *vma,
...
index a804f12d878c..94355bb34d8c 100644
--- a/mm/memory.c
+++ b/mm/memory.c
...
@@ -4506,8 +4541,11 @@ static inline vm_fault_t create_huge_pmd(struct vm_fault *vmf)
...
@@ -4642,10 +4680,11 @@ static vm_fault_t handle_pte_fault(struct vm_fault *vmf)
...
@@ -4685,7 +4724,6 @@ static vm_fault_t __handle_mm_fault(struct vm_area_struct *vma,
...
-	unsigned int dirty = flags & FAULT_FLAG_WRITE;
 	...
 	pgd_t *pgd;
 	p4d_t *p4d;
@@ -4710,9 +4748,11 @@ static vm_fault_t __handle_mm_fault(struct vm_area_struct *vma,
 		barrier();
...
+			if ((flags & FAULT_FLAG_WRITE) && !pud_write(orig_pud)) {
 				...
 				if (!(ret & VM_FAULT_FALLBACK))
 					return ret;
@@ -4750,7 +4790,8 @@ static vm_fault_t __handle_mm_fault(struct vm_area_struct *vma,
