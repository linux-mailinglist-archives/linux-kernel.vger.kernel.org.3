...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 24F2D55C59C
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Jun 2022 14:51:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345188AbiF1LBj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Jun 2022 07:01:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57972 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344833AbiF1LAi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Jun 2022 07:00:38 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 505A12F3B5
        for <linux-kernel@vger.kernel.org>; Tue, 28 Jun 2022 04:00:27 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id C20F0B81DC6
        for <linux-kernel@vger.kernel.org>; Tue, 28 Jun 2022 11:00:25 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8F651C341CB;
        Tue, 28 Jun 2022 11:00:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1656414024;
        bh=kC6pzzvTGVS2nOT1YCD5xW3o9aSZ8Gy97TCjRaYf6TM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Oded Gabbay <ogabbay@kernel.org>
To:     linux-kernel@vger.kernel.org
Cc:     gregkh@linuxfoundation.org, Moti Haimovski <mhaimovski@habana.ai>
Subject: [PATCH v2 11/12] habanalabs: add gaudi2 MMU support
Date:   Tue, 28 Jun 2022 13:59:57 +0300
Message-Id: <20220628105958.1254875-12-ogabbay@kernel.org>
...
---
Changes in v2:
 - Remove mfence command as it is redundant
 - Use correct type for passing dma_addr_t pointer
 - Add explicit casting from integer to pointer
...
index 7723575ba737..0bea03a116fa 100644
...
+	struct hl_hr_mmu_funcs hr_funcs;
 ...
 /**
@@ -3460,10 +3500,39 @@ int hl_mmu_prefetch_cache_range(struct hl_ctx *ctx, u32 flags, u32 asid, u64 va,
...
index f3734718d94f..0cbe89285f96 100644
