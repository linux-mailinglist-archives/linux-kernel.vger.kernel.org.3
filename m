...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 23E9B56AB9A
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Jul 2022 21:14:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236483AbiGGTMV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 Jul 2022 15:12:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33112 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235677AbiGGTMU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 Jul 2022 15:12:20 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E435731207
        for <linux-kernel@vger.kernel.org>; Thu,  7 Jul 2022 12:12:16 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id g12-20020a05690203cc00b0066e232409c9so11296046ybs.22
        for <linux-kernel@vger.kernel.org>; Thu, 07 Jul 2022 12:12:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:message-id:mime-version:subject:from:to:cc;
        bh=4BfyaivkteRElvRQwQwVdeOczj8ZXDW+CW9mae6P20M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:date:message-id:mime-version:subject:from:to:cc;
        bh=4BfyaivkteRElvRQwQwVdeOczj8ZXDW+CW9mae6P20M=;
        b=
X-Gm-Message-State: AJIora8XiCHKZCHA+pjwUjPBgLOww592ZC01Sd6tBCVOaN6PCENPoaOf
        YDldvXYbZXkDTwCmMFGJ0gzg/2JJ/BGW
X-Google-Smtp-Source: AGRyM1ttWGRcreE05iU+73nHkpj0QU2XhcDd0s+YXuNOhmwUtZxy8eveAz8djbYMvzDIAwtL8vX1hlJPNxiB
X-Received: from irogers.svl.corp.google.com ([2620:15c:2d4:203:bf75:f79:d509:a8d1])
 (user=irogers job=sendgmr) by 2002:a05:6902:134e:b0:66c:8d89:6fd with SMTP id
 g14-20020a056902134e00b0066c8d8906fdmr52692567ybu.199.1657221136215; Thu, 07
 Jul 2022 12:12:16 -0700 (PDT)
Date:   Thu,  7 Jul 2022 12:12:09 -0700
Message-Id: <20220707191209.273065-1-irogers@google.com>
Mime-Version: 1.0
X-Mailer: git-send-email 2.37.0.rc0.161.g10f37bed90-goog
Subject: [PATCH v2] perf parse-events: Break out tracepoint and printing.
...
index 897fc504918b..f031bb9c287b 100644
...
-
 ...
 {
 	switch (type) {
@@ -2666,571 +2531,6 @@ int exclude_perf(const struct option *opt,
 					  NULL);
 }
