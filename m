...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 440B04E4E34
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Mar 2022 09:28:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242660AbiCWI3T (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Mar 2022 04:29:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36902 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242760AbiCWI27 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Mar 2022 04:28:59 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9725175C09;
        Wed, 23 Mar 2022 01:27:25 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id BD914B81E40;
        Wed, 23 Mar 2022 08:27:23 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F3477C340E8;
        Wed, 23 Mar 2022 08:27:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1648024042;
        bh=IDTRduZ3hlWUhEWjFWNE1XUNwOIoP/5Fv1uSCBtbxCY=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=L9M23fOqoMJLDrj7fBGddIE6p9XEGTQf4tDcJG4RvxBKqBNlO+vuUGmtYK4MgoCeH
         aUvw2yIHRipgijzv+2D+AtOtoSexlWqiAYRUS3zkrxmPkeH/bX+F9TIZLUw8YuvepB
         3W47SqrfHTLW6a2+0tDBRa2aKUMixh5IkmMlXVQU=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.19.236
Date:   Wed, 23 Mar 2022 09:27:12 +0100
Message-Id: <1648024031147197@kroah.com>
X-Mailer: git-send-email 2.35.1
In-Reply-To: <164802403112185@kroah.com>
References: <164802403112185@kroah.com>
MIME-Version: 1.0
...
index 6bfb0a18ee8a..d83513c13520 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 1daefa57e274..a101f5d2fbed 100644
...
index dda6e5056810..05f41d8f7db3 100644
...
index dd320df0d026..b37d185e0e84 100644
...
index ed99d941c462..e90cf51b87ec 100644
...
index d191ce8410db..d0b7dd60861b 100644
...
index 122d5e843ab6..03b0fdccaf05 100644
...
index e54249ccc009..e41ca58bf7b6 100644
...
@@ -1368,7 +1366,6 @@ static int udc_bind_to_driver(struct usb_udc *udc, struct usb_gadget_driver *dri
...
index b5aa60430a6a..7a08053d95c2 100644
--- a/fs/ocfs2/super.c
+++ b/fs/ocfs2/super.c
...
index 5166eb40917d..011e391497f4 100644
--- a/fs/sysfs/file.c
+++ b/fs/sysfs/file.c
...
index d43d25acc95a..153628277a48 100644
...
index ebca069064df..3d52431dea9b 100644
...
@@ -1466,7 +1463,8 @@ static struct xfrm_state *xfrm_state_clone(struct xfrm_state *orig,
 	return NULL;
 }
...
index 8d8f9e778cd4..3db5cd70b16a 100644
