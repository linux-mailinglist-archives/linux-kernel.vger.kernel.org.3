...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 34F88573171
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Jul 2022 10:47:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234830AbiGMIrE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Jul 2022 04:47:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56348 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234064AbiGMIrA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Jul 2022 04:47:00 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 35CC4C1FD3
        for <linux-kernel@vger.kernel.org>; Wed, 13 Jul 2022 01:46:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1657702016; x=1689238016;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=nHjB5MNNA7hkBo6BltbX77oVhiUnAADVV1ARRiOzFHA=;
  b=W20o4bOjCyYccC/e9aiCxcdAS9sAQMFNxdvnvgv/JD88r/gFMY+7CAMs
   aVbnuT5YRpht5cUAtUbrP+obqJz3RRQ5Gy3WAQCgQbMaRiM+ON7RhN31H
   sjtZlXOrww8VqNIzNMp/1pATuz8izuYxBlCKvkEzocv3MuUAS03eyrhC8
   6DxXxnI3P76RDQWjQ62bJz9RkfXeBBfMxZcJudzKWWiQzfSmwlbsDJRDc
   N7s9TabZS0yRWSth6753nZdKsquzkrUa1jsxiTisGNzJ9oRfelG/42mu5
   5bYMM8rcrXqMsjqNWA81n90w1Fwku9x+ppEGBkXeJOG7vvJNH2urZbVOT
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10406"; a="285898601"
X-IronPort-AV: E=Sophos;i="5.92,267,1650956400"; 
   d="scan'208";a="285898601"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jul 2022 01:46:55 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,267,1650956400"; 
   d="scan'208";a="570540801"
Received: from lkp-server02.sh.intel.com (HELO 8708c84be1ad) ([10.239.97.151])
  by orsmga006.jf.intel.com with ESMTP; 13 Jul 2022 01:46:53 -0700
Received: from kbuild by 8708c84be1ad with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1oBY1E-0003Id-EL;
        Wed, 13 Jul 2022 08:46:52 +0000
Date:   Wed, 13 Jul 2022 16:46:29 +0800
...
Subject: [agd5f:drm-next 423/465]
 ...
 no previous prototype for function 'retrieve_dmi_info'
Message-ID: <202207131637.mnksaodB-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="cDwgPTwnCO5qB/DJ"
...
config: s390-randconfig-r031-20220712
...
All warnings (new ones prefixed by >>):
   ...
   include/asm-generic/io.h:652:21: warning: performing pointer arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
           writesl(PCI_IOBASE + addr, buffer, count);
                   ~~~~~~~~~~ ^
>> drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.c:1427:6: warning: no previous prototype for function 'retrieve_dmi_info' [-Wmissing-prototypes]
   void retrieve_dmi_info(struct amdgpu_display_manager *dm)
        ^
   drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.c:1427:1: note: declare 'static' if the function is not intended to be used outside of this translation unit
   void retrieve_dmi_info(struct amdgpu_display_manager *dm)
   ^
   static 
