...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1EFF44E7D88
	for <lists+linux-kernel@lfdr.de>; Sat, 26 Mar 2022 01:22:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233330AbiCYVP7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 25 Mar 2022 17:15:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43010 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233331AbiCYVPw (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 25 Mar 2022 17:15:52 -0400
Received: from 4.mo550.mail-out.ovh.net (4.mo550.mail-out.ovh.net [46.105.76.26])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 031611EEF0
        for <linux-kernel@vger.kernel.org>; Fri, 25 Mar 2022 14:14:15 -0700 (PDT)
Received: from player773.ha.ovh.net (unknown [10.109.156.39])
        by mo550.mail-out.ovh.net (Postfix) with ESMTP id 6D6C0249DD
        for <linux-kernel@vger.kernel.org>; Fri, 25 Mar 2022 16:25:09 +0000 (UTC)
Received: from sk2.org (82-65-25-201.subs.proxad.net [82.65.25.201])
        (Authenticated sender: steve@sk2.org)
        by player773.ha.ovh.net (Postfix) with ESMTPSA id B898628DB23C5;
        Fri, 25 Mar 2022 16:25:03 +0000 (UTC)
Authentication-Results: garm.ovh; auth=pass (GARM-95G001ed1861c5-34a7-4574-a95d-039b926bb30b,
...
Subject: [PATCH] ASoC: wm*: use simple i2c probe function
Date:   Fri, 25 Mar 2022 17:24:39 +0100
Message-Id: <20220325162439.1203870-1-steve@sk2.org>
X-Mailer: git-send-email 2.27.0
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Ovh-Tracer-Id: 17070049966128727686
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: -100
X-VR-SPAMCAUSE: 
...
index 86b1f6eaa599..cf8e541d146d 100644
...
+static int wm8731_i2c_probe(struct i2c_client *i2c)
 {
 	...
 	int ret;
@@ -793,7 +792,7 @@ static struct i2c_driver wm8731_i2c_driver = {
 		.name = "wm8731",
...
index 499604f1e178..a7a62eaa64dc 100644
--- a/sound/soc/codecs/wm8960.c
+++ b/sound/soc/codecs/wm8960.c
@@ -1401,8 +1401,7 @@ static void wm8960_set_pdata_from_of(struct i2c_client *i2c,
...
@@ -1500,7 +1499,7 @@ static struct i2c_driver wm8960_i2c_driver = {
 		.name = "wm8960",
...
index a5584ba962dc..85f57f0f76b7 100644
...
@@ -3879,7 +3878,7 @@ static struct i2c_driver wm8962_i2c_driver = {
...
index 21ae55c32a6d..777669eefe29 100644
...
+static int wm8971_i2c_probe(struct i2c_client *i2c)
 {
 	...
 	int ret;
@@ -705,7 +704,7 @@ static struct i2c_driver wm8971_i2c_driver = {
 	.driver = {
 		.name = "wm8971",
 	},
