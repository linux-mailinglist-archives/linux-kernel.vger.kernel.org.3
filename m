...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3887254C3A2
	for <lists+linux-kernel@lfdr.de>; Wed, 15 Jun 2022 10:37:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245729AbiFOIhR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 15 Jun 2022 04:37:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39588 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245032AbiFOIhI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 15 Jun 2022 04:37:08 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 59AB32FFD5;
        Wed, 15 Jun 2022 01:37:00 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1655282220; x=1686818220;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=jRsonxIoeDngAGVp/9nDVUtcVsuAO0jJ2TRUg/sPItI=;
  b=TSm5/W5TWrZx8UENwnKvMT7YIU05u28+xJpSfrABMxgsvLhchGAP++NK
   BeUl03qlPWqq6Bu6N6Yct4AUH18BsczbwLHpz18i7Wkqh6vYjGdUsHPbg
   QXbZ7CwtoBRVSTik7amScfywLfnqqUdzFw4Q+sIXGFcltSpXWSzAGmHuk
   9DelfNEVrBf9DTxcQAvKd6JDXDusCVGqr3Vhhc7hXCe0XV+IW0PTr7eBX
   2hK3jxCIFauwJf0AwRshvAHskKuSCAJYNoTmApDBa6gm8SL6bL5/83M78
   pp3Znqi00qbgCW1H2/2l0itXdBUPM/xlPIeoY1pPBFwKinePqh1ZP63Pr
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10378"; a="258735308"
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; 
   d="yaml'?scan'208";a="258735308"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Jun 2022 01:36:39 -0700
X-IronPort-AV: E=Sophos;i="5.91,300,1647327600"; 
   d="yaml'?scan'208";a="588989604"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Jun 2022 01:36:32 -0700
...
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        ...
        fan.zhao@intel.com, willy@infradead.org, akpm@linux-foundation.org,
        kent.overstreet@gmail.com, axboe@kernel.dk, linux-mm@kvack.org,
...
Subject: [mm/filemap]  8b157c14b5:
 ...
 -8.1% regression
Message-ID: <20220615083629.GG36441@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.18.0-12100-g8b157c14b505"
...
kbuild_queue_analysis'
	...
	export submit_id='62a8c7ec2fee50b4178f303b'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220615-46103-sstx2q-4.yaml'
	export id='7f53a3530c797724c02e3eb8bf33262d117fa37d'
	...
	export commit='8b157c14b505f861cf8da783ff89f679a0e50abe'
...
SATA_AHCI'
	...
	export enqueue_time='2022-06-15 01:39:56 +0800'
	export _id='62a8c7ec2fee50b4178f303c'
	export _rt='/result/phoronix-test-suite/performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe'
	export user='lkp'
	...
	export branch='linux-review/Yu-Kuai/mm-filemap-fix-that-first-page-is-not-mark-accessed-in-filemap_read/20220602-161035'
	export result_root='/result/phoronix-test-suite/performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/vmlinuz-5.18.0-12100-g8b157c14b505
branch=linux-review/Yu-Kuai/mm-filemap-fix-that-first-page-is-not-mark-accessed-in-filemap_read/20220602-161035
job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220615-46103-sstx2q-4.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=8b157c14b505f861cf8da783ff89f679a0e50abe
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/vmlinuz-5.18.0-12100-g8b157c14b505'
	export dequeue_time='2022-06-15 01:46:05 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220615-46103-sstx2q-4.cgz'
...
run_job()
{
	...
	run_test test='fio-1.14.1' option_a='Sequential Read' option_b='Linux AIO' option_c='Yes' option_d='Yes' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='fio-1.14.1' option_a='Sequential Read' option_b='Linux AIO' option_c='Yes' option_d='Yes' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/stats/wrapper phoronix-test-suite
...
submit_id: 62a89ae72fee509df44b5bef
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220614-40436-p3tem7-1.yaml"
id: d27689299980594c3f4cffdba890a41ffb51894c
...
enqueue_time: 2022-06-14 22:27:52.339526146 +08:00
_id: 62a89ae82fee509df44b5bf0
_rt: "/result/phoronix-test-suite/performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
result_root: "/result/phoronix-test-suite/performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/vmlinuz-5.18.0-12100-g8b157c14b505
- branch=linux-devel/devel-hourly-20220613-060637
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-Linux_AIO-Yes-Yes-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220614-40436-p3tem7-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=8b157c14b505f861cf8da783ff89f679a0e50abe
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/8b157c14b505f861cf8da783ff89f679a0e50abe/vmlinuz-5.18.0-12100-g8b157c14b505"
dequeue_time: 2022-06-14 22:36:09.857712225 +08:00
:#! /cephfs/db/releases/20220614173802/lkp-src/include/site/inn:
job_state: finished
loadavg: 1.21 0.66 0.27 1/996 8796
start_time: '1655215019'
end_time: '1655215140'
