...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 154074A9AD6
	for <lists+linux-kernel@lfdr.de>; Fri,  4 Feb 2022 15:19:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1359247AbiBDOTw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 4 Feb 2022 09:19:52 -0500
Received: from mga05.intel.com ([192.55.52.43]:42569 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1358948AbiBDOTu (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 4 Feb 2022 09:19:50 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1643984390; x=1675520390;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=eA2Hzgwpj6XxvxYAYeW9qYzutw97PperuAaDtjDnn88=;
  b=JBDKqvKrPhrGQgBLrh9Hv0OsMsT4mob0xhFlCATBafxpzF5oM1HVEgEX
   SpSXGwWGM27ucC/upSY1ICjZ4HEp94pjHLfgSxzcYgy63FL/ID/s/s+XH
   g0tmkTXcMIFjXVVFZIOE/M8PM2/dwLI1eCEnZA3PDhelhjfHrYosmi+ZR
   7Nm54Vc7CyvmJ44I6W3D2HjYXFccpMXYNdEZdPW1KUAOis8AKUo7oWHra
   e354gbC0Y3ZWX4TUYav8jxPEXKzpZfFZfNrAgQCnQmeVFf/tXhpWBuxoq
   Tfto6rU5VAoU72N2Q7QEi7h4Vmnr3OdQFI1cf06W/ikCEpTJOZcmILaje
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10247"; a="334768186"
X-IronPort-AV: E=Sophos;i="5.88,342,1635231600"; 
   d="yaml'?scan'208";a="334768186"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Feb 2022 06:19:49 -0800
X-IronPort-AV: E=Sophos;i="5.88,342,1635231600"; 
   d="yaml'?scan'208";a="524320872"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Feb 2022 06:19:44 -0800
Date:   Fri, 4 Feb 2022 22:19:41 +0800
...
Subject: [sched/pelt]  2d02fa8cc2:  stress-ng.pipeherd.ops_per_sec -9.7%
 regression
Message-ID: <20220204141941.GE4077@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.16.0-08306-g2d02fa8cc21a"
...
commit'
	...
	export submit_id='61f9c386ae93bd5b2d9be3fd'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-pipeherd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-2d02fa8cc21a93da35cfba462bf8ab87b-20220202-23341-13y8vxg-3.yaml'
	export id='0d6c0e722578b50cc73904f39e072d08232dbb49'
	...
	export need_kconfig=
	export commit='2d02fa8cc21a93da35cfba462bf8ab87bf2db651'
	export ucode='0xd000280'
	export bisect_dmesg=true
	export enqueue_time='2022-02-02 07:34:30 +0800'
	export _id='61f9c386ae93bd5b2d9be3fd'
	export _rt='/result/stress-ng/memory-performance-100%-pipeherd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651'
	export user='lkp'
	...
	export result_root='/result/stress-ng/memory-performance-100%-pipeherd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/3'
	export scheduler_version='/lkp/lkp/.src-20220131-222029'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/memory-performance-100%-pipeherd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/vmlinuz-5.16.0-08306-g2d02fa8cc21a
branch=linus/master
job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-pipeherd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-2d02fa8cc21a93da35cfba462bf8ab87b-20220202-23341-13y8vxg-3.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220201.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220201.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220130.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-24f4db1f3a27-1_20220130.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	...
	export repeat_to=6
	export good_samples='62275532.96
65030851.37
63049653.9'
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/vmlinuz-5.16.0-08306-g2d02fa8cc21a'
	export dequeue_time='2022-02-02 07:48:45 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-pipeherd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-2d02fa8cc21a93da35cfba462bf8ab87b-20220202-23341-13y8vxg-3.cgz'
...
run_job()
{
	...
	run_test class='memory' test='pipeherd' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='memory' test='pipeherd' $LKP_SRC/stats/wrapper stress-ng
...
kconfig: x86_64-rhel-8.3
submit_id: 61f98eedae93bd3dfd311773
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-pipeherd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-2d02fa8cc21a93da35cfba462bf8ab87b-20220202-15869-f5epq8-2.yaml"
id: c382f82145a42f6df7d3fee5380a36235069e83f
...
ucode: '0xd000280'
bisect_dmesg: true
enqueue_time: 2022-02-02 03:50:05.999934780 +08:00
_id: 61f994aaae93bd3dfd311775
_rt: "/result/stress-ng/memory-performance-100%-pipeherd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
...
result_root: "/result/stress-ng/memory-performance-100%-pipeherd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/vmlinuz-5.16.0-08306-g2d02fa8cc21a
- branch=linux-devel/devel-hourly-20220130-154426
- job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-pipeherd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-2d02fa8cc21a93da35cfba462bf8ab87b-20220202-15869-f5epq8-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=2d02fa8cc21a93da35cfba462bf8ab87bf2db651
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220201.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220201.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220130.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-24f4db1f3a27-1_20220130.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.17.0-rc2-wt-ath-06393-g2cda1944c0ee
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/2d02fa8cc21a93da35cfba462bf8ab87bf2db651/vmlinuz-5.16.0-08306-g2d02fa8cc21a"
dequeue_time: 2022-02-02 04:34:02.060025622 +08:00
:#! /cephfs/db/releases/20220201223042/lkp-src/include/site/inn:
job_state: finished
loadavg: 4472.70 1676.23 602.93 1/1172 21675
start_time: '1643747725'
end_time: '1643747788'
...
do
 ...
 "stress-ng" "--timeout" "60" "--times" "--verify" "--metrics-brief" "--pipeherd" "128"
