...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1B8E7519C02
	for <lists+linux-kernel@lfdr.de>; Wed,  4 May 2022 11:37:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347564AbiEDJkf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 May 2022 05:40:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48506 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347471AbiEDJkW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 May 2022 05:40:22 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id AF0231CB35
        for <linux-kernel@vger.kernel.org>; Wed,  4 May 2022 02:36:44 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 753C513D5;
        Wed,  4 May 2022 02:36:44 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id A62083FA50;
...
Subject: [PATCH 2/7] firmware: arm_scmi: Add SCMIv3.1 Powercap protocol basic support
Date:   Wed,  4 May 2022 10:36:04 +0100
Message-Id: <20220504093609.3077646-3-cristian.marussi@arm.com>
...
---
 ...
 drivers/firmware/arm_scmi/powercap.c  | 705 ++++++++++++++++++++++++++
 drivers/firmware/arm_scmi/protocols.h |   1 +
 include/linux/scmi_protocol.h         | 120 +++++
...
index c1922bd650ae..9e07f2ddc721 100644
--- a/drivers/firmware/arm_scmi/driver.c
+++ b/drivers/firmware/arm_scmi/driver.c
@@ -2400,6 +2400,7 @@ static int __init scmi_driver_init(void)
...
@@ -2416,6 +2417,7 @@ static void __exit scmi_driver_exit(void)
...
index 000000000000..7f2dcb944c4e
--- /dev/null
...
+		return -EINVAL;
+
+	*power_thresh_low = lower_32_bits(pi->domain_thresholds[domain_id]);
+	*power_thresh_high = upper_32_bits(pi->domain_thresholds[domain_id]);
+
+	return 0;
+}
+
...
+		return -EINVAL;
+
+	pi->domain_thresholds[domain_id] =
...
+						sizeof(*pinfo->domain_thresholds),
+						GFP_KERNEL);
+	if (!pinfo->domain_thresholds)
+		return -ENOMEM;
+
...
index 73304af5ec4a..c774e37062e9 100644
--- a/drivers/firmware/arm_scmi/protocols.h
+++ b/drivers/firmware/arm_scmi/protocols.h
@@ -314,5 +314,6 @@ DECLARE_SCMI_REGISTER_UNREGISTER(reset);
...
index 1c58646ba381..0216f70d57a8 100644
--- a/include/linux/scmi_protocol.h
+++ b/include/linux/scmi_protocol.h
@@ -559,6 +559,109 @@ struct scmi_voltage_proto_ops {
 			 s32 *volt_uV);
 };
...
+ * @otify_powercap_measurement_change: MEASUREMENTS change notifications
+ *				       support.
...
+ *				powercap domain.
+ *				Note that this must be called before registering
+ *				the callback with the usual @scmi_notify_ops.
...
+
  ...
  * SCMI core
@@ -660,6 +763,7 @@ enum scmi_std_protocol {
...
@@ -761,6 +865,8 @@ enum scmi_notification_events {
...
@@ -829,4 +935,18 @@ struct scmi_base_error_report {
