...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4C295519C06
	for <lists+linux-kernel@lfdr.de>; Wed,  4 May 2022 11:37:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347538AbiEDJkb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 May 2022 05:40:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48504 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347464AbiEDJkW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 May 2022 05:40:22 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 6726C26540
        for <linux-kernel@vger.kernel.org>; Wed,  4 May 2022 02:36:46 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 3C551143D;
        Wed,  4 May 2022 02:36:46 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id A33253FA50;
...
Subject: [PATCH 3/7] firmware: arm_scmi: Generalize FastChannel support
Date:   Wed,  4 May 2022 10:36:05 +0100
Message-Id: <20220504093609.3077646-4-cristian.marussi@arm.com>
...
index 9e07f2ddc721..37f8b87f150a 100644
...
@@ -1258,10 +1259,174 @@ static int scmi_iterator_run(void *iter)
 	return ret;
 }
...
index 8f4051aca220..da7fe3561217 100644
...
index c774e37062e9..13dbecbc032b 100644
--- a/drivers/firmware/arm_scmi/protocols.h
+++ b/drivers/firmware/arm_scmi/protocols.h
@@ -214,6 +214,19 @@ struct scmi_iterator_ops {
...
@@ -229,6 +242,9 @@ struct scmi_iterator_ops {
  *			provided in @ops.
...
@@ -238,6 +254,12 @@ struct scmi_proto_helpers_ops {
