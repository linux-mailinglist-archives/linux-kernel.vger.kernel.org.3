...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1886E502987
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Apr 2022 14:23:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353236AbiDOM0M (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 Apr 2022 08:26:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52008 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1353226AbiDOMZb (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 Apr 2022 08:25:31 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E932C7C146;
        Fri, 15 Apr 2022 05:23:02 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id A689CB82E46;
        Fri, 15 Apr 2022 12:23:00 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 152DDC385A5;
        Fri, 15 Apr 2022 12:22:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1650025379;
        bh=fINECySWJH88eslKJB14ZuYvFndHA70NcFwD65CTMm8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=Q2OvXLVC3gXhgxjRGQ9z07KhyBUiUkpu8VS8Yb1P0S0OvAmhYC4nmmpOb/I1dOH4w
         V4FnoippHPIMSFfqLqQS09FGLwDLtTN3vViy7qmYZL/K4Vjby5hpTAXiGsg+vuXUou
         Ig50sN7iBbVbFDULsSQaS+EfQkTGzn4nzlNmS5TQ=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.189
Date:   Fri, 15 Apr 2022 14:22:53 +0200
Message-Id: <1650025373254158@kroah.com>
X-Mailer: git-send-email 2.35.2
In-Reply-To: <1650025373126202@kroah.com>
References: <1650025373126202@kroah.com>
MIME-Version: 1.0
...
index d261b7096c69..2767f182fd3c 100644
...
index 06f743b612c4..bb53707f72cc 100644
...
index 868485714806..cbb71900d3dc 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 70a2b6e2ad3f..fa5dd992e327 100644
...
index 8240e5186972..fb92d87d8ded 100644
...
index b05bab57f90a..09816a2ee367 100644
...
index f187da4485f4..78672db9068b 100644
...
index 53bcf5386907..a02c294a4753 100644
...
index a343677837c7..17a8d1484f9b 100644
...
index a63ec938636d..daba2d2a02a0 100644
...
index 22a93009362d..1de5991916eb 100644
...
index 0117489e9b30..750acc134432 100644
...
index 6ff2c7cac4c4..408b51aba293 100644
...
index 915bb1639763..1bff0f68f027 100644
...
index 7495520d7a3e..fd1161de4535 100644
...
index 1a0c581512f2..1d443d17cf7c 100644
...
index 4b022f0c49d2..a62692d13566 100644
--- a/block/blk-merge.c
+++ b/block/blk-merge.c
@@ -7,6 +7,7 @@
 #include <linux/bio.h>
...
index 0aa489711ec4..9cbafaf6dd85 100644
...
index 1155fb9dcc3a..76b7539a37a9 100644
...
index 2826bd45c61a..0521b1d4c2fd 100644
...
index a08e3eb2a6f9..a4b7cdd0c844 100644
...
index ddbf56014c51..6da7f5749a7c 100644
...
index 5d52a2d32155..bfb00d3b091f 100644
...
@@ -4877,7 +4881,7 @@ void notify_helper(enum drbd_notification_type type,
 		 err, seq);
 }
...
@@ -4970,7 +4976,10 @@ static int get_initial_state(struct sk_buff *skb, struct netlink_callback *cb)
 		cb->args[4] = 0;
 	}
 out:
-	return skb->len;
...
index f86cea4c0f8d..5e92632881d8 100644
...
index eeaa3b49b264..4dad4dd0ceb6 100644
...
index 4b3645e648ee..2a5cd502feae 100644
...
index b453029487a1..c736adef9d3c 100644
...
@@ -2234,7 +2241,7 @@ static struct virtio_driver virtio_rproc_serial = {
...
@@ -2271,7 +2278,7 @@ static int __init init(void)
 	return err;
 }
...
@@ -2281,8 +2288,8 @@ static void __exit fini(void)
...
index e4e1b4e94a67..13332f89e034 100644
--- a/drivers/clk/clk.c
+++ b/drivers/clk/clk.c
...
@@ -3278,6 +3302,19 @@ static void clk_core_reparent_orphans_nolock(void)
...
index a88101480e33..89c1adeb84d4 100644
...
index 19eee3d0900b..c51de498b5b4 100644
...
index 8e4d863c7570..c5231c50c412 100644
...
@@ -7265,10 +7268,13 @@ dm_determine_update_type_for_commit(struct amdgpu_display_manager *dm,
...
index 3f0a79890600..aeeab1b57aad 100644
...
index 6cf59fd26ad7..b6d6d119035c 100644
...
index 8470097907bc..beb443d020c2 100644
...
index ee44640edeb5..4c9e2fc53352 100644
...
index 5a8351c9a426..ca0fe902a7db 100644
--- a/drivers/iio/inkern.c
+++ b/drivers/iio/inkern.c
@@ -588,28 +588,50 @@ EXPORT_SYMBOL_GPL(iio_read_channel_average_raw);
...
index f7398b996bac..e2eb9b9b8363 100644
--- a/drivers/input/input.c
+++ b/drivers/input/input.c
@@ -2181,12 +2181,6 @@ int input_register_device(struct input_dev *dev)
...
index 9d0b42cb9903..f589ca2480a1 100644
--- a/drivers/irqchip/irq-gic-v3.c
+++ b/drivers/irqchip/irq-gic-v3.c
@@ -162,11 +162,11 @@ static inline void __iomem *gic_dist_base(struct irq_data *d)
 	}
 }
...
@@ -180,13 +180,13 @@ static void gic_do_wait_for_rwp(void __iomem *base)
...
index 834b35dc3b13..e9b392dc09bc 100644
...
index df66461f5d4f..e7e8eba048ac 100644
...
index bfca9d0a1fe1..5ae13ee9272d 100644
...
index 0953bd8a4f79..3bb59d670220 100644
...
index 689eb119d44f..23fd93407ece 100644
--- a/drivers/mmc/host/renesas_sdhi_core.c
+++ b/drivers/mmc/host/renesas_sdhi_core.c
@@ -349,10 +349,10 @@ static void renesas_sdhi_hs400_complete(struct tmio_mmc_host *host)
...
index 5f57e78e5f13..6f6fb4c4448f 100644
...
index d636bbe214cb..df521ff0b328 100644
...
@@ -956,9 +952,6 @@ int ubi_attach_mtd_dev(struct mtd_info *mtd, int ubi_num,
 			goto out_detach;
 	}
...
-
 	...
 	if (err)
 		goto out_detach;
@@ -1003,6 +996,7 @@ int ubi_attach_mtd_dev(struct mtd_info *mtd, int ubi_num,
...
@@ -1011,7 +1005,6 @@ int ubi_attach_mtd_dev(struct mtd_info *mtd, int ubi_num,
 out_uif:
 	uif_close(ubi);
 out_detach:
...
index 53f448e7433a..6e95c4b1473e 100644
...
index 41eee6f0491c..957e51a77d4d 100644
...
index 8ecfabaefa85..d58abdfdb9b7 100644
...
index 5e8f8eb916e6..20f840ea0503 100644
...
@@ -4717,6 +4728,7 @@ static int qed_get_vf_config(struct qed_dev *cdev,
...
@@ -5147,6 +5159,12 @@ static void qed_iov_handle_trust_change(struct qed_hwfn *hwfn)
...
@@ -5162,13 +5180,20 @@ static void qed_iov_handle_trust_change(struct qed_hwfn *hwfn)
...
index bd0beb16d68a..02d6f3ad9aca 100644
...
index 21ca62b06214..8d708e7588bc 100644
--- a/drivers/net/wireless/ath/carl9170/main.c
+++ b/drivers/net/wireless/ath/carl9170/main.c
@@ -1917,7 +1917,7 @@ static int carl9170_parse_eeprom(struct ar9170 *ar)
...
index 3aed4c4b887a..544ad80629a9 100644
...
index e6001f0a81a3..b5d2e5b9f67c 100644
...
index 544287e9f449..f4de8be05c61 100644
...
index d2f8cd3a9568..721d2652319c 100644
...
@@ -1168,7 +1170,7 @@ static void advk_msi_irq_compose_msi_msg(struct irq_data *data,
...
@@ -1185,15 +1187,11 @@ static int advk_msi_irq_domain_alloc(struct irq_domain *domain,
 	int hwirq, i;
...
@@ -1211,7 +1209,7 @@ static void advk_msi_irq_domain_free(struct irq_domain *domain,
...
index 907b8be86ce0..13f3bc239c66 100644
--- a/drivers/pci/hotplug/pciehp_hpc.c
+++ b/drivers/pci/hotplug/pciehp_hpc.c
@@ -79,6 +79,8 @@ static int pcie_poll_cmd(struct controller *ctrl, int timeout)
...
+			smp_mb();
 		...
 		if (timeout < 0)
@@ -957,6 +959,8 @@ static void quirk_cmd_compl(struct pci_dev *pdev)
 }
...
index 4da37f650f98..7018eb21d189 100644
--- a/drivers/perf/qcom_l2_pmu.c
+++ b/drivers/perf/qcom_l2_pmu.c
@@ -781,7 +781,7 @@ static struct cluster_pmu *l2_cache_associate_cpu_with_cluster(
 {
 	u64 mpidr;
 	int cpu_cluster_id;
...
@@ -803,10 +803,10 @@ static struct cluster_pmu *l2_cache_associate_cpu_with_cluster(
 			 cluster->cluster_id);
...
index 17f909d8b63a..2dccd24c6555 100644
...
index 601fffeba39f..131fa7958f75 100644
...
index 26923af574f4..4fe9ea9721b3 100644
...
index 5c1378d2fab3..ba345a379e26 100644
...
index fbfce02e5b93..c285f401ff7b 100644
...
index 5d28bb7f2ca4..5c801705c470 100644
...
index 68a8217032d0..fec653b54307 100644
...
@@ -1828,7 +1830,7 @@ static void pm8001_send_read_log(struct pm8001_hba_info *pm8001_ha,
...
@@ -3773,12 +3775,11 @@ int pm8001_mpi_task_abort_resp(struct pm8001_hba_info *pm8001_ha, void *piomb)
 	mb();
...
index 161bf4760eac..ce67965a504f 100644
...
index 8f85ca011296..59f5dc9876cc 100644
...
index 7c22f8eea3ea..caf28c5281aa 100644
...
@@ -4866,4 +4870,8 @@ struct sff_8247_a0 {
 #include "qla_gbl.h"
 #include "qla_dbg.h"
...
index d9b5ea77fde9..e9f03370afba 100644
--- a/drivers/scsi/qla2xxx/qla_gs.c
+++ b/drivers/scsi/qla2xxx/qla_gs.c
@@ -675,8 +675,7 @@ qla2x00_rff_id(scsi_qla_host_t *vha, u8 type)
 		return (QLA_SUCCESS);
 	}
...
@@ -726,7 +725,7 @@ static int qla_async_rffid(scsi_qla_host_t *vha, port_id_t *d_id,
...
index 37c1f27a76cf..a6e24cef89a0 100644
...
@@ -955,6 +963,9 @@ static void qla24xx_handle_gnl_done_event(scsi_qla_host_t *vha,
...
@@ -1311,14 +1322,21 @@ int qla24xx_async_gpdb(struct scsi_qla_host *vha, fc_port_t *fcport, u8 opt)
...
+
 	...
 	if (!sp)
 		goto done;
@@ -1477,6 +1495,11 @@ static void qla_chk_n2n_b4_login(struct scsi_qla_host *vha, fc_port_t *fcport)
 	u8 login = 0;
 	int rc;
...
@@ -1534,7 +1557,8 @@ int qla24xx_fcport_handle_login(struct scsi_qla_host *vha, fc_port_t *fcport)
...
@@ -1555,7 +1579,7 @@ int qla24xx_fcport_handle_login(struct scsi_qla_host *vha, fc_port_t *fcport)
...
@@ -3223,6 +3247,14 @@ qla2x00_alloc_fw_dump(scsi_qla_host_t *vha)
...
@@ -3233,7 +3265,7 @@ qla2x00_alloc_fw_dump(scsi_qla_host_t *vha)
...
@@ -3245,8 +3277,7 @@ qla2x00_alloc_fw_dump(scsi_qla_host_t *vha)
...
@@ -3743,8 +3774,7 @@ qla2x00_setup_chip(scsi_qla_host_t *vha)
...
@@ -5217,6 +5247,13 @@ qla2x00_configure_local_loop(scsi_qla_host_t *vha)
...
index 936103604d02..103288b0377e 100644
--- a/drivers/scsi/qla2xxx/qla_iocb.c
+++ b/drivers/scsi/qla2xxx/qla_iocb.c
@@ -2859,6 +2859,7 @@ static void qla2x00_els_dcmd2_sp_done(srb_t *sp, int res)
...
+					break;
 				...
 				/* fall through */
 			default:
@@ -2868,9 +2869,7 @@ static void qla2x00_els_dcmd2_sp_done(srb_t *sp, int res)
...
+				qlt_schedule_sess_for_deletion(fcport);
 			...
 			break;
@@ -2882,8 +2881,7 @@ static void qla2x00_els_dcmd2_sp_done(srb_t *sp, int res)
 			    fw_status[0], fw_status[1], fw_status[2]);
...
index 3e9c5768815e..d7cf7f957087 100644
--- a/drivers/scsi/qla2xxx/qla_isr.c
+++ b/drivers/scsi/qla2xxx/qla_isr.c
@@ -1839,6 +1839,7 @@ qla24xx_tm_iocb_entry(scsi_qla_host_t *vha, struct req_que *req, void *tsk)
...
index 098388a12feb..29f2730fbf66 100644
...
index 97453c12b735..a15af048cd82 100644
--- a/drivers/scsi/qla2xxx/qla_nvme.c
+++ b/drivers/scsi/qla2xxx/qla_nvme.c
@@ -36,6 +36,11 @@ int qla_nvme_register_remote(struct scsi_qla_host *vha, struct fc_port *fcport)
...
@@ -152,6 +157,18 @@ static void qla_nvme_release_fcp_cmd_kref(struct kref *kref)
...
@@ -168,6 +185,8 @@ static void qla_nvme_release_ls_cmd_kref(struct kref *kref)
...
+	qla_nvme_ls_unmap(sp, fd);
 ...
 out:
 	qla2x00_rel_sp(sp);
@@ -314,6 +333,8 @@ static int qla_nvme_ls_req(struct nvme_fc_local_port *lport,
...
@@ -321,6 +342,7 @@ static int qla_nvme_ls_req(struct nvme_fc_local_port *lport,
...
index c1d4c964b0dd..a5dbaa3491f8 100644
...
@@ -5348,6 +5347,11 @@ void qla2x00_relogin(struct scsi_qla_host *vha)
...
index bbe90354f49b..d306f3ca0f3b 100644
...
index 0111c543f0e6..df598c377161 100644
--- a/drivers/scsi/qla2xxx/qla_target.c
+++ b/drivers/scsi/qla2xxx/qla_target.c
@@ -3251,6 +3251,7 @@ int qlt_xmit_response(struct qla_tgt_cmd *cmd, int xmit_type,
...
@@ -7083,8 +7084,7 @@ qlt_probe_one_stage1(struct scsi_qla_host *base_vha, struct qla_hw_data *ha)
...
index eba706d5671e..d0b5db88cd16 100644
...
index ac05c9c86488..b18ae50db1f5 100644
--- a/drivers/spi/spi.c
+++ b/drivers/spi/spi.c
...
index a31163547fba..3a1a28a79d46 100644
...
index 48832f7f2fc3..db65e1ad00de 100644
--- a/drivers/usb/host/xhci-hub.c
+++ b/drivers/usb/host/xhci-hub.c
@@ -674,7 +674,7 @@ static int xhci_exit_test_mode(struct xhci_hcd *xhci)
 	}
...
@@ -1000,6 +1000,9 @@ static void xhci_get_usb2_port_status(struct xhci_port *port, u32 *status,
...
index 8f029d44e9c9..476dc6abd5a2 100644
...
index 8b1b73065421..9c984f3c7248 100644
...
index 51f5d1c56fd9..c1ee817d7dcc 100644
...
index 246681414577..83d05600360d 100644
...
index e028e0092799..cf1e01f0dede 100644
...
index 03dce3980d90..54f0d2c4c7d8 100644
...
index 16abb017e497..68d5c73c5ed1 100644
--- a/fs/f2fs/gc.c
+++ b/fs/f2fs/gc.c
@@ -633,8 +633,10 @@ static bool is_alive(struct f2fs_sb_info *sbi, struct f2fs_summary *sum,
...
index c056ed5c6df3..d7ec0ac87fc0 100644
--- a/fs/gfs2/rgrp.c
+++ b/fs/gfs2/rgrp.c
@@ -1429,7 +1429,8 @@ int gfs2_fitrim(struct file *filp, void __user *argp)
...
index 0b1a7f68b712..f73904c08b39 100644
--- a/fs/jffs2/scan.c
+++ b/fs/jffs2/scan.c
...
index eeb93f009b28..83a173feb698 100644
--- a/fs/ubifs/dir.c
+++ b/fs/ubifs/dir.c
...
@@ -439,6 +442,8 @@ static int do_tmpfile(struct inode *dir, struct dentry *dentry,
...
+		struct ubifs_budget_req wht_req;
 		...
 		if (!dev) {
@@ -1351,6 +1358,23 @@ static int do_rename(struct inode *old_dir, struct dentry *old_dentry,
...
@@ -1425,18 +1449,6 @@ static int do_rename(struct inode *old_dir, struct dentry *old_dentry,
 	}
...
index bc8a70a7c5a1..e4f9df955040 100644
--- a/include/linux/mmzone.h
+++ b/include/linux/mmzone.h
@@ -1250,13 +1250,16 @@ static inline unsigned long *section_to_usemap(struct mem_section *ms)
...
index 288a58678256..c70b79dba1dc 100644
...
+		this_cpu_dec(*dev->pcpu_refcnt);
 ...
 /**
@@ -3788,7 +3789,8 @@ static inline void dev_put(struct net_device *dev)
  */
...
index d9d39cc20a84..9787a42f7ed3 100644
--- a/include/net/udp.h
+++ b/include/net/udp.h
...
index 63038eb23560..cb0631098f91 100644
...
index 5e465c4b1e64..117d70098cd4 100644
...
index ce1745ac7b8c..177d57ce9016 100644
...
@@ -3748,24 +3752,43 @@ static ssize_t cgroup_freeze_write(struct kernfs_open_file *of,
...
@@ -3779,7 +3802,7 @@ static ssize_t cgroup_file_write(struct kernfs_open_file *of, char *buf,
 	 */
...
+	    ctx->ns != &init_cgroup_ns && ctx->ns->root_cset->dfl_cgrp == cgrp)
 	...
 	if (cft->write)
@@ -4687,21 +4710,21 @@ void css_task_iter_end(struct css_task_iter *it)
...
@@ -4709,21 +4732,18 @@ static void *__cgroup_procs_start(struct seq_file *s, loff_t *pos,
 {
 	struct kernfs_open_file *of = s->private;
 	struct cgroup *cgrp = seq_css(s)->cgroup;
-	struct css_task_iter *it = of->priv;
...
+		ctx->procs.started = true;
 		...
 		css_task_iter_start(&cgrp->self, iter_flags, it);
@@ -4758,9 +4778,9 @@ static int cgroup_procs_show(struct seq_file *s, void *v)
...
-	struct cgroup_namespace *ns = current->nsproxy->cgroup_ns;
 	...
 	struct inode *inode;
 	int ret;
@@ -4796,8 +4816,10 @@ static int cgroup_procs_write_permission(struct cgroup *src_cgrp,
...
@@ -4814,8 +4836,16 @@ static ssize_t cgroup_procs_write(struct kernfs_open_file *of,
...
@@ -4837,8 +4867,10 @@ static void *cgroup_threads_start(struct seq_file *s, loff_t *pos)
...
+	const struct cred *saved_cred;
 	...
 	buf = strstrip(buf);
@@ -4857,9 +4889,16 @@ static ssize_t cgroup_threads_write(struct kernfs_open_file *of,
 	src_cgrp = task_cgroup_from_root(task, &cgrp_dfl_root);
 	spin_unlock_irq(&css_set_lock);
...
index 4d0b59fa5550..46f24b7a3221 100644
--- a/lib/lz4/lz4_decompress.c
+++ b/lib/lz4/lz4_decompress.c
@@ -268,8 +268,12 @@ static FORCE_INLINE int LZ4_decompress_generic(
 			ip += length;
 			op += length;
...
index 8262c3f05a5d..aefa377c9c26 100644
--- a/lib/test_xarray.c
+++ b/lib/test_xarray.c
...
index 7d22b3059127..61464c52c20e 100644
--- a/lib/xarray.c
+++ b/lib/xarray.c
...
index 4a669c81f4e2..d8cde7292bf9 100644
--- a/mm/kmemleak.c
+++ b/mm/kmemleak.c
...
index 4bb7c6a364c8..8a72fd3e73bf 100644
--- a/mm/memory.c
+++ b/mm/memory.c
...
@@ -3245,11 +3258,20 @@ static vm_fault_t __do_fault(struct vm_fault *vmf)
 		return ret;
...
index 2c4082f71d25..d79ab5116a7b 100644
--- a/mm/mempolicy.c
+++ b/mm/mempolicy.c
@@ -731,7 +731,6 @@ static int vma_replace_policy(struct vm_area_struct *vma,
...
-	struct vm_area_struct *next;
 	...
 	struct vm_area_struct *vma;
 	int err = 0;
@@ -747,8 +746,7 @@ static int mbind_range(struct mm_struct *mm, unsigned long start,
...
@@ -762,10 +760,6 @@ static int mbind_range(struct mm_struct *mm, unsigned long start,
...
@@ -2565,6 +2559,7 @@ static int shared_policy_replace(struct shared_policy *sp, unsigned long start,
...
index ba78f1f1b1bd..58cfd5b1e0b1 100644
--- a/mm/mmap.c
+++ b/mm/mmap.c
@@ -2515,7 +2515,7 @@ static int __init cmdline_parse_stack_guard_gap(char *p)
 	if (!*endptr)
...
index c3835915d115..5038611563df 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
@@ -7326,10 +7326,17 @@ static void __init find_zone_movable_pfns_for_nodes(void)
...
index 45f2106852e8..6d80e92688fe 100644
--- a/mm/rmap.c
+++ b/mm/rmap.c
@@ -1602,7 +1602,30 @@ static bool try_to_unmap_one(struct page *page, struct vm_area_struct *vma,
...
index d39518f691b4..e16b2b5cda98 100644
--- a/net/core/filter.c
+++ b/net/core/filter.c
...
+
 		...
 		break;
 #endif /* CONFIG_IPV6 */
@@ -6708,6 +6717,7 @@ bool bpf_sock_is_valid_access(int off, int size, enum bpf_access_type type,
...
+	int field_size;
 	...
 	if (off < 0 || off >= sizeof(struct bpf_sock))
 		return false;
@@ -6719,7 +6729,6 @@ bool bpf_sock_is_valid_access(int off, int size, enum bpf_access_type type,
...
@@ -6727,6 +6736,14 @@ bool bpf_sock_is_valid_access(int off, int size, enum bpf_access_type type,
...
@@ -876,8 +876,13 @@ int fib_nh_match(struct fib_config *cfg, struct fib_info *fi,
 	}
...
@@ -367,7 +366,7 @@ static int tcp_bpf_send_verdict(struct sock *sk, struct sk_psock *psock,
 			cork = true;
 			psock->cork = NULL;
 		}
...
@@ -407,8 +406,11 @@ static int tcp_bpf_send_verdict(struct sock *sk, struct sk_psock *psock,
 		}
 		if (msg &&
...
index 3cdf011a8dd8..83fd4fa40d5e 100644
--- a/net/ipv4/udp.c
+++ b/net/ipv4/udp.c
...
index a71bfa5b0277..040869f45682 100644
--- a/net/ipv6/udp.c
+++ b/net/ipv6/udp.c
...
index d7559c64795d..d3f068ad154c 100644
--- a/net/openvswitch/flow_netlink.c
+++ b/net/openvswitch/flow_netlink.c
@@ -2179,8 +2179,8 @@ static int __ovs_nla_put_key(const struct sw_flow_key *swkey,
...
index b6039642df67..08e1ccc01e98 100644
--- a/net/sunrpc/clnt.c
+++ b/net/sunrpc/clnt.c
...
+	case -ENOMEM:
 	case -ENOBUFS:
 		rpc_delay(task, HZ>>2);
 		/* fall through */
@@ -2392,6 +2394,11 @@ call_status(struct rpc_task *task)
 	case -EPIPE:
 	case -EAGAIN:
 		break;
+	case -ENFILE:
...
index 93b6afd28405..8ac579778e48 100644
--- a/net/sunrpc/xprt.c
+++ b/net/sunrpc/xprt.c
@@ -2006,7 +2006,14 @@ static void xprt_destroy(struct rpc_xprt *xprt)
 	 */
...
index d201043d661c..05ca4196cb0f 100644
--- a/sound/pci/hda/patch_realtek.c
+++ b/sound/pci/hda/patch_realtek.c
@@ -3557,8 +3557,8 @@ static void alc256_shutup(struct hda_codec *codec)
...
index 21f859e56b70..870b00229353 100644
...
index 2a261b909dd8..88392219d425 100644
--- a/tools/build/feature/Makefile
+++ b/tools/build/feature/Makefile
@@ -204,9 +204,16 @@ strip-libs = $(filter-out -l%,$(1))
...
index 63038eb23560..0bfad86ec960 100644
...
index 7578af250454..b94d9afad3f7 100644
...
@@ -354,6 +359,166 @@ static int test_cgcore_internal_process_constraint(const char *root)
 	return ret;
 }
...
index f31976010622..287444e52ccf 100644
...
@@ -766,6 +768,16 @@ static struct kvm *kvm_create_vm(unsigned long type)
...
+
 ...
 out_err:
@@ -844,6 +856,7 @@ static void kvm_destroy_vm(struct kvm *kvm)
