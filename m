...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 319B155E0F0
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Jun 2022 15:33:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240742AbiF1F4s (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Jun 2022 01:56:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36462 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229622AbiF1F4n (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Jun 2022 01:56:43 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2629D286C8
        for <linux-kernel@vger.kernel.org>; Mon, 27 Jun 2022 22:56:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656395799; x=1687931799;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=SRPxL+EHJhhL9bNna1k91GHaPtc4PevlTA/etoH7HTk=;
  b=mSsTcBDgHiYqRtDndaO3ymnjhpB1rzlYkkS1NbT26IuECe0Qqi1UYn2R
   O0DV+PlOK9MW+02aV+/mWzKXjH5v9V1haXLohK4AhLPYau37SS7kne0eL
   VVRqrMeuSx/uhyeWVxhbJn9urOLNVbTCevI4wUjDBkPFRXHb9Id7MXUh6
   wTUknjr8sGEKbOdE/8MI9/KZnmnp/Y74cJQJJ9DeJ5Ft/M+KsDora6iDY
   J82wdT6hK7oSKUbmK7D1XMcJ4k5f77VN+C1a3RvrfY+djFp9er2OEIYhx
   9cIJWtr0s4kId9pCiMNteJzYlWSPIVYEdl0OTvLQjSbpRmmlz4Y7bnhMh
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10391"; a="343332233"
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; 
   d="scan'208";a="343332233"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Jun 2022 22:55:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; 
   d="scan'208";a="594629583"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by fmsmga007.fm.intel.com with ESMTP; 27 Jun 2022 22:55:07 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o64Bm-0009ZP-VP;
        Tue, 28 Jun 2022 05:55:06 +0000
Date:   Tue, 28 Jun 2022 13:54:52 +0800
...
Subject: [ardb:arm64-compat-alignment-fixups 2/2]
 ...
 for function 'do_compat_alignment_fixup'
Message-ID: <202206281333.d7AMFcgT-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="GCVPHu2e5HcuvojF"
...
>> arch/arm64/kernel/compat_alignment.c:391:5: warning: no previous prototype for function 'do_compat_alignment_fixup' [-Wmissing-prototypes]
   int do_compat_alignment_fixup(unsigned long addr, struct pt_regs *regs)
       ^
   arch/arm64/kernel/compat_alignment.c:391:1: note: declare 'static' if the function is not intended to be used outside of this translation unit
   int do_compat_alignment_fixup(unsigned long addr, struct pt_regs *regs)
   ^
   static 
   1 warning generated.
