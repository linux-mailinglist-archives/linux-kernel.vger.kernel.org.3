...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 65AB54DAA8B
	for <lists+linux-kernel@lfdr.de>; Wed, 16 Mar 2022 07:17:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353852AbiCPGSF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 16 Mar 2022 02:18:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48306 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1353864AbiCPGR6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 16 Mar 2022 02:17:58 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BDC0060CEC
        for <linux-kernel@vger.kernel.org>; Tue, 15 Mar 2022 23:16:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1647411401; x=1678947401;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=cyST1hgK+K5eocV/0WMVGaPpSPawlABUsxoXgEte8qg=;
  b=ka6UoP4L3i7bKNw721EkYFxDFT133GYMbFq64LEOD74wXy0IpWDonxOT
   Dov2ja5XfI074szdhMhbeaMhwaV7YBJumM1PA2uNmWhEfGGUGn8XaN28I
   /RA4x3Du2ywUKRhofA7Kp4dISkXhWWTnHJ94umnFaxJKMjt3GanAdwCf0
   WRp3xlOlIkW4bYnPbJVrq18SkzGwDOEXY/aCVoAghou84HeN+WsK+khY5
   b4QkuKvxd7SFaP71MGf+8upnRh++NWNOUgVo10wzsHoH5KK9dfFdN11jG
   IqKnJs1rS5Q4s5DZNjJNxw+lWGltz1DzOgjAWlrC09mRdgQD6vSCLujjK
   A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10286"; a="238669866"
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; 
   d="scan'208";a="238669866"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Mar 2022 23:16:40 -0700
X-IronPort-AV: E=Sophos;i="5.90,185,1643702400"; 
   d="scan'208";a="557300178"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Mar 2022 23:16:38 -0700
Date:   Wed, 16 Mar 2022 14:16:28 +0800
From:   Oliver Sang <oliver.sang@intel.com>
To:     "Paul E. McKenney" <paulmck@kernel.org>
Cc:     lkp@lists.01.org, lkp@intel.com,
        LKML <linux-kernel@vger.kernel.org>
Subject: Re: [rcu]  758cf1496b: BUG:spinlock_bad_magic_on_CPU
Message-ID: <20220316061628.GA19825@xsang-OptiPlex-9020>
References: <20220314055057.GC24245@xsang-OptiPlex-9020>
 <20220314140653.GR4285@paulmck-ThinkPad-P17-Gen-1>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20220314140653.GR4285@paulmck-ThinkPad-P17-Gen-1>
...
> > 	export testbox='vm-icl-36'
> > 	export tbox_group='vm-icl'
> > 	export branch='ammarfaizi2-block/paulmck/linux-rcu/dev'
> > 	export commit='758cf1496b94442c47c339b10d80cbaadf613425'
> > 	export kconfig='x86_64-rhel-8.3-kselftests'
> > 	export repeat_to=6
> > 	export nr_vm=160
> > 	export submit_id='622ce907c93d475d56bd9d46'
> > 	export job_file='/lkp/jobs/scheduled/vm-icl-36/boot-1-yocto-i386-minimal-20190520.cgz-758cf1496b94442c47c339b10d80cbaadf613425-20220313-89430-fvvfat-4.yaml'
> > 	export id='973515790737a6a185a8f82be6155179c94fec9f'
...
> > 	export enqueue_time='2022-03-13 02:40:07 +0800'
> > 	export _id='622ce91dc93d475d56bd9d47'
> > 	export _rt='/result/boot/1/vm-icl/yocto-i386-minimal-20190520.cgz/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425'
> > 	export user='lkp'
> > 	export LKP_SERVER='internal-lkp-server'
> > 	export result_root='/result/boot/1/vm-icl/yocto-i386-minimal-20190520.cgz/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425/3'
...
> > RESULT_ROOT=/result/boot/1/vm-icl/yocto-i386-minimal-20190520.cgz/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425/3
> > BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425/vmlinuz-5.17.0-rc1-00188-g758cf1496b94
> > branch=ammarfaizi2-block/paulmck/linux-rcu/dev
> > job=/lkp/jobs/scheduled/vm-icl-36/boot-1-yocto-i386-minimal-20190520.cgz-758cf1496b94442c47c339b10d80cbaadf613425-20220313-89430-fvvfat-4.yaml
> > user=lkp
> > ARCH=x86_64
> > kconfig=x86_64-rhel-8.3-kselftests
> > commit=758cf1496b94442c47c339b10d80cbaadf613425
...
> > vga=normal
> > rw'
> > 	export modules_initrd='/pkg/linux/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425/modules.cgz'
> > 	export lkp_initrd='/osimage/user/lkp/lkp-i386.cgz'
> > 	export site='inn'
> > 	export LKP_CGI_PORT=80
> > 	export LKP_CIFS_PORT=139
> > 	export schedule_notify_address=
> > 	export kernel='/pkg/linux/x86_64-rhel-8.3-kselftests/gcc-9/758cf1496b94442c47c339b10d80cbaadf613425/vmlinuz-5.17.0-rc1-00188-g758cf1496b94'
> > 	export dequeue_time='2022-03-13 02:41:03 +0800'
> > 	export job_initrd='/lkp/jobs/scheduled/vm-icl-36/boot-1-yocto-i386-minimal-20190520.cgz-758cf1496b94442c47c339b10d80cbaadf613425-20220313-89430-fvvfat-4.cgz'
> > 
> > 	[ -n "$LKP_SRC" ] ||
