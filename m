...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B5B675600B1
	for <lists+linux-kernel@lfdr.de>; Wed, 29 Jun 2022 15:10:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233722AbiF2NHe (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 29 Jun 2022 09:07:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39380 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233735AbiF2NH0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 29 Jun 2022 09:07:26 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 83E5C369FF
        for <linux-kernel@vger.kernel.org>; Wed, 29 Jun 2022 06:07:14 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 97DF3B82479
        for <linux-kernel@vger.kernel.org>; Wed, 29 Jun 2022 13:07:12 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B2110C341CB;
        Wed, 29 Jun 2022 13:07:10 +0000 (UTC)
Authentication-Results: smtp.kernel.org;
        dkim=pass (1024-bit key) header.d=zx2c4.com header.i=@zx2c4.com header.b="EeHMSEyL"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=zx2c4.com; s=20210105;
        ...
        bh=cWIwNdEzfQtJWDNvQ+WIpEfbu15ZvCCeFhOgb0jQrMQ=;
        b=EeHMSEyLq5N3VgOFaWps0WkGuh1X9zQePL8I/eSBzZq34wuIHkBpz2OUFqYixZrZLQSrXL
        qVdUncCWSp5MPqnDz28NCnLrvnO3bsvHV0TOet4ClbailYIsLJodN4vhh2EIQkdB9DfMNr
        CFCN5xuAG7Ftolq8VGMJV9PmXFMybck=
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id 9f7cf323 (TLSv1.3:AEAD-AES256-GCM-SHA384:256:NO);
        Wed, 29 Jun 2022 13:07:08 +0000 (UTC)
From:   "Jason A. Donenfeld" <Jason@zx2c4.com>
To:     linux-kernel@vger.kernel.org, viro@zeniv.linux.org.uk
Cc:     "Jason A. Donenfeld" <Jason@zx2c4.com>
Subject: [PATCH v3 1/7] fs: do not set no_llseek in fops
Date:   Wed, 29 Jun 2022 15:06:56 +0200
Message-Id: <20220629130702.954310-2-Jason@zx2c4.com>
...
The struct file_operations ->llseek() method is supposed to be called in
two places: vfs_llseek() and dump_skip(). Both treat NULL and no_llseek
as equivalent.

The value of ->llseek is also examined in __full_proxy_fops_init() and
ovl_copy_up_data(). For the former we could as well treat no_llseek as
NULL; no need to do a proxy wrapper around the function that fails with
-ESPIPE without so much as looking at its arguments.  Same for the
latter - there no_llseek would end up with skip_hole set true until the
first time we look at it. At that point we call vfs_llseek(), observe
that it has failed (-ESPIPE), shrug and set skip_hole false. We might as
well have done that from the very beginning.

In other words, any place where .llseek is set to no_llseek could just
as well set it to NULL.
...
---
 ...
 217 files changed, 1 insertion(+), 275 deletions(-)
...
index f7dd3c849e68..b455e164114d 100644
--- a/arch/s390/kernel/perf_cpum_cf.c
+++ b/arch/s390/kernel/perf_cpum_cf.c
@@ -1255,7 +1255,6 @@ static const struct file_operations cfset_fops = {
...
index ed25168619fc..d5ba30df23e5 100644
...
- *             .llseek = no_llseek,
  ...
  *     };
  *
@@ -552,8 +551,7 @@ EXPORT_SYMBOL(drm_release_noglobal);
...
index 2acece16b890..ab97bf438cca 100644
