...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7105352BF50
	for <lists+linux-kernel@lfdr.de>; Wed, 18 May 2022 18:13:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239941AbiERQEu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 18 May 2022 12:04:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40364 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239925AbiERQEr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 18 May 2022 12:04:47 -0400
Received: from mailbox.box.xen0n.name (mail.xen0n.name [115.28.160.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 14661195EBA;
        Wed, 18 May 2022 09:04:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=xen0n.name; s=mail;
        t=1652889881; bh=ej+WuI9VtC0JptuBwJvB6WxJadQFSsCoC+ApKSUSHdg=;
        h=Date:Subject:To:Cc:References:From:In-Reply-To:From;
        b=BEJnVTfMjjk8qE5PhKsyQIuzQ2L6a2J9XvoE21oCunuydZ/hZwYA1yX3uASEJct+w
         ALp6jjpIDxMWvVrCJh/z3uixoJ895TXMv5ZEKWg23iogsHz3H55ZYCQXxljBSVrh5q
         bksOqNNF2a9jNhRm+1hytijXzo+8t+WaBn6VSlkY=
Received: from [192.168.9.172] (unknown [101.88.28.48])
        (using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by mailbox.box.xen0n.name (Postfix) with ESMTPSA id 1792760695;
        Thu, 19 May 2022 00:04:41 +0800 (CST)
Message-ID: <c47cd290-7e0c-db0b-d4a8-9db56fd67782@xen0n.name>
Date:   Thu, 19 May 2022 00:04:40 +0800
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:102.0) Gecko/20100101
 Thunderbird/102.0a1
Subject: Re: [PATCH V11 08/22] LoongArch: Add other common headers
...
References: <20220518092619.1269111-1-chenhuacai@loongson.cn>
 <20220518092619.1269111-9-chenhuacai@loongson.cn>
From:   WANG Xuerui <kernel@xen0n.name>
In-Reply-To: <20220518092619.1269111-9-chenhuacai@loongson.cn>
...
>   18 files changed, 913 insertions(+)
...
> new file mode 100644
> index 000000000000..a387773ba5d0
> --- /dev/null
...
Actually I didn't spot any usage of these 2 macros, so they can be removed?
> +
> +/*
> + * Stack alignment
> + */
...
Actually I've overlooked in v10, but it seems most of the definitions 
here are unused; I only see LONG_{L,S,ADD} and PTR_{LI,S,ADD,ADDI}, for 
example.

Can we strip down these definitions?
