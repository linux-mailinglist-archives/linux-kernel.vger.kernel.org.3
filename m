...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A7F6E50AAB6
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Apr 2022 23:23:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1441969AbiDUVZP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 21 Apr 2022 17:25:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51870 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1441936AbiDUVZD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 21 Apr 2022 17:25:03 -0400
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 341AF4BFE3
        for <linux-kernel@vger.kernel.org>; Thu, 21 Apr 2022 14:22:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1650576131; x=1682112131;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=iDfUiAkTLuxKaiLoZ/W1bN84abIQAF3UsXAdfAml3o4=;
  b=hnaX0AoU6AbSzadV339PsxpxNNeOU3z1018mptzD1BP+LYO7AnkPO+7k
   g5okhtHbjOrmiPdsyssCXUuxkBrw+8YqUY/wMbprwphPGak7qiHDBGMbi
   MZNneOjMfpKVkQkbhAl8LhR41rNydF4hDTfRNiPcqLsxofGA6iLk5kAmj
   qzIFPo5jctvWKBVJvwpMVK+cMEatoE8OumY4dKemx99XVWGUlsB/lDwxf
   1MEUku2DgqizZ/889xt5QJ5VRu0nvqIhpNU8odfBSW0AD3tkWI3F7c3fc
   ZNpFcU3Y7u0avWXW1y1YfBjvyZG8LOME27/J26jrs7ZRPprbV9wop6zY/
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10324"; a="350924996"
X-IronPort-AV: E=Sophos;i="5.90,279,1643702400"; 
   d="scan'208";a="350924996"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Apr 2022 14:22:10 -0700
X-IronPort-AV: E=Sophos;i="5.90,279,1643702400"; 
   d="scan'208";a="658704080"
Received: from rhweight-mobl.amr.corp.intel.com (HELO rhweight-mobl.ra.intel.com) ([10.209.56.239])
  by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Apr 2022 14:22:09 -0700
...
Subject: [PATCH v5 3/8] firmware_loader: Split sysfs support from fallback
Date:   Thu, 21 Apr 2022 14:21:59 -0700
Message-Id: <20220421212204.36052-4-russell.h.weight@intel.com>
...
v4:
  ...
  - Fixed errors reported by the kernel test robot <lkp@intel.com> by adjusting
    the functions that are bound by "#ifdef CONFIG_FW_LOADER_USER_HELPER".
v5:
  - Added Tested-by tag
...
index 000000000000..1509cb6b6e60
--- /dev/null
