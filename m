...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2C5CD55D17C
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Jun 2022 15:09:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344683AbiF1LAg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Jun 2022 07:00:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57952 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345149AbiF1LAV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Jun 2022 07:00:21 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5FF6625C76
        for <linux-kernel@vger.kernel.org>; Tue, 28 Jun 2022 04:00:13 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 1569561998
        for <linux-kernel@vger.kernel.org>; Tue, 28 Jun 2022 11:00:12 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 750A3C341CB;
        Tue, 28 Jun 2022 11:00:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1656414011;
        bh=ND9+5SEe7w7Vcp+TU7i2SpLnF+0xL/vCiOjeijFBauU=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Oded Gabbay <ogabbay@kernel.org>
To:     linux-kernel@vger.kernel.org
Cc:     gregkh@linuxfoundation.org
Subject: [PATCH v2 03/12] habanalabs: add gaudi2 asic-specific code
Date:   Tue, 28 Jun 2022 13:59:49 +0300
Message-Id: <20220628105958.1254875-4-ogabbay@kernel.org>
...
---
Changes in v2:
 - Remove device structure members that are relevant only for testing
 ...
 drivers/misc/habanalabs/gaudi2/gaudi2.c       | 9757 +++++++++++++++++
 ...
 22 files changed, 11162 insertions(+), 96 deletions(-)
...
index c7401b524aed..803ce808ed2e 100644
...
@@ -3377,6 +3522,11 @@ void hl_encaps_handle_do_release(struct kref *ref);
...
new file mode 100644
index 000000000000..2224d1459e89
--- /dev/null
