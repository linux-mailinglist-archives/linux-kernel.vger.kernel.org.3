...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 152824EAD5D
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Mar 2022 14:43:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236543AbiC2Mnq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 29 Mar 2022 08:43:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33292 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236444AbiC2Mm7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 29 Mar 2022 08:42:59 -0400
Received: from mail-ed1-x54a.google.com (mail-ed1-x54a.google.com [IPv6:2a00:1450:4864:20::54a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ACF2D20E978
        for <linux-kernel@vger.kernel.org>; Tue, 29 Mar 2022 05:41:06 -0700 (PDT)
Received: by mail-ed1-x54a.google.com with SMTP id c22-20020a50f616000000b004196649d144so10956411edn.10
        for <linux-kernel@vger.kernel.org>; Tue, 29 Mar 2022 05:41:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=biz+rIgT55uFrE6N/OSPE++HUy2NNspyJjcc8tnQ5F0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=biz+rIgT55uFrE6N/OSPE++HUy2NNspyJjcc8tnQ5F0=;
        b=
X-Gm-Message-State: AOAM531pLWWam5GXcAiF/D8xxzorQbeh2u9P3gZySUnsrTyCbz/eInqC
        bIc6y7IPhb+oJvj9WPSrj+XiDRoefw0=
X-Google-Smtp-Source: ABdhPJxzkkrniU6QgqwuIr0F+dsVSYX1ecitHrX465QTJKPfG1GcAjlTfnc+Fpa5BJDcv5//XO+1tVMTk9U=
X-Received: from glider.muc.corp.google.com ([2a00:79e0:15:13:36eb:759:798f:98c3])
 (user=glider job=sendgmr) by 2002:a17:907:86a8:b0:6db:6c1c:d9c4 with SMTP id
 qa40-20020a17090786a800b006db6c1cd9c4mr33198729ejc.640.1648557664969; Tue, 29
 Mar 2022 05:41:04 -0700 (PDT)
Date:   Tue, 29 Mar 2022 14:39:42 +0200
In-Reply-To: <20220329124017.737571-1-glider@google.com>
Message-Id: <20220329124017.737571-14-glider@google.com>
Mime-Version: 1.0
References: <20220329124017.737571-1-glider@google.com>
X-Mailer: git-send-email 2.35.1.1021.g381101b075-goog
Subject: [PATCH v2 13/48] kmsan: add KMSAN runtime core
...
---
 ...
 17 files changed, 1548 insertions(+)
...
index 7214f075e1f06..251fa89068ed1 100644
--- a/Makefile
+++ b/Makefile
@@ -1006,6 +1006,7 @@ include-y			:=3D scripts/Makefile.extrawarn
...
index 0f549870da6a0..eace8b4ec083c 100644
--- a/include/linux/mm_types.h
+++ b/include/linux/mm_types.h
@@ -206,6 +206,18 @@ struct page {
...
index 75ba8aa60248b..d95305372b7a1 100644
...
index 14b89aa37c5c9..d6dc915f26c76 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
@@ -968,6 +968,7 @@ config DEBUG_STACKOVERFLOW
=20
...
index 70d4309c9ce33..b04d9e8c8d4e0 100644
--- a/mm/Makefile
+++ b/mm/Makefile
...
new file mode 100644
index 0000000000000..f4196f274e754
--- /dev/null
+++ b/mm/kmsan/core.c
@@ -0,0 +1,453 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 0000000000000..59c9e7b979423
--- /dev/null
+++ b/mm/kmsan/report.c
@@ -0,0 +1,211 @@
+// SPDX-License-Identifier: GPL-2.0
...
index 79be57fdd32a4..a96cf2a5d1c09 100644
--- a/scripts/Makefile.lib
+++ b/scripts/Makefile.lib
@@ -162,6 +162,15 @@ _c_flags +=3D $(if $(patsubst n%,, \
 endif
 endif
=20
+ifeq ($(CONFIG_KMSAN),y)
