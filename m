...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F353655A69D
	for <lists+linux-kernel@lfdr.de>; Sat, 25 Jun 2022 05:41:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232463AbiFYDCx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Jun 2022 23:02:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45506 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232458AbiFYDCj (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Jun 2022 23:02:39 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BA58B81266
        for <linux-kernel@vger.kernel.org>; Fri, 24 Jun 2022 20:00:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656126053; x=1687662053;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=U5EgoHyOnP4PFmvEAzOrejGFFOow9pXGor6E0xN1b+M=;
  b=CI36TwbNOdZKtFcTolFB9rrwzEjm8hR/L+7B6fb5tC1qv1REhlfQcfyw
   dfZXlIMLSY8BzI3dnn6514n2HFyUcIfuZil2nRglImC4kilmXPsUa5SIl
   qwJx7zIIzh+wE2Wb42/8VPb10UG1iKhe6/zJ50ItHu8c5LefevEwMyzkv
   7I/9JpOZaRolxuXUZRAPoHc7el7fH4pIYUZ6gdKI032HYbwuCvK1v8lSH
   BE/o5lNDAoYgZ8juRnZsoUOdzpw3MjZ3i2ivc21atUtYjV8Xzd2BeL1X+
   JJSY+rtxQ6YGNG3f6P+FNJ1zFKPmdBqJwp14aA1pQ2W4KRwI2cR9/VJ/S
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10388"; a="281873942"
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="281873942"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jun 2022 20:00:50 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="586796870"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by orsmga007.jf.intel.com with ESMTP; 24 Jun 2022 20:00:47 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o4w2R-0005Gw-4O;
        Sat, 25 Jun 2022 03:00:47 +0000
Date:   Sat, 25 Jun 2022 10:59:55 +0800
From:   kernel test robot <lkp@intel.com>
To:     Oded Gabbay <ogabbay@kernel.org>
Cc:     llvm@lists.linux.dev, kbuild-all@lists.01.org,
        linux-kernel@vger.kernel.org
Subject: [ogabbay:gaudi2_full 47/48]
 drivers/misc/habanalabs/goya/goya.c:474:8: error: no member named
 'first_available_user_interrupt' in 'struct asic_fixed_properties'; did you
 mean 'first_available_user_msix_interrupt'?
Message-ID: <202206250601.eXJjiUKO-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="f0v5sSbjaJyQ3pzD"
...
All errors (new ones prefixed by >>):
   ...
   drivers/misc/habanalabs/goya/goya.c:397:26: error: use of undeclared identifier 'HL_COMPLETION_MODE_JOB'
           prop->completion_mode = HL_COMPLETION_MODE_JOB;
                                   ^
>> drivers/misc/habanalabs/goya/goya.c:474:8: error: no member named 'first_available_user_interrupt' in 'struct asic_fixed_properties'; did you mean 'first_available_user_msix_interrupt'?
           prop->first_available_user_interrupt = USHRT_MAX;
                 ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                 first_available_user_msix_interrupt
   drivers/misc/habanalabs/goya/../common/habanalabs.h:628:9: note: 'first_available_user_msix_interrupt' declared here
