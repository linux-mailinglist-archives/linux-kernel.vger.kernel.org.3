...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1BA0C54A8F7
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Jun 2022 07:57:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243692AbiFNF5L (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Jun 2022 01:57:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56846 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236679AbiFNF5I (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Jun 2022 01:57:08 -0400
Received: from mail-qt1-x82e.google.com (mail-qt1-x82e.google.com [IPv6:2607:f8b0:4864:20::82e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A5DC11F2EC
        for <linux-kernel@vger.kernel.org>; Mon, 13 Jun 2022 22:57:03 -0700 (PDT)
Received: by mail-qt1-x82e.google.com with SMTP id l3so4109699qtp.1
        for <linux-kernel@vger.kernel.org>; Mon, 13 Jun 2022 22:57:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gooddata.com; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=KhZowO8T3Rkdy3H6By8Ml8C2TcBPO913Ben+bBT25Os=;
        b=k7reOAFrNGcymyVVYoJQZiEpCLjOFju1k5r8B3YBxXIYZy4NlBLwc493mjG7r0KrPB
         kFFNrn3bAJRQdEk1Csvp2N1LTH1JiWvQaiCzPUHJHnjxIjtxLKbKv1TQFycs5AzR7yjy
         S0Xk35kFBCNS0BSXLNmcjWM3fP/rS+U+cUMtU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc:content-transfer-encoding;
        bh=KhZowO8T3Rkdy3H6By8Ml8C2TcBPO913Ben+bBT25Os=;
        b=
X-Gm-Message-State: AOAM533hxdUoGc5jI8kipUlTc3q2BNUQpsA6hZlTihUaDPOIlhXvhxU8
        hVO9xhzPoatNPigqfyok/YvBnYbY7RNyI3ViNLbUJA==
X-Google-Smtp-Source: ABdhPJx2N2RyU/OpADIB6q8id58KnBi99AN2HyoIVfa5v59ENv9lGCFj9wfO70ag4a2uMCNJTchwwQGUD6NTMXJRDco=
X-Received: by 2002:a05:622a:489:b0:304:c53b:afcf with SMTP id
 p9-20020a05622a048900b00304c53bafcfmr2782506qtx.351.1655186222283; Mon, 13
 Jun 2022 22:57:02 -0700 (PDT)
MIME-Version: 1.0
...
Date:   Tue, 14 Jun 2022 07:56:36 +0200
Message-ID: <CAK8fFZ68+xZ2Z0vDWnihF8PeJKEmEwCyyF-8W9PCZJTd8zfp-A@mail.gmail.com>
...
po 13. 6. 2022 v 21:49 odes=C3=ADlatel Greg Kroah-Hartman
...
>     cifs: version operations for smb20 unneeded when legacy support disab=
led
>
...
>     sysrq: do not omit current cpu when showing backtrace of all active C=
PUs
>
...
>
> Duoming Zhou <duoming@zju.edu.cn>
>     drivers: staging: rtl8192eu: Fix deadlock in rtw_joinbss_event_prehan=
dle
>
> Duoming Zhou <duoming@zju.edu.cn>
...
>     tracing: Fix sleeping function called from invalid context on RT kern=
el
>
...
>
> Luiz Augusto von Dentz <luiz.von.dentz@intel.com>
>     Bluetooth: MGMT: Add conditions for setting HCI_CONN_FLAG_REMOTE_WAKE=
UP
>
...
>
> Kan Liang <kan.liang@linux.intel.com>
>     perf evsel: Fixes topdown events in a weak group for the hybrid platf=
orm
>
...
>     net: sched: add barrier to fix packet stuck problem for lockless qdis=
c
>
...
>
> Maxim Mikityanskiy <maximmi@nvidia.com>
>     net/mlx5e: Disable softirq in mlx5e_activate_rq to avoid race conditi=
on
>
> Paul Blakey <paulb@nvidia.com>
...
>
> Christoph Hellwig <hch@lst.de>
>     block: take destination bvec offsets into account in bio_copy_data_it=
er
>
...
>     selftests/bpf: fix stacktrace_build_id with missing kprobe/urandom_re=
ad
>
> Zhihao Cheng <chengzhihao1@huawei.com>
>     ubi: ubi_create_volume: Fix use-after-free when volume creation faile=
d
>
> Zhihao Cheng <chengzhihao1@huawei.com>
>     ubi: fastmap: Fix high cpu usage of ubi_bgt by making sure wl_pool no=
t empty
>
...
>     clocksource/drivers/oxnas-rps: Fix irq_of_parse_and_map() return valu=
e
>
> Christoph Hellwig <hch@lst.de>
...
>     coresight: cpu-debug: Replace mutex with mutex_trylock on panic notif=
ier
>
...
>     power: supply: axp288_fuel_gauge: Drop BIOS version check from "T3 MR=
D" DMI quirk
>
> Hans de Goede <hdegoede@redhat.com>
>     power: supply: axp288_fuel_gauge: Fix battery reporting on the One Mi=
x 1
>
> Linus Walleij <linus.walleij@linaro.org>
...
>     usb: dwc3: gadget: Replace list_for_each_entry_safe() if using giveba=
ck
>
> Krzysztof Kozlowski <krzysztof.kozlowski@linaro.org>
...
>
> Miaoqian Lin <linmq006@gmail.com>
>     serial: 8250_aspeed_vuart: Fix potential NULL dereference in aspeed_v=
uart_probe
>
...
>
> Miaoqian Lin <linmq006@gmail.com>
>     tty: serial: owl: Fix missing clk_disable_unprepare() in owl_uart_pro=
be
>
...
>     staging: greybus: codecs: fix type confusion of list iterator variabl=
e
>
...
>  402 files changed, 2783 insertions(+), 1811 deletions(-)
>
>
