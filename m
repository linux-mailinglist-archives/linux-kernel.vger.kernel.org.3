...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 99CE455A681
	for <lists+linux-kernel@lfdr.de>; Sat, 25 Jun 2022 05:41:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232139AbiFYC7q (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Jun 2022 22:59:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42420 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232154AbiFYC66 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Jun 2022 22:58:58 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6AEC4680AE
        for <linux-kernel@vger.kernel.org>; Fri, 24 Jun 2022 19:58:50 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656125930; x=1687661930;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Cs/D+M/nKldiWzcQ/up5oIs2SGhsXnzE55cLT38oqyY=;
  b=EHnLmrremsZF6Tp2EufVuPDTSG9yPCJB/kFxuCnlWTUzqgvz8+uHyNSq
   eInoOHXrFb5Lhbdcd0AA1Lk+VGARlBMCHgs78Pum4f2TLhSds6M8P4Slp
   SsGx4CESB/BrdzFqyPL4nHZ6/BLJahxTi/xPZE1RmcCxF7JGPTFa0Gdsm
   Xmq/qdqY/VZ0jE1fA+Dz6om8ilBppBtew7z4xJzsE44zRipMwTPqTRNxV
   MS7L7j9/0HBZOW+ZIEYGEz7XPS8p6k3ZkeV6VGKK7HRbp2YkW+3KNDM+J
   H8/nDZM227snO+qtaplYMMPDTJRkKwtWv2hWWaHkWgBfrgBsGx4vhtu+5
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10388"; a="281873850"
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="281873850"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jun 2022 19:58:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="835371259"
...
Date:   Sat, 25 Jun 2022 10:58:17 +0800
From:   kernel test robot <lkp@intel.com>
To:     Sebastian Andrzej Siewior <bigeasy@linutronix.de>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [rt-devel:linux-5.19.y-rt-rebase 10/52] kernel/sched/core.c:3311:41:
 error: expected ')' before 'mismatch'
Message-ID: <202206242255.Unp4ixte-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="OFlZQa2N+F9Vcu1g"
...
>> include/asm-generic/rwonce.h:44:71: error: lvalue required as unary '&' operand
   ...
   include/asm-generic/rwonce.h:50:9: note: in expansion of macro '__READ_ONCE'
      50 |         __READ_ONCE(x);                                                 \
         |         ^~~~~~~~~~~
   kernel/sched/core.c:3310:37: note: in expansion of macro 'READ_ONCE'
    3310 |                                 if (READ_ONCE(p->__state != match_state)
         |                                     ^~~~~~~~~
>> kernel/sched/core.c:3311:41: error: expected ')' before 'mismatch'
    3311 |                                         mismatch = true;
         |                                         ^~~~~~~~
   kernel/sched/core.c:3310:36: note: to match this '('
    3310 |                                 if (READ_ONCE(p->__state != match_state)
         |                                    ^
>> kernel/sched/core.c:3323:25: error: expected expression before '}' token
    3323 |                         }
         |                         ^
