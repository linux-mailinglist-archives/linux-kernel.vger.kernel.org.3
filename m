...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 573C656CA29
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Jul 2022 16:46:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229560AbiGIOnK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 9 Jul 2022 10:43:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35862 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229460AbiGIOnH (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 9 Jul 2022 10:43:07 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D43E21F624
        for <linux-kernel@vger.kernel.org>; Sat,  9 Jul 2022 07:43:00 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1657377780; x=1688913780;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=08Ns+z379D6piwKUOHofJTchjTHioXlaDi8hlJ0ebIs=;
  b=AwsOWMzQn8NIyaGzUcfWs5rmyxL58+Pzl3OZuFniUET5AJYasBgzJ38F
   VDOf0qZRSO55dBXMp3StlJSPutZtzmP4pOiEkftMnnMzYroG1m+feRKHE
   vN/BxXfDjt5GYZS767AFsbuoa/eCYDHcyJ/uufp7OyQxoP9OG8Y+hA3KK
   1FGLj5QaEVpGM24GKwXnw/MEzA3R2Im//zEVyM7fkZaipuOQUda50tW/v
   B79fZTChYzAXN6YvX3q29OTFgJf44md003irxTBtl1mQDhJGV1Y9qHOlJ
   ueXOYJ7RgX2pQH0wkbBnLXFqGDs3asR6xVdoCjHpHNP+zCpDNC4xN0omz
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10402"; a="285565824"
X-IronPort-AV: E=Sophos;i="5.92,258,1650956400"; 
   d="yaml'?scan'208";a="285565824"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Jul 2022 07:43:00 -0700
X-IronPort-AV: E=Sophos;i="5.92,258,1650956400"; 
   d="yaml'?scan'208";a="544522470"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Jul 2022 07:42:52 -0700
Date:   Sat, 9 Jul 2022 22:42:49 +0800
...
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        ...
        Abel Wu <wuyun.abel@bytedance.com>, aubrey.li@linux.intel.com
Subject: [sched/fair]  32fe13cd7a:
 phoronix-test-suite.fio.SequentialWrite.IO_uring.Yes.No.4KB.DefaultTestDirectory.mb_s
 -11.7% regression
Message-ID: <YsmT6VAqPybIe9Pu@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="/SMe269MYm/0Nv95"
...
Content-Disposition: attachment;
	filename="config-5.19.0-rc2-00017-g32fe13cd7aa1"
...
kbuild_queue_analysis'
	...
	export submit_id='62c590e3964b8fc7be8262b8'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x8-20220706-51134-1aqiyj5-3.yaml'
	export id='40df9d15ee7634cc9e8bb31436ec2319ea4be542'
	...
	export commit='32fe13cd7aa184ed349d698ebf6f420fa426dd73'
...
SATA_AHCI'
	...
	export enqueue_time='2022-07-06 21:40:52 +0800'
	export _id='62c590e3964b8fc7be8262b8'
	export _rt='/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73'
	export user='lkp'
	...
	export branch='linux-review/Abel-Wu/sched-fair-improve-scan-efficiency-of-SIS/20220619-200743'
	export result_root='/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/vmlinuz-5.19.0-rc2-00017-g32fe13cd7aa1
branch=linux-review/Abel-Wu/sched-fair-improve-scan-efficiency-of-SIS/20220619-200743
job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x8-20220706-51134-1aqiyj5-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=32fe13cd7aa184ed349d698ebf6f420fa426dd73
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/vmlinuz-5.19.0-rc2-00017-g32fe13cd7aa1'
	export dequeue_time='2022-07-06 21:41:57 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x8-20220706-51134-1aqiyj5-3.cgz'
...
run_job()
{
	...
	run_test test='fio-1.14.1' option_a='Sequential Write' option_b='IO_uring' option_c='Yes' option_d='No' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='fio-1.14.1' option_a='Sequential Write' option_b='IO_uring' option_c='Yes' option_d='No' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/stats/wrapper phoronix-test-suite
...
submit_id: 62c548d7964b8fb79f76c5a8
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x8-20220706-47007-1tip81u-1.yaml"
id: 647824f37ab4cb1c0bf003a0a815e41dd7712d81
...
enqueue_time: 2022-07-06 16:33:28.229203824 +08:00
_id: 62c548d8964b8fb79f76c5a9
_rt: "/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
branch: linux-devel/devel-hourly-20220704-032640
result_root: "/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/vmlinuz-5.19.0-rc2-00017-g32fe13cd7aa1
- branch=linux-devel/devel-hourly-20220704-032640
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x8-20220706-47007-1tip81u-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=32fe13cd7aa184ed349d698ebf6f420fa426dd73
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/32fe13cd7aa184ed349d698ebf6f420fa426dd73/vmlinuz-5.19.0-rc2-00017-g32fe13cd7aa1"
dequeue_time: 2022-07-06 16:46:45.313390031 +08:00
:#! /cephfs/db/releases/20220706151919/lkp-src/include/site/inn:
job_state: finished
loadavg: 40.47 27.27 13.25 1/897 25065
start_time: '1657094700'
end_time: '1657095236'
