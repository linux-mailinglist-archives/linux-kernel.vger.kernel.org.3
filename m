...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 399F94D2533
	for <lists+linux-kernel@lfdr.de>; Wed,  9 Mar 2022 02:13:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230474AbiCIBJi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Mar 2022 20:09:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51014 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230267AbiCIBJE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Mar 2022 20:09:04 -0500
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EA30914864F
        for <linux-kernel@vger.kernel.org>; Tue,  8 Mar 2022 16:50:38 -0800 (PST)
Received: by mail-yb1-xb49.google.com with SMTP id d188-20020a2568c5000000b00628bf187056so505821ybc.15
        for <linux-kernel@vger.kernel.org>; Tue, 08 Mar 2022 16:50:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=oIumHAuiLMXPNtdtvCZpC2SLz5KwlQfUHlQ+jGYAwL8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=oIumHAuiLMXPNtdtvCZpC2SLz5KwlQfUHlQ+jGYAwL8=;
        b=
X-Gm-Message-State: AOAM5303AFsZcrLXcfb88MPqxCuWLad+f8Lpegm7EmW1bs/VJQj/sv2o
        +/vOEjuvd5UxkGQAfCuynfm8BHzu+D4=
X-Google-Smtp-Source: ABdhPJxieuMAswIQOJtBlmNKH6k4sSdh3w0QOfNh6USxOFdfwCkjHAJIt2gonfdvvPzoOp8hhqw2s7rYSFk=
X-Received: from yuzhao.bld.corp.google.com ([2620:15c:183:200:57a6:54a6:aad1:c0a8])
 (user=yuzhao job=sendgmr) by 2002:a25:bc8:0:b0:628:80d9:526c with SMTP id
 191-20020a250bc8000000b0062880d9526cmr14214749ybl.115.1646783315189; Tue, 08
 Mar 2022 15:48:35 -0800 (PST)
Date:   Tue,  8 Mar 2022 16:47:18 -0700
In-Reply-To: <20220308234723.3834941-1-yuzhao@google.com>
Message-Id: <20220308234723.3834941-9-yuzhao@google.com>
Mime-Version: 1.0
References: <20220308234723.3834941-1-yuzhao@google.com>
X-Mailer: git-send-email 2.35.1.616.g0bdcbb4464-goog
Subject: [PATCH v8 08/14] mm: multi-gen LRU: support page table walks
...
index 2a8bae14de74..8706f75a12dd 100644
--- a/include/linux/mmzone.h
+++ b/include/linux/mmzone.h
@@ -399,6 +399,58 @@ struct lru_gen_struct {
...
@@ -1041,6 +1095,10 @@ typedef struct pglist_data {
=20
 	unsigned long		flags;
=20
+#ifdef CONFIG_LRU_GEN
