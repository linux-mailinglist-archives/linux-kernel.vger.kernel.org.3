...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 618B15ADAD3
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Sep 2022 23:15:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229818AbiIEVPH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Sep 2022 17:15:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34396 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230204AbiIEVPD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Sep 2022 17:15:03 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1878F1929E
        for <linux-kernel@vger.kernel.org>; Mon,  5 Sep 2022 14:14:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662412498; x=1693948498;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=zhIMdeE2lrpjMAPj/UUvH7wtxdHnT8SFMuwRrjYMEfw=;
  b=mvzBADUJD8YJJS0jXPN9ASMjwwMbwws2mCzsWrUPhtT9ibu4Kuribt2L
   UnltUykZb0UtVkunD4s5QAp9mpCdJSdgPORa1ZMylM97LK2CppDwuPHks
   kZ/8+UIG1fWlfRLxYbLaEa5hsvNLdr7a8AjLxRIKi+wNmq0r58BZY4XDE
   Kym/3cONZHNWnfmhube3TMC3zmi2wgEyJcHF2UdTth9E2Se+lT5ie0R1C
   2RVTaDmtXIKzJJHVPcDEV3jiOaUAQTjsgnqQu8JGe51d0FUyM4bEIWaxa
   YlpoK/D+0KF+bKM7H4NJXBjv/DwjyHOBrEPzq90R8e/3YKIsua/j7ne3B
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10461"; a="322624831"
X-IronPort-AV: E=Sophos;i="5.93,292,1654585200"; 
   d="scan'208";a="322624831"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Sep 2022 14:14:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,292,1654585200"; 
   d="scan'208";a="942220247"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 05 Sep 2022 14:14:55 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oVJQk-0004Xl-1E;
        Mon, 05 Sep 2022 21:14:54 +0000
Date:   Tue, 6 Sep 2022 05:14:01 +0800
From:   kernel test robot <lkp@intel.com>
To:     Aurabindo Pillai <aurabindo.pillai@amd.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org,
        Alex Deucher <alexander.deucher@amd.com>,
        Harry Wentland <Harry.Wentland@amd.com>
Subject: [agd5f:drm-next 147/274]
 drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:109:29:
 warning: 'DCN_BASE' defined but not used
Message-ID: <202209060512.MS1egFmD-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="WQjZfpFkbSSva+Hd"
...
commit: f7fbcf4637fe8f54acb18d88488ae901b3d7a4dc [147/274] drm/amd/display: change to runtime initialization for reg offsets for DCN32
config: i386-buildonly-randconfig-r004-20220905
compiler: gcc-11 (Debian 11.3.0-5) 11.3.0
reproduce (this is a W=1 build):
        git remote add agd5f https://gitlab.freedesktop.org/agd5f/linux.git
        git fetch --no-tags agd5f drm-next
        git checkout f7fbcf4637fe8f54acb18d88488ae901b3d7a4dc
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dce/dce_hwseq.h:678:35: note: in expansion of macro 'DOMAIN16_PG_STATUS__DOMAIN_PGFSM_PWR_STATUS_MASK'
     678 |         .field_name = blk_name ## reg_name ## __ ## field_name ## post_fix
         |                                   ^~~~~~~~
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:632:9: note: in expansion of macro 'HWS_SF'
     632 |         HWS_SF(, DOMAIN16_PG_STATUS, DOMAIN_PGFSM_PWR_STATUS, mask_sh), \
         |         ^~~~~~
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:648:17: note: in expansion of macro 'HWSEQ_DCN32_MASK_SH_LIST'
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dce/dce_hwseq.h:678:35: note: in expansion of macro 'DOMAIN17_PG_STATUS__DOMAIN_PGFSM_PWR_STATUS_MASK'
     678 |         .field_name = blk_name ## reg_name ## __ ## field_name ## post_fix
         |                                   ^~~~~~~~
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:633:9: note: in expansion of macro 'HWS_SF'
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dce/dce_hwseq.h:678:35: note: in expansion of macro 'DOMAIN18_PG_STATUS__DOMAIN_PGFSM_PWR_STATUS_MASK'
     678 |         .field_name = blk_name ## reg_name ## __ ## field_name ## post_fix
         |                                   ^~~~~~~~
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:634:9: note: in expansion of macro 'HWS_SF'
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dce/dce_hwseq.h:678:35: note: in expansion of macro 'DOMAIN19_PG_STATUS__DOMAIN_PGFSM_PWR_STATUS_MASK'
     678 |         .field_name = blk_name ## reg_name ## __ ## field_name ## post_fix
         |                                   ^~~~~~~~
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:635:9: note: in expansion of macro 'HWS_SF'
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:1627:31: warning: variable 'state' set but not used [-Wunused-but-set-variable]
    1627 |         union dc_3dlut_state *state;
         |                               ^~~~~
   At top level:
>> drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c:109:29: warning: 'DCN_BASE' defined but not used [-Wunused-const-variable=]
...
vim +/DCN_BASE +109 drivers/gpu/drm/amd/amdgpu/../display/dc/dcn32/dcn32_resource.c

235c67634230b0f Aurabindo Pillai 2022-02-23  108  
235c67634230b0f Aurabindo Pillai 2022-02-23 @109  static const struct IP_BASE DCN_BASE = { { { { 0x00000012, 0x000000C0, 0x000034C0, 0x00009000, 0x02403C00, 0 } },
235c67634230b0f Aurabindo Pillai 2022-02-23  110  					{ { 0, 0, 0, 0, 0, 0 } },
235c67634230b0f Aurabindo Pillai 2022-02-23  111  					{ { 0, 0, 0, 0, 0, 0 } },
235c67634230b0f Aurabindo Pillai 2022-02-23  112  					{ { 0, 0, 0, 0, 0, 0 } },
235c67634230b0f Aurabindo Pillai 2022-02-23  113  					{ { 0, 0, 0, 0, 0, 0 } },
235c67634230b0f Aurabindo Pillai 2022-02-23  114  					{ { 0, 0, 0, 0, 0, 0 } } } };
235c67634230b0f Aurabindo Pillai 2022-02-23  115  
