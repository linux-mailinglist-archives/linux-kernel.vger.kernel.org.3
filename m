...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0E05556A775
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Jul 2022 18:09:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235827AbiGGQJ2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 Jul 2022 12:09:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47640 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235939AbiGGQJA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 Jul 2022 12:09:00 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C50FD13DDB;
        Thu,  7 Jul 2022 09:08:44 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id BF3C1B82298;
        Thu,  7 Jul 2022 16:08:42 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 82A1FC3411E;
        Thu,  7 Jul 2022 16:08:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1657210121;
        bh=vYYkBjrlJyWmkyEAhEKfBPWFoqAwp0GKAs9L1kWz8w4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=UA1E/7/YQ+Dv0SOOoDUeJ6EygZ52giJtvuBZnB7qmIzoIc2KzFahqspmNMU+xBd/3
         RhbIpi09GPRFc1r9WBpR8/duGhKG9AwvUna4zRj3WCUtGZJbxk3c1EQEhn3i8Kbb+Q
         TYxeP+Xu1HcggDoKXOFVZJwbYXmYaKN9LRUgqLRA=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.204
Date:   Thu,  7 Jul 2022 18:08:30 +0200
Message-Id: <1657210109148130@kroah.com>
X-Mailer: git-send-email 2.37.0
In-Reply-To: <1657210109104219@kroah.com>
References: <1657210109104219@kroah.com>
MIME-Version: 1.0
...
index 86f518e49c33..b5d1718ae70c 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 3731066f2c1c..d0538c03f033 100644
...
index 5e73cc6ad0ce..42151c9fc6e5 100644
...
index c40327ad6ad5..474cf6abefea 100644
...
index 41e58bd2e606..31ed7616e84e 100644
...
index a4af185fa466..8bee935c8f90 100644
...
index d9993884a97d..dd02fcc97277 100644
--- a/drivers/net/tun.c
+++ b/drivers/net/tun.c
...
index a06c3924e039..ea9c8361bf46 100644
...
index 566ea48fd607..8ef0a013874c 100644
...
index b8b9df82f51e..997936c3a30f 100644
...
index f4c03518d7d2..e14842fbe3d6 100644
...
index 94dd6edd1800..810fa9968be7 100644
...
index 9fa4b3f88c39..2571da63877c 100644
...
index e29553e4f4ee..a0123760fb2c 100644
...
index 619d9dffa9e4..00732ee6bbd8 100644
--- a/net/ipv6/route.c
+++ b/net/ipv6/route.c
...
index a4cad71c4204..65394abf4736 100644
...
index 16e75a996b74..117d374695fe 100644
--- a/net/ipv6/sit.c
+++ b/net/ipv6/sit.c
...
+
 	...
 	len = sizeof(*kp) * c;
@@ -348,7 +346,7 @@ static int ipip6_tunnel_get_prl(struct ip_tunnel *t,
 		ret = -EFAULT;
...
index 9de0eb20e954..e7eb56b4b89e 100644
...
@@ -693,7 +788,7 @@ int rseq_cmpeqv_storev(intptr_t *v, intptr_t expect, intptr_t newv, int cpu)
  */
 static inline __attribute__((always_inline))
 int rseq_cmpnev_storeoffp_load(intptr_t *v, intptr_t expectnot,
-			       off_t voffp, intptr_t *load, int cpu)
