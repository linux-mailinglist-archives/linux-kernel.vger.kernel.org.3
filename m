...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 57CCD52DEBF
	for <lists+linux-kernel@lfdr.de>; Thu, 19 May 2022 22:51:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244907AbiESUuf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 19 May 2022 16:50:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53802 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244878AbiESUuS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 19 May 2022 16:50:18 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 7E18B994E3
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=n8CiMczVU45Qr8oAD3KQIovfGtPuUSbTEvFOaoCPVl0=;
        b=VqhlN+6UPVaLfjOHe0NDxlHELN7iK215QlhZ9+wQjRivgILHX6QhhyDQVpFgJijh0vAd6w
        MDXScb71KtLh5fjaDTo2H3m7R+z4APNeztMO+R4EiuTAn8covTF/SyC+CFVgbAxgWlAM0E
        6ZmbcHO3UzT54vQxZgC8KYSRh/CPuRM=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-394-JViONrvvMiinmer9izzWew-1; Thu, 19 May 2022 16:50:00 -0400
X-MC-Unique: JViONrvvMiinmer9izzWew-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.rdu2.redhat.com [10.11.54.3])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id A2BF6185A7A4;
        Thu, 19 May 2022 20:49:59 +0000 (UTC)
Received: from dqiao.bos.com (unknown [10.22.35.162])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 30AE91121314;
        Thu, 19 May 2022 20:49:59 +0000 (UTC)
...
Subject: [PATCH v4 10/11] smp: replace smp_call_function_single() with smp_call
Date:   Thu, 19 May 2022 16:49:42 -0400
Message-Id: <20220519204943.1079578-11-dqiao@redhat.com>
...
index e36c67d7dffb..c91a6f3cc7c7 100644
...
index b18a45dc0028..24fb10b9926e 100644
--- a/arch/sparc/kernel/nmi.c
+++ b/arch/sparc/kernel/nmi.c
@@ -300,7 +300,7 @@ int watchdog_nmi_enable(unsigned int cpu)
 	if (!nmi_init_done)
 		return 0;
...
@@ -313,5 +313,5 @@ void watchdog_nmi_disable(unsigned int cpu)
...
index 4b6dd708f1f6..79bcc9bf86a5 100644
...
index c783f5c533e2..ac54699575b1 100644
--- a/kernel/smp.c
+++ b/kernel/smp.c
...
@@ -1190,7 +1160,8 @@ int smp_call_csd(int cpu, call_single_data_t *csd, unsigned int flags)
 		csd_lock_record(csd);
 		csd_unlock(csd);
...
index 03f72efdda84..fe086dd0fb60 100644
--- a/net/iucv/iucv.c
+++ b/net/iucv/iucv.c
