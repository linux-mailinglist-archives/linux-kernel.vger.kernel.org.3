...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 274C653593D
	for <lists+linux-kernel@lfdr.de>; Fri, 27 May 2022 08:23:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239816AbiE0GVl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 27 May 2022 02:21:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55672 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233671AbiE0GVh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 27 May 2022 02:21:37 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 24947219F
        for <linux-kernel@vger.kernel.org>; Thu, 26 May 2022 23:21:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1653632490; x=1685168490;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=KMwNENc1zKd7Rie8QdzNg4ffVeJGGCMjcWmjsqQhIls=;
  b=E3tnl6qf/rfFSRk47olmn0voM9j6tw5J0XUJ+C4IkRlp2g1WXEGn10fc
   XFIVHcAt+yPg0Pxz93j+UmBWSN/yf7W3UMlGeoX3XdmB07JkhHnKTyDXk
   ENu2zLGrli5UjpE46cZVK3DsuRioRf5m7ypsA+JFQi/wWSFjuDG1AenmI
   53+j0ps2p5KVKfy90/tbIK2s5G1UItW9S7uUiwT27yHttr4otdTVKXrlH
   YmNoVMkD9GVQG+TxMGYFsEX/Vq4ni2TS+gOp9WilGhRgnA4NGk4BC3Xnm
   BK+beUpXtnmgC2dImqtiofRtVggXJDvGwL8LhVYsFNEKaCXtowInwdU5y
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10359"; a="256465985"
X-IronPort-AV: E=Sophos;i="5.91,254,1647327600"; 
   d="yaml'?scan'208";a="256465985"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 May 2022 23:21:28 -0700
X-IronPort-AV: E=Sophos;i="5.91,254,1647327600"; 
   d="yaml'?scan'208";a="574362706"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 May 2022 23:21:23 -0700
...
Content-Disposition: attachment; filename="config-5.18.0-rc5-00025-g5278ba412faf"
...
kbuild_queue_analysis'
	...
	export submit_id='628f6e70fec3e2e1ba4dc45b'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp2/unixbench-performance-1-300s-shell1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-5278ba412faff8402e318ad20ab762cc9ba7a801-20220526-57786-4kkmzb-3.yaml'
	export id='69036e780a015a62f7b6ee4074cae8a702fc1f82'
...
/dev/disk/by-id/nvme-INTEL_SSDPE2KX040T7_PHLF7414019F4P0IGN-part3'
	...
	export commit='5278ba412faff8402e318ad20ab762cc9ba7a801'
	export netconsole_port=6680
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-05-26 20:11:28 +0800'
	export _id='628f6e70fec3e2e1ba4dc45b'
	export _rt='/result/unixbench/performance-1-300s-shell1-ucode=0xd000331/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='6b9ce23427ccdaeb192d8d172603682319a08ef9'
	export base_commit='4b0986a3613c92f4ec1bdc7f60ec66fea135991f'
	export branch='linux-review/Mel-Gorman/Mitigate-inconsistent-NUMA-imbalance-behaviour/20220520-183837'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/unixbench/performance-1-300s-shell1-ucode=0xd000331/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/3'
	export scheduler_version='/lkp/lkp/.src-20220525-200837'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/unixbench/performance-1-300s-shell1-ucode=0xd000331/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/vmlinuz-5.18.0-rc5-00025-g5278ba412faf
branch=linux-review/Mel-Gorman/Mitigate-inconsistent-NUMA-imbalance-behaviour/20220520-183837
job=/lkp/jobs/scheduled/lkp-icl-2sp2/unixbench-performance-1-300s-shell1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-5278ba412faff8402e318ad20ab762cc9ba7a801-20220526-57786-4kkmzb-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=5278ba412faff8402e318ad20ab762cc9ba7a801
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/vmlinuz-5.18.0-rc5-00025-g5278ba412faf'
	export dequeue_time='2022-05-26 20:14:40 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp2/unixbench-performance-1-300s-shell1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-5278ba412faff8402e318ad20ab762cc9ba7a801-20220526-57786-4kkmzb-3.cgz'
...
run_job()
{
	...
	run_test test='shell1' $LKP_SRC/tests/wrapper unixbench
}
...
extract_stats()
{
	...
	env test='shell1' $LKP_SRC/stats/wrapper unixbench
...
submit_id: 628f6232fec3e2e0202718c6
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp2/unixbench-performance-1-300s-shell1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-5278ba412faff8402e318ad20ab762cc9ba7a801-20220526-57376-ip6b0d-2.yaml"
id: 03a4d1085dcea734512235a6ffb72c27b5c0009d
...
ucode: '0xd000331'
bisect_dmesg: true
enqueue_time: 2022-05-26 19:19:14.787451535 +08:00
_id: 628f6232fec3e2e0202718c8
_rt: "/result/unixbench/performance-1-300s-shell1-ucode=0xd000331/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
result_root: "/result/unixbench/performance-1-300s-shell1-ucode=0xd000331/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/vmlinuz-5.18.0-rc5-00025-g5278ba412faf
- branch=linux-devel/devel-hourly-20220525-195102
- job=/lkp/jobs/scheduled/lkp-icl-2sp2/unixbench-performance-1-300s-shell1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-5278ba412faff8402e318ad20ab762cc9ba7a801-20220526-57376-ip6b0d-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=5278ba412faff8402e318ad20ab762cc9ba7a801
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/5278ba412faff8402e318ad20ab762cc9ba7a801/vmlinuz-5.18.0-rc5-00025-g5278ba412faf"
dequeue_time: 2022-05-26 19:19:58.455557238 +08:00
:#! /cephfs/db/releases/20220526141406/lkp-src/include/site/inn:
job_state: finished
loadavg: 1.31 1.12 0.69 1/1001 89971
start_time: '1653564086'
end_time: '1653564716'
