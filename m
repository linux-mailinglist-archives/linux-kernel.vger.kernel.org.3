...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A48D75ABF1A
	for <lists+linux-kernel@lfdr.de>; Sat,  3 Sep 2022 15:22:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230488AbiICNVt (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 3 Sep 2022 09:21:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229732AbiICNVn (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 3 Sep 2022 09:21:43 -0400
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B3C92679
        for <linux-kernel@vger.kernel.org>; Sat,  3 Sep 2022 06:21:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662211299; x=1693747299;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Puq77rXZ3W70j1YhZmPe5aPNrU6qmBiO3WAZNNaJEg0=;
  b=hx2VictROhao2X1vjx9Zb9soxYdZIWGOjbkBPjHH4H7PzqbSTnTNRmeg
   dToJVDlfqd2cK0TAbfDu03r74B1901HwbIsgyM1ac2Z0lfOO7Cjn5QVVg
   0v1U9DVj9Lf+czpsM6a/jeWnFN85J3PbOZO/lKXzHvK8YShFNbY8z9/Ds
   3eKUsQgx62CPYuL/NT4Tvay0YnJFqNMjM8stHnodk3dijtHHxcRCtn52R
   53fCjbw67M71O4c1ELTUnuAaTGeItXjyE24rvfdW2RnokMCwoFZiyzyr5
   31vCfBvaobDMxdNlGtLYanQcl10CUZMXuwGfHePBiXw7i/ZafxqUHhu01
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10458"; a="360113397"
X-IronPort-AV: E=Sophos;i="5.93,287,1654585200"; 
   d="scan'208";a="360113397"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Sep 2022 06:21:38 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,287,1654585200"; 
   d="scan'208";a="564254669"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by orsmga003.jf.intel.com with ESMTP; 03 Sep 2022 06:21:35 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oUT5b-0001hz-0r;
        Sat, 03 Sep 2022 13:21:35 +0000
Date:   Sat, 3 Sep 2022 21:21:12 +0800
From:   kernel test robot <lkp@intel.com>
To:     Dan Williams <dan.j.williams@intel.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [djbw-nvdimm:libnvdimm-pending 14/16] mapping.c:undefined reference
 to `vmf_insert_pfn_pud_prot'
Message-ID: <202209032100.y7ZLz1mK-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ksZhY89FUAjnn/dE"
...
commit: 980fef2c905073c395a4a5803157778a662a462c [14/16] devdax: add PUD support to the DAX mapping infrastructure
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/djbw/nvdimm.git/commit/?id=980fef2c905073c395a4a5803157778a662a462c
        ...
        git checkout 980fef2c905073c395a4a5803157778a662a462c
...
>> aarch64-linux-ld: Unexpected run-time procedure linkages detected!
   aarch64-linux-ld: drivers/dax/mapping.o: in function `dax_insert_pfn_mkwrite':
>> mapping.c:(.text+0x8ff0): undefined reference to `vmf_insert_pfn_pud_prot'
