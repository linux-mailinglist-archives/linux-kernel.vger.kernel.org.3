...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B82AA55E4A5
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Jun 2022 15:39:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245112AbiF1Nbv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Jun 2022 09:31:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57784 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346111AbiF1Nag (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Jun 2022 09:30:36 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2875D9FC8
        for <linux-kernel@vger.kernel.org>; Tue, 28 Jun 2022 06:29:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656422988; x=1687958988;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=+jxJNBeNTzJAhbnwqwNih6eWw3WHCksIxyvtD8J382U=;
  b=JAcEzHl3k4ol6rEznG+jE9RAKDzXV/N4RR8Kwb6Iy9M7byxGQwbWNzO2
   0X2ZNCVZaprvfMPlbPccdkQ4AqZ0gTEdsi54Asx2ODleGISgvjOuQswjc
   z6hekT9OsvkHapz3cyvRJXL6VYGUfBd+LJ6g3zQ5FuQmiGICu58R05rsh
   hPxtJAMgJ2gS8tXVLXdkSSfBuclbA5RK/wrzsB1xBdoZNmwl+yGd+7r5A
   EoBmYIxhXmDDCacu/ciMkFkPo8iANk/g+z7naDamhZ/X7jc2Oc7FBaqIW
   ORznBZueXOWYrKOviAJq0LftbP9pxEy5L+SxTnbcMdAjmhE6myKCHSKJW
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10391"; a="261543970"
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; 
   d="scan'208";a="261543970"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Jun 2022 06:29:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,227,1650956400"; 
   d="scan'208";a="622942090"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 28 Jun 2022 06:29:44 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o6BHj-000AAZ-DY;
        Tue, 28 Jun 2022 13:29:43 +0000
Date:   Tue, 28 Jun 2022 21:29:12 +0800
From:   kernel test robot <lkp@intel.com>
To:     Leon Romanovsky <leonro@nvidia.com>
Cc:     llvm@lists.linux.dev, kbuild-all@lists.01.org,
        GNU/Weeb Mailing List <gwml@vger.gnuweeb.org>,
        linux-kernel@vger.kernel.org, Raed Salem <raeds@nvidia.com>
Subject: [ammarfaizi2-block:mellanox/linux/queue-next 4/14]
 include/net/xfrm.h:1959:3: error: call to undeclared function
 'dev_put_track'; ISO C99 and later do not support implicit function
 declarations
Message-ID: <202206282109.hYS21CsR-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="5O65SJDpjCdS5sOr"
...
commit: 4989687be72c5d305bf38d1f77e34f4ca2dde3d4 [4/14] xfrm: add an interface to offload policy
config: i386-randconfig-a004-20220627
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/ammarfaizi2/linux-block/commit/4989687be72c5d305bf38d1f77e34f4ca2dde3d4
        git remote add ammarfaizi2-block https://github.com/ammarfaizi2/linux-block
        git fetch --no-tags ammarfaizi2-block mellanox/linux/queue-next
        git checkout 4989687be72c5d305bf38d1f77e34f4ca2dde3d4
...
All errors (new ones prefixed by >>):
   ...
   In file included from net/ipv4/route.c:97:
>> include/net/xfrm.h:1959:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   include/net/xfrm.h:1959:3: note: did you mean 'get_net_track'?
...
--
   In file included from net/ipv4/ip_input.c:140:
>> include/net/xfrm.h:1959:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   include/net/xfrm.h:1959:3: note: did you mean 'get_net_track'?
   ...
   1 error generated.
--
   In file included from net/ipv4/ah4.c:10:
>> include/net/xfrm.h:1959:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   include/net/xfrm.h:1959:3: note: did you mean 'get_net_track'?
   ...
   static inline struct net *get_net_track(struct net *net,
                             ^
   net/ipv4/ah4.c:513:4: warning: format specifies type 'unsigned short' but the argument has type 'int' [-Wformat]
   ...
   1 warning and 1 error generated.
--
   In file included from net/ipv4/esp4.c:9:
>> include/net/xfrm.h:1959:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   include/net/xfrm.h:1959:3: note: did you mean 'get_net_track'?
   ...
   static inline struct net *get_net_track(struct net *net,
                             ^
   net/ipv4/esp4.c:1114:5: warning: format specifies type 'unsigned short' but the argument has type 'int' [-Wformat]
                                   aalg_desc->uinfo.auth.icv_fullbits / 8);
                                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   include/linux/printk.h:548:34: note: expanded from macro 'pr_info'
           printk(KERN_INFO pr_fmt(fmt), ##__VA_ARGS__)
   ...
   1 warning and 1 error generated.
--
   In file included from net/xfrm/xfrm_device.c:18:
>> include/net/xfrm.h:1959:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   include/net/xfrm.h:1959:3: note: did you mean 'get_net_track'?
   ...
   static inline struct net *get_net_track(struct net *net,
                             ^
   net/xfrm/xfrm_device.c:286:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xso->dev_tracker);
                   ^
   net/xfrm/xfrm_device.c:354:3: error: call to undeclared function 'dev_put_track'; ISO C99 and later do not support implicit function declarations [-Wimplicit-function-declaration]
                   dev_put_track(dev, &xdo->dev_tracker);
                   ^
   3 errors generated.


vim +/dev_put_track +1959 include/net/xfrm.h

  1949	
  1950	static inline void xfrm_dev_policy_free(struct xfrm_policy *x)
  1951	{
  1952		struct xfrm_dev_offload *xdo = &x->xdo;
  1953		struct net_device *dev = xdo->dev;
  1954	
  1955		if (dev && dev->xfrmdev_ops) {
  1956			if (dev->xfrmdev_ops->xdo_dev_policy_free)
  1957				dev->xfrmdev_ops->xdo_dev_policy_free(x);
  1958			xdo->dev = NULL;
> 1959			dev_put_track(dev, &xdo->dev_tracker);
  1960		}
  1961	}
  1962	#else
