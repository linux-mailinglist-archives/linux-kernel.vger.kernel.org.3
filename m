...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 278FE5ACBA9
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Sep 2022 09:07:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236064AbiIEG6l (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Sep 2022 02:58:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60010 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235709AbiIEG62 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Sep 2022 02:58:28 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CAFA81FCCB
        for <linux-kernel@vger.kernel.org>; Sun,  4 Sep 2022 23:58:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662361104; x=1693897104;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=bN7+w4KmXbrZTTH8UtkCHroZI3SaHiOrY2DCN49cj1s=;
  b=QVY2eAuzwTKuxd+ZCDuAptJjiOQkqN8pZEYrgJ8OiWsxYr7bNiGeEHQ3
   WITVf8fuF/NWswX1Gi6Tlxa5xLZnfE+Ri6erzeVnLB56jpfXaU9hECrY0
   LxulVybJmrLYSP/rjYd0jsgBbT9YqgqzHduEDkHRUVipBmr4DVhfq0z4I
   uksIzL0xJEJg8TNKrMs7bcBSWPbQs29aWWIiH2vQ+JR94Z3WfHuqR2wqF
   D6Nz0eu1IUVFIwow2nLRF01yMQ3MshuoJEsm+wjiHXWnTrklhzv1do12/
   qKc+1CDwoNvW9CWdBeo/MWz2UYlUJwQIw+Cu/naoW0+TSszIuOJ1oogAq
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10460"; a="293906508"
X-IronPort-AV: E=Sophos;i="5.93,290,1654585200"; 
   d="scan'208";a="293906508"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Sep 2022 23:58:24 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,290,1654585200"; 
   d="scan'208";a="941993731"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 04 Sep 2022 23:58:22 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oV63p-0003ud-2L;
        Mon, 05 Sep 2022 06:58:21 +0000
Date:   Mon, 5 Sep 2022 14:58:05 +0800
From:   kernel test robot <lkp@intel.com>
To:     Bjorn Andersson <bjorn.andersson@linaro.org>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org,
        Steev Klimaszewski <steev@kali.org>
Subject: [steev:c630-6.0.0-rc4 54/86]
 drivers/power/supply/qcom_pmic_glink_power.c:520:30: sparse: sparse:
 incorrect type in initializer (different base types)
Message-ID: <202209051428.6vjCgKhu-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="TztQ+PThu4Ed/9HA"
...
tree:   https://github.com/steev/linux c630-6.0.0-rc4
head:   20d0898957b293f43b9ee4dd6890dc8a6fa90576
commit: 880f7e363001b4736369ed5ed2341e0706f917c1 [54/86] power: supply: Introduce Qualcomm PMIC GLINK power supply
config: loongarch-randconfig-s033-20220905
...
reproduce:
        ...
        # https://github.com/steev/linux/commit/880f7e363001b4736369ed5ed2341e0706f917c1
        git remote add steev https://github.com/steev/linux
        git fetch --no-tags steev c630-6.0.0-rc4
        git checkout 880f7e363001b4736369ed5ed2341e0706f917c1
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross C=1 CF='-fdiagnostic-prefix -D__CHECK_ENDIAN__' O=build_dir ARCH=loongarch SHELL=/bin/bash drivers/power/supply/

If you fix the issue, kindly add following tag where applicable
Reported-by: kernel test robot <lkp@intel.com>

sparse warnings: (new ones prefixed by >>)
>> drivers/power/supply/qcom_pmic_glink_power.c:520:30: sparse: sparse: incorrect type in initializer (different base types) @@     expected restricted __le32 [usertype] owner @@     got int @@
   drivers/power/supply/qcom_pmic_glink_power.c:520:30: sparse:     expected restricted __le32 [usertype] owner
   drivers/power/supply/qcom_pmic_glink_power.c:520:30: sparse:     got int
>> drivers/power/supply/qcom_pmic_glink_power.c:521:29: sparse: sparse: incorrect type in initializer (different base types) @@     expected restricted __le32 [usertype] type @@     got int @@
   drivers/power/supply/qcom_pmic_glink_power.c:521:29: sparse:     expected restricted __le32 [usertype] type
   drivers/power/supply/qcom_pmic_glink_power.c:521:29: sparse:     got int
>> drivers/power/supply/qcom_pmic_glink_power.c:522:31: sparse: sparse: incorrect type in initializer (different base types) @@     expected restricted __le32 [usertype] opcode @@     got int @@
   drivers/power/supply/qcom_pmic_glink_power.c:522:31: sparse:     expected restricted __le32 [usertype] opcode
   drivers/power/supply/qcom_pmic_glink_power.c:522:31: sparse:     got int

vim +520 drivers/power/supply/qcom_pmic_glink_power.c

   516	
   517	static int pmic_glink_power_enable_notifications(struct pmic_glink_power *pgp)
   518	{
   519		struct pmic_glink_bat_enable_notifications req = {
 > 520			.hdr.owner = PMIC_GLINK_OWNER_BC,
 > 521			.hdr.type = PMIC_GLINK_NOTIFY,
 > 522			.hdr.opcode = BC_SET_NOTIFY_REQ,
   523		};
   524	
   525		return pmic_glink_ps_send(pgp, &req, sizeof(req));
   526	}
   527	
...
CONFIG_QCOM_PMIC_GLINK_POWER=m
