...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A65D0564C4D
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Jul 2022 06:05:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231356AbiGDEFE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 Jul 2022 00:05:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38458 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229518AbiGDEFA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 Jul 2022 00:05:00 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1BC312ACE
        for <linux-kernel@vger.kernel.org>; Sun,  3 Jul 2022 21:04:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656907497; x=1688443497;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=8q32zQmo4bHHJfjaIP3QpmBQFTOH+axVRx/2L1Bnm1k=;
  b=byc29ns+Gs4MoVm52Nt1D5DNzDoAvuHDnPqDMB3Vw3/Qs4IbxTXPJJmu
   fnSgzG94WE0aMlaIxnpWXkLZX1PqZsIwTVnSP0+GfJNcByAtgSrNb2JdG
   VjWISIsnMLjiqJxvXj9TxpydnAweSdIaba8ABhgRraBeW5rgzYdjH97VR
   5rbwnxB3RD1fTtr0+Tjx0OO2tKxEDLtOKFN4d4E/1KEJouG4CyT4N38eZ
   nKnP7tOgHiWN5U0wqTft+pxcMjXHsE1yAdJ86+gvh8RfSgzKvPr4jSe9I
   e05Wi74V+7nm0mvl6q1CDPNm1aBKrgFP7LY8E9Ue3C/P6psovypuKyxjs
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10397"; a="308559924"
X-IronPort-AV: E=Sophos;i="5.92,243,1650956400"; 
   d="scan'208";a="308559924"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Jul 2022 21:04:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,243,1650956400"; 
   d="scan'208";a="838683113"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by fmsmga006.fm.intel.com with ESMTP; 03 Jul 2022 21:04:54 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o8DKP-000HR1-Id;
        Mon, 04 Jul 2022 04:04:53 +0000
Date:   Mon, 4 Jul 2022 12:04:05 +0800
...
Subject: [akpm-mm:mm-unstable 102/232] mm/mmap.c:1094:2: error: use of
 undeclared identifier 'area'
Message-ID: <202207041152.SEjC7KmH-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="m2IZ9D7KcEMQzb50"
...
>> mm/mmap.c:1094:2: error: use of undeclared identifier 'area'
           area = next;
           ^
   mm/mmap.c:1095:6: error: use of undeclared identifier 'area'
           if (area && area->vm_end == end)                /* cases 6, 7, 8 */
               ^
   mm/mmap.c:1095:14: error: use of undeclared identifier 'area'
           if (area && area->vm_end == end)                /* cases 6, 7, 8 */
                       ^
   mm/mmap.c:1100:13: error: use of undeclared identifier 'area'
           VM_WARN_ON(area && end > area->vm_end);
                      ^
   mm/mmap.c:1100:27: error: use of undeclared identifier 'area'
           VM_WARN_ON(area && end > area->vm_end);
                                    ^
   mm/mmap.c:1147:23: error: use of undeclared identifier 'area'
                           err = __vma_adjust(area, addr, next->vm_end,
                                              ^
   mm/mmap.c:1154:4: error: use of undeclared identifier 'area'
                           area = next;
                           ^
   mm/mmap.c:1158:24: error: use of undeclared identifier 'area'
                   khugepaged_enter_vma(area, vm_flags);
                                        ^
   mm/mmap.c:1159:10: error: use of undeclared identifier 'area'
                   return area;
                          ^
   9 errors generated.
...
#
CONFIG_CC_VERSION_TEXT="clang version 15.0.0 (git://gitmirror/llvm_project f7a80c3d08d4821e621fc88d6a2e435291f82dff)"
