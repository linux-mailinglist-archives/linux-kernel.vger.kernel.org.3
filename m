...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B22FB464537
	for <lists+linux-kernel@lfdr.de>; Wed,  1 Dec 2021 04:00:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346346AbhLADEI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 30 Nov 2021 22:04:08 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.129.124]:57669 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S229731AbhLADEF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 30 Nov 2021 22:04:05 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1638327645;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=ae7Gdd1P+bjWrHDbFM1rXBRXUECvd7tmZWZtk7dTfYE=;
        b=TIg2caFhYFHGJ0sc/uVZkt2rIyk9Uhhjhr2rwl3DunF9R94cTThXjYclhjHdB4QM2BG9FL
        wKDm7iPLx2FRBBDEjJyPHdpf5mwiZBJYJJ+L15nCUW/PmZYczKu5hA+7JeDz6b1+3Bi6Ak
        j20DlyoFJ1HOAk4SG3djC1/YAup6v38=
Received: from mail-ed1-f72.google.com (mail-ed1-f72.google.com
 [209.85.208.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-87-lJ3RJq6wMZSPf7bu4oCkBQ-1; Tue, 30 Nov 2021 22:00:43 -0500
X-MC-Unique: lJ3RJq6wMZSPf7bu4oCkBQ-1
Received: by mail-ed1-f72.google.com with SMTP id k7-20020aa7c387000000b003e7ed87fb31so18933579edq.3
        for <linux-kernel@vger.kernel.org>; Tue, 30 Nov 2021 19:00:43 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc:content-transfer-encoding;
        bh=ae7Gdd1P+bjWrHDbFM1rXBRXUECvd7tmZWZtk7dTfYE=;
        b=
X-Gm-Message-State: AOAM533JtHEGcfec6T9U/yRe0T2qgOMsrRmFwRSbcr3Div3NNGAbxRmY
        TWklyrt31nGOd9wL17VXQchKgEFjryvdrtp6tAo23K5uQTUiuAfcFH9QI02KHLdWqRhdBCwzODA
        dbE1cS+4nDRQ2iop/53bKU8zRIYJV8zeFvLlIvtLW
X-Received: by 2002:aa7:c941:: with SMTP id h1mr4468044edt.319.1638327642089;
        Tue, 30 Nov 2021 19:00:42 -0800 (PST)
X-Google-Smtp-Source: ABdhPJydhbu6oKlaAsc/1b56HLD7z+DxFQ4LKdUxiUPANZ/M7bCDbhL+AZpUdqXbSTl4XNTMKBXIrlHQHgTiEgBY0CA=
X-Received: by 2002:aa7:c941:: with SMTP id h1mr4468015edt.319.1638327641891;
 Tue, 30 Nov 2021 19:00:41 -0800 (PST)
MIME-Version: 1.0
References: <20211129014007.286478-1-wefu@redhat.com> <20211129014007.286478-3-wefu@redhat.com>
 <4669908.7LBx6Dm1N1@diego>
In-Reply-To: <4669908.7LBx6Dm1N1@diego>
From:   Wei Fu <wefu@redhat.com>
Date:   Wed, 1 Dec 2021 11:00:30 +0800
Message-ID: <CA+YCwKnPg0LC_=F=DaBr4478F2+RqcftdAY-S9c_Ca+a1ac7GA@mail.gmail.com>
...
> > @@ -76,7 +91,7 @@ static inline pmd_t pfn_pmd(unsigned long pfn, pgprot=
_t prot)
> >
...
> > + *  00 - PMA    Normal Cacheable, No change to implied PMA memory type
> > + *  01 - NC     Non-cacheable, idempotent, weakly-ordered Main Memory
> > + *  10 - IO     Non-cacheable, non-idempotent, strongly-ordered I/O me=
mory
> > + *  11 - Rsvd   Reserved for future standard use
> > + */
...
> > +     return (unsigned long)pfn_to_virt(_chg_of_pmd(pmd) >> _PAGE_PFN_S=
HIFT);
> >  }
> >
...
> > @@ -492,6 +491,28 @@ static inline int ptep_clear_flush_young(struct vm=
_area_struct *vma,
...
> >  #include <asm/hwcap.h>
> >  #include <asm/smp.h>
> > @@ -59,6 +60,38 @@ bool __riscv_isa_extension_available(const unsigned =
long *isa_bitmap, int bit)
> >  }
...
> > +     }
> > +
> > +     __svpbmt.pma            =3D _SVPBMT_PMA;
> > +     __svpbmt.nocache        =3D _SVPBMT_NC;
> > +     __svpbmt.io             =3D _SVPBMT_IO;
> > +     __svpbmt.mask           =3D _SVPBMT_MASK;
> > +#endif
> > +}
> > +
...
> > @@ -854,3 +854,8 @@ int __meminit vmemmap_populate(unsigned long start,=
