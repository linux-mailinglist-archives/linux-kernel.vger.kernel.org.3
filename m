...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7023E4945E0
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jan 2022 03:54:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1358220AbiATCyi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jan 2022 21:54:38 -0500
Received: from mga02.intel.com ([134.134.136.20]:22157 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S244391AbiATCyg (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jan 2022 21:54:36 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1642647275; x=1674183275;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=x49Irr/X3N7a3LlnBIOIpWKRXI+aRGL0nbbOD8yDKqs=;
  b=hVky+qqmAzZTsRy9Ev+kjK1m+TA4OUTwX9jpI2if022F2A678uM/cNXZ
   bBYdGj/Jzm8ykmrzudt7naA+sc6xKmTSP53CVTD5t1d6ZU2P3KD27nkd3
   ncwzMAtY8p2vo9fWFZc8kNrBWGZdupUx3XjAsBtXE9PC0gfkZzIoUOHhW
   6irfT91w7livpoZzC1KW/19XcRgs54dPzkAwS9GH7Ar0zUG9hXwoVX3/w
   BKy7hYYQGxpTww4kFAGQ7Cw8i3roy5ReZn3LH3gAcq89oM3FPn5dNfRTz
   mWSvWfW7Be5c8Kjx38gxsKq7gQPJI+1MLnoHPW1gCPOoeEaH15TAxH2Tw
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="232620064"
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; 
   d="yaml'?scan'208";a="232620064"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Jan 2022 18:54:34 -0800
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; 
   d="yaml'?scan'208";a="532586791"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Jan 2022 18:54:30 -0800
Date:   Thu, 20 Jan 2022 10:54:27 +0800
...
Subject: [sched/fair]  8b4e74ccb5:  stress-ng.sem.ops_per_sec 12.0%
 improvement
Message-ID: <20220120025427.GB5873@xsang-OptiPlex-9020>
MIME-Version: 1.0
 ...
 2.969e+12           -12.6%  2.596e+12 ±  2%  perf-stat.total.instructions
   ...
   1615774 ±  5%     -34.6%    1057271 ±  4%  softirqs.SCHED
     ...
     10.84 ±  9%     -10.8        0.00        perf-profile.calltrace.cycles-pp.update_sd_lb_stats.find_busiest_group.load_balance.newidle_balance.pick_next_task_fair
      ...
      1.02 ±  5%      -0.2        0.82 ±  7%  perf-profile.calltrace.cycles-pp.sem_getvalue@@GLIBC_2.2.5
     ...
     10.93 ±  9%     -10.7        0.26 ± 30%  perf-profile.children.cycles-pp.update_sd_lb_stats
      ...
      1.02 ±  4%      -0.2        0.82 ±  7%  perf-profile.children.cycles-pp.sem_getvalue@@GLIBC_2.2.5
      ...
      0.48 ±  3%      -0.1        0.43 ±  4%  perf-profile.children.cycles-pp.sem_post@@GLIBC_2.2.5
     ...
     57.04           +16.6       73.67        perf-profile.children.cycles-pp.cpu_startup_entry
      ...
      0.88 ±  5%      -0.2        0.66 ±  7%  perf-profile.self.cycles-pp.sem_getvalue@@GLIBC_2.2.5
      ...
      0.44 ±  4%      -0.1        0.37 ±  4%  perf-profile.self.cycles-pp.sem_post@@GLIBC_2.2.5
...
Content-Disposition: attachment; filename="config-5.16.0-rc1-00009-g8b4e74ccb582"
...
export_top_env()
{
	...
	export submit_id='61e7ad460b9a931b48c9d764'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/stress-ng-scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102-debian-10.4-x86_64-20200603.cgz-8b4e74ccb582797f6f0b0a50372-20220119-72520-dy2fsx-4.yaml'
	export id='7442d1a5422b263e4c1166b91c8ea8756ad624ca'
	export queuer_version='/lkp/xsang/.src-20220119-094244'
	...
	export need_kconfig=
	export commit='8b4e74ccb582797f6f0b0a50372ebd9fd2372a27'
	export ucode='0x5003102'
	export ucode_initrd='/osimage/ucode/intel-ucode-20211201.cgz'
	export need_kconfig_hw='{"I40E"=>"y"}
SATA_AHCI'
	export bisect_dmesg=true
	export enqueue_time='2022-01-19 14:18:46 +0800'
	export _id='61e7ad510b9a931b48c9d768'
	export _rt='/result/stress-ng/scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102/lkp-csl-2sp7/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='a9dd65b84c60d6fa7481363527ca07242033139d'
	export base_commit='df0cc57e057f18e44dac8e6c18aba47ab53202f9'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/stress-ng/scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102/lkp-csl-2sp7/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/3'
	export scheduler_version='/lkp/lkp/.src-20220119-092417'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102/lkp-csl-2sp7/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/vmlinuz-5.16.0-rc1-00009-g8b4e74ccb582
branch=linus/master
job=/lkp/jobs/scheduled/lkp-csl-2sp7/stress-ng-scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102-debian-10.4-x86_64-20200603.cgz-8b4e74ccb582797f6f0b0a50372-20220119-72520-dy2fsx-4.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220115.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220117.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220116.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-79e06c4c4950-1_20220116.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.16.0-rc1-00009-g8b4e74ccb582'
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/vmlinuz-5.16.0-rc1-00009-g8b4e74ccb582'
	export dequeue_time='2022-01-19 17:42:06 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/stress-ng-scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102-debian-10.4-x86_64-20200603.cgz-8b4e74ccb582797f6f0b0a50372-20220119-72520-dy2fsx-4.cgz'
...
run_job()
{
	...
	run_test class='scheduler' test='sem' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='scheduler' test='sem' $LKP_SRC/stats/wrapper stress-ng
...
kconfig: x86_64-rhel-8.3
submit_id: 61e7ad460b9a931b48c9d764
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/stress-ng-scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102-debian-10.4-x86_64-20200603.cgz-8b4e74ccb582797f6f0b0a50372-20220119-72520-dy2fsx-2.yaml"
id: 2ed72531ece1e09bd9e0e3bbdbd9effa39323fb1
queuer_version: "/lkp/xsang/.src-20220119-094244"
:#! hosts/lkp-csl-2sp7:
model: Cascade Lake
nr_node: 2
nr_cpu: 96
...
bisect_dmesg: true
enqueue_time: 2022-01-19 14:18:46.743036368 +08:00
_id: 61e7ad510b9a931b48c9d766
_rt: "/result/stress-ng/scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102/lkp-csl-2sp7/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: a9dd65b84c60d6fa7481363527ca07242033139d
base_commit: df0cc57e057f18e44dac8e6c18aba47ab53202f9
branch: linus/master
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/stress-ng/scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102/lkp-csl-2sp7/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/0"
scheduler_version: "/lkp/lkp/.src-20220119-092417"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/vmlinuz-5.16.0-rc1-00009-g8b4e74ccb582
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/stress-ng-scheduler-performance-100%-4194304-sem-60s-ucode=0x5003102-debian-10.4-x86_64-20200603.cgz-8b4e74ccb582797f6f0b0a50372-20220119-72520-dy2fsx-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=8b4e74ccb582797f6f0b0a50372ebd9fd2372a27
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220115.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220117.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220116.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-79e06c4c4950-1_20220116.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/8b4e74ccb582797f6f0b0a50372ebd9fd2372a27/vmlinuz-5.16.0-rc1-00009-g8b4e74ccb582"
dequeue_time: 2022-01-19 17:08:01.857812974 +08:00
:#! /cephfs/db/releases/20220119092046/lkp-src/include/site/inn:
job_state: finished
loadavg: 4.54 1.62 0.58 1/986 8937
start_time: '1642583371'
end_time: '1642583433'
version: "/lkp/lkp/.src-20220119-092500:61530bfc:b4c9a4ef5"
...
do
 ...
 "stress-ng" "--timeout" "60" "--times" "--verify" "--metrics-brief" "--sem" "96"
