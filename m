...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DBF1353EEB5
	for <lists+linux-kernel@lfdr.de>; Mon,  6 Jun 2022 21:37:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232483AbiFFThG (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 6 Jun 2022 15:37:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42124 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232481AbiFFThB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 6 Jun 2022 15:37:01 -0400
Received: from mail-lf1-x134.google.com (mail-lf1-x134.google.com [IPv6:2a00:1450:4864:20::134])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9BC5C84A25
        for <linux-kernel@vger.kernel.org>; Mon,  6 Jun 2022 12:36:57 -0700 (PDT)
Received: by mail-lf1-x134.google.com with SMTP id c2so5488598lfk.0
        for <linux-kernel@vger.kernel.org>; Mon, 06 Jun 2022 12:36:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=26w6VMmK7MLBC1bSKvqNHgmE6sHf4PvG5g3fn6hB0gE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=26w6VMmK7MLBC1bSKvqNHgmE6sHf4PvG5g3fn6hB0gE=;
        b=
X-Gm-Message-State: AOAM5333C1oOJpQ+3P5AJ2sc28zrsRVQOLA+f905MSNDRqzdbUS+R+6n
        b0A9oO9eAVlTnhRiPnBZaOA=
X-Google-Smtp-Source: ABdhPJwJdn06HMFXhBY7pR7eP1mSboFwG4ghcksOO75a7rmMsWEcDoPOF0F1s0OjsQQQrv1RjaRRvw==
X-Received: by 2002:a05:6512:3b85:b0:478:f40f:5815 with SMTP id g5-20020a0565123b8500b00478f40f5815mr24237370lfv.679.1654544215636;
        Mon, 06 Jun 2022 12:36:55 -0700 (PDT)
Received: from localhost.localdomain ([94.103.229.27])
        by smtp.gmail.com with ESMTPSA id h16-20020ac25d70000000b0047907872b22sm2798526lft.42.2022.06.06.12.36.54
...
Subject: [PATCH v3 1/4] staging: r8188eu: add error handling of rtw_read8
Date:   Mon,  6 Jun 2022 22:36:53 +0300
Message-Id: <6b01529709706167458c441391fc3fc2a5baf5c2.1654543286.git.paskripkin@gmail.com>
...
---
 ...
 16 files changed, 419 insertions(+), 102 deletions(-)
...
index faf23fc950c5..01e5669f2421 100644
...
@@ -6810,14 +6837,16 @@ static u8 chk_ap_is_alive(struct sta_info *psta)
 	return ret;
 }
...
@@ -7219,6 +7248,7 @@ u8 disconnect_hdl(struct adapter *padapter, unsigned char *pbuf)
...
@@ -7231,7 +7261,10 @@ u8 disconnect_hdl(struct adapter *padapter, unsigned char *pbuf)
