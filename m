...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E136650CB24
	for <lists+linux-kernel@lfdr.de>; Sat, 23 Apr 2022 16:17:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236026AbiDWOUN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 23 Apr 2022 10:20:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59178 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236024AbiDWOUD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 23 Apr 2022 10:20:03 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 217001D57B0
        for <linux-kernel@vger.kernel.org>; Sat, 23 Apr 2022 07:17:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1650723423; x=1682259423;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=5J2f1eNhVApo/cOcY1Qh+tgzDoASGWKDMaII5z8+UOA=;
  b=CrwpYxTOTEAzhCSEqmwEk+0IBYuBhG9cqbBa74nWated7xneTATj1xD6
   57BcD4o0Bsr7SXJZ2LeKS0VmDuuyyxNS4gPkq77bpxfSJLYPaVTreOb7T
   ZIzGgEr9O/rvmXHYME3AoIkRIG83ajtrDEYt1yoUjExMOSgOyQq06NFQL
   WdQ05iudwzv3/nI7VTbqtIPSCvIF/6CoFI0zkeqHSWGCj5kyaxPnkVm0/
   6XRrG8xnbIsQ75oqeDDcDm3i57unvJz8npQ1KuEMK6HPqZh4jUHmAd2q7
   +TzdaE2i4tEnB9VaLEhnS+/6bkR5fPjRB5WxKTemvhoiCFFU31Pow4OzM
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10324"; a="246809321"
X-IronPort-AV: E=Sophos;i="5.90,284,1643702400"; 
   d="scan'208";a="246809321"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Apr 2022 07:17:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,284,1643702400"; 
   d="scan'208";a="594554560"
Received: from lkp-server01.sh.intel.com (HELO 5056e131ad90) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 23 Apr 2022 07:17:00 -0700
Received: from kbuild by 5056e131ad90 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1niGZH-00006P-B8;
        Sat, 23 Apr 2022 14:16:59 +0000
Date:   Sat, 23 Apr 2022 22:16:46 +0800
...
Subject: drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:939:13:
 warning: stack frame size (1324) exceeds limit (1024) in
 'dml_rq_dlg_get_dlg_params'
Message-ID: <202204232238.UPTss3el-lkp@intel.com>
MIME-Version: 1.0
...
date:   10 months ago
config: i386-allmodconfig (https://download.01.org/0day-ci/archive/20220423/202204232238.UPTss3el-lkp@intel.com/config)
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:1007:15: warning: variable 'dispclk_delay_subtotal' set but not used [-Wunused-but-set-variable]
           unsigned int dispclk_delay_subtotal;
                        ^
>> drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:939:13: warning: stack frame size (1324) exceeds limit (1024) in 'dml_rq_dlg_get_dlg_params' [-Wframe-larger-than]
