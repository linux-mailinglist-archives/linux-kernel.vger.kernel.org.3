...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8C45147C576
	for <lists+linux-kernel@lfdr.de>; Tue, 21 Dec 2021 18:51:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240670AbhLURvg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 21 Dec 2021 12:51:36 -0500
Received: from dfw.source.kernel.org ([139.178.84.217]:60764 "EHLO
        dfw.source.kernel.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231318AbhLURvg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 21 Dec 2021 12:51:36 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id AFE8C6168A
        for <linux-kernel@vger.kernel.org>; Tue, 21 Dec 2021 17:51:35 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B6F11C36AE9;
        Tue, 21 Dec 2021 17:51:34 +0000 (UTC)
Authentication-Results: smtp.kernel.org;
        dkim=pass (1024-bit key) header.d=zx2c4.com header.i=@zx2c4.com header.b="RAHe+Ome"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=zx2c4.com; s=20210105;
        t=1640109093;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=liQfjliyFcOeT80L9ZBqOqZh24XnlaBDLvxu8kZZfls=;
        b=RAHe+Omeebf0NSH8EvaJYB278Fi8vE0rKkViuvDLRTAsrj1Hc54mDLGZh0SpNQVBzaUVV+
        CNCj8EADkTcjI6+xIDkFPrqTu6qxWTWU1UoIdADXtyMYgc4ltGk1h8jckhjCAI31n8I4kx
        fTQQxxa6vBpcWz6h3IO7MTmoXkvlf6U=
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id ee425967 (TLSv1.3:AEAD-AES256-GCM-SHA384:256:NO);
        Tue, 21 Dec 2021 17:51:32 +0000 (UTC)
From:   "Jason A. Donenfeld" <Jason@zx2c4.com>
To:     linux-kernel@vger.kernel.org, tytso@mit.edu,
        gregkh@linuxfoundation.org
Cc:     "Jason A. Donenfeld" <Jason@zx2c4.com>,
        Jean-Philippe Aumasson <jeanphilippe.aumasson@gmail.com>
Subject: [PATCH] random: use BLAKE2s instead of SHA1 in extraction
Date:   Tue, 21 Dec 2021 18:50:47 +0100
Message-Id: <20211221175047.341782-1-Jason@zx2c4.com>
MIME-Version: 1.0
...
index 73205ed269ba..3bea44ea99c3 100644
--- a/lib/crypto/Makefile
+++ b/lib/crypto/Makefile
@@ -10,8 +10,8 @@ libaes-y					:= aes.o
...
+obj-y						+= blake2s-generic.o blake2s.o
