...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 474195B1F6C
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Sep 2022 15:41:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230300AbiIHNl0 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 8 Sep 2022 09:41:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59432 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231586AbiIHNlR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 8 Sep 2022 09:41:17 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 792BCE5836
        for <linux-kernel@vger.kernel.org>; Thu,  8 Sep 2022 06:41:13 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662644473; x=1694180473;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=ue+HDbZuis9n3esL9+awJ8oSA5JfvcR94wlg950P1Fk=;
  b=F03sKglGVGShmE17JFrZ8lXKHRAPWCRQJbjmzA1wolaeMkjIJonnzaM4
   IBKNpASTr/qVUiyn9d9Y2mHCm68ftPBGlmo4lUm/dKrTkTCYLPOfIrZ2H
   ld2dtV21A26ZK2uwa1ASfCJj4BfV5yaZksDHEaUQhjRb7rGl8QpzP7ywo
   GyXFAm50ZBAodnUsExQkTnSUMQLI6Y9IvvvZWMb79DT1fI6rzrJdzFYjH
   8Q9xGSalfyqaZVWV0q9ltvBMnbm5e+EoRSnwn1HI9IJmCR6lVXJ1s0ngT
   rGPbcq/WhZaHD+wTVOwt9Pd/gCztHGKeAmdrI3xuhxYzoihgtnanABAzH
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10464"; a="298509127"
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="298509127"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Sep 2022 06:41:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="648045787"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 08 Sep 2022 06:41:10 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oWHmI-0007o1-0C;
        Thu, 08 Sep 2022 13:41:10 +0000
Date:   Thu, 8 Sep 2022 21:40:15 +0800
From:   kernel test robot <lkp@intel.com>
To:     Max Filippov <jcmvbkbc@gmail.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [jcmvbkbc-xtensa:xtensa-6.0-esp32 6/12]
 drivers/tty/serial/esp32_uart.c:33:6: warning: no previous prototype for
 'dbg_echo'
Message-ID: <202209082146.x9Kbou0b-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Yp6UqhifL62NnADc"
...
head:   dbad98e4424eaf805b96053ad50a0583588e12d7
commit: 8ddfaad265fdc37f0b3485c34843aa9a6d310a94 [6/12] WIP: drivers/tty/serial: add driver for ESP32 UART
config: m68k-allmodconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/jcmvbkbc/linux-xtensa/commit/8ddfaad265fdc37f0b3485c34843aa9a6d310a94
        git remote add jcmvbkbc-xtensa https://github.com/jcmvbkbc/linux-xtensa
        git fetch --no-tags jcmvbkbc-xtensa xtensa-6.0-esp32
        git checkout 8ddfaad265fdc37f0b3485c34843aa9a6d310a94
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=m68k SHELL=/bin/bash drivers/tty/serial/
