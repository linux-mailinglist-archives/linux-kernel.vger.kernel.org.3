...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E27EA572B74
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Jul 2022 04:52:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230140AbiGMCw1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jul 2022 22:52:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54888 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229788AbiGMCwZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jul 2022 22:52:25 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7070CD216F
        for <linux-kernel@vger.kernel.org>; Tue, 12 Jul 2022 19:52:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1657680740; x=1689216740;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=sfFWhL6J/77F30DR4OVYamCpYq0mPaDcSlobUYTc8vA=;
  b=YAOh6ojVSLFj4SEOToKrTAF4WJMP5CIozFcRtB5JjSZswkKmVHmJlH9r
   m9Jx5KfvQ8ZXBoUufAiqGRAByAVgv6Hs+SL+Qg4MKuVF+0FG5uzNgQF1m
   06r9vl0AZFe6vgCd210R9uzplSgXmYKEtL9LFJm2v2wdoLyBtjn3qJlxF
   SvTePuJ+8fJGvvoq+HQlFqgyyLLR/BpQGywu2GTuGSR5FTmQyxTgB3fF7
   W5O8ly52QvUw8rpFI3HlNo0H7rEKJGwIyNJppa1O6qNjneozdr9SyvTGs
   bu/cNeGe1HLoNUwQyiIreVgf32g5GqMOXY8Zvf4fR+Bm4kn8+UYwxsgd5
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10406"; a="268132100"
X-IronPort-AV: E=Sophos;i="5.92,266,1650956400"; 
   d="yaml'?scan'208";a="268132100"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jul 2022 19:52:19 -0700
X-IronPort-AV: E=Sophos;i="5.92,266,1650956400"; 
   d="yaml'?scan'208";a="653173963"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jul 2022 19:52:10 -0700
Date:   Wed, 13 Jul 2022 10:52:06 +0800
...
Subject: [workqueue]  1a0a67f5ef:
 phoronix-test-suite.fio.SequentialRead.IO_uring.Yes.No.1MB.DefaultTestDirectory.mb_s
 -17.7% regression
Message-ID: <Ys4zVkJCH04cnSGX@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="78hmUke7aXqjpSCV"
...
patch link: https://lore.kernel.org/lkml/20220707090501.55483-1-schspa@gmail.com
...
Content-Disposition: attachment;
	filename="config-5.19.0-rc1-00007-g1a0a67f5efc8"
...
export_top_env()
{
	...
	export submit_id='62cd2e1c0b9a9388e622d9a0'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86-20220712-35046-1a6f4uu-2.yaml'
	export id='5f6f9daa1598c0a4841d37b350a0a110b6530ebc'
	...
	export commit='1a0a67f5efc83d6ca15c1e12471175f6f7db550b'
...
SATA_AHCI'
	...
	export enqueue_time='2022-07-12 16:17:32 +0800'
	export _id='62cd2e1d0b9a9388e622d9a2'
	export _rt='/result/phoronix-test-suite/performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b'
	export user='lkp'
	...
	export branch='linux-review/Schspa-Shi/workqueue-Use-active-mask-for-new-worker-when-pool-is-DISASSOCIATED/20220707-170740'
	export result_root='/result/phoronix-test-suite/performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/vmlinuz-5.19.0-rc1-00007-g1a0a67f5efc8
branch=linux-review/Schspa-Shi/workqueue-Use-active-mask-for-new-worker-when-pool-is-DISASSOCIATED/20220707-170740
job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86-20220712-35046-1a6f4uu-2.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=1a0a67f5efc83d6ca15c1e12471175f6f7db550b
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/modules.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20220216.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.19.0-rc4-00371-g13fa82df3449'
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/vmlinuz-5.19.0-rc1-00007-g1a0a67f5efc8'
	export dequeue_time='2022-07-12 17:50:07 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86-20220712-35046-1a6f4uu-2.cgz'
...
run_job()
{
	...
	run_test test='fio-1.14.1' option_a='Sequential Read' option_b='IO_uring' option_c='Yes' option_d='No' option_e='1MB' option_f='Default Test Directory' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='fio-1.14.1' option_a='Sequential Read' option_b='IO_uring' option_c='Yes' option_d='No' option_e='1MB' option_f='Default Test Directory' $LKP_SRC/stats/wrapper phoronix-test-suite
...
submit_id: 62cd2e1c0b9a9388e622d9a0
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86-20220712-35046-1a6f4uu-7.yaml"
id: f3219c298a24b0b88562ee41bde21e2fc2b99143
queuer_version: "/lkp/xsang/.src-20220712-134145"
kconfig: x86_64-rhel-8.3
:#! hosts/lkp-csl-2sp7:
model: Cascade Lake
nr_node: 2
...
enqueue_time: 2022-07-12 16:17:32.552286734 +08:00
_id: 62cd2e1d0b9a9388e622d9a7
_rt: "/result/phoronix-test-suite/performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: 7ed695b639e855323588bb005f7637d41904304a
base_commit: 03c765b0e3b4cb5063276b086c76f7a612856a9a
branch: linux-review/Schspa-Shi/workqueue-Use-active-mask-for-new-worker-when-pool-is-DISASSOCIATED/20220707-170740
result_root: "/result/phoronix-test-suite/performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/vmlinuz-5.19.0-rc1-00007-g1a0a67f5efc8
- branch=linux-review/Schspa-Shi/workqueue-Use-active-mask-for-new-worker-when-pool-is-DISASSOCIATED/20220707-170740
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Read-IO_uring-Yes-No-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86-20220712-35046-1a6f4uu-7.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=1a0a67f5efc83d6ca15c1e12471175f6f7db550b
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.19.0-rc1-00006-g8bee9dd953b6
schedule_notify_address:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/1a0a67f5efc83d6ca15c1e12471175f6f7db550b/vmlinuz-5.19.0-rc1-00007-g1a0a67f5efc8"
dequeue_time: 2022-07-12 17:12:01.398958362 +08:00
:#! /cephfs/db/releases/20220712132854/lkp-src/include/site/inn:
job_state: finished
loadavg: 27.37 19.07 7.97 1/1010 12871
start_time: '1657614611'
end_time: '1657614834'
