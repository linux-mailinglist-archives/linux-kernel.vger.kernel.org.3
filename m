...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0EDDF4C8DBB
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Mar 2022 15:30:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235267AbiCAObc (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Mar 2022 09:31:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49748 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231383AbiCAOb3 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Mar 2022 09:31:29 -0500
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B323F9BAEB
        for <linux-kernel@vger.kernel.org>; Tue,  1 Mar 2022 06:30:43 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1646145043; x=1677681043;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=wnQ0U+3R3LZu0hyDb2wS1SHTF0GG/l1B8AqkgoLkYFo=;
  b=nMIc9we2VaT23VD9hFArVcO0sprAF6Cpyvkaf/76+WCqecBQBSvtzcJI
   8UV9xA+zx9+i9sELvodWtfJga+GHuvy9BaqLhkEwJCbXrHmNuRy7ISdOS
   nB2HUHRBt3SJ2FxoSU5+2ys9Oy33HkZ7dEirx5lQ/tCiopzxZS07ZYu3n
   BSDV6fQndkqIN+7nmCT6BtDFtyAseqtDZ/62a2VY+mUZ4vDX2xC3QKp94
   Yf3S6mdzAh3gn//kIdz9O+GAqtzWozvrDRmcAqFfROTutGAfsdYDG2ryD
   C1W4kndI1kW5B0RuhAwEYFFTyAos/eq86bcPOfcD2kePPHM/0ueZhn/uR
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10272"; a="277807269"
X-IronPort-AV: E=Sophos;i="5.90,146,1643702400"; 
   d="yaml'?scan'208";a="277807269"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Mar 2022 06:30:24 -0800
X-IronPort-AV: E=Sophos;i="5.90,146,1643702400"; 
   d="yaml'?scan'208";a="550738390"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Mar 2022 06:30:20 -0800
...
Subject: [tracing]  bc82c38a69:  will-it-scale.per_process_ops 6.1%
 improvement
Message-ID: <20220301143017.GB18164@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.17.0-rc1-00021-gbc82c38a6933"
...
commit'
	...
	export submit_id='621ba6be4ee1ee92413d1b24'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp9/will-it-scale-performance-process-50%-open2-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-bc82c38a6933aab308387d4aca47e0a05de7-20220228-102977-zhf0n8-4.yaml'
	export id='cec67082768971e24feb319a2921c2eef9b28c0d'
	...
	export commit='bc82c38a6933aab308387d4aca47e0a05de7b553'
	export ucode='0x500320a'
	export need_kconfig_hw='{"I40E"=>"y"}
SATA_AHCI'
	export enqueue_time='2022-02-28 00:28:47 +0800'
	export _id='621ba6d84ee1ee92413d1b25'
	export _rt='/result/will-it-scale/performance-process-50%-open2-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='d198cc5ce2940cf9ec309f32007bd3597303874b'
	export base_commit='cfb92440ee71adcc2105b0890bb01ac3cddb8507'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/will-it-scale/performance-process-50%-open2-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/3'
	export scheduler_version='/lkp/lkp/.src-20220225-152656'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/will-it-scale/performance-process-50%-open2-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/vmlinuz-5.17.0-rc1-00021-gbc82c38a6933
branch=linus/master
job=/lkp/jobs/scheduled/lkp-csl-2sp9/will-it-scale-performance-process-50%-open2-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-bc82c38a6933aab308387d4aca47e0a05de7-20220228-102977-zhf0n8-4.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=bc82c38a6933aab308387d4aca47e0a05de7b553
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/modules.cgz'
	...
	export last_kernel='5.17.0-rc5-wt-ath-05698-g9905da920154'
	export repeat_to=6
	export good_samples='59448
58802
59204'
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/vmlinuz-5.17.0-rc1-00021-gbc82c38a6933'
	export dequeue_time='2022-02-28 00:38:03 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp9/will-it-scale-performance-process-50%-open2-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-bc82c38a6933aab308387d4aca47e0a05de7-20220228-102977-zhf0n8-4.cgz'
...
run_job()
{
	...
	run_test mode='process' test='open2' $LKP_SRC/tests/wrapper will-it-scale
}
...
extract_stats()
{
	...
	env mode='process' test='open2' $LKP_SRC/stats/wrapper will-it-scale
...
kconfig: x86_64-rhel-8.3
submit_id: 621b79304ee1ee69660c5dbc
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp9/will-it-scale-performance-process-50%-open2-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-bc82c38a6933aab308387d4aca47e0a05de7-20220227-92518-c8y139-2.yaml"
id: f850f5f4ca9d9c03762dd92fd4d19cbcaf649116
...
- I40E: y
- SATA_AHCI
enqueue_time: 2022-02-27 21:14:24.236899846 +08:00
_id: 621b7d584ee1ee69660c5dbe
_rt: "/result/will-it-scale/performance-process-50%-open2-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: d198cc5ce2940cf9ec309f32007bd3597303874b
base_commit: cfb92440ee71adcc2105b0890bb01ac3cddb8507
branch: linus/master
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/will-it-scale/performance-process-50%-open2-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/vmlinuz-5.17.0-rc1-00021-gbc82c38a6933
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-csl-2sp9/will-it-scale-performance-process-50%-open2-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-bc82c38a6933aab308387d4aca47e0a05de7-20220227-92518-c8y139-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=bc82c38a6933aab308387d4aca47e0a05de7b553
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/modules.cgz"
...
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/bc82c38a6933aab308387d4aca47e0a05de7b553/vmlinuz-5.17.0-rc1-00021-gbc82c38a6933"
dequeue_time: 2022-02-27 21:36:48.197296666 +08:00
job_state: finished
loadavg: 37.12 27.91 12.65 1/720 14139
start_time: '1645969075'
end_time: '1645969376'
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "open2" "295" "process" "0" "44"
