...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4D6EB577103
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Jul 2022 21:23:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230376AbiGPTXA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 16 Jul 2022 15:23:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40990 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230135AbiGPTW4 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 16 Jul 2022 15:22:56 -0400
Received: from relay04.th.seeweb.it (relay04.th.seeweb.it [5.144.164.165])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B958219008;
        Sat, 16 Jul 2022 12:22:52 -0700 (PDT)
Received: from localhost.localdomain (abxj77.neoplus.adsl.tpnet.pl [83.9.3.77])
        by m-r1.th.seeweb.it (Postfix) with ESMTPA id 785E41F988;
        Sat, 16 Jul 2022 21:22:49 +0200 (CEST)
...
Subject: [PATCH 3/3] clk: qcom: Add global clock controller driver for SM6375
Date:   Sat, 16 Jul 2022 21:22:37 +0200
Message-Id: <20220716192237.452823-4-konrad.dybcio@somainline.org>
...
---
 ...
 drivers/clk/qcom/gcc-sm6375.c | 3925 +++++++++++++++++++++++++++++++++
 3 files changed, 3934 insertions(+)
...
index ab577bba8f2c..77df264c8020 100644
--- a/drivers/clk/qcom/Makefile
+++ b/drivers/clk/qcom/Makefile
@@ -97,6 +97,7 @@ obj-$(CONFIG_SM_DISPCC_8250) += dispcc-sm8250.o
...
index 000000000000..9279ca618396
--- /dev/null
