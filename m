...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 91A1B4F7137
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Apr 2022 03:31:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242244AbiDGBc1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Apr 2022 21:32:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32910 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239726AbiDGBT3 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Apr 2022 21:19:29 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8129E1AE21F;
        Wed,  6 Apr 2022 18:14:56 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id C433BB8268D;
        Thu,  7 Apr 2022 01:14:54 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 60D7CC385A6;
        Thu,  7 Apr 2022 01:14:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1649294093;
        bh=V54235r8/iwJZHzZJh9Bx2Fl/u1D+DRFrFgDgmbY7eY=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH AUTOSEL 5.10 17/25] nvme-multipath: fix hang when disk goes live over reconnect
Date:   Wed,  6 Apr 2022 21:14:05 -0400
Message-Id: <20220407011413.114662-17-sashal@kernel.org>
...
index 71c85c99e86c..3a3c28c639df 100644
...
index 5dd1dd8021ba..58e3bb672ce3 100644
--- a/drivers/nvme/host/nvme.h
+++ b/drivers/nvme/host/nvme.h
@@ -707,6 +707,7 @@ void nvme_mpath_add_disk(struct nvme_ns *ns, struct nvme_id_ns *id);
...
@@ -793,6 +794,9 @@ static inline int nvme_mpath_init_identify(struct nvme_ctrl *ctrl,
