...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B6E7155A688
	for <lists+linux-kernel@lfdr.de>; Sat, 25 Jun 2022 05:41:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232413AbiFYDBE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Jun 2022 23:01:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43026 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232266AbiFYDAG (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Jun 2022 23:00:06 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A8B7B699A0
        for <linux-kernel@vger.kernel.org>; Fri, 24 Jun 2022 19:59:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656125993; x=1687661993;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=coAruGeDqxk6DGslz6gAiSQiA+wmXzt24Ox/gJifNkA=;
  b=EVczFYJUdIKm3ks1ekhnP9aVqj0DHk6Cnsw9DWoG38tTXpo9udgjQ01Z
   6gCH4egpu4/FC6OHWBqQ5DJPlTzH6IBpJGH5yEB9nsIIigVavOqOTTS0z
   kf+XewGNrKwqcb/WIx0Q4FTfe9RR8JWWfHhbn00o9DvJaErLLDpzlk/u2
   dFrMfPwRwxe5HjHOPZW8Hd2IKvZMBOvmZlSidmADqfxYqab3lSVqGuoSj
   M9XVcyciFA6dWajEC99iSVuaxvYXtCMbc/sgRqle/G/QPPpFBZc9chBGf
   7/IRuYe+qEHDMBwImjGVJZwoTRh6cHe2ZhiCAHX5P54RQ5Cjh8kkivbmq
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10388"; a="278685476"
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="278685476"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jun 2022 19:59:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,221,1650956400"; 
   d="scan'208";a="589215323"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by orsmga002.jf.intel.com with ESMTP; 24 Jun 2022 19:59:47 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o4w1S-0005G9-SY;
        Sat, 25 Jun 2022 02:59:46 +0000
Date:   Sat, 25 Jun 2022 10:59:41 +0800
From:   kernel test robot <lkp@intel.com>
To:     Oded Gabbay <ogabbay@kernel.org>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [ogabbay:gaudi2_full 48/48]
 drivers/misc/habanalabs/gaudi/gaudi.c:1524:11: error: 'struct hl_cs' has no
 member named 'jobs_cnt'
Message-ID: <202206250610.sbuUnM6U-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="QLgCD+24ygVNKYQZ"
...
All errors (new ones prefixed by >>):
   ...
   drivers/misc/habanalabs/gaudi/gaudi.c: In function 'gaudi_collective_wait_create_job':
>> drivers/misc/habanalabs/gaudi/gaudi.c:1524:11: error: 'struct hl_cs' has no member named 'jobs_cnt'
    1524 |         cs->jobs_cnt++;
         |           ^~
   ...
   drivers/misc/habanalabs/gaudi/gaudi.c:3884:48: error: 'struct asic_fixed_properties' has no member named 'mmu_cache_mng_addr'
    3884 |         WREG32(mmSTLB_CACHE_INV_BASE_39_8, prop->mmu_cache_mng_addr >> 8);
         |                                                ^~
   drivers/misc/habanalabs/gaudi/../common/habanalabs.h:2272:61: note: in definition of macro 'WREG32'
    2272 | #define WREG32(reg, v) hdev->asic_funcs->wreg(hdev, (reg), (v))
         |                                                             ^
   drivers/misc/habanalabs/gaudi/gaudi.c:3885:49: error: 'struct asic_fixed_properties' has no member named 'mmu_cache_mng_addr'
    3885 |         WREG32(mmSTLB_CACHE_INV_BASE_49_40, prop->mmu_cache_mng_addr >> 40);
         |                                                 ^~
   drivers/misc/habanalabs/gaudi/../common/habanalabs.h:2272:61: note: in definition of macro 'WREG32'
    2272 | #define WREG32(reg, v) hdev->asic_funcs->wreg(hdev, (reg), (v))
         |                                                             ^
   drivers/misc/habanalabs/gaudi/gaudi.c: In function 'gaudi_scrub_device_mem':
   drivers/misc/habanalabs/gaudi/gaudi.c:4837:25: warning: variable 'dummy_val' set but not used [-Wunused-but-set-variable]
    4837 |         u64 addr, size, dummy_val;
         |                         ^~~~~~~~~
   drivers/misc/habanalabs/gaudi/gaudi.c: In function 'gaudi_mmu_clear_pgt_range':
   drivers/misc/habanalabs/gaudi/gaudi.c:6083:40: error: 'struct asic_fixed_properties' has no member named 'mmu_cache_mng_size'
    6083 |                         hdev->asic_prop.mmu_cache_mng_size;
         |                                        ^
   drivers/misc/habanalabs/gaudi/gaudi.c: At top level:
   drivers/misc/habanalabs/gaudi/gaudi.c:8602:5: warning: no previous prototype for 'gaudi_pre_schedule_cs' [-Wmissing-prototypes]
    8602 | int gaudi_pre_schedule_cs(struct hl_cs *cs)
         |     ^~~~~~~~~~~~~~~~~~~~~
   drivers/misc/habanalabs/gaudi/gaudi.c:8978:5: warning: no previous prototype for 'gaudi_ack_mmu_page_fault_or_access_error' [-Wmissing-prototypes]
    8978 | int gaudi_ack_mmu_page_fault_or_access_error(struct hl_device *hdev,
         |     ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
