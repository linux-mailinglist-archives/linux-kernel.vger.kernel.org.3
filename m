...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D580357E004
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Jul 2022 12:33:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234832AbiGVKbE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 22 Jul 2022 06:31:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40196 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229538AbiGVKbC (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 22 Jul 2022 06:31:02 -0400
Received: from mail-pj1-x1035.google.com (mail-pj1-x1035.google.com [IPv6:2607:f8b0:4864:20::1035])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E6B33AFB7D
        for <linux-kernel@vger.kernel.org>; Fri, 22 Jul 2022 03:31:01 -0700 (PDT)
Received: by mail-pj1-x1035.google.com with SMTP id pc13so4010794pjb.4
        for <linux-kernel@vger.kernel.org>; Fri, 22 Jul 2022 03:31:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to:user-agent;
        bh=tBUzLCUMvi2t0e3jHkRxKnlkrjAkiVQpUwiAVq5cs50=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tBUzLCUMvi2t0e3jHkRxKnlkrjAkiVQpUwiAVq5cs50=;
        b=
X-Gm-Message-State: AJIora9NwDqiwPxS62+0xdeOO1SOFdCmAjkksTYfJ9RIJdjHxRSvIC8w
        HthJwzYVZrHTc7p9iyEudoFmVOKRKZi7nw==
X-Google-Smtp-Source: AGRyM1tVDKi+if+JuyBMeA6hYYE70Fn2ex/kVMKHIruDUna0U35MWonLVL361e3wNeOtjMHYRI8Jsw==
X-Received: by 2002:a17:90b:3c49:b0:1f1:9213:e747 with SMTP id pm9-20020a17090b3c4900b001f19213e747mr3415667pjb.15.1658485861296;
        Fri, 22 Jul 2022 03:31:01 -0700 (PDT)
Received: from localhost ([58.33.57.226])
        by smtp.gmail.com with ESMTPSA id g11-20020a170902d5cb00b0016a6cd546d6sm3304743plh.251.2022.07.22.03.30.57
        (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
        Fri, 22 Jul 2022 03:31:00 -0700 (PDT)
Date:   Fri, 22 Jul 2022 18:30:13 +0800
...
Message-ID: <20220722101008.GA2223@Jiazi.Li>
References: <20220721123325.4675-1-jiazi.li@transsion.com>
 ...
 <20220722082242.GA5656@Jiazi.Li>
 <Ytpif4TmTEaDklbW@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <Ytpif4TmTEaDklbW@kroah.com>
...
On Fri, Jul 22, 2022 at 10:40:31AM +0200, Greg Kroah-Hartman wrote:
> On Fri, Jul 22, 2022 at 04:22:42PM +0800, lijiazi wrote:
...
For confidentiality reasons, company prohibits uploading codes to github
and other websites.
...
> 
> What was the problem that it had?  Perhaps post that here for us to see
> what was required to resolve this.

In i2c device driver's shutdown callback, do not set i2c_client->dev
->drvdata to NULL.
1. device_shutdown remove device from devices_kset and call shutdown
2. During the shutdown or reboot of phone, if plug/unplug usb, driver call
phy_get to obtain a reference to usb phy.
phy_get
  ->device_link_add//i2c device as usb phy's consumer
    ->device_reorder_to_tail
      ->device_kset_move_last//move i2c device to last of devices_kset
3. device_shutdown call i2c device shutdown again
My workaround is set i2c_clinet->dev->drvdata to NULL before return in
shutdown callback, and check whether drvdata is NULL at the beginning of
shutdown callback, if NULL, just return.

But this cannot prevent shutdown from being called twice.
