...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3ECA94E1F0E
	for <lists+linux-kernel@lfdr.de>; Mon, 21 Mar 2022 03:33:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344196AbiCUCeM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 20 Mar 2022 22:34:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46308 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242162AbiCUCeI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 20 Mar 2022 22:34:08 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4023179436
        for <linux-kernel@vger.kernel.org>; Sun, 20 Mar 2022 19:32:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1647829963; x=1679365963;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=z0f73rRuW/AlSxQzmK3uTFP7VurBBEVK1CjvIP8y8HM=;
  b=n2UWcblJkzT7+Gi6GN8qfIntR5sT/VmROyPIlNb9AinQxzkXVFS81zmz
   eSWYPZQWGizA9YVBDgXDeduCz0YkDFDhp9CxPoeIRnUdySZbicwfPEitN
   OFPleI2YGAEId2iBIOT950R1ih+Wbb/+tE3qPapAqfNzIri2bxrAbPdHy
   pQWEIFwtgJI7X36vQaEWLRezEWuIKZQ26y1RqYUYyIJHfu5AOESn6PhMY
   pSs3tgIDxKNAO22iDwOh6r8HjRlXJaHXW60rInhlZbmMLarJxX4i7GwRr
   i5023L+x637tNsBRglw2iN31tdVLpE5GBgnN+xISMNj5Fggcm2pbfu63U
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10292"; a="257173583"
X-IronPort-AV: E=Sophos;i="5.90,197,1643702400"; 
   d="scan'208";a="257173583"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 Mar 2022 19:32:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.90,197,1643702400"; 
   d="scan'208";a="500008874"
Received: from lkp-server02.sh.intel.com (HELO 89b41b6ae01c) ([10.239.97.151])
  by orsmga003.jf.intel.com with ESMTP; 20 Mar 2022 19:32:41 -0700
Received: from kbuild by 89b41b6ae01c with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1nW7qa-000HO8-R4; Mon, 21 Mar 2022 02:32:40 +0000
Date:   Mon, 21 Mar 2022 10:31:54 +0800
...
Message-ID: <202203211035.CCy7NOx1-lkp@intel.com>
MIME-Version: 1.0
...
head:   1cfef2c0a97afab6eef70fa0de60b1142ade482f
commit: 9f4e39a3774932c740ed9f243c390eb59106e3f0 [23/24] parisc: Convert parisc_requires_coherency() to static branch
config: parisc64-defconfig (https://download.01.org/0day-ci/archive/20220321/202203211035.CCy7NOx1-lkp@intel.com/config)
compiler: hppa64-linux-gcc (GCC) 11.2.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux.git/commit/?id=9f4e39a3774932c740ed9f243c390eb59106e3f0
        git remote add deller-parisc https://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux.git
        git fetch --no-tags deller-parisc for-next
        git checkout 9f4e39a3774932c740ed9f243c390eb59106e3f0
...
All errors (new ones prefixed by >>):
   ...
   In file included from arch/parisc/include/asm/processor.h:284,
