...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EDC8147CEA8
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Dec 2021 10:03:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243655AbhLVJD2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Dec 2021 04:03:28 -0500
Received: from ams.source.kernel.org ([145.40.68.75]:34250 "EHLO
        ams.source.kernel.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243634AbhLVJDL (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Dec 2021 04:03:11 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id DCBE0B81B77;
        Wed, 22 Dec 2021 09:03:09 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C4756C36AE8;
        Wed, 22 Dec 2021 09:03:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1640163788;
        bh=P8iezXMCgxoFNTqVkeAH7V1BNF6qvzGqsFAo1bFx2/M=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=UXte6mYdniv+Wz76u6UOqzwxnGq1mBDcFhEsbLZjhCcQ+iilUuqaMjKVxiyRByASt
         YPbgNEm/Y6MYG0LjCcwR6DVHbB9E3D1Lq49xiLNUWU8pGoNF2k2gXfSexJZHZkuDk2
         YkryXtpxWcSmIa0oNt1zMVYtwCeIW9OQ0W1s8AZI=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.19.222
Date:   Wed, 22 Dec 2021 10:02:57 +0100
Message-Id: <1640163777130114@kroah.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <164016377752242@kroah.com>
References: <164016377752242@kroah.com>
MIME-Version: 1.0
...
index c0676abcf60f..aa6cdaebe18b 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 6348b0964e9c..be4403a8e1b4 100644
--- a/arch/x86/Kconfig
+++ b/arch/x86/Kconfig
...
@@ -887,7 +905,7 @@ static int xennet_get_responses(struct netfront_queue *queue,
 	}
...
@@ -1075,7 +1094,9 @@ static int xennet_poll(struct napi_struct *napi, int budget)
...
@@ -1099,7 +1120,8 @@ static int xennet_poll(struct napi_struct *napi, int budget)
...
@@ -850,7 +857,7 @@ static int msix_capability_init(struct pci_dev *dev, struct msix_entry *entries,
 	free_msi_irqs(dev);
...
index 848562222015..a456267b6b78 100644
...
index 6244345a5745..f01ecc197a45 100644
--- a/fs/fuse/dir.c
+++ b/fs/fuse/dir.c
...
@@ -116,8 +116,7 @@ int ovl_cleanup_and_whiteout(struct dentry *workdir, struct inode *dir,
 	goto out;
 }
...
@@ -654,10 +654,14 @@ static struct dentry *ovl_workdir_create(struct ovl_fs *ofs,
 			goto retry;
 		}
...
index c66fd11d94bc..f246818e35db 100644
...
index cbcb60face2c..e5c4a72f8e57 100644
...
index 8d9005019ef7..1309161032d5 100644
...
index 321c41562b97..d8cbbedef316 100755
