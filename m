...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6E06E50EED0
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Apr 2022 04:35:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242543AbiDZCiU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 25 Apr 2022 22:38:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39848 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231448AbiDZCiS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 25 Apr 2022 22:38:18 -0400
Received: from mail-pl1-x632.google.com (mail-pl1-x632.google.com [IPv6:2607:f8b0:4864:20::632])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EE9FA5F60
        for <linux-kernel@vger.kernel.org>; Mon, 25 Apr 2022 19:35:10 -0700 (PDT)
Received: by mail-pl1-x632.google.com with SMTP id s14so28891479plk.8
        for <linux-kernel@vger.kernel.org>; Mon, 25 Apr 2022 19:35:10 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=kfsygK83j9OWM2CoXkmQJYR0L/9WFxwyzmxwaIxu6Kw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=kfsygK83j9OWM2CoXkmQJYR0L/9WFxwyzmxwaIxu6Kw=;
        b=
X-Gm-Message-State: AOAM532YKN3tM44ptw8M2FQX3ZIfBaKLTYhLwH7rbdEva01Md7XQbbxw
        mJNf1HLvLKUCiKI0Kz5Ra4fxH7OOKHc=
X-Google-Smtp-Source: ABdhPJxxI9OUrjwFaq1fwLwX0Sqn5JISk8JLAbTCdqeN4r6w9hzo7nSqK+X2f023yVQyKYhFDUo65A==
X-Received: by 2002:a17:90b:4d01:b0:1d0:f39f:6073 with SMTP id mw1-20020a17090b4d0100b001d0f39f6073mr24234505pjb.175.1650940509647;
        Mon, 25 Apr 2022 19:35:09 -0700 (PDT)
Received: from daehojeong-desktop.mtv.corp.google.com ([2620:15c:211:201:a0e6:3a7:e52:ee03])
        by smtp.gmail.com with ESMTPSA id w129-20020a628287000000b0050d4246fbedsm4403603pfd.187.2022.04.25.19.35.08
...
Subject: [PATCH v2] f2fs: change the current atomic write way
Date:   Mon, 25 Apr 2022 19:34:59 -0700
Message-Id: <20220426023459.1742796-1-daeho43@gmail.com>
...
---
 ...
 13 files changed, 302 insertions(+), 442 deletions(-)

diff --git a/fs/f2fs/data.c b/fs/f2fs/data.c
index 9a1a526f2092..103eb25d549d 100644
--- a/fs/f2fs/data.c
+++ b/fs/f2fs/data.c
...
@@ -3563,18 +3657,6 @@ static bool f2fs_dirty_data_folio(struct address_space *mapping,
...
@@ -3654,42 +3736,14 @@ static sector_t f2fs_bmap(struct address_space *mapping, sector_t block)
