...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4FE3D4D6FC6
	for <lists+linux-kernel@lfdr.de>; Sat, 12 Mar 2022 16:43:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232009AbiCLPol (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 12 Mar 2022 10:44:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58142 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229908AbiCLPok (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 12 Mar 2022 10:44:40 -0500
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9481E3B565
        for <linux-kernel@vger.kernel.org>; Sat, 12 Mar 2022 07:43:30 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1647099810; x=1678635810;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=1EhlEtSAPQKh1ycbufRcouszNNVDtexwR1Ewe+Q6Jz8=;
  b=VGJ7IGT8tN/x+BsBmRyc8ayX2YHa8pkomhyL006szl7XoMPs/B6lbgvi
   uwQTAbIbxjhDIHezMlnJsOUa3d73ofvkKd7EwkHgR2mxae9hrA/BQfRMP
   sGVjuK5yUTDGmawHX55uMYDKANMBIRZRbtl6XQPy9SrPcYyG4A5TjPuu6
   I+l22AXUv1qHfU9qxsxJKE7gG/MNYEEq8wY77iDFuKH8TqOglcLb1rNAj
   jMrEwKol451zhMa2qzB6REeUn89TNKQsqOJvusH8RlFWHyoDPaYu9PnYz
   e7lF7PP1nkbREquuREcfRcha7d3Ms5YxFfKDGEImrnWGH+qR0lo5lQgc9
   A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10284"; a="254631483"
X-IronPort-AV: E=Sophos;i="5.90,175,1643702400"; 
   d="yaml'?scan'208";a="254631483"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Mar 2022 07:43:29 -0800
X-IronPort-AV: E=Sophos;i="5.90,175,1643702400"; 
   d="yaml'?scan'208";a="555771088"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Mar 2022 07:43:24 -0800
...
Content-Disposition: attachment; filename="config-5.17.0-rc7-00001-g8212a964ee02"
...
commit'
	...
	export submit_id='622af9ecdc9545e089945af8'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp5/vm-scalability-performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-8212a964ee020471104e34d-20220311-57481-16ojmn5-4.yaml'
	export id='70cd03382906c4eb95cbef499cc2c7bf45f578d0'
	...
	export commit='8212a964ee020471104e34dce7029dec33c218a9'
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-03-11 15:27:41 +0800'
	export _id='622afa03dc9545e089945af9'
	export _rt='/result/vm-scalability/performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9'
	export user='lkp'
	...
	export branch='linux-review/Mel-Gorman/Re-PATCH-v2-mm-page_alloc-call-check_new_pages-while-zone-spinlock-is-not-held/20220309-203504'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/vm-scalability/performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/3'
	export scheduler_version='/lkp/lkp/.src-20220311-152040'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/vm-scalability/performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/vmlinuz-5.17.0-rc7-00001-g8212a964ee02
branch=linux-review/Mel-Gorman/Re-PATCH-v2-mm-page_alloc-call-check_new_pages-while-zone-spinlock-is-not-held/20220309-203504
job=/lkp/jobs/scheduled/lkp-icl-2sp5/vm-scalability-performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-8212a964ee020471104e34d-20220311-57481-16ojmn5-4.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=8212a964ee020471104e34dce7029dec33c218a9
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220226.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-3bf7edc84a9e-1_20220310.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/vm-scalability_20210701.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/vm-scalability-x86_64-1.0-0_20220308.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/vmlinuz-5.17.0-rc7-00001-g8212a964ee02'
	export dequeue_time='2022-03-11 15:30:32 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp5/vm-scalability-performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-8212a964ee020471104e34d-20220311-57481-16ojmn5-4.cgz'
...
run_job()
{
	...
	run_test test='anon-w-rand-hugetlb' $LKP_SRC/tests/wrapper vm-scalability
}
...
extract_stats()
{
	...
	env test='anon-w-rand-hugetlb' $LKP_SRC/stats/wrapper vm-scalability
...
kconfig: x86_64-rhel-8.3
submit_id: 622ad8e9dc9545def0fe1cf4
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp5/vm-scalability-performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-8212a964ee020471104e34d-20220311-57072-1iinmwp-1.yaml"
id: '02190ecd9a2446353e0c20afd9927b41c221bed6'
...
ucode: '0xd000331'
bisect_dmesg: true
enqueue_time: 2022-03-11 13:06:49.441986149 +08:00
_id: 622ad8ffdc9545def0fe1cf5
_rt: "/result/vm-scalability/performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
...
result_root: "/result/vm-scalability/performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/vmlinuz-5.17.0-rc7-00001-g8212a964ee02
- branch=linux-devel/devel-hourly-20220310-022543
- job=/lkp/jobs/scheduled/lkp-icl-2sp5/vm-scalability-performance-300s-512G-anon-w-rand-hugetlb-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-8212a964ee020471104e34d-20220311-57072-1iinmwp-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=8212a964ee020471104e34dce7029dec33c218a9
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/modules.cgz"
...
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/8212a964ee020471104e34dce7029dec33c218a9/vmlinuz-5.17.0-rc7-00001-g8212a964ee02"
dequeue_time: 2022-03-11 13:38:32.187949637 +08:00
:#! /cephfs/db/releases/20220310172418/lkp-src/include/site/inn:
job_state: finished
loadavg: 85.64 48.27 19.37 1/1169 14582
start_time: '1646977183'
end_time: '1646977368'
version: "/lkp/lkp/.src-20220311-100200:1f333e53:0be9e22d1"
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 134833008640 /tmp/vm-scalability-tmp/vm-scalability.img
 ...
 ./usemem --runtime 300 -n 128 -O -U --random 526691440
 ./case-anon-w-rand-hugetlb
 ./usemem --runtime 300 -n 128 -O -U --random 526691440
 ./case-anon-w-rand-hugetlb
 ./usemem --runtime 300 -n 128 -O -U --random 526691440
