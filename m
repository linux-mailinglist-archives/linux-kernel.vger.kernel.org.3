...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D44245694F3
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Jul 2022 00:03:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234742AbiGFWBm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Jul 2022 18:01:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44468 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234631AbiGFWBP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Jul 2022 18:01:15 -0400
Received: from mail-yb1-xb4a.google.com (mail-yb1-xb4a.google.com [IPv6:2607:f8b0:4864:20::b4a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B78AF2A404
        for <linux-kernel@vger.kernel.org>; Wed,  6 Jul 2022 15:01:03 -0700 (PDT)
Received: by mail-yb1-xb4a.google.com with SMTP id b129-20020a25e487000000b0066e1c52ac55so9821187ybh.11
        for <linux-kernel@vger.kernel.org>; Wed, 06 Jul 2022 15:01:03 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=QRwOHdNvCJsdEWcZ8PiNBBmz8P6BxE21GfKaWd62Hcs=;
        b=
X-Gm-Message-State: AJIora8FKk5GvrOOlKIV5A/EBWkeU0cl1xcuXwZqF7JczAxpKiRPA+bV
        731epSgCmnNM1UNVyuuhcPLIDVz2egw=
...
@@ -5130,6 +5130,7 @@ context_switch(struct rq *rq, struct task_struct *pre=
v,
...
@@ -3237,8 +3717,28 @@ static unsigned long get_pte_pfn(pte_t pte, struct v=
...
+				   struct pglist_data *pgdat, bool can_swap)
 {
 	struct folio *folio;
=20
@@ -3253,9 +3753,371 @@ static struct folio *get_pfn_folio(unsigned long pf=
...
+
 ...
 {
 	struct lru_gen_struct *lrugen =3D &lruvec->lrugen;
@@ -3307,7 +4169,7 @@ static bool try_to_inc_min_seq(struct lruvec *lruvec,=
 bool can_swap)
 	return success;
 }
=20
...
+static void inc_max_seq(struct lruvec *lruvec, bool can_swap)
 {
 	int prev, next;
 	int type, zone;
@@ -3317,9 +4179,6 @@ static void inc_max_seq(struct lruvec *lruvec, unsign=
...
-
 	for (type =3D 0; type < ANON_AND_FILE; type++) {
 		if (get_nr_gens(lruvec, type) !=3D MAX_NR_GENS)
 			continue;
@@ -3357,10 +4216,76 @@ static void inc_max_seq(struct lruvec *lruvec, unsi=
...
+
 ...
 {
@@ -3438,7 +4363,7 @@ static void age_lruvec(struct lruvec *lruvec, struct =
scan_control *sc)
...
l *sc)
@@ -3447,6 +4372,8 @@ static void lru_gen_age_node(struct pglist_data *pgda=
...
@@ -3455,11 +4382,16 @@ static void lru_gen_age_node(struct pglist_data *pg=
...
+ * eviction and the aging.
 ...
 void lru_gen_look_around(struct page_vma_mapped_walk *pvmw)
 {
@@ -3468,6 +4400,8 @@ void lru_gen_look_around(struct page_vma_mapped_walk =
*pvmw)
 	unsigned long start;
 	unsigned long end;
 	unsigned long addr;
...
@@ -3497,6 +4431,7 @@ void lru_gen_look_around(struct page_vma_mapped_walk =
*pvmw)
 	}
=20
...
=20
 	rcu_read_lock();
 	arch_enter_lazy_mmu_mode();
@@ -3511,13 +4446,15 @@ void lru_gen_look_around(struct page_vma_mapped_wal=
k *pvmw)
 		if (!pte_young(pte[i]))
 			continue;
=20
...
+
 		if (pte_dirty(pte[i]) && !folio_test_dirty(folio) &&
 		    !(folio_test_anon(folio) && folio_test_swapbacked(folio) &&
 		      !folio_test_swapcache(folio)))
@@ -3533,7 +4470,11 @@ void lru_gen_look_around(struct page_vma_mapped_walk=
 *pvmw)
 	arch_leave_lazy_mmu_mode();
 	rcu_read_unlock();
=20
...
@@ -3545,8 +4486,10 @@ void lru_gen_look_around(struct page_vma_mapped_walk=
 *pvmw)
 	if (!mem_cgroup_trylock_pages(memcg))
 		return;
=20
...
=20
 	for_each_set_bit(i, bitmap, MIN_LRU_BATCH) {
 		folio =3D pfn_folio(pte_pfn(pte[i]));
@@ -3557,10 +4500,14 @@ void lru_gen_look_around(struct page_vma_mapped_wal=
k *pvmw)
...
@@ -3843,6 +4790,7 @@ static int evict_folios(struct lruvec *lruvec, struct=
...
=20
@@ -3879,6 +4827,10 @@ static int evict_folios(struct lruvec *lruvec, struc=
...
@@ -3936,7 +4888,8 @@ static unsigned long get_nr_to_scan(struct lruvec *lr=
...
@@ -3951,6 +4904,8 @@ static void lru_gen_shrink_lruvec(struct lruvec *lruv=
...
+
 	while (true) {
 		int delta;
 		int swappiness;
@@ -3978,6 +4933,8 @@ static void lru_gen_shrink_lruvec(struct lruvec *lruv=
ec, struct scan_control *sc
 		cond_resched();
 	}
=20
