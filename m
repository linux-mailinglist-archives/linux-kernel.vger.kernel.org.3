...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 78C274945C7
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jan 2022 03:20:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232155AbiATCU4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jan 2022 21:20:56 -0500
Received: from mga03.intel.com ([134.134.136.65]:34642 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229875AbiATCUw (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jan 2022 21:20:52 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1642645252; x=1674181252;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=qcMp5taH75l5G0aGhGuU2RnjdYXCgW0N1S3r3615vUY=;
  b=B4YfOWRHmCBSPRlnbQTrmKCtuowuZ8JVca+RDHDlK2xnUz+iaE3hajjN
   jrpsU1C0WC7WO8KSIHqxaAf/zmRPQ98LgAP+o+neUO/IyN6i0GIdr02lb
   vs/X+PY8EuhxKdjOlg4Tvuo+f8ursa1GxfCq5x7mplSFuCItqDSmVG6CS
   A0H/GCm4peliHA8PoJELUYv3qs/z+nDQkf6bLK33iUQHhT3G807Md/GEq
   Ew0Rs7KcDhPSEIk7f2ZTZovAvfQAHYxFOqmB2Foxc7QkfozM5u46UQlb7
   u0zqrbljTs3+MZkG/2i2YYCrbITDdDeiNIb5UaJNHVY6yOAzhr64BqmpJ
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10232"; a="245207746"
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; 
   d="yaml'?scan'208";a="245207746"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Jan 2022 18:20:45 -0800
X-IronPort-AV: E=Sophos;i="5.88,301,1635231600"; 
   d="yaml'?scan'208";a="477623923"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Jan 2022 18:20:41 -0800
Date:   Thu, 20 Jan 2022 10:20:35 +0800
...
Message-ID: <20220120022035.GA5873@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.16.0-rc7-02009-g91a760b26926"
...
commit'
	...
	export submit_id='61e773dce366698d8b069a1f'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-network-performance-100%-sockfd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-91a760b26926265a60c77ddf016529bcf3-20220119-36235-12lc09q-4.yaml'
	export id='4449facace15414e47f29096e1e1b6ccbf058970'
	...
	export need_kconfig=
	export commit='91a760b26926265a60c77ddf016529bcf3e17a04'
	export ucode='0xd000280'
	export bisect_dmesg=true
	export enqueue_time='2022-01-19 10:13:48 +0800'
	export _id='61e773eee366698d8b069a20'
	export _rt='/result/stress-ng/network-performance-100%-sockfd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='d772d6c8bdb1d4c5619aa3cc44a8ed9b30b1f685'
	export base_commit='df0cc57e057f18e44dac8e6c18aba47ab53202f9'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/stress-ng/network-performance-100%-sockfd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/3'
	export scheduler_version='/lkp/lkp/.src-20220119-092417'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/network-performance-100%-sockfd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/vmlinuz-5.16.0-rc7-02009-g91a760b26926
branch=linus/master
job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-network-performance-100%-sockfd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-91a760b26926265a60c77ddf016529bcf3-20220119-36235-12lc09q-4.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/vmlinuz-5.16.0-rc7-02009-g91a760b26926'
	export dequeue_time='2022-01-19 10:26:34 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-network-performance-100%-sockfd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-91a760b26926265a60c77ddf016529bcf3-20220119-36235-12lc09q-4.cgz'
...
run_job()
{
	...
	run_test class='network' test='sockfd' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='network' test='sockfd' $LKP_SRC/stats/wrapper stress-ng
...
kconfig: x86_64-rhel-8.3
submit_id: 61e759e2e36669869a0e4d54
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-network-performance-100%-sockfd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-91a760b26926265a60c77ddf016529bcf3-20220119-34458-6qqd7y-0.yaml"
id: a566c9ff745340c3f74b5b444aba5a73642b6c19
...
ucode: '0xd000280'
bisect_dmesg: true
enqueue_time: 2022-01-19 08:22:58.869733864 +08:00
_id: 61e759e2e36669869a0e4d54
_rt: "/result/stress-ng/network-performance-100%-sockfd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: d772d6c8bdb1d4c5619aa3cc44a8ed9b30b1f685
base_commit: df0cc57e057f18e44dac8e6c18aba47ab53202f9
branch: linux-devel/devel-hourly-20220116-203101
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/stress-ng/network-performance-100%-sockfd-60s-ucode=0xd000280/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/1"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/vmlinuz-5.16.0-rc7-02009-g91a760b26926
- branch=linux-devel/devel-hourly-20220116-203101
- job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-network-performance-100%-sockfd-60s-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-91a760b26926265a60c77ddf016529bcf3-20220119-34458-6qqd7y-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=91a760b26926265a60c77ddf016529bcf3e17a04
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.16.0-rc7-02009-g91a760b26926
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/91a760b26926265a60c77ddf016529bcf3e17a04/vmlinuz-5.16.0-rc7-02009-g91a760b26926"
dequeue_time: 2022-01-19 09:52:03.146966618 +08:00
:#! /cephfs/db/releases/20220119092046/lkp-src/include/site/inn:
job_state: finished
loadavg: 85.73 34.53 12.58 1/1224 9879
start_time: '1642557217'
end_time: '1642557279'
...
do
 ...
 "stress-ng" "--timeout" "60" "--times" "--verify" "--metrics-brief" "--sockfd" "128"
