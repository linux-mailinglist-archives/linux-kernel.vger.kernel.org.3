...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 701FA5600B9
	for <lists+linux-kernel@lfdr.de>; Wed, 29 Jun 2022 15:10:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233707AbiF2NHU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 29 Jun 2022 09:07:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233709AbiF2NHR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 29 Jun 2022 09:07:17 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0CC972E9DD
        for <linux-kernel@vger.kernel.org>; Wed, 29 Jun 2022 06:07:11 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id A3A54B82477
        for <linux-kernel@vger.kernel.org>; Wed, 29 Jun 2022 13:07:09 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1DBC3C34114;
        Wed, 29 Jun 2022 13:07:08 +0000 (UTC)
Authentication-Results: smtp.kernel.org;
        dkim=pass (1024-bit key) header.d=zx2c4.com header.i=@zx2c4.com header.b="VnbF8BGD"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=zx2c4.com; s=20210105;
        t=1656508026;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=zaoftG1oOck9I7dul0J3l13B1c7KGuasF0GaoB5PXy8=;
        b=VnbF8BGDU/5z5f3VUgKNNKY1qiPMBSgbhv6EOyk4HbrI4P+HAin/ALx0WaDYd/NlEkXY9E
        Zkds2pg750bLlsa3h1WiEwJOsRsCcrdvrdv92tEo8dHV2N/DuhPEXHMajog3CYOMqUI4eB
        2ST1Xl6+R0uO89GL5+GT/f9rQpGfO0o=
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id ec0e30b7 (TLSv1.3:AEAD-AES256-GCM-SHA384:256:NO);
        Wed, 29 Jun 2022 13:07:06 +0000 (UTC)
From:   "Jason A. Donenfeld" <Jason@zx2c4.com>
To:     linux-kernel@vger.kernel.org, viro@zeniv.linux.org.uk
Cc:     "Jason A. Donenfeld" <Jason@zx2c4.com>
Subject: [PATCH v3 0/7] cleanup llseek and splice
Date:   Wed, 29 Jun 2022 15:06:55 +0200
Message-Id: <20220629130702.954310-1-Jason@zx2c4.com>
MIME-Version: 1.0
...
With FMODE_LSEEK as good information, the series is able to adjust
internal pipe splicing to use that.

It is then able to remove no_llseek entirely, and make all checks use
FMODE_LSEEK and all invocations use vfs_llseek.

Along the way the series also fixes related bugs in ksmbd, dma-buf, and
vfio.

Changes v2->v3:
- Do `if (!a) return -error; return 0;` rather than `if (a) return 0;
  return -error;` for Christophe.
- Drop the ksmbd patch, because Steve already sent it up to Linus.
- Accumuate various acks.
...
Jason A. Donenfeld (7):
 ...
 226 files changed, 16 insertions(+), 302 deletions(-)
