...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BED3C4DC249
	for <lists+linux-kernel@lfdr.de>; Thu, 17 Mar 2022 10:05:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231714AbiCQJFs (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Mar 2022 05:05:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43606 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231635AbiCQJFn (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Mar 2022 05:05:43 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EC57DDF48D
        for <linux-kernel@vger.kernel.org>; Thu, 17 Mar 2022 02:04:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1647507863; x=1679043863;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=y0ZdLCDIrxGxirsPPaoyp1qYVxnMqOlctnNVtNNsCpw=;
  b=YVs/5cgd6OBJemvd5MBypqUUhZ0OqXB+OpvweZZdhAnGZdEt5QV31He/
   Ey0VMl9albY8BLmqVDUrX4Ag3zpby/QrA/apfQZbxvjdqH2cF14R5QbBw
   MNusOJAfVpZO/2LwSsC93AtYHtTUS6lFZ2D1YQJ8iT4m42PMCsuI/ytkd
   pYbQkW19U7ExZtqd0HmxgPimTiwubhyDaayVzVD1lMxg5EBVmnA/jttF5
   gMVPaLndjXNzTK4YJdM4qk5Dg1I7+fwwJ7OnvCf/AbvpLbE7Pj+K3eZL/
   rGW2KP6GBDR3GQC7ED8KE8CPMoWKXaaqsOHg4UgRxEehV2W5RUitQQ5/I
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10288"; a="256772024"
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; 
   d="yaml'?scan'208";a="256772024"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Mar 2022 02:04:22 -0700
X-IronPort-AV: E=Sophos;i="5.90,188,1643702400"; 
   d="yaml'?scan'208";a="557848444"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Mar 2022 02:04:18 -0700
...
Content-Disposition: attachment; filename="config-5.12.0-rc2-00003-g6035152d8eeb"
...
export_top_env()
{
	...
	export commit='6035152d8eebe16a5bb60398d3e05dc7799067b0'
	export kconfig='x86_64-rhel-8.3'
	export submit_id='620f32fa0b9a93d2721f2b79'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp5/will-it-scale-performance-thread-100%-tlb_flush1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-6035152d8eebe16a5bb60398d3e05dc-20220218-53874-3hatro-1.yaml'
	export id='6df619f875f1429dc1882a46c1200a26fbe59581'
	export queuer_version='/lkp/xsang/.src-20220218-093616'
	...
	export enqueue_time='2022-02-18 13:47:39 +0800'
	export compiler='gcc-9'
	export _id='620f32fd0b9a93d2721f2b7a'
	export _rt='/result/will-it-scale/performance-thread-100%-tlb_flush1-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0'
	export user='lkp'
	export LKP_SERVER='internal-lkp-server'
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/vmlinuz-5.12.0-rc2-00003-g6035152d8eeb'
	export result_root='/result/will-it-scale/performance-thread-100%-tlb_flush1-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/3'
	export dequeue_time='2022-02-18 14:12:42 +0800'
	export scheduler_version='/lkp/lkp/.src-20220218-123838'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/will-it-scale/performance-thread-100%-tlb_flush1-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/vmlinuz-5.12.0-rc2-00003-g6035152d8eeb
branch=linus/master
job=/lkp/jobs/scheduled/lkp-icl-2sp5/will-it-scale-performance-thread-100%-tlb_flush1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-6035152d8eebe16a5bb60398d3e05dc-20220218-53874-3hatro-1.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=6035152d8eebe16a5bb60398d3e05dc7799067b0
...
run_job()
{
	...
	run_test mode='thread' test='tlb_flush1' $LKP_SRC/tests/wrapper will-it-scale
}
...
extract_stats()
{
	...
	env mode='thread' test='tlb_flush1' $LKP_SRC/stats/wrapper will-it-scale
...
---
:#! /lkp/lkp/src/jobs/will-it-scale-part4.yaml:
suite: will-it-scale
...
:#! hosts/inn:
serial_servers: lkp-wildcat lkp-nhm-dp2 lkp-nhm-d01 lkp-serial02 lkp-serial03 lkp-serial04
...
commit: 6035152d8eebe16a5bb60398d3e05dc7799067b0
kconfig: x86_64-rhel-8.3
submit_id: 620ef83f0b9a9380f4cf491e
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp5/will-it-scale-performance-thread-100%-tlb_flush1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-6035152d8eebe16a5bb60398d3e05dc-20220218-33012-18euok1-1.yaml"
id: cf4575bf2784dd7d83ec7baacb1ff5e14b286098
queuer_version: "/lkp/xsang/.src-20220218-093616"
:#! hosts/lkp-icl-2sp5:
model: Ice Lake
nr_node: 2
nr_cpu: 128
...
enqueue_time: 2022-02-18 09:37:03.183939823 +08:00
compiler: gcc-9
_id: 620ef8400b9a9380f4cf491f
_rt: "/result/will-it-scale/performance-thread-100%-tlb_flush1-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0"
:#! schedule options:
user: lkp
LKP_SERVER: internal-lkp-server
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/vmlinuz-5.12.0-rc2-00003-g6035152d8eeb"
result_root: "/result/will-it-scale/performance-thread-100%-tlb_flush1-ucode=0xd000331/lkp-icl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/0"
dequeue_time: 2022-02-18 09:56:19.334437905 +08:00
scheduler_version: "/lkp/lkp/.src-20220217-223842"
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/vmlinuz-5.12.0-rc2-00003-g6035152d8eeb
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-icl-2sp5/will-it-scale-performance-thread-100%-tlb_flush1-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-6035152d8eebe16a5bb60398d3e05dc-20220218-33012-18euok1-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=6035152d8eebe16a5bb60398d3e05dc7799067b0
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/6035152d8eebe16a5bb60398d3e05dc7799067b0/modules.cgz"
...
:#! runtime status:
job_state: finished
last_kernel: 5.12.0-rc2-00002-g4c1ba3923e6c
loadavg: 91.46 76.21 34.77 1/962 15287
start_time: '1645149446'
end_time: '1645149748'
version: "/lkp/lkp/.src-20220217-223920:848a26a9:499352d36"
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "tlb_flush1" "295" "thread" "0" "128"
