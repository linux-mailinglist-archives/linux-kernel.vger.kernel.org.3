...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E4E86485560
	for <lists+linux-kernel@lfdr.de>; Wed,  5 Jan 2022 16:05:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241355AbiAEPFB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 5 Jan 2022 10:05:01 -0500
Received: from alexa-out-sd-02.qualcomm.com ([199.106.114.39]:55600 "EHLO
        alexa-out-sd-02.qualcomm.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S241382AbiAEPD6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 5 Jan 2022 10:03:58 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=quicinc.com; i=@quicinc.com; q=dns/txt; s=qcdkim;
  t=1641395038; x=1672931038;
  h=from:to:cc:subject:date:message-id:mime-version;
  bh=HQ+adIISdv2g2dYKbMYlhCrnlL2pG5ZYWOPF3M9x8Ag=;
  b=TcXHYgM7HF8tZo815Rr8mCyPgFCF6PjBDb8mwaWQGtgdE0DcNCk/TV2n
   0LU+Uh67OzXw4U30bIlfGejFVwRWiTL3N3Z09RlVF7Zp2iuomGboVss6T
   V4yASZC25TFY5gF8G4VVoUKwDPsBtcOsYPghp+N7Vqmg9W+QZPn0sIP92
   Q=;
Received: from unknown (HELO ironmsg02-sd.qualcomm.com) ([10.53.140.142])
  by alexa-out-sd-02.qualcomm.com with ESMTP; 05 Jan 2022 07:03:56 -0800
X-QCInternal: smtphost
Received: from nasanex01c.na.qualcomm.com ([10.47.97.222])
  by ironmsg02-sd.qualcomm.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2022 07:03:56 -0800
Received: from nalasex01a.na.qualcomm.com (10.47.209.196) by
 nasanex01c.na.qualcomm.com (10.47.97.222) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.922.19; Wed, 5 Jan 2022 07:03:55 -0800
Received: from hu-charante-hyd.qualcomm.com (10.80.80.8) by
 nalasex01a.na.qualcomm.com (10.47.209.196) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.922.19; Wed, 5 Jan 2022 07:03:51 -0800
...
Subject: [PATCH v3] mm: shmem: implement POSIX_FADV_[WILL|DONT]NEED for shmem
Date:   Wed, 5 Jan 2022 20:33:45 +0530
Message-ID: <1641395025-7922-1-git-send-email-quic_charante@quicinc.com>
...
@@ -2791,6 +2793,175 @@ static long shmem_fallocate(struct file *file, int mode, loff_t offset,
 	return error;
 }
...
@@ -3777,6 +3948,7 @@ static const struct file_operations shmem_file_operations = {
