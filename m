...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CF58F524B42
	for <lists+linux-kernel@lfdr.de>; Thu, 12 May 2022 13:17:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353170AbiELLRL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 12 May 2022 07:17:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58624 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1352704AbiELLQa (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 12 May 2022 07:16:30 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3525720192;
        Thu, 12 May 2022 04:16:26 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 9C1F6B8277C;
        Thu, 12 May 2022 11:16:24 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8DFA3C385CB;
        Thu, 12 May 2022 11:16:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1652354183;
        bh=AXY5ZllGy3acVv+CjBIJT2xEQjjJG38UHXMotXmiNb8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=ovzazE5fN9xR1aQF6q5pnFoBTOOBmYB0yLuQGkQKeVHMI2UVH0oOHVf/h7vkbsxs9
         Mj7kT1kP0Fe981DbRquduREEuPi6Q5Y8I3/CbvQWfLWpFeEHwerl3dB8UfLUoX7thD
         +Bln63ii+xtiI0LP7vYX9Ujx3gFFLO8hjwdTWZec=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.193
Date:   Thu, 12 May 2022 13:16:10 +0200
Message-Id: <1652354169123165@kroah.com>
X-Mailer: git-send-email 2.36.1
In-Reply-To: <16523541695441@kroah.com>
References: <16523541695441@kroah.com>
MIME-Version: 1.0
...
index 968470cf368e..888d89605855 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 1da7ba18d399..3a43e5d6ed3b 100644
...
index 3ece59185d37..b1dcd2dd52e6 100644
...
index 530c0fe14229..37b8bb4d80f0 100644
--- a/drivers/md/dm.c
+++ b/drivers/md/dm.c
...
index b8f1f2b69dd3..3496dfa1b521 100644
...
index 7f590a9e3af7..5a7d5e7f3b23 100644
...
index 63a2d1bcccfb..bec09008997d 100644
...
index b577c8f7e346..e0570cd0e520 100644
...
index 9237362e5606..65be8bd1f0f4 100644
--- a/include/net/tcp.h
+++ b/include/net/tcp.h
...
index 426d70d45eda..72fe93ace7d7 100644
...
index 69aef71f32ea..92b32d131e1c 100644
...
+	bool was_ready;
 	...
 	ASSERT_RTNL();
@@ -3780,7 +3781,10 @@ static int addrconf_ifdown(struct net_device *dev, int how)
...
@@ -3854,7 +3858,7 @@ static int addrconf_ifdown(struct net_device *dev, int how)
 	if (how) {
...
index ec155844012b..37ab254f7b92 100644
...
index 51c900e9bfe2..063898cae3e5 100644
...
index e752692d3680..63701a980ee1 100644
--- a/net/nfc/core.c
+++ b/net/nfc/core.c
...
index 4d90cbdc083b..9e94f732e717 100644
--- a/net/nfc/netlink.c
+++ b/net/nfc/netlink.c
...
index 480e879e74ae..43bc02dea80c 100644
