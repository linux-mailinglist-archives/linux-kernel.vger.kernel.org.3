...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E37F24EDD2C
	for <lists+linux-kernel@lfdr.de>; Thu, 31 Mar 2022 17:34:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238656AbiCaPev (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 31 Mar 2022 11:34:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52036 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238475AbiCaPds (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 31 Mar 2022 11:33:48 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BE020223226;
        Thu, 31 Mar 2022 08:31:46 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 368BDB82173;
        Thu, 31 Mar 2022 15:31:45 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3F172C3411A;
        Thu, 31 Mar 2022 15:31:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1648740703;
        bh=zYyLgvI8NRECfb6qHlwlG/4LlDG2jFcDVsTM7uNkoDc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Jeff Layton <jlayton@kernel.org>
To:     ceph-devel@vger.kernel.org
Cc:     xiubli@redhat.com, idryomov@gmail.com, lhenriques@suse.de,
        linux-fsdevel@vger.kernel.org, linux-kernel@vger.kernel.org
Subject: [PATCH v12 12/54] ceph: implement -o test_dummy_encryption mount option
Date:   Thu, 31 Mar 2022 11:30:48 -0400
Message-Id: <20220331153130.41287-13-jlayton@kernel.org>
...
index 3ec01702e7be..2f6ea02ac22d 100644
--- a/fs/ceph/crypto.c
+++ b/fs/ceph/crypto.c
@@ -4,6 +4,7 @@
...
@@ -78,6 +79,7 @@ static struct fscrypt_operations ceph_fscrypt_ops = {
 	.key_prefix		= "ceph:",
...
@@ -86,3 +88,49 @@ void ceph_fscrypt_set_ops(struct super_block *sb)
 {
...
index 81904cde2609..c82a02ba6635 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
