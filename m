...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1DBA7584D88
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Jul 2022 10:41:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234573AbiG2Ili (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Jul 2022 04:41:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49318 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230053AbiG2Ilg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Jul 2022 04:41:36 -0400
Received: from xry111.site (xry111.site [89.208.246.23])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B165FC14
        for <linux-kernel@vger.kernel.org>; Fri, 29 Jul 2022 01:41:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=xry111.site;
        s=default; t=1659084095;
        bh=DEm0AiZvgESD0YKH9m6+qJUmd8ZlwNHimBfcIFiEhRo=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=YHcPCeFtcom6xD7njxjurdv3QUa+CGRWyFVVt9n/9CkeE1dYmOVMKtMfDBMJiPURK
         2N+WdPAKDJkh8H6ZCILDOI7bsgq6nB54g5sGRzp2OwX0ba4W6Uesbly1FvpiMsLSO8
         4o100kBdCnOou1zot+XK3n2/bpBSGDUVsY40MGHQ=
Received: from localhost.localdomain (xry111.site [IPv6:2001:470:683e::1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature ECDSA (P-384) server-digest SHA384)
        (Client did not present a certificate)
        (Authenticated sender: xry111@xry111.site)
        by xry111.site (Postfix) with ESMTPSA id 132DF669EC;
        Fri, 29 Jul 2022 04:41:33 -0400 (EDT)
Message-ID: <55e9722e962a3fe535f63206ac169538f902d0f2.camel@xry111.site>
Subject: [PATCH v4 3/4] LoongArch: Remove -fplt and -Wa,-mla-* from CFLAGS
...
Date:   Fri, 29 Jul 2022 16:41:32 +0800
