...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 543F85493F7
	for <lists+linux-kernel@lfdr.de>; Mon, 13 Jun 2022 18:32:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1382040AbiFMOMT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 13 Jun 2022 10:12:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51778 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1381747AbiFMOEq (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 13 Jun 2022 10:04:46 -0400
Received: from sin.source.kernel.org (sin.source.kernel.org [IPv6:2604:1380:40e1:4800::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 43E752C645;
        Mon, 13 Jun 2022 04:39:58 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by sin.source.kernel.org (Postfix) with ESMTPS id 73808CE1234;
        Mon, 13 Jun 2022 11:39:55 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id E599DC34114;
        Mon, 13 Jun 2022 11:39:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1655120393;
        bh=tFOMutZmf63j0trDdHMTZi6D4yQwGGQIukRiMScmD+o=;
        h=From:To:Cc:Subject:Date:From;
        b=v58ZREe52l0nEsw0ZqC2FGtXP7SGwXWsG+Th35W3bRvk+jqsWJhtYwP016MN0TRk3
         ebdtgah4hzJBykd1h3R2C3jXGNaAMxjX3yzocwRgDyT40EwbcZ7sS/SnXDX90DikIq
         +f8uaLGXmwQ8pOu4bIKrHxWLZOF++ZwCbkkjbzsE=
...
Subject: [PATCH 5.17 000/298] 5.17.15-rc1 review
Date:   Mon, 13 Jun 2022 12:08:14 +0200
Message-Id: <20220613094924.913340374@linuxfoundation.org>
X-Mailer: git-send-email 2.36.1
MIME-Version: 1.0
User-Agent: quilt/0.66
X-stable: review
X-Patchwork-Hint: ignore
X-KernelTest-Patch: http://kernel.org/pub/linux/kernel/v5.x/stable-review/patch-5.17.15-rc1.gz
X-KernelTest-Tree: git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable-rc.git
X-KernelTest-Branch: linux-5.17.y
X-KernelTest-Patches: git://git.kernel.org/pub/scm/linux/kernel/git/stable/stable-queue.git
X-KernelTest-Version: 5.17.15-rc1
...
There are 298 patches in this series, all will be posted as a response
...
The whole patch series can be found in one patch at:
	https://www.kernel.org/pub/linux/kernel/v5.x/stable-review/patch-5.17.15-rc1.gz
...
Diffstat:
 ...
 356 files changed, 2368 insertions(+), 1550 deletions(-)
