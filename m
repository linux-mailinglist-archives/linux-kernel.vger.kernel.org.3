...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 70CBC505BD0
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Apr 2022 17:48:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345751AbiDRPuc (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 18 Apr 2022 11:50:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60924 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345740AbiDRPtn (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 18 Apr 2022 11:49:43 -0400
Received: from angie.orcam.me.uk (angie.orcam.me.uk [IPv6:2001:4190:8020::34])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 8BFE95F82;
        Mon, 18 Apr 2022 08:27:34 -0700 (PDT)
Received: by angie.orcam.me.uk (Postfix, from userid 500)
        id EB01A92009E; Mon, 18 Apr 2022 17:27:33 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
        by angie.orcam.me.uk (Postfix) with ESMTP id E34CD92009C;
        Mon, 18 Apr 2022 16:27:33 +0100 (BST)
Date:   Mon, 18 Apr 2022 16:27:33 +0100 (BST)
From:   "Maciej W. Rozycki" <macro@orcam.me.uk>
To:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Jiri Slaby <jirislaby@kernel.org>
cc:     Andy Shevchenko <andy.shevchenko@gmail.com>,
        linux-serial@vger.kernel.org, linux-kernel@vger.kernel.org
Subject: [PATCH v5 5/5] serial: 8250: Add proper clock handling for OxSemi
 PCIe devices
In-Reply-To: <alpine.DEB.2.21.2204181506000.9383@angie.orcam.me.uk>
Message-ID: <alpine.DEB.2.21.2204181519450.9383@angie.orcam.me.uk>
...
- Use DIV_ROUND_CLOSEST in place of handcoded calculations; no change in 
  machine produced (for i386 and RISC-V targets).

- Fix a couple of grammatical mistakes in the change description.
...
+#include <linux/math.h>
 ...
 #include <linux/tty.h>
@@ -1044,6 +1045,208 @@ static int pci_oxsemi_tornado_init(struc
 	return number_uarts;
 }
...
@@ -2245,7 +2448,7 @@ static struct pci_serial_quirk pci_seria
...
@@ -2253,7 +2456,7 @@ static struct pci_serial_quirk pci_seria
 		.subvendor	= PCI_ANY_ID,
 		.subdevice	= PCI_ANY_ID,
 		.init		= pci_oxsemi_tornado_init,
-		.setup		= pci_default_setup,
...
@@ -2261,7 +2464,7 @@ static struct pci_serial_quirk pci_seria
...
@@ -4205,165 +4408,165 @@ static const struct pci_device_id serial
 	 */
