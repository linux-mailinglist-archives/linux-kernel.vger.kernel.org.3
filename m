...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4EB6B535E8D
	for <lists+linux-kernel@lfdr.de>; Fri, 27 May 2022 12:45:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1351067AbiE0KpZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 27 May 2022 06:45:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47932 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1351056AbiE0Kop (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 27 May 2022 06:44:45 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id A2968541B3
        for <linux-kernel@vger.kernel.org>; Fri, 27 May 2022 03:44:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1653648277;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=a+624a4dl77Q/Ww9CpMgWwgbUHYzlKaqeP7gvvgLyfs=;
        b=KEDpavkzoIQ9bn8ze4iGC2V4kW+BkgX6fspuHkoDslPR76j9WOq3SO2167pGRdHugssCil
        Lp616a2aduns0U9oJiXWkIowlsbyIuvgm8LmAsGkipV5NQkboOrDlPZ7D7Q1cmHJsDo7Iw
        Sr6XgfL2BDNLUEX/MVIpRP7Unp4q9jw=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-86-eK6Y5xHKN-uAA91SCLk9AA-1; Fri, 27 May 2022 06:44:34 -0400
X-MC-Unique: eK6Y5xHKN-uAA91SCLk9AA-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.rdu2.redhat.com [10.11.54.2])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 91CBA811E75;
        Fri, 27 May 2022 10:44:33 +0000 (UTC)
Received: from warthog.procyon.org.uk (unknown [10.33.36.8])
        by smtp.corp.redhat.com (Postfix) with ESMTP id C7A9F40EC002;
        Fri, 27 May 2022 10:44:31 +0000 (UTC)
Organization: Red Hat UK Ltd. Registered Address: Red Hat UK Ltd, Amberley
        Place, 107-111 Peascod Street, Windsor, Berkshire, SI4 1TE, United
        Kingdom.
        Registered in England and Wales under Company Registration No. 3798903
Subject: [PATCH v3 5/9] cifs: Change the I/O paths to use an iterator rather
 than a page list
...
Date:   Fri, 27 May 2022 11:44:31 +0100
Message-ID: <165364827111.3334034.934805882842932881.stgit@warthog.procyon.org.uk>
...
---
 ...
 13 files changed, 1092 insertions(+), 1074 deletions(-)
...
index 2eedffef6f53..865fb679cbee 100644
--- a/fs/cifs/cifssmb.c
+++ b/fs/cifs/cifssmb.c
@@ -24,6 +24,7 @@
...
+			cifs_undirty_folios(inode, fpos, cur_len);
 		...
 		rc = cifs_get_writable_file(CIFS_I(inode), FIND_WR_ANY,
 					    &wdata2->cfile);
@@ -2088,33 +2113,22 @@ cifs_writev_requeue(struct cifs_writedata *wdata)
...
@@ -2127,7 +2141,6 @@ cifs_writev_complete(struct work_struct *work)
...
@@ -2138,40 +2151,25 @@ cifs_writev_complete(struct work_struct *work)
...
@@ -2279,11 +2277,7 @@ cifs_async_writev(struct cifs_writedata *wdata,
...
index d511a78383c3..2f32a4dd18ab 100644
--- a/fs/cifs/file.c
+++ b/fs/cifs/file.c
...
@@ -2551,6 +2552,374 @@ static int cifs_writepages(struct address_space *mapping,
...
@@ -2608,6 +2977,7 @@ static int cifs_write_end(struct file *file, struct address_space *mapping,
 	struct inode *inode = mapping->host;
...
@@ -2618,14 +2988,14 @@ static int cifs_write_end(struct file *file, struct address_space *mapping,
...
+	if (!folio_test_uptodate(folio)) {
 		...
 		unsigned int xid;
@@ -2782,6 +3152,7 @@ int cifs_flush(struct file *file, fl_owner_t id)
 	return rc;
 }
...
+#if 0 // TODO: Remove for iov_iter support
 ...
 {
@@ -2822,17 +3193,15 @@ size_t get_numpages(const size_t wsize, const size_t len, size_t *cur_len)
...
@@ -2858,6 +3227,7 @@ cifs_uncached_writev_complete(struct work_struct *work)
...
@@ -2899,6 +3269,7 @@ wdata_fill_from_iovec(struct cifs_writedata *wdata, struct iov_iter *from,
 	*num_pages = i + 1;
 	return 0;
 }
+#endif
...
@@ -2970,23 +3341,58 @@ cifs_resend_wdata(struct cifs_writedata *wdata, struct list_head *wdata_list,
 	return rc;
 }
...
+	unsigned int xid, max_segs = INT_MAX;
 	...
 	if (cifs_sb->mnt_cifs_flags & CIFS_MOUNT_RWPIDFORWARD)
 		pid = open_file->pid;
@@ -2996,10 +3402,20 @@ cifs_write_from_iter(loff_t offset, size_t len, struct iov_iter *from,
...
@@ -3014,97 +3430,43 @@ cifs_write_from_iter(loff_t offset, size_t len, struct iov_iter *from,
 		if (rc)
 			break;
...
+
 		...
 		if (!rc) {
@@ -3119,16 +3481,14 @@ cifs_write_from_iter(loff_t offset, size_t len, struct iov_iter *from,
...
@@ -3227,8 +3587,6 @@ static ssize_t __cifs_writev(
...
-	size_t len = iov_iter_count(from);
 	...
 	/*
@@ -3262,23 +3620,26 @@ static ssize_t __cifs_writev(
 		ctx->iocb = iocb;
...
+	rc = cifs_write_from_iter(iocb->ki_pos, ctx->len, &ctx->iter,
 	...
 	/*
@@ -3418,14 +3779,12 @@ cifs_strict_writev(struct kiocb *iocb, struct iov_iter *from)
 	return written;
 }
...
@@ -3435,27 +3794,14 @@ cifs_readdata_direct_alloc(struct page **pages, work_func_t complete)
 	return rdata;
 }
...
@@ -3465,85 +3811,9 @@ cifs_readdata_release(struct kref *refcount)
 	if (rdata->cfile)
...
-
 ...
 static void
@@ -3555,9 +3825,11 @@ cifs_uncached_readv_complete(struct work_struct *work)
 	complete(&rdata->done);
...
@@ -3631,6 +3903,7 @@ cifs_uncached_copy_into_pages(struct TCP_Server_Info *server,
 {
...
@@ -3700,37 +3973,36 @@ static int cifs_resend_rdata(struct cifs_readdata *rdata,
 	} while (rc == -EAGAIN);
...
@@ -3750,79 +4022,38 @@ cifs_send_async_read(loff_t offset, size_t len, struct cifsFileInfo *open_file,
 		if (rc)
 			break;
...
+
 		...
 		if (!rc) {
@@ -3834,17 +4065,15 @@ cifs_send_async_read(loff_t offset, size_t len, struct cifsFileInfo *open_file,
...
@@ -3886,22 +4115,6 @@ collect_uncached_read_data(struct cifs_aio_ctx *ctx)
...
@@ -3918,7 +4131,7 @@ collect_uncached_read_data(struct cifs_aio_ctx *ctx)
 						&tmp_list, ctx);
...
@@ -3926,8 +4139,6 @@ collect_uncached_read_data(struct cifs_aio_ctx *ctx)
 				goto again;
...
@@ -3936,7 +4147,7 @@ collect_uncached_read_data(struct cifs_aio_ctx *ctx)
...
+		kref_put(&rdata->refcount, cifs_readdata_release);
 	...
 	if (!ctx->direct_io)
@@ -3996,7 +4207,10 @@ static ssize_t __cifs_readv(
 	if (!ctx)
 		return -ENOMEM;
...
+	ctx->cfile	= cifsFileInfo_get(cfile);
 	...
 	if (!is_sync_kiocb(iocb))
 		ctx->iocb = iocb;
@@ -4004,19 +4218,12 @@ static ssize_t __cifs_readv(
 	if (iter_is_iovec(to))
...
+	ctx->npages = rc;
 	...
 	/* grab a lock here due to read response handlers can access ctx */
 	mutex_lock(&ctx->aio_mutex);
@@ -4269,6 +4476,8 @@ int cifs_file_mmap(struct file *file, struct vm_area_struct *vma)
 	return rc;
 }
...
+
 ...
 {
@@ -4399,19 +4608,74 @@ cifs_readpages_copy_into_pages(struct TCP_Server_Info *server,
 {
...
@@ -4420,22 +4684,21 @@ static void cifs_readahead(struct readahead_control *ractl)
 	else
 		pid = current->tgid;
...
@@ -4444,22 +4707,24 @@ static void cifs_readahead(struct readahead_control *ractl)
 		if (caching) {
 			if (check_cache) {
...
@@ -4467,9 +4732,9 @@ static void cifs_readahead(struct readahead_control *ractl)
 					 */
 					caching = false;
 				}
-				unlock_page(page);
...
+				cache_nr_pages -= fsize;
 				if (cache_nr_pages == 0)
 					check_cache = true;
 				continue;
@@ -4494,8 +4759,9 @@ static void cifs_readahead(struct readahead_control *ractl)
 						   &rsize, credits);
 		if (rc)
 			break;
...
@@ -4508,33 +4774,31 @@ static void cifs_readahead(struct readahead_control *ractl)
 			break;
 		}
...
@@ -4545,18 +4809,15 @@ static void cifs_readahead(struct readahead_control *ractl)
...
-		last_batch_size = nr_pages;
 	...
 	free_xid(xid);
@@ -4598,10 +4859,6 @@ static int cifs_readpage_worker(struct file *file, struct page *page,
...
index 1b7ad0c09566..ed59f4437ad4 100644
--- a/fs/cifs/smb2pdu.c
+++ b/fs/cifs/smb2pdu.c
...
@@ -4462,7 +4456,7 @@ smb2_async_writev(struct cifs_writedata *wdata,
...
@@ -4479,26 +4473,18 @@ smb2_async_writev(struct cifs_writedata *wdata,
...
@@ -4517,19 +4503,13 @@ smb2_async_writev(struct cifs_writedata *wdata,
...
index 31ef64eb7fbb..6894fa9c062d 100644
