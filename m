...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2AB6A535D60
	for <lists+linux-kernel@lfdr.de>; Fri, 27 May 2022 11:28:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240840AbiE0JYy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 27 May 2022 05:24:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45180 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235388AbiE0JYt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 27 May 2022 05:24:49 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 23574B82F3;
        Fri, 27 May 2022 02:24:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1653643482; x=1685179482;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=o8q6YBjucjlz0u3zqAxDHfScjzFYPg5KEDsBJZSC2G8=;
  b=kbCOphz+t9VbFYtCm7UCKXGHrV+xx6Hr1XBDy3ilWppU4vNJp64DS/wv
   QkZ3ELeGO7j/e29W9ox9/Q3o/wbSuZYQr9TKSz/ShaZb6sYvd+XPyZRUn
   xVVq/8ryp1t993lfMUK3T7cojTy4UMxi+ZPbcjL5J1xTn9/dWS/OPDort
   4aYR7VWlVtt0/6fO0uZQXVtHvENNzcyDZyYMz56WOrF5ojr89vJ2lx2fP
   MLYfKxZyo2KoSG4g33s7gviacC2Ti8zxjWwWHg/KIl5/D7RqeWIUvQqeR
   oaDltJ94pbigaqKQpySOqh2yQgOdJIjS/wnyphBoy/bAOOKkt0RED02V+
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10359"; a="335081286"
X-IronPort-AV: E=Sophos;i="5.91,255,1647327600"; 
   d="yaml'?scan'208";a="335081286"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 May 2022 02:24:41 -0700
X-IronPort-AV: E=Sophos;i="5.91,255,1647327600"; 
   d="yaml'?scan'208";a="718809921"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 May 2022 02:24:35 -0700
...
Content-Disposition: attachment; filename="config-5.18.0-rc1-00003-g584b0180f0f4"
...
kbuild_queue_analysis'
	...
	export submit_id='62905a5f2f8844281ecf79db'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220527-10270-vih7br-5.yaml'
	export id='e4e519884736358f90fcde2c3944f9a4537ffe16'
	...
	export commit='584b0180f0f4d67d7145950fe68c625f06c88b10'
...
SATA_AHCI'
	...
	export enqueue_time='2022-05-27 12:58:07 +0800'
	export _id='62905a5f2f8844281ecf79dd'
	export _rt='/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='8fd126576b34ef9841a47f241554b51bff868465'
	export base_commit='42226c989789d8da4af1de0c31070c96726d990c'
	export branch='linus/master'
	export result_root='/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/vmlinuz-5.18.0-rc1-00003-g584b0180f0f4
branch=linus/master
job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220527-10270-vih7br-5.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/vmlinuz-5.18.0-rc1-00003-g584b0180f0f4'
	export dequeue_time='2022-05-27 12:59:04 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220527-10270-vih7br-5.cgz'
...
run_job()
{
	...
	run_test test='fio-1.14.1' option_a='Sequential Write' option_b='IO_uring' option_c='Yes' option_d='Yes' option_e='1MB' option_f='Default Test Directory' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='fio-1.14.1' option_a='Sequential Write' option_b='IO_uring' option_c='Yes' option_d='Yes' option_e='1MB' option_f='Default Test Directory' $LKP_SRC/stats/wrapper phoronix-test-suite
...
kconfig: x86_64-rhel-8.3
submit_id: 62902db22f88441f2026acf7
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220527-7968-6oopoj-0.yaml"
id: 265582376f85f22b71826ea73c163871960e37c7
...
enqueue_time: 2022-05-27 09:47:30.868410854 +08:00
_id: 62902db22f88441f2026acf7
_rt: "/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: 8fd126576b34ef9841a47f241554b51bff868465
base_commit: 42226c989789d8da4af1de0c31070c96726d990c
branch: linus/master
result_root: "/result/phoronix-test-suite/performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/vmlinuz-5.18.0-rc1-00003-g584b0180f0f4
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-IO_uring-Yes-Yes-1MB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x-20220527-7968-6oopoj-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=584b0180f0f4d67d7145950fe68c625f06c88b10
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/modules.cgz"
ucode_initrd: "/osimage/ucode/intel-ucode-20220216.cgz"
lkp_initrd: "/osimage/user/lkp/lkp-x86_64.cgz"
site: inn
:#! /cephfs/db/releases/20220518145428/lkp-src/include/site/inn:
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/584b0180f0f4d67d7145950fe68c625f06c88b10/vmlinuz-5.18.0-rc1-00003-g584b0180f0f4"
dequeue_time: 2022-05-27 10:40:42.355565053 +08:00
:#! /cephfs/db/releases/20220527092544/lkp-src/include/site/inn:
job_state: finished
loadavg: 16.08 8.35 3.41 1/892 15204
start_time: '1653617044'
end_time: '1653617337'
