...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D8F384FFD3B
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Apr 2022 19:57:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237545AbiDMSAC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Apr 2022 14:00:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54536 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237526AbiDMR7x (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Apr 2022 13:59:53 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6BFA66D872;
        Wed, 13 Apr 2022 10:57:19 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 086AFB826AA;
        Wed, 13 Apr 2022 17:57:17 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 70D7AC385A4;
        Wed, 13 Apr 2022 17:57:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1649872635;
        bh=sETSOiYl4Hr9p9Eoi0JXyR9nWyXpvrwv/SzEvPoOwt0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=V3WQ/E647VmhzfYCpRnU3ZXWjl77NmBoj/JftkB3Kr2ptJRbwCfE5wlRxDzDM8+HI
         wrvfSVd0XPSgGa6ucKnWAa9ycbeSIYqSaGC+R4UEu0lHjNAXV4ElFQSi9d3Mh5IE4j
         K7qaVWoLPkcWfpfnJAKvdfwBAPhYjGzyST3XZe7g=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.17.3
Date:   Wed, 13 Apr 2022 19:57:03 +0200
Message-Id: <164987262222559@kroah.com>
X-Mailer: git-send-email 2.35.2
In-Reply-To: <16498726229578@kroah.com>
References: <16498726229578@kroah.com>
MIME-Version: 1.0
...
index 06d852cad74f..02fbef1a0213 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 5aa45f13b16d..ba40b7fced5a 100644
...
index 466d18fc0c5d..5fa3870b8988 100644
...
index 6630d92e30ad..344e376b2ee9 100644
...
index b28b5c490860..90c017859ad4 100644
...
index 530a72e3eefe..2cefdd96d0cb 100644
...
index 8d64187478e4..0e11285035b6 100644
...
index 12a2b37e87f3..4bea1dfa41cd 100644
...
index 53256aca27c7..5fd2bbeab2d1 100644
...
index 296f9d5f7408..db2e02e673a7 100644
...
index feb874bde171..30620b942fa0 100644
...
index 70173389f6eb..52089538e9de 100644
...
index d853e8d0195a..27ead825c2bb 100644
...
index 908dbac20b48..55163469030d 100644
...
index ad9aac06427a..00f0f282e7a1 100644
...
index 0f4408f9dadd..ec4950cfe1ea 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
...
index d6f8ccc7bfe2..c3be6a541c8f 100644
--- a/fs/cifs/connect.c
+++ b/fs/cifs/connect.c
...
index 5e6788ab188f..1a9630dc5361 100644
--- a/fs/io_uring.c
+++ b/fs/io_uring.c
@@ -112,8 +112,7 @@
...
+		return ret;
 	...
 	if (force_nonblock) {
@@ -3749,14 +3718,6 @@ static int io_read(struct io_kiocb *req, unsigned int issue_flags)
 	return 0;
 }
...
index 60693ab6a032..938850303099 100644
--- a/fs/nfs/write.c
+++ b/fs/nfs/write.c
...
index 29982d60b68a..5be3faf88c1a 100644
...
index 015bfec0dbfd..4b46021eafa9 100644
...
index 69cf71d97312..0ee9ffceb976 100644
...
index 1620ae8535dc..1eec4925b8c6 100644
...
index 9b33ba9c3c42..e8a5549488dd 100644
...
index 1628cd90d9fc..f468bd911c3b 100644
--- a/mm/mempolicy.c
+++ b/mm/mempolicy.c
@@ -2736,6 +2736,7 @@ static int shared_policy_replace(struct shared_policy *sp, unsigned long start,
...
index a105b7317560..d984777c9b58 100644
...
index 405d48c3e63e..8f4c5698913d 100644
...
index 284befa90967..303c5e56e4df 100644
--- a/net/smc/af_smc.c
+++ b/net/smc/af_smc.c
...
index 11eab0f0333b..7aef2876beb3 100644
...
index e1b505606882..122d79c8f4b4 100644
...
index 246168310a75..610cc7920c8a 100644
