...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CEE0E584B0B
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Jul 2022 07:23:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234306AbiG2FXA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Jul 2022 01:23:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229528AbiG2FW6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Jul 2022 01:22:58 -0400
Received: from mail-pj1-x102c.google.com (mail-pj1-x102c.google.com [IPv6:2607:f8b0:4864:20::102c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3CD8B67CB9
        for <linux-kernel@vger.kernel.org>; Thu, 28 Jul 2022 22:22:56 -0700 (PDT)
Received: by mail-pj1-x102c.google.com with SMTP id t2-20020a17090a4e4200b001f21572f3a4so4281320pjl.0
        for <linux-kernel@vger.kernel.org>; Thu, 28 Jul 2022 22:22:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=ab+lr+au9UriMl9Fbf9rU9WLixGYuvF4NaEm7BgFrMM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ab+lr+au9UriMl9Fbf9rU9WLixGYuvF4NaEm7BgFrMM=;
        b=
X-Gm-Message-State: ACgBeo1XNxx+vXtyLm++BNEy7O+4ajS7Cx3iAYlVT+O94rNNeMXidGqD
        iLdxDW+2WWFXpvWpqdCiwVllkD3/CmO1/yPuwV8=
X-Google-Smtp-Source: AA6agR4MvXGZnWcnKiDV1TvKCfOwZmIZIZfPZZyMEDy/uP0fX7FDSP1OTcicfrDtM00O4nGfu4pvuj3lFeNp8VrjHxA=
X-Received: by 2002:a17:90a:1d4f:b0:1f3:10f2:155c with SMTP id
 u15-20020a17090a1d4f00b001f310f2155cmr2841934pju.25.1659072175476; Thu, 28
 Jul 2022 22:22:55 -0700 (PDT)
MIME-Version: 1.0
References: <20220606150305.1883410-1-hsinyi@chromium.org> <20220606150305.1883410-4-hsinyi@chromium.org>
 ...
 <c02886b7-c3c0-aafa-d360-4bf54b972311@squashfs.org.uk> <CAEVVKH_NemHoUuH6+Zf+gD5NgY_svGZ87G2XhHoK+1nEpL0sXA@mail.gmail.com>
In-Reply-To: <CAEVVKH_NemHoUuH6+Zf+gD5NgY_svGZ87G2XhHoK+1nEpL0sXA@mail.gmail.com>
From:   Xiongwei Song <sxwjean@gmail.com>
Date:   Fri, 29 Jul 2022 13:22:29 +0800
Message-ID: <CAEVVKH8Ci-nU4eFqaLRrXN69zQuTr6PLZt3dcDkgcB6NrYPuSA@mail.gmail.com>
...
>
> On Fri, Jun 10, 2022 at 3:42 PM Phillip Lougher <phillip@squashfs.org.uk>=
 wrote:
> >
...
> > > "Loop ${cnt}:"; time -v find /software/test[0-9][0-9] | xargs -P 24 -=
i
...
>
> Please see the test results below, which are from my colleague Xiaohong Q=
i:
>
> I test file size from  256KB to 5120KB with thread number
> 1,2,4,8,16,24,32(run ten times and get it=E2=80=99s average value). The r=
ead
...
> should be 4k. We didn't try other block sizes because we have identical s=
quashfs
...
> elapsed times of squashfs_readahead() when reading files before(this stat=
us
...
>
> By the way, I think my test results that I have ever sent out in v5 threa=
d
> is related with if the partitions remade:
> https://lore.kernel.org/lkml/20220606150305.1883410-1-hsinyi@chromium.org=
/T/#m5f3f8386eb8b72a1f63b60be37ea2cc6d03c5f84
>
> >
...
> > started happening after the latest update.  It turns out the new versio=
n
...
> > > Xiongwei
> > >
> > > On Mon, Jun 6, 2022 at 11:03 PM Hsin-Yi Wang <hsinyi@chromium.org> wr=
ote:
> > >>
...
> > >>
> > >> v4: https://lore.kernel.org/lkml/20220601103922.1338320-4-hsinyi@chr=
omium.org/
> > >> v3: https://lore.kernel.org/lkml/20220523065909.883444-4-hsinyi@chro=
mium.org/
> > >> v2: https://lore.kernel.org/lkml/20220517082650.2005840-4-hsinyi@chr=
omium.org/
> > >> v1: https://lore.kernel.org/lkml/20220516105100.1412740-3-hsinyi@chr=
omium.org/
> > >> ---
...
> > >> +               return;
> > >> +
> > >> +       pages =3D kmalloc_array(max_pages, sizeof(void *), GFP_KERNE=
L);
> > >> +       if (!pages)
> > >> +               return;
> > >> +
> > >> +       actor =3D squashfs_page_actor_init_special(pages, max_pages,=
 0);
> > >> +       if (!actor)
> > >> +               goto out;
> > >> +
...
> > >> +
> > >> +               nr_pages =3D __readahead_batch(ractl, pages, max_pag=
es);
> > >> +               if (!nr_pages)
> > >> +                       break;
> > >> +
...
index & ~block_mask);
> > >> +
> > >> +                       buffer =3D squashfs_get_datablock(inode->i_s=
b, block,
> > >> +                                                       bsize);
> > >> +                       if (buffer->error) {
...
> > >> +                       for (i =3D 0; i < nr_pages && expected > 0; =
i++,
> > >> +                                               expected -=3D PAGE_S=
IZE, offset++) {
> > >> +                               int avail =3D min_t(int, expected, P=
AGE_SIZE);
> > >> +
...
> > >> +                       int bytes;
> > >> +
> > >> +                       /* Last page may have trailing bytes not fil=
led */
> > >> +                       bytes =3D res % PAGE_SIZE;
> > >> +                       if (bytes) {
> > >> +                               void *pageaddr;
> > >> +
> > >> +                               pageaddr =3D kmap_atomic(pages[nr_pa=
ges - 1]);
> > >> +                               memset(pageaddr + bytes, 0, PAGE_SIZ=
E - bytes);
