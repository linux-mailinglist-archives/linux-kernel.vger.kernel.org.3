...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 92D8149C09D
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jan 2022 02:19:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235825AbiAZBTY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 25 Jan 2022 20:19:24 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46196 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235815AbiAZBTJ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 25 Jan 2022 20:19:09 -0500
Received: from mail-wm1-x334.google.com (mail-wm1-x334.google.com [IPv6:2a00:1450:4864:20::334])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 486D3C061744;
        Tue, 25 Jan 2022 17:19:08 -0800 (PST)
Received: by mail-wm1-x334.google.com with SMTP id j5-20020a05600c1c0500b0034d2e956aadso3133032wms.4;
        Tue, 25 Jan 2022 17:19:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=56eo4fWV4Z6U55NqfyfCVuJdAqOjU6TrXcGAOY0LOgs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=56eo4fWV4Z6U55NqfyfCVuJdAqOjU6TrXcGAOY0LOgs=;
        b=
X-Gm-Message-State: AOAM530EsEdhQTbyDNF2JrLtHrzLy3i7c/AFOObh30diks33Gm8NPfrf
        dcx+NjqnqKSWf2t+7KBD+spKMpgJBzFlsMkpPr7gLueB
X-Google-Smtp-Source: ABdhPJyyS1ylYCLLQ6ICsBtJWgy3jMu8B2WPgB2c33t7caoGyzvAzeDnXoI4fSypyeawf5I8IanwosZCBGSMcpwFKJY=
X-Received: by 2002:a05:600c:2245:: with SMTP id a5mr4846674wmm.8.1643159945169;
 Tue, 25 Jan 2022 17:19:05 -0800 (PST)
MIME-Version: 1.0
References: <20220125155348.141138434@linuxfoundation.org> <CAJq+SaC78nnBi5p6LYMWSs=-FSGMX5uom4MnE9i4C7F0FWuTcQ@mail.gmail.com>
In-Reply-To: <CAJq+SaC78nnBi5p6LYMWSs=-FSGMX5uom4MnE9i4C7F0FWuTcQ@mail.gmail.com>
From:   Allen <allen.lkml@gmail.com>
Date:   Tue, 25 Jan 2022 17:18:53 -0800
Message-ID: <CAOMdWSKXEO8VT_Ub1AZnPm_PF_UW+9LgviwtDhTJWdXGmMZzUA@mail.gmail.com>
Subject: Re: [PATCH 5.10 000/560] 5.10.94-rc2 review
To:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Cc:     shuah@kernel.org, patches@kernelci.org, pavel@denx.de,
...
>
> Alexander Stein <alexander.stein@mailbox.org>
>     dt-bindings: display: meson-dw-hdmi: add missing sound-name-prefix pr=
operty
>
...
>
> Eric Dumazet <edumazet@google.com>
>     af_unix: annote lockless accesses to unix_tot_inflight & gc_in_progre=
ss
>
...
>     Revert "net/mlx5: Add retry mechanism to the command entry index allo=
cation"
>
...
>
> Xin Yin <yinxin.x@bytedance.com>
>     ext4: fix fast commit may miss tracking range for FALLOC_FL_ZERO_RANG=
E
>
...
>
> Jan Kara <jack@suse.cz>
>     ext4: make sure to reset inode lockdep class when quota enabling fail=
s
>
...
>
> Pali Roh=C3=A1r <pali@kernel.org>
>     PCI: pci-bridge-emul: Make expansion ROM Base Address register read-o=
nly
>
> Hans de Goede <hdegoede@redhat.com>
>     PCI: pciehp: Use down_read/write_nested(reset_lock) to fix lockdep er=
rors
>
...
>     ubifs: Error path in ubifs_remount_rw() seems to wrongly free write b=
uffers
>
...
>     KVM: PPC: Book3S: Suppress failed alloc warning in H_COPY_TOFROM_GUES=
T
>
> Alexey Kardashevskiy <aik@ozlabs.ru>
...
>     x86/kbuild: Enable CONFIG_KALLSYMS_ALL=3Dy in the defconfigs
>
> John David Anglin <dave.anglin@bell.net>
...
>     ACPICA: Executer: Fix the REFCLASS_REFOF case in acpi_ex_opcode_1A_0T=
_1R()
>
> Rafael J. Wysocki <rafael.j.wysocki@intel.com>
...
>
> Randy Dunlap <rdunlap@infradead.org>
>     um: registers: Rename function names to avoid conflicts and build pro=
blems
>
...
>
> Hans de Goede <hdegoede@redhat.com>
>     ACPI: Change acpi_device_always_present() into acpi_device_override_s=
tatus()
>
> Hans de Goede <hdegoede@redhat.com>
...
>     tty: serial: imx: disable UCR4_OREN in .stop_rx() instead of .shutdow=
n()
>
...
>     powerpc/64s: Convert some cpu_setup() and cpu_restore() functions to =
C
>
> Niklas S=C3=B6derlund <niklas.soderlund+renesas@ragnatech.se>
...
>
> Marc Kleine-Budde <mkl@pengutronix.de>
>     can: softing: softing_startstop(): fix set but not used variable warn=
ing
>
> Christophe Jaillet <christophe.jaillet@wanadoo.fr>
...
>     debugfs: lockdown: Allow reading debugfs files that are not world rea=
dable
>
> Jos=C3=A9 Exp=C3=B3sito <jose.exposito89@gmail.com>
...
>
> Jos=C3=A9 Exp=C3=B3sito <jose.exposito89@gmail.com>
>     HID: hid-uclogic-params: Invalid parameter check in uclogic_params_in=
it
>
> Miaoqian Lin <linmq006@gmail.com>
...
>
> Miaoqian Lin <linmq006@gmail.com>
>     Bluetooth: hci_qca: Fix NULL vs IS_ERR_OR_NULL check in qca_serdev_pr=
obe
>
> Jiasheng Jiang <jiasheng@iscas.ac.cn>
...
>
> Marijn Suijten <marijn.suijten@somainline.org>
>     backlight: qcom-wled: Override default length with qcom,enabled-strin=
gs
>
> Marijn Suijten <marijn.suijten@somainline.org>
...
>
> Marijn Suijten <marijn.suijten@somainline.org>
>     backlight: qcom-wled: Pass number of elements to read to read_u32_arr=
ay
>
> Marijn Suijten <marijn.suijten@somainline.org>
...
>
> Nicolas Toromanoff <nicolas.toromanoff@foss.st.com>
>     crypto: stm32/cryp - fix xts and race condition in crypto_engine requ=
ests
>
> Nicolas Toromanoff <nicolas.toromanoff@foss.st.com>
...
>
> Herbert Xu <herbert@gondor.apana.org.au>
>     crypto: stm32 - Fix last sparse warning in stm32_cryp_check_ctr_count=
er
>
...
>     arm64: clear_page() shouldn't use DC ZVA when DCZID_EL0.DZP =3D=3D 1
>
...
>     sched/fair: Fix per-CPU kthread and wakee stacking for asym CPU capac=
ity
>
> Vincent Donnefort <vincent.donnefort@arm.com>
...
>     staging: rtl8192e: rtllib_module: fix error handle case in alloc_rtll=
ib()
>
> Yang Yingliang <yangyingliang@huawei.com>
...
>
> Alexander Stein <alexander.stein@mailbox.org>
>     arm64: dts: amlogic: meson-g12: Fix GPU operating point table node na=
me
>
...
>
> Benjamin Li <benl@squareup.com>
>     wcn36xx: ensure pairing of init_scan/finish_scan and start_scan/end_s=
can
>
> Maxime Ripard <maxime@cerno.tech>
...
>     shmem: fix a race between shmem_unused_huge_shrink and shmem_evict_in=
ode
>
...
>     PCI: Add function 1 DMA alias quirk for Marvell 88SE9125 SATA control=
ler
>
...
>     can: softing_cs: softingcs_probe(): fix memleak on registration failu=
re
>
...
>     mtd: rawnand: gpmi: Remove explicit default gpmi clock setting for i.=
MX6
>
...
>
> Jason Gerecke <killertofu@gmail.com>
>     HID: wacom: Reset expected and received contact counts at the same ti=
me
>
