...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0A54553D844
	for <lists+linux-kernel@lfdr.de>; Sat,  4 Jun 2022 21:31:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240119AbiFDTbR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 4 Jun 2022 15:31:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47032 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239950AbiFDTbE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 4 Jun 2022 15:31:04 -0400
Received: from mail-qk1-x72e.google.com (mail-qk1-x72e.google.com [IPv6:2607:f8b0:4864:20::72e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DB3C730547
        for <linux-kernel@vger.kernel.org>; Sat,  4 Jun 2022 12:30:56 -0700 (PDT)
Received: by mail-qk1-x72e.google.com with SMTP id c144so5882473qkg.11
        for <linux-kernel@vger.kernel.org>; Sat, 04 Jun 2022 12:30:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=UkPAS4liYvOTlrN2mCbMGX2bGNI539krqD2I4TdcYXI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Gm-Message-State: AOAM5310rTdfWQTxW2irOzQYHZJiziE8hKKsL8EJOZXtLmXweVEjJfQz
        6gVv436b1SzA0JuZJzkKFPpxGWH4LD/f
X-Google-Smtp-Source: ABdhPJxZJlSDtjelxbjtpFmx79UGsutzCbAbuhfuIrPWLOdYLNkk4Mi7PsBq5xxLkSNAYmK8rJOzvw==
X-Received: by 2002:a05:620a:4084:b0:6a0:4561:399f with SMTP id f4-20020a05620a408400b006a04561399fmr11049675qko.569.1654371054362;
        Sat, 04 Jun 2022 12:30:54 -0700 (PDT)
Received: from moria.home.lan (c-73-219-103-14.hsd1.vt.comcast.net. [73.219.103.14])
        by smtp.gmail.com with ESMTPSA id o17-20020ac84291000000b00304defdb1b3sm3537426qtl.85.2022.06.04.12.30.52
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 04 Jun 2022 12:30:53 -0700 (PDT)
From:   Kent Overstreet <kent.overstreet@gmail.com>
To:     linux-kernel@vger.kernel.org
Cc:     Kent Overstreet <kent.overstreet@gmail.com>, pmladek@suse.com,
        rostedt@goodmis.org
Subject: [PATCH v3 03/33] vsprintf: Convert to printbuf
Date:   Sat,  4 Jun 2022 15:30:12 -0400
Message-Id: <20220604193042.1674951-4-kent.overstreet@gmail.com>
...
---
 ...
 lib/vsprintf.c         | 1362 +++++++++++++++++++---------------------
 3 files changed, 640 insertions(+), 731 deletions(-)
...
index 40d26a07a1..b686dafb2f 100644
--- a/lib/vsprintf.c
+++ b/lib/vsprintf.c
@@ -44,6 +44,7 @@
 #ifdef CONFIG_BLOCK
...
@@ -512,67 +513,42 @@ char *number(char *buf, char *end, unsigned long long num,
 	if (i > precision)
 		precision = i;
...
@@ -582,25 +558,28 @@ char *special_hex_number(char *buf, char *end, unsigned long long num, int size)
 	spec.base = 16;
 	spec.precision = -1;
...
+	out->pos += spaces;
 ...
 /*
@@ -612,67 +591,55 @@ static void move_right(char *buf, char *end, unsigned len, unsigned spaces)
...
@@ -682,7 +649,7 @@ static char *error_string(char *buf, char *end, const char *s,
 	if (spec.precision == -1)
...
+	string_nocheck(out, s, spec);
 ...
 /*
@@ -701,14 +668,15 @@ static const char *check_pointer_msg(const void *ptr)
 	return NULL;
 }
...
@@ -716,18 +684,19 @@ static int check_pointer(char **buf, char *end, const void *ptr,
 }
...
+			   struct printf_spec spec)
 {
 	spec.base = 16;
 	spec.flags |= SMALL;
@@ -736,7 +705,7 @@ static char *pointer_string(char *buf, char *end,
 		spec.flags |= ZEROPAD;
 	}
...
@@ -825,8 +794,9 @@ int ptr_to_hashval(const void *ptr, unsigned long *hashval_out)
...
@@ -837,47 +807,49 @@ static char *ptr_to_id(char *buf, char *end, const void *ptr,
...
@@ -888,7 +860,7 @@ char *restricted_pointer(char *buf, char *end, const void *ptr,
...
+			return error_string(out, "pK-error", spec);
 		...
 		/*
@@ -914,12 +886,13 @@ char *restricted_pointer(char *buf, char *end, const void *ptr,
 		break;
 	}
...
@@ -936,9 +909,9 @@ char *dentry_name(char *buf, char *end, const struct dentry *d, struct printf_sp
...
@@ -951,7 +924,7 @@ char *dentry_name(char *buf, char *end, const struct dentry *d, struct printf_sp
 		}
 	}
 	s = array[--i];
...
+	for (n = 0; n != spec.precision; n++) {
 		...
 		if (!c) {
 			if (!i)
@@ -959,49 +932,47 @@ char *dentry_name(char *buf, char *end, const struct dentry *d, struct printf_sp
 			c = '/';
 			s = array[--i];
 		}
-		if (buf < end)
...
@@ -1024,9 +995,9 @@ char *symbol_string(char *buf, char *end, void *ptr,
 	else
...
@@ -1061,8 +1032,8 @@ static const struct printf_spec default_dec04_spec = {
 };
...
@@ -1101,69 +1072,67 @@ char *resource_string(char *buf, char *end, struct resource *res,
...
@@ -1171,10 +1140,10 @@ char *hex_string(char *buf, char *end, u8 *addr, struct printf_spec spec,
...
+		return;
 	...
 	switch (fmt[1]) {
 	case 'C':
@@ -1195,34 +1164,27 @@ char *hex_string(char *buf, char *end, u8 *addr, struct printf_spec spec,
...
@@ -1241,54 +1203,45 @@ char *bitmap_string(char *buf, char *end, unsigned long *bitmap,
 		bit = i % BITS_PER_LONG;
...
+			struct printf_spec spec, const char *fmt)
 {
 	...
 	char *p = mac_addr;
@@ -1296,8 +1249,8 @@ char *mac_address_string(char *buf, char *end, u8 *addr,
 	char separator;
 	bool reversed = false;
...
+		return;
 	...
 	switch (fmt[1]) {
 	case 'F':
@@ -1324,11 +1277,12 @@ char *mac_address_string(char *buf, char *end, u8 *addr,
 	}
 	*p = '\0';
...
@@ -1361,24 +1315,21 @@ char *ip4_string(char *p, const u8 *addr, const char *fmt)
...
@@ -1422,14 +1373,14 @@ char *ip6_compressed_string(char *p, const char *addr)
 	for (i = 0; i < range; i++) {
 		if (i == colonpos) {
 			if (needcolon || i == 0)
-				*p++ = ':';
...
@@ -1438,81 +1389,79 @@ char *ip6_compressed_string(char *p, const char *addr)
 		lo = word & 0xff;
 		if (hi) {
 			if (hi > 0x0f)
...
-	u8 off = 0;
 	...
 	fmt++;
 	while (isalpha(*++fmt)) {
@@ -1532,44 +1481,42 @@ char *ip6_addr_string_sa(char *buf, char *end, const struct sockaddr_in6 *sa,
 		}
 	}
...
@@ -1588,30 +1535,29 @@ char *ip4_addr_string_sa(char *buf, char *end, const struct sockaddr_in *sa,
 		}
 	}
...
+		return ip4_addr_string(out, ptr, spec, fmt);
 	case 'S': {
 		const union {
 			struct sockaddr		raw;
@@ -1621,21 +1567,21 @@ char *ip_addr_string(char *buf, char *end, const void *ptr,
...
+		    struct printf_spec spec, const char *fmt)
 {
 	bool found = true;
 	int count = 1;
@@ -1643,10 +1589,10 @@ char *escaped_string(char *buf, char *end, u8 *addr, struct printf_spec spec,
 	int len;
...
+		return;
 	...
 	do {
 		switch (fmt[count++]) {
@@ -1681,44 +1627,35 @@ char *escaped_string(char *buf, char *end, u8 *addr, struct printf_spec spec,
 		flags = ESCAPE_ANY_NP;
...
+		return;
 	...
 	switch (*(++fmt)) {
 	case 'L':
@@ -1734,60 +1671,58 @@ char *uuid_string(char *buf, char *end, const u8 *addr,
...
+		return;
 	...
 	val = orig & ~BIT(31);
@@ -1796,31 +1731,29 @@ char *fourcc_string(char *buf, char *end, const u32 *fourcc,
...
+		return;
 	...
 	switch (fmt[1]) {
 	case 'd':
@@ -1834,55 +1767,44 @@ char *address_val(char *buf, char *end, const void *addr,
 		break;
 	}
...
+		return;
 	...
 	switch (fmt[count]) {
 	case 'd':
@@ -1910,21 +1832,16 @@ char *rtc_str(char *buf, char *end, const struct rtc_time *tm,
 	} while (found);
...
+		struct printf_spec spec, const char *fmt)
 {
 	...
 	struct tm tm;
@@ -1942,47 +1859,48 @@ char *time64_str(char *buf, char *end, const time64_t time,
...
@@ -1991,20 +1909,15 @@ char *format_flags(char *buf, char *end, unsigned long flags,
 		if ((flags & mask) != mask)
 			continue;
...
@@ -2029,20 +1942,18 @@ static const struct page_flags_fields pff[] = {
 };
...
@@ -2053,41 +1964,31 @@ char *format_page_flags(char *buf, char *end, unsigned long flags)
 			continue;
...
+		return format_page_flags(out, *(unsigned long *)flags_ptr);
 	case 'v':
 		...
 		names = vmaflag_names;
@@ -2097,15 +1998,15 @@ char *flags_string(char *buf, char *end, void *flags_ptr,
 		names = gfpflag_names;
 		break;
 	default:
...
@@ -2114,25 +2015,23 @@ char *fwnode_full_name_string(struct fwnode_handle *fwnode, char *buf,
...
@@ -2140,13 +2039,13 @@ char *device_node_string(char *buf, char *end, struct device_node *dn,
...
+		return;
 	...
 	fmt++;
@@ -2155,32 +2054,28 @@ char *device_node_string(char *buf, char *end, struct device_node *dn,
...
@@ -2188,21 +2083,21 @@ char *device_node_string(char *buf, char *end, struct device_node *dn,
...
@@ -2212,37 +2107,38 @@ char *device_node_string(char *buf, char *end, struct device_node *dn,
 		}
 	}
...
@@ -2398,8 +2294,8 @@ early_param("no_hash_pointers", no_hash_pointers_enable);
...
+	     void *ptr, struct printf_spec spec)
 {
 	switch (*fmt) {
 	case 'S':
@@ -2407,24 +2303,24 @@ char *pointer(const char *fmt, char *buf, char *end, void *ptr,
...
+		return mac_address_string(out, ptr, spec, fmt);
 	case 'I':			/* Formatted IP supported
 					 * 4:	1.2.3.4
 					 * 6:	0001:0203:...:0708
@@ -2434,57 +2330,57 @@ char *pointer(const char *fmt, char *buf, char *end, void *ptr,
 					 * 4:	001.002.003.004
 					 * 6:   000102...0f
 					 */
...
@@ -2706,52 +2602,27 @@ set_precision(struct printf_spec *spec, int prec)
 }
...
@@ -2760,16 +2631,9 @@ int vsnprintf(char *buf, size_t size, const char *fmt, va_list args)
 		fmt += read;
...
@@ -2779,44 +2643,29 @@ int vsnprintf(char *buf, size_t size, const char *fmt, va_list args)
...
@@ -2869,21 +2718,70 @@ int vsnprintf(char *buf, size_t size, const char *fmt, va_list args)
...
@@ -3021,53 +2919,46 @@ EXPORT_SYMBOL(sprintf);
...
@@ -3098,16 +2989,12 @@ int vbin_printf(u32 *bin_buf, size_t size, const char *fmt, va_list args)
 		case FORMAT_TYPE_STR: {
...
@@ -3127,12 +3014,7 @@ int vbin_printf(u32 *bin_buf, size_t size, const char *fmt, va_list args)
 					save_arg(void *);
 					break;
 				}
-				str = pointer(fmt, str, end, va_arg(args, void *),
...
+				pointer(out, fmt, va_arg(args, void *), spec);
 			...
 			while (isalnum(*fmt))
@@ -3170,15 +3052,15 @@ int vbin_printf(u32 *bin_buf, size_t size, const char *fmt, va_list args)
 	}
...
- * @size: The size of the buffer, including the trailing null space
  ...
  *
@@ -3188,26 +3070,14 @@ EXPORT_SYMBOL_GPL(vbin_printf);
  *
...
+		return;
 ...
 #define get_arg(type)							\
 ({									\
@@ -3224,12 +3094,6 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
 	value;								\
 })
...
@@ -3237,16 +3101,9 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
 		fmt += read;
...
@@ -3256,38 +3113,24 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
...
+			int len;
 			...
 			switch (*fmt) {
 			case 'S':
@@ -3303,17 +3146,12 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
 					break;
 				}
...
+				pointer(out, fmt, get_arg(void *), spec);
 			...
 			while (isalnum(*fmt))
 				fmt++;
@@ -3321,9 +3159,7 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
 		}
...
+			__prt_char(out, '%');
 		...
 		case FORMAT_TYPE_INVALID:
@@ -3366,23 +3202,87 @@ int bstr_printf(char *buf, size_t size, const char *fmt, const u32 *bin_buf)
 				num = get_arg(int);
 			}
