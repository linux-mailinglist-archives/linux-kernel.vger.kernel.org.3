...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 29E31487CCF
	for <lists+linux-kernel@lfdr.de>; Fri,  7 Jan 2022 20:08:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229716AbiAGTIe (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 7 Jan 2022 14:08:34 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51752 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229474AbiAGTId (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 7 Jan 2022 14:08:33 -0500
Received: from mail-oi1-x22b.google.com (mail-oi1-x22b.google.com [IPv6:2607:f8b0:4864:20::22b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E8CDDC06173E
        for <linux-kernel@vger.kernel.org>; Fri,  7 Jan 2022 11:08:32 -0800 (PST)
Received: by mail-oi1-x22b.google.com with SMTP id be32so9436941oib.11
        for <linux-kernel@vger.kernel.org>; Fri, 07 Jan 2022 11:08:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:content-transfer-encoding:in-reply-to;
        bh=NuTTjb13NMBF2ZTEH87dlhF6sSlusEQjIbe6ZPmAAao=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         ...
         :in-reply-to;
        bh=NuTTjb13NMBF2ZTEH87dlhF6sSlusEQjIbe6ZPmAAao=;
        b=
X-Gm-Message-State: AOAM533y3E7kMbJ5hD8YHwC3p/3mLdyzc/Izq9xi5w9u6Iit4LANHpy5
        KDfukv1bB2rvw3Sr6iSjQc8emg==
X-Google-Smtp-Source: ABdhPJxkMZOQhu9U87vq0Ni7D6xrjVOaSGKd4TFAwBhcxMEkQ2QfLVvWcTytkz+2UmDMvlPhYLzcpQ==
X-Received: by 2002:aca:e041:: with SMTP id x62mr11189522oig.84.1641582511011;
        Fri, 07 Jan 2022 11:08:31 -0800 (PST)
Received: from ripper (104-57-184-186.lightspeed.austtx.sbcglobal.net. [104.57.184.186])
        by smtp.gmail.com with ESMTPSA id q14sm974150ood.28.2022.01.07.11.08.29
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 07 Jan 2022 11:08:30 -0800 (PST)
Date:   Fri, 7 Jan 2022 11:09:16 -0800
...
Subject: Re: [PATCH V3 1/1] mmc:sdhci-bayhub:fix Qualcomm sd host 7180 SD
 card compatibility issue
Message-ID: <YdiP3N95q3JgxitR@ripper>
References: <20220107103400.578-1-chevron.li@bayhubtech.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=windows-1252
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20220107103400.578-1-chevron.li@bayhubtech.com>
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

On Fri 07 Jan 02:34 PST 2022, Chevron Li wrote:
...
I think the forking of sdhci-msm into a new driver, in order to support
the redriver, is a showstopper for this. Further more, lumping that and
all your modifications into a single change makes it impossible to
review your changes to the file.

You also missed the relevant MMC/SDHCI maintainers and mailing lists
when sending this, so please use ./scripts/get_maintainer.pl to get the
appropriate recipients list.
