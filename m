...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EF23A580423
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Jul 2022 20:40:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235846AbiGYSkI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 25 Jul 2022 14:40:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51336 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231523AbiGYSkF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 25 Jul 2022 14:40:05 -0400
Received: from mail-qt1-x832.google.com (mail-qt1-x832.google.com [IPv6:2607:f8b0:4864:20::832])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 481441275A;
        Mon, 25 Jul 2022 11:40:02 -0700 (PDT)
Received: by mail-qt1-x832.google.com with SMTP id e5so8930860qts.1;
        Mon, 25 Jul 2022 11:40:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=H4UOO6JJV2646TQxmFMmikcFcxl0awwf2bpisModNzo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=H4UOO6JJV2646TQxmFMmikcFcxl0awwf2bpisModNzo=;
        b=
X-Gm-Message-State: AJIora8FOrWJIwPF/AjG5dgooA2xaZdpDpL6mS+VDlSduNDC2fyXhxze
        zhbrJoyiNAF/ELbGqthl6MB3MyzIAmY=
X-Google-Smtp-Source: AGRyM1vgcwUF2Hnm+/4wcqj89ZnlSbCMX8AGIhd+ldDg3eWlPkE3vwhrIWfPkoHlDwv0wB70kvvu/A==
X-Received: by 2002:ac8:5fcf:0:b0:31f:3ac:487d with SMTP id k15-20020ac85fcf000000b0031f03ac487dmr11701986qta.148.1658774400307;
        Mon, 25 Jul 2022 11:40:00 -0700 (PDT)
Received: from localhost ([2601:4c1:c100:1230:3948:b82b:8f44:3d84])
        by smtp.gmail.com with ESMTPSA id n13-20020a05620a294d00b006b61b34d2c2sm9924111qkp.42.2022.07.25.11.39.59
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 25 Jul 2022 11:39:59 -0700 (PDT)
Date:   Mon, 25 Jul 2022 11:39:58 -0700
...
Message-ID: <Yt7jfiSlNOeeookP@yury-laptop>
References: <YtR8tPTkL/L1kFkY@yury-laptop>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <YtR8tPTkL/L1kFkY@yury-laptop>
...
I'm sorry addressing this to you directly, but I think the bug is
quite important because it prevents me from rebooting VM on x86.

I didn't investigate on it and I think I'll have no chance to look
closer at next week or two.

The bug is completely unclear to me. I'm not even sure that VFS
is not a random victim.

The attached config is basically a default debian config with all
necessary drivers built into the kernel image. Probably this is a
root of the problem?..
...
On Sun, Jul 17, 2022 at 02:18:46PM -0700, Yury Norov wrote:
> Hi Alexander, all,
> 
