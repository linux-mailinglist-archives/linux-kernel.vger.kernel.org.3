...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A2C4D514C7A
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Apr 2022 16:13:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376867AbiD2OQy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Apr 2022 10:16:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47592 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376911AbiD2OQc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Apr 2022 10:16:32 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 6F66427CE7
        for <linux-kernel@vger.kernel.org>; Fri, 29 Apr 2022 07:13:12 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 409F6150C;
        Fri, 29 Apr 2022 07:13:12 -0700 (PDT)
Received: from localhost.localdomain (FVFF7649Q05P.cambridge.arm.com [10.1.32.23])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id D6CE63F774;
...
Subject: [PATCH v8 6/7] sched/fair: Remove task_util from effective utilization in feec()
Date:   Fri, 29 Apr 2022 15:11:47 +0100
Message-Id: <20220429141148.181816-7-vincent.donnefort@arm.com>
...
index 684e89a0f694..83a6eb99d938 100644
--- a/kernel/sched/fair.c
+++ b/kernel/sched/fair.c
@@ -6719,61 +6719,97 @@ static unsigned long cpu_util_next(int cpu, struct task_struct *p, int dst_cpu)
 }
...
@@ -6782,12 +6818,30 @@ compute_energy(struct task_struct *p, int dst_cpu, struct cpumask *cpus,
...
+	return em_cpu_energy(pd->em_pd, max_util, busy_time, eenv->cpu_cap);
 ...
 /*
@@ -6833,11 +6887,12 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
 {
...
@@ -6860,22 +6915,36 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
 	if (!task_util_est(p))
 		goto unlock;
...
@@ -6888,15 +6957,17 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
...
@@ -6919,8 +6992,8 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
