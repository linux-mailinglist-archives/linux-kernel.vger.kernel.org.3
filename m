...
index 6370e96ebfac..3eea68f3a526 100644
...
index 94994a939277..6ef48eb3a77d 100644
...
index f310a94e0489..b81579afa361 100644
...
index 6ca2216e4058..da2862d59681 100644
...
index 4cff0a6b1098..1c9a1b94f6e2 100644
...
index be5bd2f637d8..b51a2367dbaa 100644
--- a/drivers/net/vrf.c
+++ b/drivers/net/vrf.c
...
index c68217b7dace..a8d97773d3d9 100644
...
index 6bd3fdb925cd..d2980e30f341 100644
...
index cabcbb47f0ac..f0aff79f544c 100644
...
index 9a4260927ce3..48832f7f2fc3 100644
...
index 5ec31d2d32e0..7fa27b403756 100644
...
index 4bb850370bb6..1c8070023161 100644
...
index 730386c130e0..f6328ae9b2da 100644
--- a/fs/nfsd/nfsctl.c
+++ b/fs/nfsd/nfsctl.c
...
@@ -1565,13 +1567,12 @@ static int __init init_nfsd(void)
 	nfsd4_exit_pnfs();
 out_free_slabs:
 	nfsd4_free_slabs();
...
index 46dc16e01fe2..ea18e4a2a691 100644
--- a/fs/ntfs/inode.c
+++ b/fs/ntfs/inode.c
@@ -30,10 +30,10 @@
 /**
...
index efe078fe5d4a..3fdbbc7a9848 100644
...
index 85bedeb9ca9f..ad46ed41e883 100644
...
index 3f2480e4c5af..3954ef0cc770 100644
--- a/mm/backing-dev.c
+++ b/mm/backing-dev.c
@@ -1013,6 +1013,13 @@ void bdi_unregister(struct backing_dev_info *bdi)
 	wb_shutdown(&bdi->wb);
...
index 02e55041a881..8b6140e67e7f 100644
...
index fdbd56ee1300..a0016f05c4f8 100644
--- a/net/ipv4/udp.c
+++ b/net/ipv4/udp.c
...
index 99b06a16b808..0f61dad7256b 100644
--- a/net/nfc/netlink.c
+++ b/net/nfc/netlink.c
...
index 0b03777d0111..9e31f4bd4382 100644
...
@@ -1946,7 +1959,7 @@ static int snd_pcm_oss_set_fragment1(struct snd_pcm_substream *substream, unsign
...
index 94fc17b28e9c..9514db7c2a86 100644
--- a/sound/pci/hda/patch_realtek.c
+++ b/sound/pci/hda/patch_realtek.c
@@ -9620,6 +9620,27 @@ static void alc671_fixup_hp_headset_mic2(struct hda_codec *codec,
 	}
 }
...
@@ -10106,6 +10129,19 @@ static const struct hda_fixup alc662_fixups[] = {
 			{}
 		},
 	},
+	[ALC897_FIXUP_LENOVO_HEADSET_MIC] = {
...
@@ -10150,6 +10186,10 @@ static const struct snd_pci_quirk alc662_fixup_tbl[] = {
...
index 8c6e1ea67f21..1ea26bb8c579 100644
...
index 054e09ab4a9e..2a261b909dd8 100644
...
index 88145e8cde1a..6eaeaf2da36e 100644
...
index c75c9b03d6e7..7578af250454 100644
...
index 4e19a1c00ddd..6986086035d6 100755
...
index 4144984ebee5..d0c56d5a5c52 100644
