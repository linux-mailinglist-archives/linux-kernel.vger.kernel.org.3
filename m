...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1E2F54E87DA
	for <lists+linux-kernel@lfdr.de>; Sun, 27 Mar 2022 15:23:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234643AbiC0NYN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 27 Mar 2022 09:24:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39212 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232851AbiC0NYM (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 27 Mar 2022 09:24:12 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4CB336B58
        for <linux-kernel@vger.kernel.org>; Sun, 27 Mar 2022 06:22:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1648387349; x=1679923349;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=kRe3YwZIoVkIGgk3mNJNIh0CHvHgBNYqnM4exvCZQuI=;
  b=duvzV84LZSR6aVZvYuT0TQT9y1WY87aFDKnFoBRgzMCFD9jTNdbOEmqo
   oLCaHiCVU4gfTgmjkUM3fJFef8T317g+5DvRaKi4X6bYFaIa5pOT47jBe
   SbymJCYOAJUkLidFP5FZINE92ZXNc6Rjr0Zpji8e3L5yGKxpILcxBs0Ep
   JKj4Jm/K9riiOGakS+OAUxQxJH4Jiuy4giuoj0sshBfACvTN1CLYfX6YA
   HZt7O17h/EA3lZUCCS2X9rT8hwHdR4w39MiowVVqBI5uZw+5lhbe/gUiE
   mOKhAizKMt17LoE3BJzVGROKA9H3+XRDLZ7w5GqRwiwFrUq6+j9+kdCky
   A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10298"; a="258818754"
X-IronPort-AV: E=Sophos;i="5.90,215,1643702400"; 
   d="yaml'?scan'208";a="258818754"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Mar 2022 06:22:28 -0700
X-IronPort-AV: E=Sophos;i="5.90,215,1643702400"; 
   d="yaml'?scan'208";a="562391450"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Mar 2022 06:22:21 -0700
Date:   Sun, 27 Mar 2022 21:22:18 +0800
...
Cc:     Rodrigo Vivi <rodrigo.vivi@intel.com>,
        ...
        Jason Ekstrand <jason@jlesktrand.net>,
        ...
        fan.zhao@intel.com
Subject: [drm/i915]  58586680ff:
 phoronix-test-suite.darktable.Boat.OpenCL.seconds 139.5% regression
Message-ID: <20220327132218.GC32190@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.11.0-rc5-01307-g58586680ffad"
...
commit'
	...
	export submit_id='623e87cfa31d8ba07549fa1c'
	export job_file='/lkp/jobs/scheduled/lkp-cfl-d1/phoronix-test-suite-performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec-debian-x86_64-phoronix-58586680ffadc37636120d9f59955aa5f7-20220326-41077-7ic4hx-5.yaml'
	export id='953c29b2a1ffe936264be6a510210b389cb95d91'
	...
	export commit='58586680ffadc37636120d9f59955aa5f7a32b7d'
...
DRM_I915'
	...
	export enqueue_time='2022-03-26 11:26:08 +0800'
	export _id='623e87e8a31d8ba07549fa1e'
	export _rt='/result/phoronix-test-suite/performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec/lkp-cfl-d1/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d'
	export user='lkp'
	...
	export result_root='/result/phoronix-test-suite/performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec/lkp-cfl-d1/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec/lkp-cfl-d1/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/vmlinuz-5.11.0-rc5-01307-g58586680ffad
branch=linus/master
job=/lkp/jobs/scheduled/lkp-cfl-d1/phoronix-test-suite-performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec-debian-x86_64-phoronix-58586680ffadc37636120d9f59955aa5f7-20220326-41077-7ic4hx-5.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=58586680ffadc37636120d9f59955aa5f7a32b7d
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/vmlinuz-5.11.0-rc5-01307-g58586680ffad'
	export dequeue_time='2022-03-26 11:40:29 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-cfl-d1/phoronix-test-suite-performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec-debian-x86_64-phoronix-58586680ffadc37636120d9f59955aa5f7-20220326-41077-7ic4hx-5.cgz'
...
run_job()
{
	...
	run_test test='darktable-1.0.5' option_a='Boat' option_b='OpenCL' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='darktable-1.0.5' option_a='Boat' option_b='OpenCL' $LKP_SRC/stats/wrapper phoronix-test-suite
...
kconfig: x86_64-rhel-8.3
submit_id: 623e5beda31d8b8db34ad886
job_file: "/lkp/jobs/scheduled/lkp-cfl-d1/phoronix-test-suite-performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec-debian-x86_64-phoronix-58586680ffadc37636120d9f59955aa5f7-20220326-36275-3lxjhq-0.yaml"
id: 3b386df2695116ab8e56788c45009e0c6c7731f0
...
enqueue_time: 2022-03-26 08:18:54.054331138 +08:00
_id: 623e5beda31d8b8db34ad886
_rt: "/result/phoronix-test-suite/performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec/lkp-cfl-d1/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
...
branch: linus/master
result_root: "/result/phoronix-test-suite/performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec/lkp-cfl-d1/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/1"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/vmlinuz-5.11.0-rc5-01307-g58586680ffad
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-cfl-d1/phoronix-test-suite-performance-Boat-OpenCL-darktable-1.0.5-ucode=0xec-debian-x86_64-phoronix-58586680ffadc37636120d9f59955aa5f7-20220326-36275-3lxjhq-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=58586680ffadc37636120d9f59955aa5f7a32b7d
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.11.0-rc5-01307-g58586680ffad
:#! /cephfs/db/releases/20220323100239/lkp-src/include/site/inn:
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/58586680ffadc37636120d9f59955aa5f7a32b7d/vmlinuz-5.11.0-rc5-01307-g58586680ffad"
dequeue_time: 2022-03-26 08:58:49.274278363 +08:00
:#! /cephfs/db/releases/20220325203930/lkp-src/include/site/inn:
job_state: finished
loadavg: 0.36 0.25 0.11 1/305 4759
start_time: '1648256312'
end_time: '1648256479'
