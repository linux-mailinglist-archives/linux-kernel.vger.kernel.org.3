...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D00DC5611E8
	for <lists+linux-kernel@lfdr.de>; Thu, 30 Jun 2022 07:48:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232271AbiF3Fsm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 30 Jun 2022 01:48:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35766 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231366AbiF3Fsk (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 30 Jun 2022 01:48:40 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5B2341EC76
        for <linux-kernel@vger.kernel.org>; Wed, 29 Jun 2022 22:48:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1656568115; x=1688104115;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=sSkiDi1nERJUEgLlQAXqL+BJR4imVYXGiTMnpCzo0Hs=;
  b=N3EhKUPGwC+K508fPbSpxNLg70atcQZNGaz3JpuYbjSLjYXP2eJuX2br
   eYtT5K/c4DQ0SnVej5L4dGbC/x1MAkkmBUghtXcAnUTFUlYTPThs3lB64
   kpOzQGVmQFDkTIrIfrrIo6E3KHDfl4u86fojBF8CmlF4EUScueRejXdUR
   SpPGcqZA8U30JZenHM+rKUSNWPea3PrMBIoMyRAwc7g65KJbE5eoCohkr
   VJA6HSAnR23n6eGkmDS4SdSmR/xtZ7yauaDPTOV6IM4rnt3nTvQd8knbV
   BZQh19K+7utygEeb6xU72UkMZ6Ayo5aC1xN/3u0mLNXcDgxBCVEbcYa2C
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10393"; a="343939121"
X-IronPort-AV: E=Sophos;i="5.92,233,1650956400"; 
   d="scan'208";a="343939121"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jun 2022 22:48:34 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,233,1650956400"; 
   d="scan'208";a="541153545"
Received: from lkp-server01.sh.intel.com (HELO 68b931ab7ac1) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 29 Jun 2022 22:48:31 -0700
Received: from kbuild by 68b931ab7ac1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1o6n2U-000CIU-JO;
        Thu, 30 Jun 2022 05:48:30 +0000
Date:   Thu, 30 Jun 2022 13:48:06 +0800
From:   kernel test robot <lkp@intel.com>
To:     Alexander Lobakin <alexandr.lobakin@intel.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [alobakin:xdp_hints 20/52]
 drivers/net/ethernet/freescale/dpaa/dpaa_eth.c:2553:17: error: implicit
 declaration of function 'xdp_set_data_meta_invalid'
Message-ID: <202206301327.zZkOjYBP-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="7AsdoAieDLgFwgWj"
...
All errors (new ones prefixed by >>):
   ...
   drivers/net/ethernet/freescale/dpaa/dpaa_eth.c: In function 'dpaa_run_xdp':
>> drivers/net/ethernet/freescale/dpaa/dpaa_eth.c:2553:17: error: implicit declaration of function 'xdp_set_data_meta_invalid' [-Werror=implicit-function-declaration]
    2553 |                 xdp_set_data_meta_invalid(&xdp);
         |                 ^~~~~~~~~~~~~~~~~~~~~~~~~
>> drivers/net/ethernet/freescale/dpaa/dpaa_eth.c:2567:33: error: implicit declaration of function 'xdp_data_meta_unsupported' [-Werror=implicit-function-declaration]
