...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC81F47A0D9
	for <lists+linux-kernel@lfdr.de>; Sun, 19 Dec 2021 15:19:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235891AbhLSOTB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 Dec 2021 09:19:01 -0500
Received: from mga06.intel.com ([134.134.136.31]:11595 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231478AbhLSOTA (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 Dec 2021 09:19:00 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1639923539; x=1671459539;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=eJJouTUldzP0MXS/TFnVeqhkmYphbKmNX1CX92iXrLI=;
  b=J6UbsGNjASbWI23b71KdEmZSwRB5HfDEnJiRRMVnQjNDKyV1I7WxdDzt
   00bvkQdmUnPreZ5W2hWi1jKhpNs3QsGpFGSy6pSfF9GxHvr0T8yYHLF0J
   tdRmA+To6AyoI+gER1aI0R42vGCr5YX0PkC9Mh/yOJYBiwltkWkHo3nLh
   80zjTF90y5fvqELsWpqxpwokZDmYY3bmnkaPWgEPCMVnVpitutCWtFWk8
   8POe5Y6isZx7deKSo2gxTmK9OrQA9gS+ky4I6t+dluOTXM7xfUlAfFmEg
   GZTQOgd7NFNlWnQweVKDgv4yNiN+csf+ej5mMev5osQihAWzp1+gSekDU
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10202"; a="300797051"
X-IronPort-AV: E=Sophos;i="5.88,218,1635231600"; 
   d="yaml'?scan'208";a="300797051"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Dec 2021 06:18:58 -0800
X-IronPort-AV: E=Sophos;i="5.88,218,1635231600"; 
   d="yaml'?scan'208";a="663368630"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Dec 2021 06:18:54 -0800
Date:   Sun, 19 Dec 2021 22:18:52 +0800
...
Subject: [block]  cb2ac2912a:
 fxmark.ssd_f2fs_dbench_client_4_bufferedio.works/sec -66.0% regression
Message-ID: <20211219141852.GH14057@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Q59ABw34pTSIagmi"
...
Content-Disposition: attachment; filename="config-5.16.0-rc1-00039-gcb2ac2912a9c"
...
queue_at_least_once'
	...
	export submit_id='61bd8f906e0ace7f73dce82d'
	export job_file='/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-cb2ac2912a9ca7d3d2629-20211218-32627-x9f4aj-3.yaml'
	export id='d33eab6ce9405aaaa69d72ecccd3971771aec2bb'
...
{"PCI"=>"y"}
{"F2FS_FS"=>"m"}'
	export commit='cb2ac2912a9ca7d3d26291c511939a41361d2d83'
	export netconsole_port=6688
	export ucode='0x9c02000e'
	export bisect_dmesg=true
	export enqueue_time='2021-12-18 15:36:48 +0800'
	export _id='61bd8f906e0ace7f73dce82d'
	export _rt='/result/fxmark/performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='c190467238b2da86101450b383befda405f9e884'
	export base_commit='2585cf9dfaaddf00b069673f27bb3f8530e2039c'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/fxmark/performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/3'
	export scheduler_version='/lkp/lkp/.src-20211216-154940'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/fxmark/performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/vmlinuz-5.16.0-rc1-00039-gcb2ac2912a9c
branch=linus/master
job=/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-cb2ac2912a9ca7d3d2629-20211218-32627-x9f4aj-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=cb2ac2912a9ca7d3d26291c511939a41361d2d83
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20210707.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/fxmark_20210701.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/fxmark-x86_64-0ce9491-1_20211209.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20211212.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-a763d5a5abd6-1_20211212.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20210222.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.16.0-rc5'
	export repeat_to=6
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/vmlinuz-5.16.0-rc1-00039-gcb2ac2912a9c'
	export dequeue_time='2021-12-18 15:37:58 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-cb2ac2912a9ca7d3d2629-20211218-32627-x9f4aj-3.cgz'
...
run_job()
{
	...
	run_test test='dbench_client' fstype='f2fs' directio='bufferedio' $LKP_SRC/tests/wrapper fxmark
}
...
extract_stats()
{
	...
	env test='dbench_client' fstype='f2fs' directio='bufferedio' $LKP_SRC/stats/wrapper fxmark
...
kconfig: x86_64-rhel-8.3
submit_id: 61bd7ed09e570b0f71efb1ab
job_file: "/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-cb2ac2912a9ca7d3d2629-20211218-69489-lhg14y-1.yaml"
id: '0683beadfc1c4e3b614c6a99f1897b77a6937632'
...
ucode: '0x9c02000e'
bisect_dmesg: true
enqueue_time: 2021-12-18 14:25:20.303165607 +08:00
_id: 61bd82a89e570b0f71efb1ac
_rt: "/result/fxmark/performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: c190467238b2da86101450b383befda405f9e884
base_commit: 2585cf9dfaaddf00b069673f27bb3f8530e2039c
branch: linux-devel/devel-hourly-20211217-044658
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/fxmark/performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/0"
scheduler_version: "/lkp/lkp/.src-20211216-154940"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/vmlinuz-5.16.0-rc1-00039-gcb2ac2912a9c
- branch=linux-devel/devel-hourly-20211217-044658
- job=/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-bufferedio-1SSD-f2fs-ssd-dbench_client-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-cb2ac2912a9ca7d3d2629-20211218-69489-lhg14y-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=cb2ac2912a9ca7d3d26291c511939a41361d2d83
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/modules.cgz"
...
site: inn
:#! /cephfs/db/releases/20211216212633/lkp-src/include/site/inn:
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
:#! runtime status:
last_kernel: 5.16.0-rc5-07930-g627d28b70200
repeat_to: 3
schedule_notify_address:
:#! user overrides:
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/cb2ac2912a9ca7d3d26291c511939a41361d2d83/vmlinuz-5.16.0-rc1-00039-gcb2ac2912a9c"
dequeue_time: 2021-12-18 14:50:25.905258689 +08:00
job_state: finished
loadavg: 1.93 10.41 8.35 1/137 10803
start_time: '1639810364'
end_time: '1639810936'
version: "/lkp/lkp/.src-20211216-155029:7e363507:dac9f3cb8"
