...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D32AC53EEB7
	for <lists+linux-kernel@lfdr.de>; Mon,  6 Jun 2022 21:37:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232584AbiFFThZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 6 Jun 2022 15:37:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43470 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232515AbiFFThR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 6 Jun 2022 15:37:17 -0400
Received: from mail-lj1-x230.google.com (mail-lj1-x230.google.com [IPv6:2a00:1450:4864:20::230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8DEDF13E30
        for <linux-kernel@vger.kernel.org>; Mon,  6 Jun 2022 12:37:10 -0700 (PDT)
Received: by mail-lj1-x230.google.com with SMTP id y15so11448051ljc.0
        for <linux-kernel@vger.kernel.org>; Mon, 06 Jun 2022 12:37:10 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=YNftCWsQPjdVEtDfBkKkc1kJq46k95l2yEfGpvnU3KE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YNftCWsQPjdVEtDfBkKkc1kJq46k95l2yEfGpvnU3KE=;
        b=
X-Gm-Message-State: AOAM533fHYltURJ61spkdoSWEbzaOtqB+MfyrLrVknL43HqXPncCO9If
        Q6dDeP9AOhYUzcM/e4PZKf6I8CzT7Fo=
X-Google-Smtp-Source: ABdhPJy8luz2h9UuVgxKXkGfOg0Tr4yXKppPWm0FQSiY2cE0jSJ2dfST8CcPzrQXedaRpF+qp0HU3w==
X-Received: by 2002:a2e:81cc:0:b0:255:5d1c:196a with SMTP id s12-20020a2e81cc000000b002555d1c196amr18207855ljg.1.1654544228679;
        Mon, 06 Jun 2022 12:37:08 -0700 (PDT)
Received: from localhost.localdomain ([94.103.229.27])
        by smtp.gmail.com with ESMTPSA id u7-20020ac25bc7000000b00478fe690207sm1281745lfn.286.2022.06.06.12.37.07
...
Subject: [PATCH v3 3/4] staging: r8188eu: add error handling of rtw_read32
Date:   Mon,  6 Jun 2022 22:37:06 +0300
Message-Id: <3b43d4dfedfdf9b8e73436c317ed62117178c724.1654543286.git.paskripkin@gmail.com>
...
index 01e5669f2421..88a4953d31d8 100644
...
+			    reg32 | RCR_CBSSID_DATA | RCR_CBSSID_BCN);
 		...
 		if (check_fwstate(mlmepriv, WIFI_STATION_STATE)) {
 			retry_limit = 48;
@@ -6839,10 +6844,14 @@ static u8 chk_ap_is_alive(struct sta_info *psta)
