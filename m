...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 85CA74A3343
	for <lists+linux-kernel@lfdr.de>; Sun, 30 Jan 2022 03:32:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353761AbiA3C2h (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 29 Jan 2022 21:28:37 -0500
Received: from mga12.intel.com ([192.55.52.136]:41734 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1346564AbiA3C2f (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 29 Jan 2022 21:28:35 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1643509715; x=1675045715;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=yUmLX9RuSEsBvVbCCmMGx6h6vjzJ/7rhXnCvmc0keGk=;
  b=lDdaUrlyVBeaM7UNlckS2hFjWeQcrmbLRlbTYD5ALwOWA30K58AJfbsY
   eFzYrjuiI7eke9Smsn17WcBZbRDpP0UiHFHHT0eqDzDgNWP+Btxt0IrBl
   oYqzZ8gEjwAMy/YGhWqJE2joFFLFgAjagvIlvd0iCw4u6ubY4E8lPfWS+
   GsgmGBhuGUn97dY7/wpFZuV5eyQO8Yspv/Qd5fa0clvLeAJIt/ItbqMu0
   hmTfl5hs04vbJCexrHPuSLNytLgplAFuRIjKZjRgcrDcmvGr1amo4wrHm
   dsiR4RfjW/nSq0BVMDHM4vMMB1Yr8BAO0KdOu1ea/Nus8arIdZaGPubVP
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10242"; a="227286207"
X-IronPort-AV: E=Sophos;i="5.88,327,1635231600"; 
   d="yaml'?scan'208";a="227286207"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jan 2022 18:28:34 -0800
X-IronPort-AV: E=Sophos;i="5.88,327,1635231600"; 
   d="yaml'?scan'208";a="478671722"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jan 2022 18:28:29 -0800
...
Content-Disposition: attachment; filename="config-5.16.0-rc3-00004-g1ac2a4104968"
...
commit'
	...
	export submit_id='61f4b073f58688023c777698'
	export job_file='/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-1ac2a4104968e0a60b4b3572216a92a-20220129-572-yqqyh0-3.yaml'
	export id='89a78c0c02904c6adfe7e94aa975e3480449e603'
...
{"PCI"=>"y"}
{"F2FS_FS"=>"m"}'
	export commit='1ac2a4104968e0a60b4b3572216a92aab5c1b025'
	export netconsole_port=6688
	export ucode='0x9c02000e'
	export bisect_dmesg=true
	export enqueue_time='2022-01-29 11:11:47 +0800'
	export _id='61f4b073f58688023c777698'
	export _rt='/result/fxmark/performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='3b89024a3724bbcb444f677badbc9d9e85d84f87'
	export base_commit='e783362eb54cd99b2cac8b3a9aeac942e6f6ac07'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/fxmark/performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/3'
	export scheduler_version='/lkp/lkp/.src-20220125-183421'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/fxmark/performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/vmlinuz-5.16.0-rc3-00004-g1ac2a4104968
branch=linus/master
job=/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-1ac2a4104968e0a60b4b3572216a92a-20220129-572-yqqyh0-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=1ac2a4104968e0a60b4b3572216a92aab5c1b025
max_uptime=2100
...
rw'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/vmlinuz-5.16.0-rc3-00004-g1ac2a4104968'
	export dequeue_time='2022-01-29 11:13:11 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-1ac2a4104968e0a60b4b3572216a92a-20220129-572-yqqyh0-3.cgz'
...
run_job()
{
	...
	run_test test='MRPL' fstype='btrfs' directio='directio' $LKP_SRC/tests/wrapper fxmark
}
...
extract_stats()
{
	...
	env test='MRPL' fstype='btrfs' directio='directio' $LKP_SRC/stats/wrapper fxmark
...
kconfig: x86_64-rhel-8.3
submit_id: 61f4929cf586886857b6d657
job_file: "/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-1ac2a4104968e0a60b4b3572216a92a-20220129-26711-8fwpha-2.yaml"
id: f8ec84837d576c07775bf4d4f68454e60aa39ba6
...
ucode: '0x9c02000e'
bisect_dmesg: true
enqueue_time: 2022-01-29 09:04:28.409970820 +08:00
_id: 61f499fbf586886857b6d659
_rt: "/result/fxmark/performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: 3b89024a3724bbcb444f677badbc9d9e85d84f87
base_commit: e783362eb54cd99b2cac8b3a9aeac942e6f6ac07
branch: linux-devel/devel-hourly-20220125-150204
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/fxmark/performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e/lkp-snr-a1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/vmlinuz-5.16.0-rc3-00004-g1ac2a4104968
- branch=linux-devel/devel-hourly-20220125-150204
- job=/lkp/jobs/scheduled/lkp-snr-a1/fxmark-performance-directio-1SSD-btrfs-ssd-MRPL-ucode=0x9c02000e-debian-10.4-x86_64-20200603.cgz-1ac2a4104968e0a60b4b3572216a92a-20220129-26711-8fwpha-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=1ac2a4104968e0a60b4b3572216a92aab5c1b025
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/modules.cgz"
...
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/1ac2a4104968e0a60b4b3572216a92aab5c1b025/vmlinuz-5.16.0-rc3-00004-g1ac2a4104968"
dequeue_time: 2022-01-29 09:58:52.839512829 +08:00
:#! /cephfs/db/releases/20220128213436/lkp-src/include/site/inn:
job_state: finished
loadavg: 3.52 13.30 7.96 1/324 10700
start_time: '1643421677'
end_time: '1643422039'
