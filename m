...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DCE6E5AD4AC
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Sep 2022 16:23:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231159AbiIEOWl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Sep 2022 10:22:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43650 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230293AbiIEOWg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Sep 2022 10:22:36 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 41E5A3CBC9;
        Mon,  5 Sep 2022 07:22:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662387752; x=1693923752;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=iQH961f7rfMB6KOXitrmrbeHaTu3WYartfajliw9ink=;
  b=CyhgSqwVJnsAUeyCIiMyUTvd7BzTVJmiCm//Buv/7LuglLjCtEiRlO6Z
   ewKLwSe9bCRXARM5vJNCb6tWNbCthvxquIgTrtwscCqnNJtjrILk1JQub
   /g1yWZb+zCQSwfBHzfJiegnKJsE3pd03V+GgxygKj7ET0ZFwfsSkSoSRl
   /VuwAH2EvacuDRQh3n+Id946xvSr8mDYaiDyDP+Izz2trMXGofbEaD6Jg
   N0FeB5w6Jdnta9Xc+yFrx8/7vxYE6SXEH/cLsJyleWk2dzm0eJhjKvzkV
   7Jt54T04DCEtAADLUrTIm6X7zBZDOxnmBrbsmW1RRAAQxyas/6g3Z0QXz
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10461"; a="297187066"
X-IronPort-AV: E=Sophos;i="5.93,291,1654585200"; 
   d="scan'208";a="297187066"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Sep 2022 07:22:31 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,291,1654585200"; 
   d="scan'208";a="682081212"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by fmsmga004.fm.intel.com with ESMTP; 05 Sep 2022 07:22:28 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oVCzb-0004EP-2a;
        Mon, 05 Sep 2022 14:22:27 +0000
Date:   Mon, 5 Sep 2022 22:22:20 +0800
...
Subject: Re: [PATCH 2/2] kbuild: move -Wundef from KBUILD_CFLAGS to
 KBUILD_CPPFLAGS
Message-ID: <202209052214.zRGP8DUv-lkp@intel.com>
References: <20220905083619.672091-2-masahiroy@kernel.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="N5doipdfx+AXKgLK"
...
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   14  
^1da177e4c3f41 Linus Torvalds     2005-04-16   15  /*
^1da177e4c3f41 Linus Torvalds     2005-04-16   16   * vma_vm_mm - get mm pointer from vma pointer (vma->vm_mm)
^1da177e4c3f41 Linus Torvalds     2005-04-16   17   */
^1da177e4c3f41 Linus Torvalds     2005-04-16   18  	.macro	vma_vm_mm, rd, rn
^1da177e4c3f41 Linus Torvalds     2005-04-16   19  	ldr	\rd, [\rn, #VMA_VM_MM]
^1da177e4c3f41 Linus Torvalds     2005-04-16   20  	.endm
^1da177e4c3f41 Linus Torvalds     2005-04-16   21  
^1da177e4c3f41 Linus Torvalds     2005-04-16   22  /*
^1da177e4c3f41 Linus Torvalds     2005-04-16   23   * vma_vm_flags - get vma->vm_flags
^1da177e4c3f41 Linus Torvalds     2005-04-16   24   */
^1da177e4c3f41 Linus Torvalds     2005-04-16   25  	.macro	vma_vm_flags, rd, rn
^1da177e4c3f41 Linus Torvalds     2005-04-16   26  	ldr	\rd, [\rn, #VMA_VM_FLAGS]
^1da177e4c3f41 Linus Torvalds     2005-04-16   27  	.endm
^1da177e4c3f41 Linus Torvalds     2005-04-16   28  
^1da177e4c3f41 Linus Torvalds     2005-04-16   29  /*
^1da177e4c3f41 Linus Torvalds     2005-04-16   30   * act_mm - get current->active_mm
^1da177e4c3f41 Linus Torvalds     2005-04-16   31   */
^1da177e4c3f41 Linus Torvalds     2005-04-16   32  	.macro	act_mm, rd
50596b7559bf22 Ard Biesheuvel     2021-09-18   33  	get_current \rd
ffa47aa678cfaa Arnd Bergmann      2017-06-30   34  	.if (TSK_ACTIVE_MM > IMM12_MASK)
ffa47aa678cfaa Arnd Bergmann      2017-06-30   35  	add	\rd, \rd, #TSK_ACTIVE_MM & ~IMM12_MASK
ffa47aa678cfaa Arnd Bergmann      2017-06-30   36  	.endif
ffa47aa678cfaa Arnd Bergmann      2017-06-30   37  	ldr	\rd, [\rd, #TSK_ACTIVE_MM & IMM12_MASK]
^1da177e4c3f41 Linus Torvalds     2005-04-16   38  	.endm
^1da177e4c3f41 Linus Torvalds     2005-04-16   39  
^1da177e4c3f41 Linus Torvalds     2005-04-16   40  /*
^1da177e4c3f41 Linus Torvalds     2005-04-16   41   * mmid - get context id from mm pointer (mm->context.id)
9520a5bece13b7 Ben Dooks          2013-02-11   42   * note, this field is 64bit, so in big-endian the two words are swapped too.
^1da177e4c3f41 Linus Torvalds     2005-04-16   43   */
^1da177e4c3f41 Linus Torvalds     2005-04-16   44  	.macro	mmid, rd, rn
9520a5bece13b7 Ben Dooks          2013-02-11   45  #ifdef __ARMEB__
9520a5bece13b7 Ben Dooks          2013-02-11   46  	ldr	\rd, [\rn, #MM_CONTEXT_ID + 4 ]
9520a5bece13b7 Ben Dooks          2013-02-11   47  #else
^1da177e4c3f41 Linus Torvalds     2005-04-16   48  	ldr	\rd, [\rn, #MM_CONTEXT_ID]
9520a5bece13b7 Ben Dooks          2013-02-11   49  #endif
^1da177e4c3f41 Linus Torvalds     2005-04-16   50  	.endm
^1da177e4c3f41 Linus Torvalds     2005-04-16   51  
^1da177e4c3f41 Linus Torvalds     2005-04-16   52  /*
^1da177e4c3f41 Linus Torvalds     2005-04-16   53   * mask_asid - mask the ASID from the context ID
^1da177e4c3f41 Linus Torvalds     2005-04-16   54   */
^1da177e4c3f41 Linus Torvalds     2005-04-16   55  	.macro	asid, rd, rn
^1da177e4c3f41 Linus Torvalds     2005-04-16   56  	and	\rd, \rn, #255
^1da177e4c3f41 Linus Torvalds     2005-04-16   57  	.endm
22b1908610dd7f Russell King       2006-06-29   58  
22b1908610dd7f Russell King       2006-06-29   59  	.macro	crval, clear, mmuset, ucset
22b1908610dd7f Russell King       2006-06-29   60  #ifdef CONFIG_MMU
22b1908610dd7f Russell King       2006-06-29   61  	.word	\clear
22b1908610dd7f Russell King       2006-06-29   62  	.word	\mmuset
22b1908610dd7f Russell King       2006-06-29   63  #else
22b1908610dd7f Russell King       2006-06-29   64  	.word	\clear
22b1908610dd7f Russell King       2006-06-29   65  	.word	\ucset
22b1908610dd7f Russell King       2006-06-29   66  #endif
22b1908610dd7f Russell King       2006-06-29   67  	.endm
bbe888864ec324 Catalin Marinas    2007-05-08   68  
bbe888864ec324 Catalin Marinas    2007-05-08   69  /*
f91e2c3bd42723 Catalin Marinas    2010-12-07   70   * dcache_line_size - get the minimum D-cache line size from the CTR register
f91e2c3bd42723 Catalin Marinas    2010-12-07   71   * on ARMv7.
bbe888864ec324 Catalin Marinas    2007-05-08   72   */
bbe888864ec324 Catalin Marinas    2007-05-08   73  	.macro	dcache_line_size, reg, tmp
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   74  #ifdef CONFIG_CPU_V7M
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   75  	movw	\tmp, #:lower16:BASEADDR_V7M_SCB + V7M_SCB_CTR
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   76  	movt	\tmp, #:upper16:BASEADDR_V7M_SCB + V7M_SCB_CTR
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   77  	ldr     \tmp, [\tmp]
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   78  #else
f91e2c3bd42723 Catalin Marinas    2010-12-07   79  	mrc	p15, 0, \tmp, c0, c0, 1		@ read ctr
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   80  #endif
f91e2c3bd42723 Catalin Marinas    2010-12-07   81  	lsr	\tmp, \tmp, #16
f91e2c3bd42723 Catalin Marinas    2010-12-07   82  	and	\tmp, \tmp, #0xf		@ cache line size encoding
f91e2c3bd42723 Catalin Marinas    2010-12-07   83  	mov	\reg, #4			@ bytes per word
bbe888864ec324 Catalin Marinas    2007-05-08   84  	mov	\reg, \reg, lsl \tmp		@ actual cache line size
bbe888864ec324 Catalin Marinas    2007-05-08   85  	.endm
da0916539d20f2 Russell King       2008-09-06   86  
da30e0ac0f9a52 Catalin Marinas    2010-12-07   87  /*
da30e0ac0f9a52 Catalin Marinas    2010-12-07   88   * icache_line_size - get the minimum I-cache line size from the CTR register
da30e0ac0f9a52 Catalin Marinas    2010-12-07   89   * on ARMv7.
da30e0ac0f9a52 Catalin Marinas    2010-12-07   90   */
da30e0ac0f9a52 Catalin Marinas    2010-12-07   91  	.macro	icache_line_size, reg, tmp
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   92  #ifdef CONFIG_CPU_V7M
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   93  	movw	\tmp, #:lower16:BASEADDR_V7M_SCB + V7M_SCB_CTR
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   94  	movt	\tmp, #:upper16:BASEADDR_V7M_SCB + V7M_SCB_CTR
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   95  	ldr     \tmp, [\tmp]
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   96  #else
da30e0ac0f9a52 Catalin Marinas    2010-12-07   97  	mrc	p15, 0, \tmp, c0, c0, 1		@ read ctr
9a1af5f2206bd3 Vladimir Murzin    2016-08-30   98  #endif
da30e0ac0f9a52 Catalin Marinas    2010-12-07   99  	and	\tmp, \tmp, #0xf		@ cache line size encoding
da30e0ac0f9a52 Catalin Marinas    2010-12-07  100  	mov	\reg, #4			@ bytes per word
da30e0ac0f9a52 Catalin Marinas    2010-12-07  101  	mov	\reg, \reg, lsl \tmp		@ actual cache line size
da30e0ac0f9a52 Catalin Marinas    2010-12-07  102  	.endm
da0916539d20f2 Russell King       2008-09-06  103  
da0916539d20f2 Russell King       2008-09-06  104  /*
da0916539d20f2 Russell King       2008-09-06  105   * Sanity check the PTE configuration for the code below - which makes
25985edcedea63 Lucas De Marchi    2011-03-30  106   * certain assumptions about how these bits are laid out.
da0916539d20f2 Russell King       2008-09-06  107   */
8b79d5f217d7fc Catalin Marinas    2009-07-24  108  #ifdef CONFIG_MMU
da0916539d20f2 Russell King       2008-09-06 @109  #if L_PTE_SHARED != PTE_EXT_SHARED
da0916539d20f2 Russell King       2008-09-06  110  #error PTE shared bit mismatch
da0916539d20f2 Russell King       2008-09-06  111  #endif
1b6ba46b7efa31 Catalin Marinas    2011-11-22  112  #if !defined (CONFIG_ARM_LPAE) && \
1b6ba46b7efa31 Catalin Marinas    2011-11-22 @113  	(L_PTE_XN+L_PTE_USER+L_PTE_RDONLY+L_PTE_DIRTY+L_PTE_YOUNG+\
b007ea798f5c56 Kirill A. Shutemov 2015-02-10 @114  	 L_PTE_PRESENT) > L_PTE_SHARED
da0916539d20f2 Russell King       2008-09-06  115  #error Invalid Linux PTE bit settings
da0916539d20f2 Russell King       2008-09-06  116  #endif
8b79d5f217d7fc Catalin Marinas    2009-07-24  117  #endif	/* CONFIG_MMU */
da0916539d20f2 Russell King       2008-09-06  118  
