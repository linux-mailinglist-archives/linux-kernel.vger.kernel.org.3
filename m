...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4A41457297F
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Jul 2022 00:50:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233768AbiGLWux (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jul 2022 18:50:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56542 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229994AbiGLWuu (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jul 2022 18:50:50 -0400
Received: from mout.kundenserver.de (mout.kundenserver.de [212.227.126.135])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C2BE2CA6EB
        for <linux-kernel@vger.kernel.org>; Tue, 12 Jul 2022 15:50:46 -0700 (PDT)
Received: from [192.168.1.107] ([37.4.249.155]) by mrelayeu.kundenserver.de
 (mreue012 [212.227.15.167]) with ESMTPSA (Nemesis) id
 1N01hu-1nOEGn1b9S-00x326; Wed, 13 Jul 2022 00:50:23 +0200
Message-ID: <17fece62-7674-6366-7a34-98c0cf799eab@i2se.com>
Date:   Wed, 13 Jul 2022 00:50:21 +0200
MIME-Version: 1.0
...
Cc:     gregkh@linuxfoundation.org, f.fainelli@gmail.com,
        ...
        gascoar@gmail.com, ojaswin98@gmail.com, len.baker@gmx.com,
        jakobkoschel@gmail.com, linux-staging@lists.linux.dev,
...
X-Provags-ID: V03:K1:bkK2VKBPzcUGBJaNiHmfM8RUf3rtpuGXmB7FZDqDGhTV/4ByjsU
 Qd9UtnUjDLF2gAEih1fvMlfRQMRXrYMaWHl5F8fQdEM/Cv7+VeIWTv5TcGsSfvBfBjhrHdV
 l3ylvbRFdFWA1zBe5mg/dbPL0MYpZHsXi+T50fX+r7qOadcN8+2g26JQa0jgCt3Ff/+vuY7
 zM1aE4+SsfkXT8OvSk5wA==
X-UI-Out-Filterresults: notjunk:1;V03:K0:x1z/7vX3NwA=:lB2F2zxeRUhzy1gdjzhrio
 
...
Am 12.07.22 um 20:19 schrieb Joel Slebodnick:
> Remove all instances of enum vchiq_status from vc04_services and replace
> them with regular linux error values.
thanks. How did you test this changes according to the new TESTING document?
>
...
i had used -EAGAIN in this case.
...
Is there a chance to make this a separate patch?
>
...
Please also make the TODO changes a separate patch.
