...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 046035049F3
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Apr 2022 01:03:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235325AbiDQXFa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 17 Apr 2022 19:05:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52902 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235309AbiDQXF1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 17 Apr 2022 19:05:27 -0400
Received: from angie.orcam.me.uk (angie.orcam.me.uk [IPv6:2001:4190:8020::34])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id BCE3918B1F;
        Sun, 17 Apr 2022 16:02:48 -0700 (PDT)
Received: by angie.orcam.me.uk (Postfix, from userid 500)
        id 16E3E9200B3; Mon, 18 Apr 2022 01:02:48 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
        by angie.orcam.me.uk (Postfix) with ESMTP id 1023B92009C;
        Mon, 18 Apr 2022 00:02:48 +0100 (BST)
Date:   Mon, 18 Apr 2022 00:02:47 +0100 (BST)
From:   "Maciej W. Rozycki" <macro@orcam.me.uk>
To:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Jiri Slaby <jirislaby@kernel.org>
cc:     Andy Shevchenko <andy.shevchenko@gmail.com>,
        linux-serial@vger.kernel.org, linux-kernel@vger.kernel.org
Subject: [PATCH v4 5/5] serial: 8250: Add proper clock handling for OxSemi
 PCIe devices
In-Reply-To: <alpine.DEB.2.21.2204161848030.9383@angie.orcam.me.uk>
Message-ID: <alpine.DEB.2.21.2204162141010.9383@angie.orcam.me.uk>
...
- Make ICR access helpers static rather than static inline and factor out
  the change to export them to 3/5.

- Factor out MCR sticky bit handling in console restore to 4/5; add 
  `Fixes' annotation there.
...
@@ -1044,6 +1044,208 @@ static int pci_oxsemi_tornado_init(struc
 	return number_uarts;
 }
...
@@ -2245,7 +2447,7 @@ static struct pci_serial_quirk pci_seria
...
@@ -2253,7 +2455,7 @@ static struct pci_serial_quirk pci_seria
 		.subvendor	= PCI_ANY_ID,
 		.subdevice	= PCI_ANY_ID,
 		.init		= pci_oxsemi_tornado_init,
-		.setup		= pci_default_setup,
...
@@ -2261,7 +2463,7 @@ static struct pci_serial_quirk pci_seria
...
@@ -2578,7 +2780,7 @@ enum pci_board_num_t {
 	pbn_b0_2_1843200,
 	pbn_b0_4_1843200,
...
+	pbn_b0_1_15625000,
 	...
 	pbn_b0_bt_1_115200,
 	pbn_b0_bt_2_115200,
@@ -2657,10 +2859,10 @@ enum pci_board_num_t {
 	pbn_panacom4,
 	pbn_plx_romulus,
 	pbn_oxsemi,
...
+	pbn_oxsemi_8_15625000,
 	...
 	pbn_sgi_ioc3,
 	pbn_computone_4,
@@ -2803,10 +3005,10 @@ static struct pciserial_board pci_boards
 		.uart_offset	= 8,
 	},
...
@@ -3187,31 +3389,31 @@ static struct pciserial_board pci_boards
 		.base_baud	= 115200,
 		.uart_offset	= 8,
 	},
-	[pbn_oxsemi_1_3906250] = {
...
@@ -4205,165 +4407,165 @@ static const struct pci_device_id serial
 	 */
...
@@ -3329,7 +3308,7 @@ static void serial8250_console_restore(s
