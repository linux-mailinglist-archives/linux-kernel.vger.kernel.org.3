...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A2D784F72F9
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Apr 2022 05:18:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240136AbiDGDTf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Apr 2022 23:19:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44276 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239965AbiDGDS0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Apr 2022 23:18:26 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 02505AACA1
        for <linux-kernel@vger.kernel.org>; Wed,  6 Apr 2022 20:16:06 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id p15-20020a25818f000000b0063daf5f7957so3275140ybk.12
        for <linux-kernel@vger.kernel.org>; Wed, 06 Apr 2022 20:16:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=2FVgzTnmb2JeqfQyoTBFNGi6zNu2jJ43Oxn+apD3DdM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2FVgzTnmb2JeqfQyoTBFNGi6zNu2jJ43Oxn+apD3DdM=;
        b=
X-Gm-Message-State: AOAM533tqqHBWw6gqklYd2oBIbtJN+N0DDr0SUx7f5m3G4uU/MYt6DFs
        W1aiiwgm83cNsF7jUECdriLok3oL2Iw=
X-Google-Smtp-Source: ABdhPJwb/kFQSSyXRQuXuCiEhLpFhfCD+ZGa12jHRxQR469lOgwSlQltO6Amf8P1HoYy/R9f+MpnivDRFHM=
X-Received: from yuzhao.bld.corp.google.com ([2620:15c:183:200:9ea2:c755:ae22:6862])
 (user=yuzhao job=sendgmr) by 2002:a25:59c3:0:b0:63d:8ccc:37b0 with SMTP id
 n186-20020a2559c3000000b0063d8ccc37b0mr8744785ybb.612.1649301365790; Wed, 06
 Apr 2022 20:16:05 -0700 (PDT)
Date:   Wed,  6 Apr 2022 21:15:18 -0600
In-Reply-To: <20220407031525.2368067-1-yuzhao@google.com>
Message-Id: <20220407031525.2368067-7-yuzhao@google.com>
Mime-Version: 1.0
References: <20220407031525.2368067-1-yuzhao@google.com>
X-Mailer: git-send-email 2.35.1.1094.g7c7d902a7c-goog
Subject: [PATCH v10 06/14] mm: multi-gen LRU: minimal implementation
...
+ *
+ * MAX_NR_TIERS is set to 4 so that the multi-gen LRU can support twice of=
 the
...
--- a/mm/swap.c
+++ b/mm/swap.c
@@ -405,6 +405,43 @@ static void __lru_cache_activate_folio(struct folio *f=
olio)
...
+
  ...
  *
@@ -417,6 +454,11 @@ static void __lru_cache_activate_folio(struct folio *f=
olio)
  */
...
@@ -2999,6 +3031,754 @@ static struct lruvec __maybe_unused *get_lruvec(str=
...
@@ -3054,6 +3844,11 @@ static void shrink_lruvec(struct lruvec *lruvec, str=
uct scan_control *sc)
 	struct blk_plug plug;
 	bool scan_adjusted;
=20
...
@@ -3558,6 +4353,9 @@ static void snapshot_refaults(struct mem_cgroup *targ=
...
@@ -3928,6 +4726,11 @@ static void age_active_anon(struct pglist_data *pgda=
t,
 	struct mem_cgroup *memcg;
...
@@ -264,10 +369,14 @@ void *workingset_eviction(struct folio *folio, struct=
...
@@ -298,7 +407,13 @@ void workingset_refault(struct folio *folio, void *sha=
dow)
 	int memcgid;
 	long nr;
=20
