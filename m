...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A28795980B1
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Aug 2022 11:19:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230075AbiHRJTo (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 18 Aug 2022 05:19:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43994 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239604AbiHRJTR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 18 Aug 2022 05:19:17 -0400
Received: from out0.migadu.com (out0.migadu.com [IPv6:2001:41d0:2:267::])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 102824BD14
        for <linux-kernel@vger.kernel.org>; Thu, 18 Aug 2022 02:19:05 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=qyEVh1JMxIRxomH1QldNUUxAXM0JxLRF2OseZ5hCiag=;
        b=ZVtxOChpvztE7Y9cYR+DgLHUFxbc9/f+Q9sG1z+hTRTMIen4OoZ8KmIHj9RVQA4Iemblth
        3ER/O594tQoAdf6Bfid48AeqsHEQkxqJNtbJfZaCtjmu1qElXZHwFpaui1iaFiJa8THtgv
        dBUummR8HbYR3rk31ICu2CPt7uVXOFI=
MIME-Version: 1.0
Subject: Re: [PATCH 4/6] mm: hugetlb_vmemmap: add missing smp_wmb() before
 set_pte_at()
X-Report-Abuse: Please report any abuse attempt to abuse@migadu.com and include these headers.
From:   Muchun Song <muchun.song@linux.dev>
In-Reply-To: <7408156a-f708-5e73-d0a2-69b1acca9b96@intel.com>
Date:   Thu, 18 Aug 2022 17:18:09 +0800
Cc:     Andrew Morton <akpm@linux-foundation.org>,
        Mike Kravetz <mike.kravetz@oracle.com>,
        Muchun Song <songmuchun@bytedance.com>,
        Linux MM <linux-mm@kvack.org>, linux-kernel@vger.kernel.org
Content-Transfer-Encoding: quoted-printable
Message-Id: <15DD6DCA-39BC-4EA2-984F-D488E94CC4FF@linux.dev>
...
>> entry.
>=20
> The difference I can see is that pmd/pte thing has both hardware page =
walker and
> software page walker (like GUP) as read side. While the case here only =
has hardware
> page walker as read side. But I suppose the memory barrier requirement =
still apply
> here.
...
>=20
> Maybe we could do a test: add large delay between reset_struct_page() =
and set_pte_at?
...
another thread
detect if it can see a tail page with PG_head after the previous thread =
has executed
set_pte_at().
