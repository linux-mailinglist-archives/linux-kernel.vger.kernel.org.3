...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0335B4A54E4
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Feb 2022 02:59:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232443AbiBAB7s (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 31 Jan 2022 20:59:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54706 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232190AbiBAB7b (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 31 Jan 2022 20:59:31 -0500
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B1319C061753
        for <linux-kernel@vger.kernel.org>; Mon, 31 Jan 2022 17:59:21 -0800 (PST)
Received: by mail-yb1-xb49.google.com with SMTP id 2-20020a251302000000b006118f867dadso30470813ybt.12
        for <linux-kernel@vger.kernel.org>; Mon, 31 Jan 2022 17:59:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc:content-transfer-encoding;
        bh=xTg///6yInZ2qgYnxFqRDbG3Vp+CdPQsVvNnhhYcbQs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xTg///6yInZ2qgYnxFqRDbG3Vp+CdPQsVvNnhhYcbQs=;
        b=
X-Gm-Message-State: AOAM533qP8Kirmd4ZGEhhxrxnDRdUUeJIho04BRVDgpJF1y5zw5WSdcY
        //ONm9OW8CfU0wZhrs5uap+04yP11Riv
X-Google-Smtp-Source: ABdhPJx5TaLRxpf2yarew7z1n5KfBU2ulPC+LGXcVJ7jTgMlUicA2MSedZ7jRA8Wtv6jhK6LZB89b6kuZZeC
X-Received: from irogers.svl.corp.google.com ([2620:15c:2cd:202:b14e:bc64:b7f6:5d4b])
 (user=irogers job=sendgmr) by 2002:a5b:48:: with SMTP id e8mr21718302ybp.64.1643680760854;
 Mon, 31 Jan 2022 17:59:20 -0800 (PST)
Date:   Mon, 31 Jan 2022 17:58:38 -0800
In-Reply-To: <20220201015858.1226914-1-irogers@google.com>
Message-Id: <20220201015858.1226914-7-irogers@google.com>
Mime-Version: 1.0
References: <20220201015858.1226914-1-irogers@google.com>
X-Mailer: git-send-email 2.35.0.rc2.247.g8bbb082509-goog
Subject: [PATCH v2 06/26] perf vendor events: Update metrics for Ivybridge
...
$ perf stat --metric-no-group -M Load_Miss_Real_Latency -a sleep 1
 ...
 Performance counter stats for 'system wide':
          ...
          14935022      mem_load_uops_retired.hit_lfb #    23.55 Load_Miss_=
Real_Latency   (83.23%)
           4716714      MEM_LOAD_UOPS_RETIRED.L1_MISS                      =
               (66.68%)
         462705675      L1D_PEND_MISS.PENDING                              =
           (83.22%)
...
---
 ...
 11 files changed, 2678 insertions(+), 2619 deletions(-)
 create mode 100644 tools/perf/pmu-events/arch/x86/ivybridge/uncore-cache.j=
son
 create mode 100644 tools/perf/pmu-events/arch/x86/ivybridge/uncore-other.j=
son
...
+    }
+]
diff --git a/tools/perf/pmu-events/arch/x86/ivybridge/uncore.json b/tools/p=
erf/pmu-events/arch/x86/ivybridge/uncore.json
