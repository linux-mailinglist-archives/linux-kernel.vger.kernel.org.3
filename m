...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E666859D535
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Aug 2022 11:09:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347604AbiHWI4b (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 23 Aug 2022 04:56:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60846 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242792AbiHWIz6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 23 Aug 2022 04:55:58 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DB1217FE65
        for <linux-kernel@vger.kernel.org>; Tue, 23 Aug 2022 01:24:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1661243082; x=1692779082;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=sbXWxMfY2whEtc0ykrjnmLntH2CG1Vecggal2VBh7ZA=;
  b=PTN5aN35niko//lQib1b+k7qODaVm78+KWWxRdAEmwcOX32mrg1Zlg4j
   TRL1TUlAIB7eEZVHSIook5Z1NRe40qvfEhp664GvRgirbyKv/pZB+HvG9
   Iim5CEOsfIVZc/MH8vo5tj0Tz3PvjsMufEyJA00AUVn47ETlzZGFkSOLQ
   yXK/d1t/nvd6ts1LJ5hVSQ1S9kiLy4dvGyyyq8TvbAWhE1+fm/hOrzy/2
   idIXZklD5wusobp2qrqtudlzGQx66EscNnjRWysDW4J4uHo0IcVEbEBP9
   HlHPGqCfvIMERudblLlXQeBvvmTqw7VEkX3ONqp4ZM2oRToujMmUAJtfi
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10447"; a="274011608"
X-IronPort-AV: E=Sophos;i="5.93,257,1654585200"; 
   d="scan'208";a="274011608"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Aug 2022 01:23:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,257,1654585200"; 
   d="scan'208";a="677534087"
Received: from lkp-server02.sh.intel.com (HELO 9bbcefcddf9f) ([10.239.97.151])
  by fmsmga004.fm.intel.com with ESMTP; 23 Aug 2022 01:23:44 -0700
Received: from kbuild by 9bbcefcddf9f with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oQPCK-00002B-0m;
        Tue, 23 Aug 2022 08:23:44 +0000
Date:   Tue, 23 Aug 2022 16:23:27 +0800
From:   kernel test robot <lkp@intel.com>
To:     Martin =?utf-8?Q?Povi=C5=A1er?= <povik+lin@cutebit.org>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [asahilinux:pr/46 21/34] sound/soc/codecs/cs42l84.c:371:17: error:
 implicit declaration of function 'FIELD_PREP'
Message-ID: <202208231602.FNLuHpOW-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Gb8Et+KPZVCOqRax"
...
commit: fede0e659aa9b0d19c539a78acd458efeb3d5684 [21/34] wip: ASoC: cs42l84: Start new codec driver
config: nios2-randconfig-r014-20220821
compiler: nios2-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/AsahiLinux/linux/commit/fede0e659aa9b0d19c539a78acd458efeb3d5684
        git remote add asahilinux https://github.com/AsahiLinux/linux
        git fetch --no-tags asahilinux pr/46
        git checkout fede0e659aa9b0d19c539a78acd458efeb3d5684
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=nios2 SHELL=/bin/bash kernel/ sound/soc/codecs/
