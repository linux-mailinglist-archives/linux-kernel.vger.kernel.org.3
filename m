...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4F1424C86A4
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Mar 2022 09:39:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233433AbiCAIjx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Mar 2022 03:39:53 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49234 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231998AbiCAIjv (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Mar 2022 03:39:51 -0500
Received: from mga06.intel.com (mga06.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 696766C97A
        for <linux-kernel@vger.kernel.org>; Tue,  1 Mar 2022 00:39:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1646123947; x=1677659947;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:content-transfer-encoding:in-reply-to;
  bh=vtIgsaxJdKkUzxJDs1z1dpOeudAbeoL8oVjgzoFgj60=;
  b=lAcbDtatGxaIx2mxCRxbhye6znw4lcwZuw/NdrANeUMU6MLxShNkPzR6
   91KcHd+xH8ZTcLv10zNuVE3KtOeU+r3Ic2Cah5sni5U2qhr4nSWc28EyG
   DJeyB0arUBY2bqN+Ovy3HnW0Ujz9ROJLN5NPftu886vu9C1OiCn74JhY7
   g1tlih8vTxDslNU8hQll6SzlRi7LaY5uz0i7u3Vp2Y29HWR1DCgHyBmF0
   op16wdnx6ZAVwMLz/X5foqkDUIjv7al6jQ+7cr0RDOulGLtAp/1ekbFcJ
   L1NZ68gsvEQQmV0owWLl4ANVxsJiSzkGO9PrKt9qbyD3cxb499GJ7kg47
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10272"; a="313809549"
X-IronPort-AV: E=Sophos;i="5.90,145,1643702400"; 
   d="scan'208";a="313809549"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Mar 2022 00:39:06 -0800
X-IronPort-AV: E=Sophos;i="5.90,145,1643702400"; 
   d="scan'208";a="550623594"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Mar 2022 00:39:03 -0800
...
Subject: Re: [srcu]  92093b1bdf:  will-it-scale.per_process_ops -7.0%
 regression
Message-ID: <20220301083900.GC13547@xsang-OptiPlex-9020>
References: <20220217143139.GD28592@xsang-OptiPlex-9020>
 <20220217145353.GP4285@paulmck-ThinkPad-P17-Gen-1>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20220217145353.GP4285@paulmck-ThinkPad-P17-Gen-1>
...
On Thu, Feb 17, 2022 at 06:53:53AM -0800, Paul E. McKenney wrote:
> On Thu, Feb 17, 2022 at 10:31:39PM +0800, kernel test robot wrote:
> > 
> > 
> > Greeting,
> > 
...
> 
> This is in addition to the previously reported performance regression
> on the ancestor commit, or in place of that performance regression?

both are separate ones. one of our auto-bisect spot one commit comparing to
its parent, as the table in original reports shows :)

> 
> Either way, I can much more easily imagine this commit resulting in
> a performance regression.  ;-)
> 
> And either way, does booting with srcutree.convert_to_big=2 help?

since recently we updated ucode, so we retested, what we found is the
srcutree.convert_to_big=2 seems no impact upon 92093b1bdf.

=========================================================================================
commit/compiler/cpufreq_governor/kconfig/mode/nr_task/rootfs/tbox_group/test/testcase/ucode:
  92093b1bdf48286aefc8da09db3f28dab01f0449/gcc-9/performance/x86_64-rhel-8.3/process/16/debian-10.4-x86_64-20200603.cgz/lkp-icl-2sp2/open1/will-it-scale/0xd000331

debug-setup:
  convert_to_big_default   <---- doesn't set srcutree.convert_to_big
  convert_to_big_2         <---- set srcutree.convert_to_big=2

convert_to_big_d            convert_to_big_2
---------------- ---------------------------
         %stddev     %change         %stddev
             \          |                \
   3349905            -0.0%    3348358        will-it-scale.16.processes
     86.81            -0.0%      86.80        will-it-scale.16.processes_idle
    209368            -0.0%     209271        will-it-scale.per_process_ops


then we also tested the parent with default srcutree.convert_to_big
(just not setting it, I guess no need to test parent of 92093b1bdf with
srcutree.convert_to_big=2, am I right?), we found the regression is still there:

=========================================================================================
compiler/cpufreq_governor/debug-setup/kconfig/mode/nr_task/rootfs/tbox_group/test/testcase/ucode:
  gcc-9/performance/convert_to_big_default/x86_64-rhel-8.3/process/16/debian-10.4-x86_64-20200603.cgz/lkp-icl-2sp2/open1/will-it-scale/0xd000331
...
---------------- ---------------------------
         %stddev     %change         %stddev
             \          |                \
   3633830            -7.8%    3349905        will-it-scale.16.processes
     86.81            -0.0%      86.81        will-it-scale.16.processes_idle
    227114            -7.8%     209368        will-it-scale.per_process_ops
...
> > 	export submit_id='620c8bf1c17dd734e8346907'
> > 	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp2/will-it-scale-performance-process-16-open1-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-92093b1bdf48286aefc8da09db3f28dab01f0-20220216-13544-1qc9p9a-5.yaml'
> > 	export id='875fd65dedf99b4fb8eeba2d28866abc5c598724'
...
> > 	export commit='92093b1bdf48286aefc8da09db3f28dab01f0449'
> > 	export netconsole_port=6680
> > 	export ucode='0xd000280'
> > 	export bisect_dmesg=true
> > 	export enqueue_time='2022-02-16 13:30:25 +0800'
> > 	export _id='620c8c01c17dd734e8346909'
> > 	export _rt='/result/will-it-scale/performance-process-16-open1-ucode=0xd000280/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449'
> > 	export user='lkp'
> > 	export compiler='gcc-9'
> > 	export LKP_SERVER='internal-lkp-server'
> > 	export head_commit='060c64f35800d9cb1df10f126b8679ee37c605a7'
> > 	export base_commit='754e0b0e35608ed5206d6a67a791563c631cec07'
> > 	export branch='linux-next/master'
> > 	export rootfs='debian-10.4-x86_64-20200603.cgz'
> > 	export result_root='/result/will-it-scale/performance-process-16-open1-ucode=0xd000280/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/3'
> > 	export scheduler_version='/lkp/lkp/.src-20220214-105719'
> > 	export arch='x86_64'
> > 	export max_uptime=2100
> > 	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
> > 	export bootloader_append='root=/dev/ram0
> > RESULT_ROOT=/result/will-it-scale/performance-process-16-open1-ucode=0xd000280/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/3
> > BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/vmlinuz-5.17.0-rc1-00019-g92093b1bdf48
> > branch=linux-next/master
> > job=/lkp/jobs/scheduled/lkp-icl-2sp2/will-it-scale-performance-process-16-open1-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-92093b1bdf48286aefc8da09db3f28dab01f0-20220216-13544-1qc9p9a-5.yaml
> > user=lkp
> > ARCH=x86_64
> > kconfig=x86_64-rhel-8.3
> > commit=92093b1bdf48286aefc8da09db3f28dab01f0449
> > max_uptime=2100
...
> > vga=normal
> > rw'
> > 	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/modules.cgz'
> > 	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/will-it-scale_20220111.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/will-it-scale-x86_64-a34a85c-1_20220127.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20200721.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-3.7-4_20200721.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220212.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-754e0b0e3560-1_20220214.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
> > 	export ucode_initrd='/osimage/ucode/intel-ucode-20210222.cgz'
> > 	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
> > 	export site='inn'
> > 	export LKP_CGI_PORT=80
> > 	export LKP_CIFS_PORT=139
> > 	export last_kernel='5.17.0-rc4'
> > 	export repeat_to=6
> > 	export schedule_notify_address=
> > 	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/vmlinuz-5.17.0-rc1-00019-g92093b1bdf48'
> > 	export dequeue_time='2022-02-16 13:40:57 +0800'
> > 	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp2/will-it-scale-performance-process-16-open1-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-92093b1bdf48286aefc8da09db3f28dab01f0-20220216-13544-1qc9p9a-5.cgz'
> > 
> > 	[ -n "$LKP_SRC" ] ||
...
> > kconfig: x86_64-rhel-8.3
> > submit_id: 620c801ec17dd72ecd7c69ff
> > job_file: "/lkp/jobs/scheduled/lkp-icl-2sp2/will-it-scale-performance-process-16-open1-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-92093b1bdf48286aefc8da09db3f28dab01f0-20220216-11981-6yc6o-0.yaml"
> > id: 9cf2e1f1159e8d1154f88be6a9d2dcf7bb958246
...
> > ucode: '0xd000280'
> > bisect_dmesg: true
> > enqueue_time: 2022-02-16 12:39:58.564168455 +08:00
> > _id: 620c801ec17dd72ecd7c69ff
> > _rt: "/result/will-it-scale/performance-process-16-open1-ucode=0xd000280/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449"
> > :#! schedule options:
> > user: lkp
> > compiler: gcc-9
> > LKP_SERVER: internal-lkp-server
> > head_commit: 060c64f35800d9cb1df10f126b8679ee37c605a7
> > base_commit: 754e0b0e35608ed5206d6a67a791563c631cec07
> > branch: linux-devel/devel-hourly-20220214-231901
> > rootfs: debian-10.4-x86_64-20200603.cgz
> > result_root: "/result/will-it-scale/performance-process-16-open1-ucode=0xd000280/lkp-icl-2sp2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/0"
...
> > - BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/vmlinuz-5.17.0-rc1-00019-g92093b1bdf48
> > - branch=linux-devel/devel-hourly-20220214-231901
> > - job=/lkp/jobs/scheduled/lkp-icl-2sp2/will-it-scale-performance-process-16-open1-ucode=0xd000280-debian-10.4-x86_64-20200603.cgz-92093b1bdf48286aefc8da09db3f28dab01f0-20220216-11981-6yc6o-0.yaml
> > - user=lkp
> > - ARCH=x86_64
> > - kconfig=x86_64-rhel-8.3
> > - commit=92093b1bdf48286aefc8da09db3f28dab01f0449
...
> > - vga=normal
> > - rw
> > modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/modules.cgz"
...
> > watchdog:
> > :#! runtime status:
> > last_kernel: 5.17.0-rc4-07341-g9545032ff549
> > repeat_to: 3
> > schedule_notify_address:
> > :#! user overrides:
> > kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/92093b1bdf48286aefc8da09db3f28dab01f0449/vmlinuz-5.17.0-rc1-00019-g92093b1bdf48"
> > dequeue_time: 2022-02-16 12:56:36.356432391 +08:00
> > :#! /cephfs/db/releases/20220216094919/lkp-src/include/site/inn:
> > job_state: finished
> > loadavg: 13.94 11.43 5.45 1/982 14009
> > start_time: '1644987496'
> > end_time: '1644987797'
...
> > done
> > 
> >  "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "open1" "295" "process" "0" "16"
> 
