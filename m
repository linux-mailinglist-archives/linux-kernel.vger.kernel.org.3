...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BE133514C7C
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Apr 2022 16:13:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377139AbiD2OQv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Apr 2022 10:16:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47496 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376824AbiD2OQ3 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Apr 2022 10:16:29 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id DD8B020F68
        for <linux-kernel@vger.kernel.org>; Fri, 29 Apr 2022 07:13:10 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 9E04A14BF;
        Fri, 29 Apr 2022 07:13:10 -0700 (PDT)
Received: from localhost.localdomain (FVFF7649Q05P.cambridge.arm.com [10.1.32.23])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 5FA4E3F774;
        Fri, 29 Apr 2022 07:13:09 -0700 (PDT)
From:   Vincent Donnefort <vincent.donnefort@arm.com>
To:     peterz@infradead.org, mingo@redhat.com, vincent.guittot@linaro.org
Cc:     linux-kernel@vger.kernel.org, dietmar.eggemann@arm.com,
        morten.rasmussen@arm.com, chris.redpath@arm.com,
        qperret@google.com, tao.zhou@linux.dev
Subject: [PATCH v8 5/7] sched/fair: Use the same cpumask per-PD throughout find_energy_efficient_cpu()
Date:   Fri, 29 Apr 2022 15:11:46 +0100
Message-Id: <20220429141148.181816-6-vincent.donnefort@arm.com>
...
index c1c63322836a..684e89a0f694 100644
--- a/kernel/sched/fair.c
+++ b/kernel/sched/fair.c
@@ -6726,14 +6726,14 @@ static unsigned long cpu_util_next(int cpu, struct task_struct *p, int dst_cpu)
  * task.
  */
 static long
...
@@ -6744,7 +6744,7 @@ compute_energy(struct task_struct *p, int dst_cpu, struct perf_domain *pd)
...
@@ -6831,6 +6831,7 @@ compute_energy(struct task_struct *p, int dst_cpu, struct perf_domain *pd)
  */
...
@@ -6865,7 +6866,9 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
...
@@ -6902,12 +6905,12 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
 			continue;
...
@@ -6916,7 +6919,8 @@ static int find_energy_efficient_cpu(struct task_struct *p, int prev_cpu)
