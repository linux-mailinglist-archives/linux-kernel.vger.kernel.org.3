...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CE79D5320D8
	for <lists+linux-kernel@lfdr.de>; Tue, 24 May 2022 04:21:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233242AbiEXCVn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 23 May 2022 22:21:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42314 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232894AbiEXCVk (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 23 May 2022 22:21:40 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A6DE36E16;
        Mon, 23 May 2022 19:21:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1653358894; x=1684894894;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=6zQLpuh0Dmb3yj+miENyWn2T80m4HpkD6WKerUi3meA=;
  b=fRGyU9Frg+DWiB77fy/cAV+YbC/Uc1H0yMIuHWk91280+Ao9egBnh0zR
   wCFFGS9zuAfIzmzXch0beo4ant7mz4tgMsaC2mJ/MGlJyfI3jfDmZY77B
   Io7JmggMldi9+xDSEaHDvMF0uNn/3VnEnRFNg5J+jQjUgkbg5BvYQHI6d
   YSh1P1S0hXYRUpfiL4uQn5an9S6cl7pvaU71k/3DAryQg57nKh0FVYpRX
   1KeLuXf8QU46NfrJ1/vyPvcD054jfxeSwQv+XYXl3Sk5w/wJnMXuGRssZ
   XbdXI0LxZYOn7Q3bCvGyAxjPxSz8gxV8bbpEbHs6cxOjOWV9JZwyx6pgR
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10356"; a="298723952"
X-IronPort-AV: E=Sophos;i="5.91,247,1647327600"; 
   d="yaml'?scan'208";a="298723952"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 May 2022 19:21:33 -0700
X-IronPort-AV: E=Sophos;i="5.91,247,1647327600"; 
   d="yaml'?scan'208";a="548268769"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 May 2022 19:21:28 -0700
Date:   Tue, 24 May 2022 10:21:21 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Dai Ngo <dai.ngo@oracle.com>
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        linux-nfs@vger.kernel.org, lkp@lists.01.org, ying.huang@intel.com,
        feng.tang@intel.com, zhengjun.xing@linux.intel.com,
        fengwei.yin@intel.com, chuck.lever@oracle.com,
        trondmy@hammerspace.com
Subject: [NFSD]  c6138abff4:  fsmark.files_per_sec -6.5% regression
Message-ID: <20220524022121.GA24917@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="xHFwDpU9dbj6ez1V"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <1653079929-18283-1-git-send-email-dai.ngo@oracle.com>
...
patch link: https://lore.kernel.org/linux-nfs/1653079929-18283-1-git-send-email-dai.ngo@oracle.com
...
Content-Disposition: attachment; filename="config-5.18.0-rc7-00137-gc6138abff45e"
...
kbuild_queue_analysis'
	...
	export submit_id='628b4734caa5f72208cf2044'
	export job_file='/lkp/jobs/scheduled/lkp-cpl-4sp1/fsmark-performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402-debian-10.4-x86_64-20200603.cgz-c6138abff45e497e14575b6ac3-20220523-74248-fepsct-3.yaml'
	export id='0cb3d2b43a9f6b118bc052f913b90cdcbbe81036'
...
{"PCI"=>"y"}
NFSD'
	export commit='c6138abff45e497e14575b6ac321b17899a5944c'
	export need_kconfig_hw='{"IGB"=>"y"}
SATA_AHCI'
	export ucode='0x7002402'
	export bisect_dmesg=true
	export enqueue_time='2022-05-23 16:35:01 +0800'
	export _id='628b4734caa5f72208cf2044'
	export _rt='/result/fsmark/performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='2e53d0da7d26b2732034c9962c9b2e6e29bd544c'
	export base_commit='42226c989789d8da4af1de0c31070c96726d990c'
	export branch='linux-review/Dai-Ngo/NFSD-sleeping-function-called-from-invalid-context-at-kernel-locking-rwsem-c/20220521-045428'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/fsmark/performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/3'
	export scheduler_version='/lkp/lkp/.src-20220523-104828'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/fsmark/performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/vmlinuz-5.18.0-rc7-00137-gc6138abff45e
branch=linux-review/Dai-Ngo/NFSD-sleeping-function-called-from-invalid-context-at-kernel-locking-rwsem-c/20220521-045428
job=/lkp/jobs/scheduled/lkp-cpl-4sp1/fsmark-performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402-debian-10.4-x86_64-20200603.cgz-c6138abff45e497e14575b6ac3-20220523-74248-fepsct-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=c6138abff45e497e14575b6ac321b17899a5944c
...
rw'
	...
	export repeat_to=6
	export bad_samples='3709.4
3627.5
3560.7'
	export schedule_notify_address=
	export kbuild_queue_analysis=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/vmlinuz-5.18.0-rc7-00137-gc6138abff45e'
	export dequeue_time='2022-05-23 16:49:15 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-cpl-4sp1/fsmark-performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402-debian-10.4-x86_64-20200603.cgz-c6138abff45e497e14575b6ac3-20220523-74248-fepsct-3.cgz'
...
submit_id: 628a4abecaa5f71295b7e61c
job_file: "/lkp/jobs/scheduled/lkp-cpl-4sp1/fsmark-performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402-debian-10.4-x86_64-20200603.cgz-c6138abff45e497e14575b6ac3-20220522-70293-15p80m-1.yaml"
id: a5248ccd16e0d06eed3b60131ee91c6235c0fb03
...
bisect_dmesg: true
fs2: nfsv4
enqueue_time: 2022-05-22 22:37:50.383024786 +08:00
_id: 628a4abecaa5f71295b7e61d
_rt: "/result/fsmark/performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: 2e53d0da7d26b2732034c9962c9b2e6e29bd544c
base_commit: 42226c989789d8da4af1de0c31070c96726d990c
branch: linux-devel/devel-hourly-20220521-052946
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/fsmark/performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/0"
scheduler_version: "/lkp/lkp/.src-20220520-222747"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/vmlinuz-5.18.0-rc7-00137-gc6138abff45e
- branch=linux-devel/devel-hourly-20220521-052946
- job=/lkp/jobs/scheduled/lkp-cpl-4sp1/fsmark-performance-1SSD-8K-xfs-nfsv4-1x-6t-NoSync-60G-ucode=0x7002402-debian-10.4-x86_64-20200603.cgz-c6138abff45e497e14575b6ac3-20220522-70293-15p80m-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=c6138abff45e497e14575b6ac321b17899a5944c
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/modules.cgz"
...
site: inn
:#! /cephfs/db/releases/20220520222415/lkp-src/include/site/inn:
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
:#! runtime status:
last_kernel: 5.18.0-rc4-00001-g0fc74d820a01
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kbuild_queue_analysis: 1
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/c6138abff45e497e14575b6ac321b17899a5944c/vmlinuz-5.18.0-rc7-00137-gc6138abff45e"
dequeue_time: 2022-05-22 22:44:18.027668263 +08:00
:#! /cephfs/db/releases/20220522125200/lkp-src/include/site/inn:
job_state: finished
loadavg: 9.75 10.33 8.75 2/1211 58265
start_time: '1653230735'
end_time: '1653232353'
...
fs_mark -d /nfs/nvme0n1p4/1 -d /nfs/nvme0n1p4/2 -d /nfs/nvme0n1p4/3 -d /nfs/nvme0n1p4/4 -d /nfs/nvme0n1p4/5 -d /nfs/nvme0n1p4/6 -n 1000000 -L 1 -S 0 -s 8192
