...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 29A424D2027
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Mar 2022 19:23:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349603AbiCHSYD (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Mar 2022 13:24:03 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44588 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1349612AbiCHSXD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Mar 2022 13:23:03 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 38C3C56C24;
        Tue,  8 Mar 2022 10:22:04 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 8BC7B615A3;
        Tue,  8 Mar 2022 18:22:03 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 36D69C340EB;
        Tue,  8 Mar 2022 18:22:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1646763723;
        bh=ALJwWe+Dcdqb3O9ir7Sf8JHA/odDIecPatavY3s4l3Q=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=NwAYAcoFjB7Oztn1k3lH4a+9mN6z1jB0U2/FT0JCyfyAk5REs3KdDzNreIZQyfC2X
         QRKiTjKQkDPhLqLqxittT9n45feBcHk3sCd2VBgIK/FjLICdVZtBKTsWLqiVDpu/pl
         t2plnhkUGiDkuHdkucq6yrm7lqkwRhz+GKq1gy5c=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.183
Date:   Tue,  8 Mar 2022 19:21:51 +0100
Message-Id: <1646763711247223@kroah.com>
X-Mailer: git-send-email 2.35.1
In-Reply-To: <164676371112015@kroah.com>
References: <164676371112015@kroah.com>
MIME-Version: 1.0
...
index 8750309fc42a..a94b5ea499e1 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 6a95b9296640..183a6f2f165a 100644
...
index 538d5da741b0..6e7f841f67ff 100644
--- a/arch/arm/mm/mmu.c
+++ b/arch/arm/mm/mmu.c
...
index dd5624975c9b..b7e7bb3517c0 100644
...
index 70d1587ddcd4..361b10993372 100644
...
index 499a947d56dd..fef46de2f6b2 100644
...
index c51de498b5b4..19eee3d0900b 100644
...
index 4e43bdfa041f..f0b055bc027c 100644
...
index 436d1776bc7b..a32d15b2928f 100644
...
index 01135713e8f9..419d8dec7e49 100644
...
index 749558aa27e7..d1ba6fafe960 100644
...
index 2d08a8719506..854f1b2658b8 100644
...
index 5ab901ad615d..c265fe462162 100644
...
index e2eb9b9b8363..f7398b996bac 100644
...
index 196e8505dd8d..aaef8847f886 100644
...
index 8b4c1bb77c33..76747d94c760 100644
...
index 26d49dcdbeb3..34bf6f4eef4a 100644
...
index 309e953ed1e4..e8850ba5604c 100644
...
index f4b05af0dd2f..1a4947e6933c 100644
...
index b43be9f14105..921a2ddb497e 100644
...
index 38767d797914..431146b391d0 100644
...
index 94c652b9a0a8..9cbc0179d24e 100644
...
index d2eb33f53993..43aab2835f8f 100644
...
index 77ac5a721e7b..414341c9cf5a 100644
...
index 07b070b14d75..6e1721d53384 100644
...
index 5f1e15172403..9cd80ad075bd 100644
...
index a5041bf0d5db..5a3006c75d63 100644
--- a/fs/btrfs/qgroup.c
+++ b/fs/btrfs/qgroup.c
...
index 7bc4477d7ee7..9b703c0db979 100644
--- a/fs/btrfs/tree-log.c
+++ b/fs/btrfs/tree-log.c
@@ -1308,6 +1308,15 @@ static int unlink_old_inode_refs(struct btrfs_trans_handle *trans,
 						 inode, name, namelen);
 			kfree(name);
 			iput(dir);
+			/*
...
+	const u64 i_size = i_size_read(&inode->vfs_inode);
 	...
 	int ins_nr = 0;
@@ -5062,13 +5081,21 @@ static int copy_inode_items_to_log(struct btrfs_trans_handle *trans,
...
@@ -5099,10 +5126,8 @@ static int copy_inode_items_to_log(struct btrfs_trans_handle *trans,
...
@@ -5155,9 +5180,21 @@ static int copy_inode_items_to_log(struct btrfs_trans_handle *trans,
 			break;
 		}
 	}
-	if (ins_nr)
...
index 41b3c5fc958c..f44b6f9d0777 100644
--- a/fs/cifs/cifsfs.c
+++ b/fs/cifs/cifsfs.c
...
index 8ce63850d6d0..614f19bbad74 100644
...
index 311a57f3e01a..7f0ae1f411e3 100644
...
index 615259d8fa9a..1a89b2bf626a 100644
...
index 3cef24c6391a..413da11260f8 100644
...
index 13ccf2f28987..a422cf6a0358 100644
...
index 18e644f3cb30..5f44c94ad707 100644
...
index e9ecbb57df45..b53d5e1d026f 100644
--- a/net/dcb/dcbnl.c
+++ b/net/dcb/dcbnl.c
...
index 86c836fa2145..00210e55b4cd 100644
--- a/net/ipv4/esp4.c
+++ b/net/ipv4/esp4.c
...
index 12570a73def8..7a739f16d82b 100644
--- a/net/ipv6/esp6.c
+++ b/net/ipv6/esp6.c
...
index d847aa32628d..918a9520d1f1 100644
...
index 464029892478..ab91683d9459 100644
--- a/net/mac80211/rx.c
+++ b/net/mac80211/rx.c
...
index 5d5bdf450091..451b2df998ea 100644
...
index f8f52ff99cfb..643dbfe7c581 100644
...
index ca21f8f4a47c..7d3ab08a5a2d 100644
...
index aeea67f90841..12672019f76c 100644
...
index bb2292b5260c..d758e9ec3d00 100644
...
index c6b2c99b501b..1423e2b7cb42 100644
...
index f5dcd625e435..c88bc6bb41cf 100644
