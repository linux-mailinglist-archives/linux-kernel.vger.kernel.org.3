...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9CDAC5542B0
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Jun 2022 08:25:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1351247AbiFVGUK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Jun 2022 02:20:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37138 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1351173AbiFVGUE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Jun 2022 02:20:04 -0400
Received: from mail-oi1-x241.google.com (mail-oi1-x241.google.com [IPv6:2607:f8b0:4864:20::241])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A92ADE1
        for <linux-kernel@vger.kernel.org>; Tue, 21 Jun 2022 23:20:01 -0700 (PDT)
Received: by mail-oi1-x241.google.com with SMTP id i25so19945623oii.7
        for <linux-kernel@vger.kernel.org>; Tue, 21 Jun 2022 23:20:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=mWo9XIKeezUY0SN25PqCk22B3MKwAg8wfQXOyogiy5c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mWo9XIKeezUY0SN25PqCk22B3MKwAg8wfQXOyogiy5c=;
        b=
X-Gm-Message-State: AJIora8ioFYesaNnjqNCoYiWBvbFKHdyLGgKDVThNT8d7eJf69stJjPx
        ITspfN6xOAgUg354FmYHas8=
X-Google-Smtp-Source: AGRyM1u/GWNysJ6dmlThCZou2+pMAEjdim9FhbfYGurlkEs39phDPw4WFfHSRZneDZdYT0c9nFAeGA==
X-Received: by 2002:a05:6808:10ca:b0:331:4684:7519 with SMTP id s10-20020a05680810ca00b0033146847519mr11493137ois.299.1655878800269;
        Tue, 21 Jun 2022 23:20:00 -0700 (PDT)
Received: from bertie (072-190-140-117.res.spectrum.com. [72.190.140.117])
        by smtp.gmail.com with ESMTPSA id f21-20020a05680814d500b0032f2ccdafc9sm10806270oiw.3.2022.06.21.23.19.59
...
Subject: [PATCH 2/4] memblock tests: add verbose output to memblock tests
Date:   Wed, 22 Jun 2022 01:19:30 -0500
Message-Id: <11a239045cca7b5add6c16c6a5a43a2075d7525f.1655878337.git.remckee0@gmail.com>
...
---
 ...
 6 files changed, 882 insertions(+), 344 deletions(-)
...
index 62d3191f7c9a..248c214c5216 100644
...
+
+static char prefixes[PREFIXES_LEN_MAX];
+#endif
+
 void reset_memblock_regions(void)
 {
 	memset(memblock.memory.regions, 0,
@@ -46,3 +54,55 @@ void dummy_physical_memory_cleanup(void)
 {
