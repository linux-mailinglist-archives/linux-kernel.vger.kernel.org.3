...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2608F46BD33
	for <lists+linux-kernel@lfdr.de>; Tue,  7 Dec 2021 15:04:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237530AbhLGOH7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 7 Dec 2021 09:07:59 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38560 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232946AbhLGOH5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 7 Dec 2021 09:07:57 -0500
Received: from mail-ed1-x534.google.com (mail-ed1-x534.google.com [IPv6:2a00:1450:4864:20::534])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 553C6C061574
        for <linux-kernel@vger.kernel.org>; Tue,  7 Dec 2021 06:04:26 -0800 (PST)
Received: by mail-ed1-x534.google.com with SMTP id g14so56787770edb.8
        for <linux-kernel@vger.kernel.org>; Tue, 07 Dec 2021 06:04:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=a3jkljh6vi6gY+5IhDrxccQ0YCxaI4z9UEdJ+Ta5ILc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=a3jkljh6vi6gY+5IhDrxccQ0YCxaI4z9UEdJ+Ta5ILc=;
        b=
X-Gm-Message-State: AOAM530s1+A9kZCX/ekUy+Yg3ti9brXNWrcF6nAn9OaopkmQm888Jhu3
        aPX0j2dRzVVdNfS57W7aPfk=
X-Google-Smtp-Source: ABdhPJwI6j1A4nwVAM2gYGVbXIAKOD/rcxyokUv6Ti2v8NQcpE0kOmQaA+bg+/moUN2TkCf2xifbSw==
X-Received: by 2002:a17:907:3e0a:: with SMTP id hp10mr54354778ejc.318.1638885864412;
        Tue, 07 Dec 2021 06:04:24 -0800 (PST)
Received: from localhost.localdomain ([2a02:8108:96c0:3b88::5a55])
        by smtp.gmail.com with ESMTPSA id hq37sm8856432ejc.116.2021.12.07.06.04.23
...
Subject: [PATCH v2] staging: r8188eu: convert type of HalData in struct adapter
Date:   Tue,  7 Dec 2021 15:04:05 +0100
Message-Id: <20211207140405.8673-1-straube.linux@gmail.com>
...
---
v2: Rebased on todays staging-testing tree.
 ...
 drivers/staging/r8188eu/hal/usb_halinit.c     | 56 ++++++++-----------
 ...
 16 files changed, 89 insertions(+), 120 deletions(-)
...
index d241daff4064..d8d6547465a7 100644
...
index 8e2495751dd6..40227078c4b6 100644
...
@@ -73,7 +74,7 @@ u32 rtl8188eu_InitPowerOn(struct adapter *adapt)
 {
 	u16 value16;
...
@@ -128,7 +129,7 @@ static void _InitInterrupt(struct adapter *Adapter)
...
+	struct hal_data_8188e *haldata = &Adapter->haldata;
 	...
 	u32 numHQ	= 0;
 	u32 numLQ	= 0;
@@ -196,7 +197,7 @@ static void _InitNormalChipRegPriority(struct adapter *Adapter, u16 beQ,
...
@@ -218,7 +219,7 @@ static void _InitNormalChipOneOutEpPriority(struct adapter *Adapter)
...
+	struct hal_data_8188e *haldata = &Adapter->haldata;
 	...
 	u16 valueHi = 0;
@@ -284,7 +285,7 @@ static void _InitNormalChipThreeOutEpPriority(struct adapter *Adapter)
...
+	struct hal_data_8188e *haldata = &Adapter->haldata;
 	...
 	case 1:
@@ -328,7 +329,7 @@ static void _InitDriverInfoSize(struct adapter *Adapter, u8 drvInfoSize)
...
@@ -420,7 +421,7 @@ static void _InitRetryFunction(struct adapter *Adapter)
  *---------------------------------------------------------------------------*/
...
@@ -813,7 +814,7 @@ u32 rtl8188eu_hal_init(struct adapter *Adapter)
...
@@ -970,7 +971,7 @@ void ReadAdapterInfo8188EU(struct adapter *Adapter)
...
@@ -984,7 +985,7 @@ static void ResumeTxBeacon(struct adapter *adapt)
...
+	struct hal_data_8188e *haldata = &adapt->haldata;
 	...
 	/*  2010.03.01. Marked by tynli. No need to call workitem beacause we record the value */
 	/*  which should be read from register to a global variable. */
@@ -1091,7 +1092,7 @@ static void hw_var_set_bcn_func(struct adapter *Adapter, u8 variable, u8 *val)
...
@@ -1608,7 +1609,7 @@ void SetHwReg8188EU(struct adapter *Adapter, u8 variable, u8 *val)
...
+	struct hal_data_8188e *haldata = &Adapter->haldata;
 	...
 	switch (variable) {
@@ -1664,7 +1665,7 @@ void GetHwReg8188EU(struct adapter *Adapter, u8 variable, u8 *val)
...
+	struct hal_data_8188e *haldata = &Adapter->haldata;
 	...
 	switch (eVariable) {
@@ -1749,7 +1750,7 @@ u8 GetHalDefVar8188EUsb(struct adapter *Adapter, enum hal_def_variable eVariable
...
index 891be6721a7b..c586a35014d8 100644
...
index 540f2091aadc..f8ac4920f049 100644
...
@@ -292,9 +291,6 @@ struct hal_data_8188e {
