...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C7D2F473BBD
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Dec 2021 04:58:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233434AbhLND5R (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 13 Dec 2021 22:57:17 -0500
Received: from mga07.intel.com ([134.134.136.100]:9202 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231380AbhLND5L (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 13 Dec 2021 22:57:11 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1639454231; x=1670990231;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=I9TEY3oGjpYMOFaI98lQ1MCaYNhCiTOnZ/Ku0+Oj5hM=;
  b=bN636dybRpC/zYvCI5pSdAyQK1YKDxE5zWOIRCOeemwcAziFhORDT+Dy
   CRWdWazhejZNUEALYTlueYe7NuZ0ZXKhoYXnOim20DF4YhxihTdFJlgPG
   0ZfoMDhR7KGXuM1bEUoiM6biF/KHLCLmJrsque4DmdkwBe8fexhTRhFvB
   xt+m42n3wkUiqbcsLKbuE9HwjjNsdZULoaX6VOxmUoTSKrJdGMMsFEmP8
   vHFKeI2lvlHQDdO/SeiVDv4/nWO148R2IKJSL42idGxC0YD/gBBwLumGd
   +MIv9ZMJKYDD/rnrjTfPcstB5PXXDJb31iYCxbNi4qf2Asr7Z4o+t24o0
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10197"; a="302270744"
X-IronPort-AV: E=Sophos;i="5.88,204,1635231600"; 
   d="scan'208";a="302270744"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Dec 2021 19:57:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,204,1635231600"; 
   d="scan'208";a="481758605"
Received: from lkp-server02.sh.intel.com (HELO 9e1e9f9b3bcb) ([10.239.97.151])
  by orsmga002.jf.intel.com with ESMTP; 13 Dec 2021 19:57:08 -0800
Received: from kbuild by 9e1e9f9b3bcb with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1mwyw7-0007PY-Rn; Tue, 14 Dec 2021 03:57:07 +0000
Date:   Tue, 14 Dec 2021 11:56:24 +0800
...
Subject: drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:939:13:
 warning: stack frame size (1340) exceeds limit (1024) in
 'dml_rq_dlg_get_dlg_params'
Message-ID: <202112141115.g0ktQV8p-lkp@intel.com>
MIME-Version: 1.0
...
date:   6 months ago
config: i386-buildonly-randconfig-r001-20211213 (https://download.01.org/0day-ci/archive/20211214/202112141115.g0ktQV8p-lkp@intel.com/config)
...
All warnings (new ones prefixed by >>):
   ...
   drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:1007:15: warning: variable 'dispclk_delay_subtotal' set but not used [-Wunused-but-set-variable]
           unsigned int dispclk_delay_subtotal;
                        ^
>> drivers/gpu/drm/amd/amdgpu/../display/dc/dml/dcn31/display_rq_dlg_calc_31.c:939:13: warning: stack frame size (1340) exceeds limit (1024) in 'dml_rq_dlg_get_dlg_params' [-Wframe-larger-than]
