...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 578FF54D024
	for <lists+linux-kernel@lfdr.de>; Wed, 15 Jun 2022 19:39:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1357656AbiFORjC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 15 Jun 2022 13:39:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52830 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1357431AbiFORi7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 15 Jun 2022 13:38:59 -0400
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com [IPv6:2a00:1450:4864:20::435])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C74D352E52
        for <linux-kernel@vger.kernel.org>; Wed, 15 Jun 2022 10:38:55 -0700 (PDT)
Received: by mail-wr1-x435.google.com with SMTP id h5so16388396wrb.0
        for <linux-kernel@vger.kernel.org>; Wed, 15 Jun 2022 10:38:55 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=0xi3ldOIY1gDekxpm5S3GVzH5inV1UWvj0nNk19DHvs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=0xi3ldOIY1gDekxpm5S3GVzH5inV1UWvj0nNk19DHvs=;
        b=
X-Gm-Message-State: AJIora8mdbU5MlGsf17xsBqrxDiXjvqY+OHoL7zbIA359tt0pbQF5NRd
        4jPTaOsk4IxaBFEIuhulMh9qQoww5YN1KNb2ebl+Cw==
X-Google-Smtp-Source: AGRyM1vCTfE2VszRlWTTPJYFBijvzQTU4LLX0WJA3XBwrGUvV4etWUNKyHcQtXUH065gKGQ2bYa3Ll9Kpur3+NcszK8=
X-Received: by 2002:a05:6000:1a8d:b0:219:e3f2:c092 with SMTP id
 f13-20020a0560001a8d00b00219e3f2c092mr902396wry.375.1655314733217; Wed, 15
 Jun 2022 10:38:53 -0700 (PDT)
MIME-Version: 1.0
References: <20220615060354.1763693-1-irogers@google.com> <482ed1f6-af6f-b5cd-393f-77d91f24af9d@intel.com>
 <CAP-5=fWp7NifZm4B_xgnPURxsFbdUPnsyfgLaNQeOBSs+v99YQ@mail.gmail.com> <2524d9e0-644a-7a50-c654-36e973778cc2@intel.com>
In-Reply-To: <2524d9e0-644a-7a50-c654-36e973778cc2@intel.com>
From:   Ian Rogers <irogers@google.com>
Date:   Wed, 15 Jun 2022 10:38:40 -0700
Message-ID: <CAP-5=fXGiHpSjQBZOt2f-Ni9F7THW6CgNBZ0w+aA=DKBg85M=A@mail.gmail.com>
...
On Wed, Jun 15, 2022 at 9:40 AM Adrian Hunter <adrian.hunter@intel.com> wrote:
>
...
My understanding is that signal will specify SA_RESTART but sigaction
won't, so cases like:
https://git.kernel.org/pub/scm/linux/kernel/git/acme/linux.git/tree/tools/perf/util/evlist.c?h=perf/core#n1475
will cause EINTR. The existing code is partially EINTR resistant and
so I'm looking to see this be the norm. I think having a mix is
confusing, perhaps existing EINTR usage could be turned into asserts
to discover when this does happen. In general I think it is better to
be robust, which will matter more in contexts like libperf.
