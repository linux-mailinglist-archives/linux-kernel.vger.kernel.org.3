...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 79353576458
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Jul 2022 17:19:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235506AbiGOPTC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 Jul 2022 11:19:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56390 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234986AbiGOPSs (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 Jul 2022 11:18:48 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F161CFD4
        for <linux-kernel@vger.kernel.org>; Fri, 15 Jul 2022 08:18:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1657898318; x=1689434318;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=ZyXcfK4EcTMOzV3YgaqAlN/ZO6wToxRrCYmxeqBRK1Y=;
  b=hIt9Y1lvEF0jlwC7QgrWbTdUXdJqTeB6cDgd7LJIV4bZ7sB6+r1L5Rej
   VpybqysNK4MO3utw/7Kbrorc9S0Z66xjZ+UZvqdT74ch0pW45RRud/dQJ
   AosYfVBEP/ZeCJRtbdLw0S4AtbxjKxNRlmDESc7OeWuOwbvaxhENsLKU6
   mXdZIu9/sXSbCKkZ2IeqrDHzRgaTCZfbmIFW/vOL2vwaEe8Gx1WRu1Tf6
   mfM3CZ1luWQTXH+VvZgQV3JCt2YczWzuyXILWyQAXwW83uMaSwWHq68BL
   A9DZ0c3uZaMvg4UEwF8+xWk4T4FVYqmp6tiSiz/kOst28FPEio2TMYb+u
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10408"; a="311483505"
X-IronPort-AV: E=Sophos;i="5.92,274,1650956400"; 
   d="scan'208";a="311483505"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Jul 2022 08:18:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.92,274,1650956400"; 
   d="scan'208";a="738689523"
Received: from lkp-server02.sh.intel.com (HELO ff137eb26ff1) ([10.239.97.151])
  by fmsmga001.fm.intel.com with ESMTP; 15 Jul 2022 08:18:33 -0700
Received: from kbuild by ff137eb26ff1 with local (Exim 4.95)
        (envelope-from <lkp@intel.com>)
        id 1oCN5M-0000CG-BR;
        Fri, 15 Jul 2022 15:18:32 +0000
Date:   Fri, 15 Jul 2022 23:17:05 +0800
From:   kernel test robot <lkp@intel.com>
To:     Sebastian Reichel <sebastian.reichel@collabora.com>
Cc:     Paul Gazzillo <paul@pgazz.com>,
        Necip Fazil Yildiran <fazilyildiran@gmail.com>,
        kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [sre-misc:rk3588 39/42] kismet: WARNING: unmet direct dependencies
 detected for REGMAP_I2C when selected by SND_SOC_RK817
Message-ID: <202207151836.e65dLLVE-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="I5DiOTb50tGLKrhm"
...
reproduce:
        ...
        # 1. reproduce by kismet
           ...
           kismet --linux-ksrc=linux --selectees CONFIG_REGMAP_I2C --selectors CONFIG_SND_SOC_RK817 -a=i386
        # 2. reproduce by make
...
>> kismet: WARNING: unmet direct dependencies detected for REGMAP_I2C when selected by SND_SOC_RK817
   ...
   WARNING: unmet direct dependencies detected for REGMAP_I2C
     Depends on [n]: I2C [=n]
     Selected by [y]:
     - SND_SOC_RK817 [=y] && SOUND [=y] && !UML && SND [=y] && SND_SOC [=y] && MFD_RK808 [=y]
