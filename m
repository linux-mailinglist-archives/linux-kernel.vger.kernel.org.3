...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2EE4A574511
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Jul 2022 08:29:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234007AbiGNG3l (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Jul 2022 02:29:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49466 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229745AbiGNG3i (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Jul 2022 02:29:38 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1E22E64DC
        for <linux-kernel@vger.kernel.org>; Wed, 13 Jul 2022 23:29:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1657780174; x=1689316174;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=FpGSJHuKo3Xqye/YND8e97hvPTLP8N03g+ZHg6YMSPI=;
  b=BpdEWa2n4AOEfS4Ry6Fz5JPt/9T6K/5KCbe5t95xRqLLeCLtLmD1mD1E
   3hXixlOv+C5qVuzkctKPNmoNNiqcR6m2g4asKB0+ozo+fyugCLbSa7KCG
   s9jUjwYUC735W5nrHSboRgYxj18ZjWXU8cZAK1SmSeRFGJdEFqkG2n7nd
   /FNI1y4z43xCqz2jfdf5UPE5FLuUl3lxVuJn26/clANrKjUMfJdeXfAwj
   pWqrQrmi9hFYbchI2+H1+xbac91+xeIGmdbYZvQj5jPyLXoaywP92eYBj
   JGmbI4My5ale7fGQV1xmSK2S0/GbJlkNv/rFVBINlZqiRhCNDJ6/sxpgj
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10407"; a="284186049"
X-IronPort-AV: E=Sophos;i="5.92,269,1650956400"; 
   d="yaml'?scan'208";a="284186049"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jul 2022 23:29:33 -0700
X-IronPort-AV: E=Sophos;i="5.92,269,1650956400"; 
   d="yaml'?scan'208";a="546151960"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga003-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jul 2022 23:29:23 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="pwG91HJnUIUQ3oTj"
...
Content-Disposition: attachment;
	filename="config-5.19.0-rc4-00072-g64fe24a3e05e"
...
export_top_env()
{
	...
	export testtime=60
	export job_origin='stress-ng-class-cpu-cache.yaml'
...
kbuild_queue_analysis'
	...
	export submit_id='62ce949b4b75de126e1faff9'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-2ep1/stress-ng-cpu-cache-performance-100%-icache-60s-ucode=0x42e-debian-11.1-x86_64-20220510.cgz-64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8-20220713-4718-1m52mvc-3.yaml'
	export id='093f31248d1e3c4159890f181de3f4080de11b71'
	...
	export need_kconfig=
	export commit='64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6'
	export ucode='0x42e'
...
{"SCSI_SAS_ATA"=>"y"}'
	...
	export enqueue_time='2022-07-13 17:47:07 +0800'
	export _id='62ce949b4b75de126e1faff9'
	export _rt='/result/stress-ng/cpu-cache-performance-100%-icache-60s-ucode=0x42e/lkp-ivb-2ep1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6'
	export user='lkp'
	...
	export result_root='/result/stress-ng/cpu-cache-performance-100%-icache-60s-ucode=0x42e/lkp-ivb-2ep1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/3'
	export scheduler_version='/lkp/lkp/.src-20220713-131348'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-11.1-x86_64-20220510.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/cpu-cache-performance-100%-icache-60s-ucode=0x42e/lkp-ivb-2ep1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/vmlinuz-5.19.0-rc4-00072-g64fe24a3e05e
branch=linux-next/master
job=/lkp/jobs/scheduled/lkp-ivb-2ep1/stress-ng-cpu-cache-performance-100%-icache-60s-ucode=0x42e-debian-11.1-x86_64-20220510.cgz-64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8-20220713-4718-1m52mvc-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6
max_uptime=2100
...
rw'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/vmlinuz-5.19.0-rc4-00072-g64fe24a3e05e'
	export dequeue_time='2022-07-13 17:49:23 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-2ep1/stress-ng-cpu-cache-performance-100%-icache-60s-ucode=0x42e-debian-11.1-x86_64-20220510.cgz-64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8-20220713-4718-1m52mvc-3.cgz'
...
run_job()
{
	...
	run_test class='cpu-cache' test='icache' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='cpu-cache' test='icache' $LKP_SRC/stats/wrapper stress-ng
...
---
:#! jobs/stress-ng-class-cpu-cache.yaml:
suite: stress-ng
testcase: stress-ng
category: benchmark
nr_threads: 100%
...
stress-ng:
  class: cpu-cache
  test: icache
job_origin: stress-ng-class-cpu-cache.yaml
:#! queue options:
queue_cmdline_keys:
- branch
- commit
...
submit_id: 62ce83ec4b75de8f21840487
job_file: "/lkp/jobs/scheduled/lkp-ivb-2ep1/stress-ng-cpu-cache-performance-100%-icache-60s-ucode=0x42e-debian-11.1-x86_64-20220510.cgz-64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8-20220713-36641-4cs9gn-2.yaml"
id: fb2654fba499c0d18be0e27bcff4bdd6b1cc880e
...
- SCSI_SAS_ATA: y
bisect_dmesg: true
enqueue_time: 2022-07-13 16:35:56.920204183 +08:00
_id: 62ce87b24b75de8f21840489
_rt: "/result/stress-ng/cpu-cache-performance-100%-icache-60s-ucode=0x42e/lkp-ivb-2ep1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
result_root: "/result/stress-ng/cpu-cache-performance-100%-icache-60s-ucode=0x42e/lkp-ivb-2ep1/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/0"
scheduler_version: "/lkp/lkp/.src-20220713-131348"
arch: x86_64
max_uptime: 2100
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/vmlinuz-5.19.0-rc4-00072-g64fe24a3e05e
- branch=linux-devel/devel-hourly-20220707-184910
- job=/lkp/jobs/scheduled/lkp-ivb-2ep1/stress-ng-cpu-cache-performance-100%-icache-60s-ucode=0x42e-debian-11.1-x86_64-20220510.cgz-64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8-20220713-36641-4cs9gn-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/64fe24a3e05e5f3ac56fcd45afd2fd1d9cc8fcb6/vmlinuz-5.19.0-rc4-00072-g64fe24a3e05e"
dequeue_time: 2022-07-13 16:53:28.833198068 +08:00
:#! /cephfs/db/releases/20220713161514/lkp-src/include/site/inn:
job_state: finished
loadavg: 23.44 8.94 3.23 2/512 6563
start_time: '1657702481'
end_time: '1657702543'
version: "/lkp/lkp/.src-20220713-131424:ee84fe112:be52a6112"
...
do
 ...
 "stress-ng" "--timeout" "60" "--times" "--verify" "--metrics-brief" "--icache" "48"
