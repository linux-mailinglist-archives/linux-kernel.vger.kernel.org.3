...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0E3894DE079
	for <lists+linux-kernel@lfdr.de>; Fri, 18 Mar 2022 18:52:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240006AbiCRRwA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 18 Mar 2022 13:52:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37100 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239860AbiCRRvK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 18 Mar 2022 13:51:10 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 9CA1C173F60;
        Fri, 18 Mar 2022 10:49:50 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 6570B1570;
        Fri, 18 Mar 2022 10:49:50 -0700 (PDT)
Received: from eglon.cambridge.arm.com (eglon.cambridge.arm.com [10.1.196.218])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 9EE513F7B4;
        Fri, 18 Mar 2022 10:49:49 -0700 (PDT)
From:   James Morse <james.morse@arm.com>
To:     stable@vger.kernel.org
Cc:     linux-kernel@vger.kernel.org, james.morse@arm.com,
        catalin.marinas@arm.com
Subject: [stable:PATCH v4.19.235 19/22] arm64: Mitigate spectre style branch history side channels
...
index 5bfc335224e7..3a5336ba745c 100644
--- a/arch/arm64/include/asm/assembler.h
+++ b/arch/arm64/include/asm/assembler.h
@@ -713,7 +713,9 @@ USER(\label, ic	ivau, \tmp2)			// invalidate I line PoU
...
index e59b9ee43e4a..86a7dda74535 100644
...
index fe011f78ad86..50368f962213 100644
...
index ed99d941c462..b7b102292498 100644
...
index 791dd8dadd9e..f96ab92545d7 100644
...
@@ -848,6 +849,13 @@ const struct arm64_cpu_capabilities arm64_errata[] = {
...
@@ -938,6 +946,33 @@ ssize_t cpu_show_spec_store_bypass(struct device *dev,
...
+ */
 ...
 enum mitigation_state arm64_get_spectre_bhb_state(void)
@@ -945,6 +980,163 @@ enum mitigation_state arm64_get_spectre_bhb_state(void)
...
+
 ...
 {
@@ -960,7 +1152,7 @@ static const char *kvm_bhb_get_vecs_end(const char *start)
 	return NULL;
 }
...
@@ -996,5 +1188,77 @@ void kvm_setup_bhb_slot(const char *hyp_vecs_start)
...
index 05593f631eca..55ed2cb81dc6 100644
