...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 59E284DE8D0
	for <lists+linux-kernel@lfdr.de>; Sat, 19 Mar 2022 15:44:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243347AbiCSOpu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 19 Mar 2022 10:45:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57744 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243333AbiCSOpo (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 19 Mar 2022 10:45:44 -0400
Received: from mail-pj1-x1033.google.com (mail-pj1-x1033.google.com [IPv6:2607:f8b0:4864:20::1033])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 53AC81AA8EB;
        Sat, 19 Mar 2022 07:44:21 -0700 (PDT)
Received: by mail-pj1-x1033.google.com with SMTP id bx24-20020a17090af49800b001c6872a9e4eso6671293pjb.5;
        Sat, 19 Mar 2022 07:44:21 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=sender:from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=l7JM11t0DKfFmZNMJ8A+5QKIOMbnmMHOUMQjbuFnG1Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=l7JM11t0DKfFmZNMJ8A+5QKIOMbnmMHOUMQjbuFnG1Y=;
        b=
X-Gm-Message-State: AOAM533rGezIwmwWP2zvIZ+feTsNtsqoC2KHEwFTZWSxcPqHPVqVqwXT
        IVIoC38tOhrKmdn/Pza3qZU=
X-Google-Smtp-Source: ABdhPJx/k6DjlcrupGU1eisKcX6ltg9JVp9jTeJ/oAvM/KNXgqa1NBROL3xDp37bws88mMuoLbwt2w==
X-Received: by 2002:a17:90b:78a:b0:1c6:d793:9d16 with SMTP id l10-20020a17090b078a00b001c6d7939d16mr3044259pjz.235.1647701060429;
        Sat, 19 Mar 2022 07:44:20 -0700 (PDT)
Received: from localhost.localdomain ([50.7.60.25])
        by smtp.gmail.com with ESMTPSA id q12-20020a17090aa00c00b001bc6f1baaaesm14546829pjp.39.2022.03.19.07.44.11
...
Subject: [PATCH V8 20/22] LoongArch: Add multi-processor (SMP) support
Date:   Sat, 19 Mar 2022 22:38:15 +0800
Message-Id: <20220319143817.1026708-13-chenhuacai@loongson.cn>
...
index e3b1b98b9e9a..f19a274870c0 100644
--- a/arch/loongarch/include/asm/pgtable.h
+++ b/arch/loongarch/include/asm/pgtable.h
@@ -300,8 +300,29 @@ static inline void set_pte(pte_t *ptep, pte_t pteval)
...
index b5e89333eff7..6a8f292e6645 100644
--- a/arch/loongarch/kernel/asm-offsets.c
+++ b/arch/loongarch/kernel/asm-offsets.c
@@ -253,3 +253,11 @@ void output_signal_defines(void)
...
index f10212dba59a..323775e502bd 100644
...
index b4a0b28da3e7..12325386d7b4 100644
--- a/arch/loongarch/kernel/head.S
+++ b/arch/loongarch/kernel/head.S
@@ -69,4 +69,34 @@ SYM_CODE_START(kernel_entry)			# kernel entry point
...
new file mode 100644
index 000000000000..c0f1aca1eb7e
--- /dev/null
...
index de9ea1a08ad8..5a87e95d52d8 100644
...
index 2caee2154f17..fd11b6506b87 100644
