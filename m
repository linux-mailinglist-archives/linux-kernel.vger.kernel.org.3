...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0C025511AF2
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Apr 2022 16:57:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235587AbiD0NPN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 Apr 2022 09:15:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43640 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235544AbiD0NO5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 Apr 2022 09:14:57 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 24D98255A0;
        Wed, 27 Apr 2022 06:11:43 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 8E38661BBE;
        Wed, 27 Apr 2022 13:11:42 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 280F5C385A7;
        Wed, 27 Apr 2022 13:11:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1651065102;
        bh=bmh18ONiBDbLCQfiaOlXmrm4DZ+PGZlD/9kDI+9aWXA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=D1OSHLEl1NkOMPQHCb5ciESY0ZJ0TuGiDxAyaa/sjz0YP5LnsJlDmPFgI63aYTecB
         OKmbwZ67+kY/nu3o2ktzl/15px8R+wQHVWJeS/klH+IayQJlRqeqwVPPvBiKg/bXMz
         LN+TNfqCx/7+KTIgvWgHZL7hbLMhRUbec27f4V8Q=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.10.113
Date:   Wed, 27 Apr 2022 15:11:29 +0200
Message-Id: <1651065089132221@kroah.com>
X-Mailer: git-send-email 2.36.0
In-Reply-To: <165106508947180@kroah.com>
References: <165106508947180@kroah.com>
MIME-Version: 1.0
...
index 05013bf5a469..99bbaa9f54f4 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index f3a70dc7c594..3f74db7b0a31 100644
...
index 7b41cdff1a2c..51af0dfc3c63 100644
...
index bbdd086be7f5..4b92c6341490 100644
...
index 455eb349c76f..8329961546b5 100644
--- a/fs/ext4/ext4.h
+++ b/fs/ext4/ext4.h
...
index 0fda3051760d..80b876ab6b1f 100644
--- a/fs/ext4/extents.c
+++ b/fs/ext4/extents.c
...
index 96546df39bcf..31ab73c4b07e 100644
--- a/fs/ext4/inode.c
+++ b/fs/ext4/inode.c
...
index a622e186b7ee..47ea35e98ffe 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
index defd2e10dfd1..4569075a7da0 100644
--- a/fs/ext4/page-io.c
+++ b/fs/ext4/page-io.c
...
index 9e210bc85c81..5e6c03458317 100644
--- a/fs/ext4/super.c
+++ b/fs/ext4/super.c
...
@@ -4931,9 +4933,18 @@ static int ext4_fill_super(struct super_block *sb, void *data, int silent)
...
index 5fc9ccab907c..a2f43f1a85f8 100644
...
index b121d7d434c6..867362f45cf6 100644
--- a/fs/jbd2/commit.c
+++ b/fs/jbd2/commit.c
...
index f996d1f343bb..4bca80c9931f 100644
...
index 46c160d4eac1..102f73ed4b1b 100644
--- a/mm/mmap.c
+++ b/mm/mmap.c
...
index 419a814f467e..3d7c557fb70c 100644
--- a/mm/oom_kill.c
+++ b/mm/oom_kill.c
@@ -633,7 +633,7 @@ static void oom_reap_task(struct task_struct *tsk)
 	 */
...
index 9a0263f25232..1f6c752f13b4 100644
