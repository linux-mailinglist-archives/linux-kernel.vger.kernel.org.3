...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 790C84C7113
	for <lists+linux-kernel@lfdr.de>; Mon, 28 Feb 2022 16:57:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237440AbiB1P61 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Feb 2022 10:58:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39630 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232034AbiB1P6X (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Feb 2022 10:58:23 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D3EC1A1B8
        for <linux-kernel@vger.kernel.org>; Mon, 28 Feb 2022 07:57:40 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1646063860; x=1677599860;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=BJSh2M/eztOX87CpuDAg4haCZWcfoS+hEq8IJ6jGhT0=;
  b=iCyrArw2Y2vD+RKk9Pq1oRCHQGZOZhjFUEKb9n0GRVCPeyIwtSx4IN0Y
   RsJPmkqp5WukLqn6YKu1evecmIVo47zDQM661yiA43FmC7USoo9iC9KE4
   9/U48mkAv9hfgxPM+e9m0YtOldjygWrLz2G3Bi3Z1ZbWaBWvFGkmoEiSi
   OtBjToztESBMR/hPFiKpY1aFke6jlIy5glRUEDKZiY9VRVjeDjXbCFzkX
   KpvlHin14clfEz7ojEzNje9d2+wjgCi0Lcs0lyERHZL1zjL6WuHdvCzH9
   2unKAHXPOl/yQzdV3/qAMwc+I0IZV90bfbNp0FZMaKGfihBQX5aaJGj8S
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10272"; a="253106161"
X-IronPort-AV: E=Sophos;i="5.90,142,1643702400"; 
   d="yaml'?scan'208";a="253106161"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Feb 2022 07:57:39 -0800
X-IronPort-AV: E=Sophos;i="5.90,142,1643702400"; 
   d="yaml'?scan'208";a="550291571"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Feb 2022 07:57:36 -0800
...
Content-Disposition: attachment; filename="config-5.17.0-rc5-00006-g39907a939a34"
...
commit'
	...
	export submit_id='621bbf9b68b653d8dff560d7'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-39907a939a34033eeea11275-20220228-55519-1sdp1f2-3.yaml'
	export id='9ac2b9c30e380f93e76fb3f68466473c72565a2b'
	...
	export commit='39907a939a34033eeea112751f0e4330628d3a9a'
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-02-28 02:14:51 +0800'
	export _id='621bbf9b68b653d8dff560d7'
	export _rt='/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a'
	export user='lkp'
	...
	export result_root='/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/3'
	export scheduler_version='/lkp/lkp/.src-20220225-152656'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/vmlinuz-5.17.0-rc5-00006-g39907a939a34
branch=mel/mm-pcpllist-v1r2
job=/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-39907a939a34033eeea11275-20220228-55519-1sdp1f2-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=39907a939a34033eeea112751f0e4330628d3a9a
...
run_job()
{
	...
	if role client
	then
		run_test test='UDP_STREAM' $LKP_SRC/tests/wrapper netperf
	fi
}
...
extract_stats()
{
	...
	env test='UDP_STREAM' $LKP_SRC/stats/wrapper netperf
...
kconfig: x86_64-rhel-8.3
submit_id: 621baec768b653d298b3a2ec
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-39907a939a34033eeea11275-20220228-53912-1ow2mbk-0.yaml"
id: a6c1c4ffee3975ac66df47502989dc4858bd27a9
...
ucode: '0xd000331'
bisect_dmesg: true
enqueue_time: 2022-02-28 01:03:03.546058983 +08:00
_id: 621baec768b653d298b3a2ec
_rt: "/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a"
:#! schedule options:
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
...
result_root: "/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/vmlinuz-5.17.0-rc5-00006-g39907a939a34
- branch=linux-devel/devel-hourly-20220227-112335
- job=/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-39907a939a34033eeea11275-20220228-53912-1ow2mbk-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=39907a939a34033eeea112751f0e4330628d3a9a
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.17.0-rc5-wt-ath-06619-ge7c02a777df0
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/39907a939a34033eeea112751f0e4330628d3a9a/vmlinuz-5.17.0-rc5-00006-g39907a939a34"
dequeue_time: 2022-02-28 01:38:07.094548350 +08:00
job_state: finished
loadavg: 1.81 1.37 0.64 1/967 15440
start_time: '1645983579'
end_time: '1645983880'
...
netserver -4 -D
netperf -4 -H 127.0.0.1 -t UDP_STREAM -c -C -l 300  &
wait
