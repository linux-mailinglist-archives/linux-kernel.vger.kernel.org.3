...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C77EB46EA30
	for <lists+linux-kernel@lfdr.de>; Thu,  9 Dec 2021 15:41:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238803AbhLIOpZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 9 Dec 2021 09:45:25 -0500
Received: from mga11.intel.com ([192.55.52.93]:57022 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231863AbhLIOpW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 9 Dec 2021 09:45:22 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1639060909; x=1670596909;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=DhKn4VjlgJ+ekRulE1FmtOEKDuWKkEGwZg922xtGBsA=;
  b=cBlnCBYVzM70MjKc2cgZO/xAmLtjZLc1o5DxpRUL1x4WCv0uKFdGyCBE
   PXOeYh8CyYuqm2mLwKArSGi/rGbba4VxwyP/w+c6B0305CIBg3g6dPylK
   TeVh99Q7v680UGf1D1EnUVdpuwrKrHw11Vxp3I3DHkVppw+D0Oz2V+nVA
   cymAXmkm5tazroNqJyWjk6czKwedldnXjsXgGXB6UwXnvq8RCYCUsev2M
   RSddYQtnYS4CF5Up0U3CWM6ECExDwL5TObE+x7UoswwcMdbEqr2jq11Vo
   RFwf5Z9TWCmRmCAnH7LeAzjyb778rvlwfyofSwU0evB6zx1m6msulVtgQ
   g==;
X-IronPort-AV: E=McAfee;i="6200,9189,10192"; a="235622683"
X-IronPort-AV: E=Sophos;i="5.88,192,1635231600"; 
   d="xz'?scan'208";a="235622683"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Dec 2021 06:41:48 -0800
X-IronPort-AV: E=Sophos;i="5.88,192,1635231600"; 
   d="xz'?scan'208";a="516322915"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Dec 2021 06:41:44 -0800
Date:   Thu, 9 Dec 2021 22:41:41 +0800
...
Subject: [x86/mm/64]  f154f29085:
 BUG:kernel_reboot-without-warning_in_boot_stage
Message-ID: <20211209144141.GC25654@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
commit: f154f290855b070cc94dd44ad253c0ef8a9337bb ("x86/mm/64: Flush global =
TLB on boot and AP bringup")
...
Command line: ip=3D::::vm-snb-192::dhcp root=3D/dev/ram0 user=3Dlkp job=3D/=
lkp/jobs/scheduled/vm-snb-192/boot-1-debian-10.4-x86_64-20200603.cgz-f154f2=
90855b070cc94dd44ad253c0ef8a9337bb-20211208-23538-lnvkeg-5.yaml ARCH=3Dx86_=
64 kconfig=3Dx86_64-randconfig-a013-20211207 branch=3Dtip/x86/mm commit=3Df=
154f290855b070cc94dd44ad253c0ef8a9337bb BOOT_IMAGE=3D/pkg/linux/x86_64-rand=
config-a013-20211207/clang-14/f154f290855b070cc94dd44ad253c0ef8a9337bb/vmli=
nuz-5.16.0-rc3-00003-gf154f290855b vmalloc=3D128M initramfs_async=3D0 page_=
owner=3Don max_uptime=3D600 RESULT_ROOT=3D/result/boot/1/vm-snb/debian-10.4=
-x86_64-20200603.cgz/x86_64-randconfig-a013-20211207/clang-14/f154f290855b0=
70cc94dd44ad253c0ef8a9337bb/3 LKP_SERVER=3Dinternal-lkp-server selinux=3D0 =
...
tk=3DttyS0,115200 console=3DttyS0,115200 vga=3Dnormal rw rcuperf.shutdown=
...
--ncSAzJYg3Aa9+CRW
Content-Type: text/plain; charset=us-ascii
Content-Disposition: attachment; filename="config-5.16.0-rc3-00003-gf154f290855b"
...

