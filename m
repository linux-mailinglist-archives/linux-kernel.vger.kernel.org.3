...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9988C53A4E6
	for <lists+linux-kernel@lfdr.de>; Wed,  1 Jun 2022 14:26:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1352662AbiFAM0L (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 1 Jun 2022 08:26:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57294 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237528AbiFAM0F (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 1 Jun 2022 08:26:05 -0400
Received: from out3-smtp.messagingengine.com (out3-smtp.messagingengine.com [66.111.4.27])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AA4603DA5C;
        Wed,  1 Jun 2022 05:26:02 -0700 (PDT)
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.nyi.internal (Postfix) with ESMTP id EB4E65C021C;
        Wed,  1 Jun 2022 08:26:01 -0400 (EDT)
Received: from imap44 ([10.202.2.94])
  by compute4.internal (MEProxy); Wed, 01 Jun 2022 08:26:01 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; h=
        cc:cc:content-transfer-encoding:content-type:date:date:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to; s=fm2; t=1654086361; x=
        1654172761; bh=NhU7VLvxzUG9v6H/5YDGHuRcs0Gz8ACJPlNwUHvWUfk=; b=b
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:cc:content-transfer-encoding
        :content-type:date:date:feedback-id:feedback-id:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to:x-me-proxy:x-me-proxy
        :x-me-sender:x-me-sender:x-sasl-enc; s=fm1; t=1654086361; x=
        1654172761; bh=NhU7VLvxzUG9v6H/5YDGHuRcs0Gz8ACJPlNwUHvWUfk=; b=b
        
X-ME-Sender: <xms:2FqXYtSkyHyR9B_oin09jxeNXk69LQGdJnmAX-hBdatv-KjDP5ci8A>
    <xme:2FqXYmzC6nhdHAKkfoOGoQkxFNgO6h-zGgd3UVTJaKAThr9EOQ1SvMg_DyVUtLmBr
    18ux-gRjkpSGxKtM_M>
...
X-ME-Proxy: <xmx:2VqXYi0okkEXNm-EWBGipsfqAsfVFeBsMDoXPYrbmytAvFj-L5s1AQ>
    <xmx:2VqXYlD1so-db9zE5Mhd7kFdL6hpkFQ8ag0AKtbr9AQlX85TSVMVHw>
    <xmx:2VqXYmgXnLltFNU7nSn5tAQpixuBXPc8Uu5SSzKhFrPa7CgxhPO1eA>
    <xmx:2VqXYtTJwKnKcj2LCkzFfs0uohNQPM0xpplmqaMnLQmnJ3-NMdFKwQ>
Feedback-ID: ifd894703:Fastmail
Received: by mailuser.nyi.internal (Postfix, from userid 501)
        id E53F036A006D; Wed,  1 Jun 2022 08:26:00 -0400 (EDT)
X-Mailer: MessagingEngine.com Webmail Interface
User-Agent: Cyrus-JMAP/3.7.0-alpha0-591-gfe6c3a2700-fm-20220427.001-gfe6c3a27
Mime-Version: 1.0
Message-Id: <0d445de3-935c-4993-abe6-9ef8c6e4eb34@www.fastmail.com>
In-Reply-To: <20220601100005.2989022-9-chenhuacai@loongson.cn>
References: <20220601100005.2989022-1-chenhuacai@loongson.cn>
 <20220601100005.2989022-9-chenhuacai@loongson.cn>
Date:   Wed, 01 Jun 2022 13:25:39 +0100
...
Subject: Re: [PATCH V12 08/24] LoongArch: Add CPU definition headers
...
>
> diff --git a/arch/loongarch/include/asm/addrspace.h=20
...
> diff --git a/arch/loongarch/include/asm/cpu-features.h=20
...
> +#define cpu_has_loongarch32		(cpu_data[0].isa_level &=20
> LOONGARCH_CPU_ISA_32BIT)
> +#define cpu_has_loongarch64		(cpu_data[0].isa_level &=20
> LOONGARCH_CPU_ISA_64BIT)
> +
...
> +
> +#ifdef CONFIG_32BIT
> +# define cpu_has_64bits			(cpu_data[0].isa_level &=20
> LOONGARCH_CPU_ISA_64BIT)
...
> +#define cpu_has_lbt		(cpu_has_lbt_x86|cpu_has_lbt_arm|cpu_has_lbt_mip=
s)
...
> diff --git a/arch/loongarch/include/asm/cpu-info.h=20
...
> +	struct cache_desc	vcache; /* Victim cache, between pcache and scache=20
> */
...
*/
> +	unsigned int		watch_reg_use_cnt; /* min(NUM_WATCH_REGS,=20
...
> +extern int proc_cpuinfo_notifier_call_chain(unsigned long val, void=20
> *v);
> +
...
> +{
> +	struct cpuinfo_loongarch *infoa =3D &cpu_data[cpua];
> +	struct cpuinfo_loongarch *infob =3D &cpu_data[cpub];
> +
> +	if (infoa->package !=3D infob->package)
> +		return false;
> +
> +	if (infoa->core !=3D infob->core)
> +		return false;
> +
> +	return true;
> +}
> +
> +static inline unsigned long cpu_asid_mask(struct cpuinfo_loongarch=20
> *cpuinfo)
> +{
> +	return cpuinfo->asid_mask;
> +}
> +
> +static inline void set_cpu_asid_mask(struct cpuinfo_loongarch *cpuinf=
o,
> +				     unsigned long asid_mask)
> +{
> +	cpuinfo->asid_mask =3D asid_mask;
> +}
> +
> +#endif /* __ASM_CPU_INFO_H */
> diff --git a/arch/loongarch/include/asm/cpu.h=20
...
> +
> +/*
> + * As described in LoongArch specs from Loongson Technology, the PRID=20
> register
...
> +
> +/*
> + * Assigned Series ID values for bits 15:12 of the PRID register. In=20
> order
> + * to detect a certain CPU type exactly eventually additional=20
> registers may
> + * need to be examined.
> + */
> +
...
> +#define PRID_SERIES_LA364	0xb000  /* Loongson 64bit=EF=BC=8C3-issue */
...
> +
> +#define LOONGARCH_CPU_ISA_32BIT (LOONGARCH_CPU_ISA_LA32R |=20
...
> +#define CPU_FEATURE_EIODECODE		22	/* CPU has EXTIOI interrupt pin=20
> decode mode */
> +#define CPU_FEATURE_GUESTID		23	/* CPU has GuestID feature */
> +#define CPU_FEATURE_HYPERVISOR		24	/* CPU has hypervisor (running in=20
> VM) */
> +
...
> +
> +#endif /* _ASM_CPU_H */
> diff --git a/arch/loongarch/include/asm/fpregdef.h=20
...
> +
> +#define fa0	$f0	/* argument registers, fa0/fa1 reused as fv0/fv1 for=20
> return value */
> +#define fa1	$f1
> +#define fa2	$f2
> +#define fa3	$f3
...
> diff --git a/arch/loongarch/include/asm/loongarch.h=20
...
> + * corresponding register number, which is assigned to the variable=20
> \var. It is
> + * needed to allow explicit encoding of instructions in inline=20
> assembly where
> + * registers are chosen by the compiler in $n form, allowing us to=20
> avoid using
> + * fixed register numbers.
> + *
> + * It also allows newer instructions (not implemented by the=20
> assembler) to be
> + * transparently implemented using assembler macros, instead of=20
> needing separate
...
> +#define  CSR_ESTAT_ESUBCODE		(_ULCAST_(0x1ff) <<=20
...
> +#define  CSR_TLBLO0_PFN			(_ULCAST_(0xfffffffff) <<=20
...
> +#define  CSR_TLBLO1_PFN			(_ULCAST_(0xfffffffff) <<=20
...
> +#define  CSR_GTLBC_GMTLBSZ		(_ULCAST_(0x3f) << CSR_GTLBC_GMTLBSZ_SHIF=
T)
> +
...
> +
> +#define LOONGARCH_CSR_PGDL		0x19	/* Page table base address when=20
> VA[47] =3D 0 */
> +
> +#define LOONGARCH_CSR_PGDH		0x1a	/* Page table base address when=20
> VA[47] =3D 1 */
> +
...
> +#define  CSR_CONF1_TMRBITS		(_ULCAST_(0xff) << CSR_CONF1_TMRBITS_SHIF=
T)
...
> +#define  CSR_TCFG_VAL			(_ULCAST_(0x3fffffffffff) <<=20
> CSR_TCFG_VAL_SHIFT)
...
> +#define  CSR_GCFG_GCIP_HIT		(_ULCAST_(0x1) << (CSR_GCFG_GCIP_SHIFT +=20
> 1))
> +#define  CSR_GCFG_GCIP_SECURE		(_ULCAST_(0x1) << (CSR_GCFG_GCIP_SHIFT=20
> + 2))
...
> +#define LOONGARCH_CSR_TLBRSAVE		0x8b	/* KSave for TLB refill exceptio=
n=20
> */
...
> +#define LOONGARCH_CSR_MERRSAVE		0x95	/* KSave for machine error=20
> exception */
> +
...
> +#define LOONGARCH_CSR_PERFCNTR0		0x201	/* 64 perf event 0 count value=20
> */
> +#define LOONGARCH_CSR_PERFCTRL1		0x202	/* 32 perf event 1 config */
> +#define LOONGARCH_CSR_PERFCNTR1		0x203	/* 64 perf event 1 count value=20
> */
> +#define LOONGARCH_CSR_PERFCTRL2		0x204	/* 32 perf event 2 config */
> +#define LOONGARCH_CSR_PERFCNTR2		0x205	/* 64 perf event 2 count value=20
> */
> +#define LOONGARCH_CSR_PERFCTRL3		0x206	/* 32 perf event 3 config */
> +#define LOONGARCH_CSR_PERFCNTR3		0x207	/* 64 perf event 3 count value=20
> */
...
> +	uint64_t val =3D 0;
> +
> +	val =3D IOCSR_ANY_SEND_BLOCKING | addr;
> +	val |=3D (cpu << IOCSR_ANY_SEND_CPU_SHIFT);
> +	val |=3D (data_mask << IOCSR_ANY_SEND_MASK_SHIFT);
> +	val |=3D ((uint64_t)data << IOCSR_ANY_SEND_BUF_SHIFT);
> +	iocsr_write64(val, LOONGARCH_IOCSR_ANY_SEND);
> +}
> +
> +static inline unsigned int read_csr_excode(void)
> +{
> +	return (csr_read32(LOONGARCH_CSR_ESTAT) & CSR_ESTAT_EXC) >>=20
> CSR_ESTAT_EXC_SHIFT;
> +}
> +
...
> +{
> +	return (csr_read32(LOONGARCH_CSR_TLBIDX) & CSR_TLBIDX_SIZEM) >>=20
> CSR_TLBIDX_SIZE;
> +}
> +
> +static inline void write_csr_pagesize(unsigned int size)
> +{
> +	csr_xchg32(size << CSR_TLBIDX_SIZE, CSR_TLBIDX_SIZEM,=20
> LOONGARCH_CSR_TLBIDX);
> +}
> +
> +static inline unsigned int read_csr_tlbrefill_pagesize(void)
> +{
> +	return (csr_read64(LOONGARCH_CSR_TLBREHI) & CSR_TLBREHI_PS) >>=20
> CSR_TLBREHI_PS_SHIFT;
> +}
> +
> +static inline void write_csr_tlbrefill_pagesize(unsigned int size)
> +{
> +	csr_xchg64(size << CSR_TLBREHI_PS_SHIFT, CSR_TLBREHI_PS,=20
...
> +#define write_csr_entrylo0(val)		csr_write64(val,=20
> LOONGARCH_CSR_TLBELO0)
> +#define read_csr_entrylo1()		csr_read64(LOONGARCH_CSR_TLBELO1)
> +#define write_csr_entrylo1(val)		csr_write64(val,=20
...
> +#define write_csr_stlbpgsize(val)	csr_write32(val,=20
...
> +#define write_csr_tintclear(val)	csr_write32(val,=20
> LOONGARCH_CSR_TINTCLR)
> +#define read_csr_impctl1()		csr_read64(LOONGARCH_CSR_IMPCTL1)
> +#define write_csr_impctl1(val)		csr_write64(val, LOONGARCH_CSR_IMPCTL=
1)
> +#define write_csr_impctl2(val)		csr_write64(val, LOONGARCH_CSR_IMPCTL=
2)
> +
...
> +#define write_csr_perfctrl0(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCTRL0)
> +#define write_csr_perfcntr0(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCNTR0)
> +#define write_csr_perfctrl1(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCTRL1)
> +#define write_csr_perfcntr1(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCNTR1)
> +#define write_csr_perfctrl2(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCTRL2)
> +#define write_csr_perfcntr2(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCNTR2)
> +#define write_csr_perfctrl3(val)	csr_write64(val,=20
> LOONGARCH_CSR_PERFCTRL3)
> +#define write_csr_perfcntr3(val)	csr_write64(val,=20
...
> diff --git a/arch/loongarch/include/asm/loongson.h=20
...
> +#define LOONGSON_CHIPTEMP(id) (*(volatile u32=20
> *)(loongson_chiptemp[id]))
> +
> +/* Freq Control register of each physical cpu package */
> +extern u64 loongson_freqctrl[MAX_PACKAGES];
> +#define LOONGSON_FREQCTRL(id) (*(volatile u32=20
> *)(loongson_freqctrl[id]))
> +
...
> +}
> +
> +static inline void xconf_writeq(u64 val64, volatile void __iomem *add=
r)
> +{
> +	asm volatile (
> +	"	st.d	%[v], %[hw], 0	\n"
...
> +}
> +
> +/* =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D LS7A registers =3D=3D=3D=
...
> +
> +#define LS7A_DMA_CFG			(volatile void=20
> *)TO_UNCACHE(LS7A_CHIPCFG_REG_BASE + 0x041c)
> +#define LS7A_DMA_NODE_SHF		8
> +#define LS7A_DMA_NODE_MASK		0x1F00
> +
> +#define LS7A_INT_MASK_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x020)
> +#define LS7A_INT_EDGE_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x060)
> +#define LS7A_INT_CLEAR_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x080)
> +#define LS7A_INT_HTMSI_EN_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x040)
> +#define LS7A_INT_ROUTE_ENTRY_REG	(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x100)
> +#define LS7A_INT_HTMSI_VEC_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x200)
> +#define LS7A_INT_STATUS_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x3a0)
> +#define LS7A_INT_POL_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x3e0)
> +#define LS7A_LPC_INT_CTL		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x2000)
> +#define LS7A_LPC_INT_ENA		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x2004)
> +#define LS7A_LPC_INT_STS		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x2008)
> +#define LS7A_LPC_INT_CLR		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x200c)
> +#define LS7A_LPC_INT_POL		(volatile void=20
> *)TO_UNCACHE(LS7A_PCH_REG_BASE + 0x2010)
> +
> +#define LS7A_PMCON_SOC_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x000)
> +#define LS7A_PMCON_RESUME_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x004)
> +#define LS7A_PMCON_RTC_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x008)
> +#define LS7A_PM1_EVT_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x00c)
> +#define LS7A_PM1_ENA_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x010)
> +#define LS7A_PM1_CNT_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x014)
> +#define LS7A_PM1_TMR_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x018)
> +#define LS7A_P_CNT_REG			(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x01c)
> +#define LS7A_GPE0_STS_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x028)
> +#define LS7A_GPE0_ENA_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x02c)
> +#define LS7A_RST_CNT_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x030)
> +#define LS7A_WD_SET_REG			(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x034)
> +#define LS7A_WD_TIMER_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x038)
> +#define LS7A_THSENS_CNT_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x04c)
> +#define LS7A_GEN_RTC_1_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x050)
> +#define LS7A_GEN_RTC_2_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x054)
> +#define LS7A_DPM_CFG_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x400)
> +#define LS7A_DPM_STS_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x404)
> +#define LS7A_DPM_CNT_REG		(volatile void=20
> *)TO_UNCACHE(LS7A_ACPI_REG_BASE + 0x408)
> +
> +typedef enum {
> +	ACPI_PCI_HOTPLUG_STATUS	=3D 1 << 1,
> +	ACPI_CPU_HOTPLUG_STATUS	=3D 1 << 2,
> +	ACPI_MEM_HOTPLUG_STATUS	=3D 1 << 3,
> +	ACPI_POWERBUTTON_STATUS	=3D 1 << 8,
> +	ACPI_RTC_WAKE_STATUS	=3D 1 << 10,
> +	ACPI_PCI_WAKE_STATUS	=3D 1 << 14,
> +	ACPI_ANY_WAKE_STATUS	=3D 1 << 15,
> +} AcpiEventStatusBits;
> +
...
> +#define ls7a_writeb(val, addr)	*(volatile unsigned char =20
> *)TO_UNCACHE(addr) =3D (val)
> +#define ls7a_writew(val, addr)	*(volatile unsigned short=20
> *)TO_UNCACHE(addr) =3D (val)
> +#define ls7a_writel(val, addr)	*(volatile unsigned int  =20
> *)TO_UNCACHE(addr) =3D (val)
> +#define ls7a_writeq(val, addr)	*(volatile unsigned long =20
> *)TO_UNCACHE(addr) =3D (val)
> +
> +#endif /* __ASM_LOONGSON_H */
> diff --git a/arch/loongarch/include/asm/regdef.h=20
...
> +#define a0	$r4	/* argument registers, a0/a1 reused as v0/v1 for retur=
n=20
> value */
> +#define a1	$r5
> +#define a2	$r6
