...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3D22C55C876
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Jun 2022 14:55:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241230AbiF0U1E (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Jun 2022 16:27:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49018 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241206AbiF0U0p (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Jun 2022 16:26:45 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E38A31A80F
        for <linux-kernel@vger.kernel.org>; Mon, 27 Jun 2022 13:26:41 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 5FA58B81B1B
        for <linux-kernel@vger.kernel.org>; Mon, 27 Jun 2022 20:26:40 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 08371C341CB;
        Mon, 27 Jun 2022 20:26:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1656361600;
        bh=Dexiut5UTGQbWVPoVExzxDYja81/qHYNZtBpPLkvCuQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=pjAFMHoLlvkX8g7EGEJ1JQvCrWsAUllBQCcpbhd67tx9XgKq0UVOoVzc4VlIwRU/m
         0Zs9F9RxCaKDhZHAd6mNT2nkG1bRAoxrXu6KEYgnvSnOH/RMniKxTiNI0rZmsi9UI8
         CMFIXAnBTLfR4uPcaWHnoR7tua4A54ip1DsQu4+3sUVU9pw0PQprU21UnfWBnjsIHE
...
Subject: [PATCH 07/12] habanalabs/gaudi2: add gaudi2 security module
Date:   Mon, 27 Jun 2022 23:26:15 +0300
Message-Id: <20220627202620.961350-8-ogabbay@kernel.org>
...
---
 drivers/misc/habanalabs/gaudi2/Makefile       |    2 +-
 ...
 4 files changed, 3867 insertions(+), 2 deletions(-)
...
index e4857daa1253..9fbd905166a2 100644
...
index 78a1b115a459..669dee491132 100644
--- a/drivers/misc/habanalabs/gaudi2/gaudi2.c
+++ b/drivers/misc/habanalabs/gaudi2/gaudi2.c
@@ -2700,6 +2700,7 @@ static int gaudi2_late_init(struct hl_device *hdev)
...
@@ -5958,6 +5970,7 @@ static int gaudi2_non_hard_reset_late_init(struct hl_device *hdev)
 	 */
 	gaudi2_init_arcs(hdev);
 	gaudi2_scrub_arcs_dccm(hdev);
+	gaudi2_init_security(hdev);
...
@@ -9731,12 +9744,13 @@ static const struct hl_asic_funcs gaudi2_funcs = {
...
index e5ba1fdac61a..dc0094a2a911 100644
...
index 000000000000..afca8352a223
--- /dev/null
