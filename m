...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C27FD4C559D
	for <lists+linux-kernel@lfdr.de>; Sat, 26 Feb 2022 12:16:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231481AbiBZLQj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 26 Feb 2022 06:16:39 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47816 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231461AbiBZLQg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 26 Feb 2022 06:16:36 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A2561A948A;
        Sat, 26 Feb 2022 03:16:00 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id DD78B6113B;
        Sat, 26 Feb 2022 11:15:59 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 37EC3C340E8;
        Sat, 26 Feb 2022 11:15:55 +0000 (UTC)
...
Subject: [PATCH V6 20/22] LoongArch: Add multi-processor (SMP) support
Date:   Sat, 26 Feb 2022 19:03:36 +0800
Message-Id: <20220226110338.77547-21-chenhuacai@loongson.cn>
...
index 61993cd4c3d7..27b616afeb5f 100644
--- a/arch/loongarch/include/asm/pgtable.h
+++ b/arch/loongarch/include/asm/pgtable.h
@@ -303,8 +303,29 @@ static inline void set_pte(pte_t *ptep, pte_t pteval)
...
index 3f2101fd19bd..313601c76be2 100644
...
index a7794d89e1ac..460a3e84b7a5 100644
...
index 8dfe1d9b55f7..6e2aa3e6ba0c 100644
...
@@ -461,6 +462,29 @@ static int __init reserve_memblock_reserved_regions(void)
 }
...
+
 ...
 {
 	cpu_probe();
@@ -478,6 +502,8 @@ void __init setup_arch(char **cmdline_p)
...
new file mode 100644
index 000000000000..84b26a7f2c94
--- /dev/null
