...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1B6D6501781
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Apr 2022 18:00:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348690AbiDNPkI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Apr 2022 11:40:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53324 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1353129AbiDNOfP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Apr 2022 10:35:15 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9D20CFBAF
        for <linux-kernel@vger.kernel.org>; Thu, 14 Apr 2022 07:27:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1649946448; x=1681482448;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=AAIhh2e0TcxTT1BMcDDf0AbLMupc/FkOf4xe5Gl2V0g=;
  b=dbTR+SKptAQd4+7iqNPPxkR7ERqNWdkGn3bjrj2ZagZfRhDrfCqsOXu1
   Rvx5VQy5/8ywswbJsnqeumCeB5CjgKm6mMyR3Gf4ncPm3WxcF425DDrkZ
   yS9ux/qtHQoZaZjPJN1vw81o7NonHrE7CcGKVLsgJgo58eMe5SwHmuWgt
   xWT0ItkCDxYU0NgQV8V1uUerI5uUjWL8vIQOGutAUADK73VIfZn3fPcKV
   VViJzBBUX0TjfSF+n1+T+BG182rN6zGICZgte2jiEJrmwNPeiXVaVEVdE
   dpxunkolQs5lPZA3f4fH7zk9JFSjGMJP+Qqjj6u77VLGnJMFE5ASphGcw
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10317"; a="260536149"
X-IronPort-AV: E=Sophos;i="5.90,259,1643702400"; 
   d="yaml'?scan'208";a="260536149"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Apr 2022 07:27:28 -0700
X-IronPort-AV: E=Sophos;i="5.90,259,1643702400"; 
   d="yaml'?scan'208";a="573820135"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Apr 2022 07:27:24 -0700
...
Content-Disposition: attachment; filename="config-5.18.0-rc1-00362-g70bed0d5447e"
...
commit'
	...
	export submit_id='6255f7fa2153edd31db969db'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp6/fsmark-performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-70bed0d54-20220413-54045-1ql22ov-4.yaml'
	export id='deb39813ae2583b62e7e2825d02609e9c7ec0b5e'
...
NFSD
NFS_V4'
	export commit='70bed0d5447e08702c7595d26c88ca37e8eb88b4'
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-04-13 06:06:50 +0800'
	export _id='6255f7fb2153edd31db969dc'
	export _rt='/result/fsmark/performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='7b7dbf01188a00138f10029d3e1f44c7fd3bd0f3'
	export base_commit='ce522ba9ef7e2d9fb22a39eb3371c0c64e2a433e'
	export branch='hch-block/block-api'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/fsmark/performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/3'
	export scheduler_version='/lkp/lkp/.src-20220412-092640'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/fsmark/performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/vmlinuz-5.18.0-rc1-00362-g70bed0d5447e
branch=hch-block/block-api
job=/lkp/jobs/scheduled/lkp-icl-2sp6/fsmark-performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-70bed0d54-20220413-54045-1ql22ov-4.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=70bed0d5447e08702c7595d26c88ca37e8eb88b4
...
rw'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/vmlinuz-5.18.0-rc1-00362-g70bed0d5447e'
	export dequeue_time='2022-04-13 06:20:31 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp6/fsmark-performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-70bed0d54-20220413-54045-1ql22ov-4.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 6255e7032153edcee88fa62b
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp6/fsmark-performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-70bed0d54-20220413-52968-1co5931-2.yaml"
id: 0f84b992b5f0e4068f0ee9c81207fd298a8f22d7
...
bisect_dmesg: true
:#! include/fs/nfsv4:
enqueue_time: 2022-04-13 04:54:27.953776464 +08:00
_id: 6255ea8e2153edcee88fa62d
_rt: "/result/fsmark/performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: 7b7dbf01188a00138f10029d3e1f44c7fd3bd0f3
base_commit: ce522ba9ef7e2d9fb22a39eb3371c0c64e2a433e
branch: linux-devel/devel-hourly-20220411-133916
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/fsmark/performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/vmlinuz-5.18.0-rc1-00362-g70bed0d5447e
- branch=linux-devel/devel-hourly-20220411-133916
- job=/lkp/jobs/scheduled/lkp-icl-2sp6/fsmark-performance-1HDD-4K-btrfs-nfsv4-1x-1fpd-1t-fsyncBeforeClose-40M-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-70bed0d54-20220413-52968-1co5931-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=70bed0d5447e08702c7595d26c88ca37e8eb88b4
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.18.0-rc2-wt-ath-05328-gab260e225192
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/70bed0d5447e08702c7595d26c88ca37e8eb88b4/vmlinuz-5.18.0-rc1-00362-g70bed0d5447e"
dequeue_time: 2022-04-13 05:24:57.057039166 +08:00
:#! /cephfs/db/releases/20220412142511/lkp-src/include/site/inn:
job_state: finished
loadavg: 1.84 1.31 0.59 1/1089 14954
start_time: '1649798786'
end_time: '1649799065'
...
mkdir -p /nfs/sdb1
timeout 5m mount -t nfs -o vers=4 localhost:/fs/sdb1 /nfs/sdb1
touch /nfs/sdb1/wait_for_nfs_grace_period
...
fs_mark -d /nfs/sdb1/1 -D 10240 -N 1 -n 10240 -L 1 -S 1 -s 4096
