...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 43AD35694F1
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Jul 2022 00:03:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234666AbiGFWBS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Jul 2022 18:01:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44126 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234525AbiGFWBD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Jul 2022 18:01:03 -0400
Received: from mail-yw1-x1149.google.com (mail-yw1-x1149.google.com [IPv6:2607:f8b0:4864:20::1149])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A42F2A42E
        for <linux-kernel@vger.kernel.org>; Wed,  6 Jul 2022 15:01:00 -0700 (PDT)
Received: by mail-yw1-x1149.google.com with SMTP id 00721157ae682-31cb2fea145so52762347b3.8
        for <linux-kernel@vger.kernel.org>; Wed, 06 Jul 2022 15:01:00 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=y0ZxSqiIOv2HRYm553wZrJx5fChLkGPPbLO1qwZgmyQ=;
        b=
X-Gm-Message-State: AJIora+ZIJyBwO7AW854ZShxniBrJKnTn27ZZ2ziK63n/0asD2YlJGmK
        demQfQkmOd2Os78tOhc3B57k9dblyPY=
X-Google-Smtp-Source: AGRyM1sRDxtae2IlBgXPvJfXEts8Wxw8Va1kZtVIMGzblX4Mg8zS6Ie6RM5yT6WBMCN4GAE5u4jJ09Jf3oM=
...
@@ -3023,6 +3039,764 @@ static struct lruvec __maybe_unused *get_lruvec(str=
...
@@ -3078,6 +3862,11 @@ static void shrink_lruvec(struct lruvec *lruvec, str=
uct scan_control *sc)
 	struct blk_plug plug;
 	bool scan_adjusted;
=20
...
@@ -3582,6 +4371,9 @@ static void snapshot_refaults(struct mem_cgroup *targ=
...
@@ -3946,12 +4738,17 @@ unsigned long try_to_free_mem_cgroup_pages(struct m=
em_cgroup *memcg,
 }
 #endif
=20
...
+
 	if (!can_age_anon_pages(pgdat, sc))
 		return;
=20
@@ -4271,12 +5068,11 @@ static int balance_pgdat(pg_data_t *pgdat, int orde=
