...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 22AC051D398
	for <lists+linux-kernel@lfdr.de>; Fri,  6 May 2022 10:44:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1390252AbiEFIrR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 May 2022 04:47:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34340 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1390239AbiEFIrC (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 May 2022 04:47:02 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 11EB75C747
        for <linux-kernel@vger.kernel.org>; Fri,  6 May 2022 01:43:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1651826595; x=1683362595;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=iwYqaafPyGHFupl/rIKstH29zAs83L2ScQyn9/gjk60=;
  b=TejHYWQE54eheQxSNRbRTKrLYhsO47jKMROWRe7nHpjEalcQkcuj4EnH
   iWRCL+wFYiDLSvRANywFs+iLH7OuZExkUvno46h9s8oHfvDAM7wmDFHQf
   ZBk0ldOiOqf0wY5vA8f86KCGWhCAAeAexzZFoI+JU5bKGmgVytKinRVBs
   6dJO+c/KCadxa4TiCKABh2arT8KYC8ZTw27J5qY0NXptnkA/toFaiPvX7
   bV02Y2mJfZYd6C9S+rlBu4b4Nk7vSUqKQheQEo+WGg47YCNHJ8pqYQesP
   gsa4IyO3s5LLXMjbJwtOgqcvBV1m9pnDBGPoaA3fOG4BF8ek15OQCWCBD
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10338"; a="265989976"
X-IronPort-AV: E=Sophos;i="5.91,203,1647327600"; 
   d="yaml'?scan'208";a="265989976"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 May 2022 01:43:14 -0700
X-IronPort-AV: E=Sophos;i="5.91,203,1647327600"; 
   d="yaml'?scan'208";a="563717111"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 May 2022 01:43:10 -0700
Date:   Fri, 6 May 2022 16:43:07 +0800
...
Subject: [x86/split_lock]  b041b525da:  stress-ng.lockbus.ops_per_sec -48.3%
 regression
Message-ID: <20220506084306.GG23061@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.18.0-rc4-00001-gb041b525dab9"
...
kbuild_queue_analysis'
	...
	export submit_id='6271699e26c1f458dcf46266'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-lockbus-60s-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-b041b525dab95352fbd666b14dc73ab898-20220504-22748-1ebzay0-4.yaml'
	export id='0330cccac311111d2a4ecc7df8c8ea1a1f2ed1c1'
	...
	export need_kconfig=
	export commit='b041b525dab95352fbd666b14dc73ab898df465f'
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-05-04 01:42:55 +0800'
	export _id='6271699f26c1f458dcf46267'
	export _rt='/result/stress-ng/memory-performance-100%-lockbus-60s-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='d7b87fa06b0f2bc171350e55b64cd34e71f11535'
	export base_commit='672c0c5173427e6b3e2a9bbb7be51ceeec78093a'
	export branch='tip/x86/splitlock'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/stress-ng/memory-performance-100%-lockbus-60s-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/3'
	export scheduler_version='/lkp/lkp/.src-20220429-091100'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/stress-ng/memory-performance-100%-lockbus-60s-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/vmlinuz-5.18.0-rc4-00001-gb041b525dab9
branch=tip/x86/splitlock
job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-lockbus-60s-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-b041b525dab95352fbd666b14dc73ab898-20220504-22748-1ebzay0-4.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220503.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220503.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220430.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-57ae8a492116-1_20220430.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20220216.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.18.0-rc5-intel-next-01221-g3fd79b0ffd72'
	export repeat_to=6
	export schedule_notify_address=
	export stop_repeat_if_found=
	export kbuild_queue_analysis=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/vmlinuz-5.18.0-rc4-00001-gb041b525dab9'
	export dequeue_time='2022-05-04 01:54:09 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-lockbus-60s-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-b041b525dab95352fbd666b14dc73ab898-20220504-22748-1ebzay0-4.cgz'
...
run_job()
{
	...
	run_test class='memory' test='lockbus' $LKP_SRC/tests/wrapper stress-ng
}
...
extract_stats()
{
	...
	env class='memory' test='lockbus' $LKP_SRC/stats/wrapper stress-ng
...
kconfig: x86_64-rhel-8.3
submit_id: 62715bb226c1f407edc4ade5
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-lockbus-60s-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-b041b525dab95352fbd666b14dc73ab898-20220504-2029-1u8ve3f-2.yaml"
id: 220a6d6f2bedc2e23aa8283d1580374bc18cb68f
...
ucode: '0xd000331'
bisect_dmesg: true
enqueue_time: 2022-05-04 00:43:31.007293781 +08:00
_id: 6271651a26c1f407edc4ade7
_rt: "/result/stress-ng/memory-performance-100%-lockbus-60s-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: d7b87fa06b0f2bc171350e55b64cd34e71f11535
base_commit: 672c0c5173427e6b3e2a9bbb7be51ceeec78093a
branch: linux-devel/devel-hourly-20220502-132343
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/stress-ng/memory-performance-100%-lockbus-60s-ucode=0xd000331/lkp-icl-2sp6/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/vmlinuz-5.18.0-rc4-00001-gb041b525dab9
- branch=linux-devel/devel-hourly-20220502-132343
- job=/lkp/jobs/scheduled/lkp-icl-2sp6/stress-ng-memory-performance-100%-lockbus-60s-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-b041b525dab95352fbd666b14dc73ab898-20220504-2029-1u8ve3f-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=b041b525dab95352fbd666b14dc73ab898df465f
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/stress-ng_20220503.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/stress-ng-x86_64-0.11-06_20220503.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220430.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-57ae8a492116-1_20220430.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.18.0-rc5-intel-next-01252-g6bdda710dca8
repeat_to: 3
schedule_notify_address:
stop_repeat_if_found:
:#! user overrides:
kbuild_queue_analysis: 1
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/b041b525dab95352fbd666b14dc73ab898df465f/vmlinuz-5.18.0-rc4-00001-gb041b525dab9"
dequeue_time: 2022-05-04 01:25:36.756514842 +08:00
job_state: finished
loadavg: 0.84 0.39 0.15 1/1098 9650
start_time: '1651598800'
end_time: '1651598863'
...
do
 ...
 "stress-ng" "--timeout" "60" "--times" "--verify" "--metrics-brief" "--lockbus" "128"
