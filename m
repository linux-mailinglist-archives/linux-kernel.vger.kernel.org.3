...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6DFA7534811
	for <lists+linux-kernel@lfdr.de>; Thu, 26 May 2022 03:26:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344426AbiEZB0J (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 25 May 2022 21:26:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50626 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230018AbiEZB0H (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 25 May 2022 21:26:07 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AD8A26EC4F;
        Wed, 25 May 2022 18:26:06 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 62FEDB81E9F;
        Thu, 26 May 2022 01:26:05 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 16C54C34118;
        Thu, 26 May 2022 01:26:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1653528364;
        bh=lDpTSVw2M6hQDO6YVoSC7pj8BgxtHOakbMzZN1/oTg4=;
        h=References:In-Reply-To:From:Date:Subject:To:Cc:From;
        b=
Received: by mail-vs1-f54.google.com with SMTP id h4so99944vsr.13;
        Wed, 25 May 2022 18:26:04 -0700 (PDT)
X-Gm-Message-State: AOAM532OsV/h/fHrA0P4J8+AEsb2ya6ATXv8w9q28n1tAjrz4o+/6QcD
        40STFvCESHmbYfc4GnHNsVAA2LT42rrRaRJ0b2M=
X-Google-Smtp-Source: ABdhPJyVK/9aM/Bld5RLqEMJ+E/KWn7qCpsh4NevJw8t9GH6u65V4mzymKSq53MHh8kQhztxGCTG5OUjMwKAkMXlC5w=
X-Received: by 2002:a67:c89c:0:b0:335:d83b:df76 with SMTP id
 v28-20020a67c89c000000b00335d83bdf76mr13037783vsk.51.1653528362997; Wed, 25
 May 2022 18:26:02 -0700 (PDT)
MIME-Version: 1.0
References: <mhng-7a88227d-dc64-4d87-9e1a-0ea802ddf0a1@palmer-ri-x1c9> <mhng-54a3577b-2ae9-4ca0-a27d-f75f13807a29@palmer-ri-x1c9>
In-Reply-To: <mhng-54a3577b-2ae9-4ca0-a27d-f75f13807a29@palmer-ri-x1c9>
From:   Guo Ren <guoren@kernel.org>
Date:   Thu, 26 May 2022 09:25:51 +0800
X-Gmail-Original-Message-ID: <CAJF2gTQQEYKz7EG9=bdSC6E4_ds5D9FmAK1TBZgmsB3T-nrGiw@mail.gmail.com>
Message-ID: <CAJF2gTQQEYKz7EG9=bdSC6E4_ds5D9FmAK1TBZgmsB3T-nrGiw@mail.gmail.com>
...
> >>>
> >>> Sorry I'm a bit buried right now, this is fixing the issue you pointe=
d out earlier?
> >>>
> >> Yes.
> >
...
>
> >
> > Fixes: 3092eb456375 ("riscv: compat: vdso: Add setup additional pages i=
mplementation")
> >
...
> >>>>> @@ -206,12 +206,23 @@ static struct __vdso_info vdso_info __ro_afte=
r_init =3D {
> >>>>>   };
> >>>>>
> >>>>>   #ifdef CONFIG_COMPAT
> >>>>> +static struct vm_special_mapping rv_compat_vdso_maps[] __ro_after_=
init =3D {
> >>>>> +    [RV_VDSO_MAP_VVAR] =3D {
> >>>>> +        .name   =3D "[vvar]",
> >>>>> +        .fault =3D vvar_fault,
