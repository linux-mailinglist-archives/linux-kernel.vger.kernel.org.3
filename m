...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6B3275B23A7
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Sep 2022 18:33:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230416AbiIHQda (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 8 Sep 2022 12:33:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45980 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229548AbiIHQd1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 8 Sep 2022 12:33:27 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B8B9EF08
        for <linux-kernel@vger.kernel.org>; Thu,  8 Sep 2022 09:33:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662654803; x=1694190803;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=uGERMMGADFWY3vmT0fdxVVFERV5ePCrnILnmZM5N10s=;
  b=IiolwRVFHsvXU2WmQeiDu7GF13xPF7r55qN0TuJFcZP4iOIh8J8Zv7SL
   nB1/mu5eMm4oSYFZxMY9Vq1dsUZYiJOCkiRtOmQWhgHNWnpBq+Aakduad
   QsELpFE9Dh52nxaQPkSvuW5a+ejzeoG4e06xAE+ZVxTsXY3HPC89SHwQt
   QOnj/4IpHmhmKxvul5ERR0YtWcJ4JLW6WzS0YFMkijtz3w3cqeGUtWDUQ
   R3MJissfQ5nZEUM11hXHgtFwzgrfpTxVTXRqRGLb/FRoq0WRPjoQwSpB6
   gVRg6MtqHunviJuVHheho5wO24jFGrBQVtb///cGKK4+tZ4i+NaMuOA2z
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10464"; a="276982019"
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="276982019"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Sep 2022 09:33:22 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="614952494"
Received: from lkp-server02.sh.intel.com (HELO b2938d2e5c5a) ([10.239.97.151])
  by orsmga002.jf.intel.com with ESMTP; 08 Sep 2022 09:33:19 -0700
Received: from kbuild by b2938d2e5c5a with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oWKSt-00008s-0Q;
        Thu, 08 Sep 2022 16:33:19 +0000
Date:   Fri, 9 Sep 2022 00:32:31 +0800
From:   kernel test robot <lkp@intel.com>
To:     Linus Walleij <linus.walleij@linaro.org>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: [arm-integrator:virt-to-pfn-v6.0-rc1 19/24]
 arch/mips/include/asm/page.h:262:40: error: implicit declaration of function
 'virt_to_phys'; did you mean 'virt_to_pfn'?
Message-ID: <202209090040.4IFIu36M-lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="EfOsLtD54dO53wT3"
...
commit: 13692cc7e141e337e44c8b64f7c74fb50840c9b6 [19/24] MIPS: Make virt_to_pfn() a static inline
config: mips-allyesconfig
compiler: mips-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://git.kernel.org/pub/scm/linux/kernel/git/linusw/linux-integrator.git/commit/?id=13692cc7e141e337e44c8b64f7c74fb50840c9b6
        git remote add arm-integrator https://git.kernel.org/pub/scm/linux/kernel/git/linusw/linux-integrator.git
        git fetch --no-tags arm-integrator virt-to-pfn-v6.0-rc1
        git checkout 13692cc7e141e337e44c8b64f7c74fb50840c9b6
