...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 625D54EE0BD
	for <lists+linux-kernel@lfdr.de>; Thu, 31 Mar 2022 20:38:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239884AbiCaSiF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 31 Mar 2022 14:38:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53528 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235340AbiCaSgl (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 31 Mar 2022 14:36:41 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id AC7B6232D06;
        Thu, 31 Mar 2022 11:34:50 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 8BC4C1596;
        Thu, 31 Mar 2022 11:34:50 -0700 (PDT)
Received: from eglon.cambridge.arm.com (eglon.cambridge.arm.com [10.1.196.218])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id C442E3F718;
        Thu, 31 Mar 2022 11:34:49 -0700 (PDT)
From:   James Morse <james.morse@arm.com>
To:     stable@vger.kernel.org, linux-kernel@vger.kernel.org
Cc:     james.morse@arm.com, catalin.marinas@arm.com
Subject: [stable:PATCH v4.14.274 24/27] arm64: Mitigate spectre style branch history side channels
Date:   Thu, 31 Mar 2022 19:33:57 +0100
Message-Id: <20220331183400.73183-25-james.morse@arm.com>
...
index 729384f19c7f..7605d2f00d55 100644
...
index 93316937f9ce..b84e367e2720 100644
...
index 5f9f40a02784..4c23c5778030 100644
--- a/arch/arm64/include/asm/cpufeature.h
+++ b/arch/arm64/include/asm/cpufeature.h
@@ -456,6 +456,21 @@ static inline bool cpu_supports_mixed_endian_el0(void)
...
index de5cbd7614f8..401088d9cd82 100644
...
index 2564dd429ab6..7567b0e8c00b 100644
...
index b10fc7b5e6b4..b8f87041f792 100644
...
@@ -731,6 +732,13 @@ const struct arm64_cpu_capabilities arm64_errata[] = {
...
@@ -795,6 +803,33 @@ ssize_t cpu_show_spec_store_bypass(struct device *dev,
...
+ */
 ...
 enum mitigation_state arm64_get_spectre_bhb_state(void)
@@ -802,6 +837,163 @@ enum mitigation_state arm64_get_spectre_bhb_state(void)
...
+
 ...
 {
@@ -817,7 +1009,7 @@ static const char *kvm_bhb_get_vecs_end(const char *start)
 	return NULL;
 }
...
@@ -855,5 +1047,77 @@ void kvm_setup_bhb_slot(const char *hyp_vecs_start)
