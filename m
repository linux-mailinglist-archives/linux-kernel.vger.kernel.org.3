...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1902D53CD35
	for <lists+linux-kernel@lfdr.de>; Fri,  3 Jun 2022 18:29:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343915AbiFCQ3Z (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 3 Jun 2022 12:29:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40928 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244687AbiFCQ3W (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 3 Jun 2022 12:29:22 -0400
Received: from out03.mta.xmission.com (out03.mta.xmission.com [166.70.13.233])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 36EAC51584
        for <linux-kernel@vger.kernel.org>; Fri,  3 Jun 2022 09:29:20 -0700 (PDT)
Received: from in02.mta.xmission.com ([166.70.13.52]:56664)
        by out03.mta.xmission.com with esmtps  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.93)
        (envelope-from <ebiederm@xmission.com>)
        id 1nxAAj-008aMV-4j; Fri, 03 Jun 2022 10:29:13 -0600
Received: from ip68-227-174-4.om.om.cox.net ([68.227.174.4]:38856 helo=email.froward.int.ebiederm.org.xmission.com)
        by in02.mta.xmission.com with esmtpsa  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.93)
        (envelope-from <ebiederm@xmission.com>)
        id 1nxAAh-00H94e-PG; Fri, 03 Jun 2022 10:29:12 -0600
...
In-Reply-To: <cb17bad6-dbfa-013c-f879-c1883575f72b@huawei.com> (Miaohe Lin's
        message of "Thu, 2 Jun 2022 17:22:07 +0800")
...
Date:   Fri, 03 Jun 2022 11:28:58 -0500
Message-ID: <87ilph90dx.fsf@email.froward.int.ebiederm.org>
MIME-Version: 1.0
Content-Type: text/plain
X-XM-SPF: eid=1nxAAh-00H94e-PG;;;mid=<87ilph90dx.fsf@email.froward.int.ebiederm.org>;;;hst=in02.mta.xmission.com;;;ip=68.227.174.4;;;frm=ebiederm@xmission.com;;;spf=softfail
X-XM-AID: U2FsdGVkX1/gRKhgbPDJYnswsXncEZobWy1dsmVlhZI=
...
X-Spam-Timing: total 735 ms - load_scoreonly_sql: 0.04 (0.0%),
        signal_user_changed: 4.7 (0.6%), b_tie_ro: 3.2 (0.4%), parse: 1.40
        (0.2%), extract_message_metadata: 14 (1.8%), get_uri_detail_list: 4.9
        (0.7%), tests_pri_-1000: 4.1 (0.6%), tests_pri_-950: 1.07 (0.1%),
        tests_pri_-900: 0.82 (0.1%), tests_pri_-90: 132 (18.0%), check_bayes:
        130 (17.7%), b_tokenize: 10 (1.4%), b_tok_get_all: 12 (1.7%),
        b_comp_prob: 3.5 (0.5%), b_tok_touch_all: 101 (13.7%), b_finish: 0.75
        (0.1%), tests_pri_0: 566 (76.9%), check_dkim_signature: 0.46 (0.1%),
        check_dkim_adsp: 3.6 (0.5%), poll_dns_idle: 0.25 (0.0%), tests_pri_10:
        1.70 (0.2%), tests_pri_500: 6 (0.9%), rewrite_mail: 0.00 (0.0%)
