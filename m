...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 760515822D7
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Jul 2022 11:10:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231774AbiG0JKQ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 Jul 2022 05:10:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48772 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231570AbiG0JJW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 Jul 2022 05:09:22 -0400
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6660A48EAC;
        Wed, 27 Jul 2022 02:07:39 -0700 (PDT)
Received: from dggemv711-chm.china.huawei.com (unknown [172.30.72.53])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4Lt7CL6X0yzkYJC;
...
Subject: [RFC v4 14/17] perf kwork: Implement bpf trace
Date:   Wed, 27 Jul 2022 17:03:27 +0800
Message-ID: <20220727090330.107760-15-yangjihong1@huawei.com>
...
index dc5fca1863f6..c8f19f26dc86 100644
--- a/tools/perf/builtin-kwork.c
+++ b/tools/perf/builtin-kwork.c
@@ -1446,13 +1446,69 @@ static void process_skipped_events(struct perf_kwork *kwork,
 	}
 }
...
@@ -1688,6 +1744,10 @@ int cmd_kwork(int argc, const char **argv)
 		   "input file name"),
...
@@ -1701,6 +1761,10 @@ int cmd_kwork(int argc, const char **argv)
