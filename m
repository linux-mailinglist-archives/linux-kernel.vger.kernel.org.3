...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1D8C6525B9B
	for <lists+linux-kernel@lfdr.de>; Fri, 13 May 2022 08:37:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377305AbiEMGdf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 13 May 2022 02:33:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34826 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236494AbiEMGdc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 13 May 2022 02:33:32 -0400
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6E30D2A18B7;
        Thu, 12 May 2022 23:33:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1652423607; x=1683959607;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=pUSAJ6Aw0k/bmqyQei+TLZZTJvI7M2nD18CowZJ/r+8=;
  b=UNi5QXnouLcwjptdXsLg/6njgK3rUrjbdJo7JcN/IV65YcoWc/QtMDhL
   R/o13wRGpnsu6BhmAZYxP5QZ7RcEZOOAsJaS61SgDceOGxUhLKcXAMS1u
   5YBx6cY4sPNLOB95sfWuTHqHqKIezGMw+UeTXPfZn2wb8452YpLHJT8FE
   xZ2zCdPDrit6ztseoJ+SmqSQFw8HV+SMRbt4LHmpVGdNg/lRSQTg6Z1cz
   jdkX/+mUq0Q2Kzu/WrBLBsPlgXS49tG7VzzHW5h+76ntpTEBhYQ/Tvq0O
   AzxS72auHhtfDWtLYvZNkMXCToeujb8T/s0Udg5QwoFhapnGtABPP5mV7
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10345"; a="356658800"
X-IronPort-AV: E=Sophos;i="5.91,221,1647327600"; 
   d="yaml'?scan'208";a="356658800"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 May 2022 23:33:26 -0700
X-IronPort-AV: E=Sophos;i="5.91,221,1647327600"; 
   d="yaml'?scan'208";a="595072940"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 May 2022 23:33:21 -0700
Date:   Fri, 13 May 2022 14:33:08 +0800
...
Subject: [cgroup/cpuset]  7aaa45f837:  kbuild.buildtime_per_iteration 2583.0%
 regression
Message-ID: <20220513063308.GA21013@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.18.0-rc3-00100-g7aaa45f83748"
...
export_top_env()
{
	...
	export suite='kbuild'
	export testcase='kbuild'
	export category='benchmark'
	export runtime=300
	export nr_task=44
	export target='autoksyms_recursive'
	export job_origin='kbuild-cgroup2.yaml'
...
kbuild_queue_analysis'
	...
	export submit_id='626cabd6a0458033e711c47c'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp9/kbuild-performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-7aaa45f8374887-20220430-13287-holi70-4.yaml'
	export id='400d1bac56714862ffff08c2a3598ea0c427c817'
	...
	export need_kconfig=\{\"CGROUPS\"\=\>\"y\"\}'
'\{\"MEMCG\"\=\>\"y\"\}'
'\{\"CGROUP_PIDS\"\=\>\"y\"\}'
'\{\"CGROUP_RDMA\"\=\>\"y\"\}'
'\{\"BLK_CGROUP\"\=\>\"y\"\}
	export commit='7aaa45f8374887d98cd479a6bdd3b4c74e6a981a'
	export ucode='0x500320a'
	export need_kconfig_hw='{"I40E"=>"y"}
SATA_AHCI'
	export enqueue_time='2022-04-30 11:24:06 +0800'
	export _id='626cabd6a0458033e711c47d'
	export _rt='/result/kbuild/performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a'
	export user='lkp'
	...
	export branch='linux-review/Waiman-Long/cgroup-cpuset-Remove-redundant-cpu-node-masks-setup-in-cpuset_init_smp/20220425-101126'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/kbuild/performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/3'
	export scheduler_version='/lkp/lkp/.src-20220429-091100'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/kbuild/performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/vmlinuz-5.18.0-rc3-00100-g7aaa45f83748
branch=linux-review/Waiman-Long/cgroup-cpuset-Remove-redundant-cpu-node-masks-setup-in-cpuset_init_smp/20220425-101126
job=/lkp/jobs/scheduled/lkp-csl-2sp9/kbuild-performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-7aaa45f8374887-20220430-13287-holi70-4.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=7aaa45f8374887d98cd479a6bdd3b4c74e6a981a
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/kbuild_20210716.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/kbuild-x86_64-5.4-1_20220409.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-22da5264abf4-1_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20220216.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.18.0-rc4-intel-next-02054-g96ef47437568'
	export repeat_to=6
	export schedule_notify_address=
	export kbuild_queue_analysis=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/vmlinuz-5.18.0-rc3-00100-g7aaa45f83748'
	export dequeue_time='2022-04-30 11:24:55 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp9/kbuild-performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-7aaa45f8374887-20220430-13287-holi70-4.cgz'
...
run_job()
{
	...
	run_setup memory_46_high=123695058124 memory_46_low=68719476736 memory_46_max='max' memory_46_swap_46_max= io_46_max= io_46_weight= rdma_46_max= pids_46_max=10000 $LKP_SRC/setup/cgroup2
	...
	run_test $LKP_SRC/tests/wrapper kbuild
}
...
extract_stats()
{
	...
	$LKP_SRC/stats/wrapper time kbuild.time
...
target: autoksyms_recursive
kbuild:
job_origin: kbuild-cgroup2.yaml
:#! queue options:
queue_cmdline_keys:
- branch
- commit
...
kconfig: x86_64-rhel-8.3
submit_id: 626c4559a04580230860c7ff
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp9/kbuild-performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-7aaa45f8374887-20220430-8968-1xuzi33-2.yaml"
id: f275975e3f874e68d67d918ac86bb1c2eff5c9bb
...
- I40E: y
- SATA_AHCI
enqueue_time: 2022-04-30 04:06:49.226222869 +08:00
_id: 626c495aa04580230860c801
_rt: "/result/kbuild/performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
result_root: "/result/kbuild/performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a/lkp-csl-2sp9/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/vmlinuz-5.18.0-rc3-00100-g7aaa45f83748
- branch=linux-devel/devel-hourly-20220428-184920
- job=/lkp/jobs/scheduled/lkp-csl-2sp9/kbuild-performance-90%-50%-max-50%-10000-300s-autoksyms_recursive-ucode=0x500320a-debian-10.4-x86_64-20200603.cgz-7aaa45f8374887-20220430-8968-1xuzi33-2.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=7aaa45f8374887d98cd479a6bdd3b4c74e6a981a
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/kbuild_20210716.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/kbuild-x86_64-5.4-1_20220409.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-22da5264abf4-1_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/7aaa45f8374887d98cd479a6bdd3b4c74e6a981a/vmlinuz-5.18.0-rc3-00100-g7aaa45f83748"
dequeue_time: 2022-04-30 04:25:27.808283725 +08:00
:#! /cephfs/db/releases/20220429090705/lkp-src/include/site/inn:
job_state: finished
loadavg: 32.59 43.81 34.45 2/709 31568
start_time: '1651264000'
end_time: '1651265193'
...
echo '+cpuset' > '/cgroup2/cgroup.subtree_control'
echo '+cpu' > '/cgroup2/cgroup.subtree_control'
echo '+io' > '/cgroup2/cgroup.subtree_control'
echo '+memory' > '/cgroup2/cgroup.subtree_control'
echo '+hugetlb' > '/cgroup2/cgroup.subtree_control'
echo '+pids' > '/cgroup2/cgroup.subtree_control'
echo '+rdma' > '/cgroup2/cgroup.subtree_control'
mkdir -p /cgroup2/kbuild.1
echo 123695058124 > '/cgroup2/kbuild.1/memory.high'
echo 68719476736 > '/cgroup2/kbuild.1/memory.low'
echo max > '/cgroup2/kbuild.1/memory.max'
echo 10000 > '/cgroup2/kbuild.1/pids.max'
echo 3909 > '/cgroup2/kbuild.1/cgroup.procs'
...
cd /lkp/benchmarks/kbuild/linux
make mrproper
make defconfig
