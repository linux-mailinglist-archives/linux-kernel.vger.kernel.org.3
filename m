...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 190E347CEA5
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Dec 2021 10:03:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243630AbhLVJDK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Dec 2021 04:03:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44002 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243593AbhLVJDD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Dec 2021 04:03:03 -0500
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 49FBFC06173F;
        Wed, 22 Dec 2021 01:03:03 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id AFB09B817BF;
        Wed, 22 Dec 2021 09:03:00 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 97E8CC36AE5;
        Wed, 22 Dec 2021 09:02:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1640163779;
        bh=c+yra1ndYnYe8ZLOFQ03n3XxptWhS9KjQoSkAOl9Y3s=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=QAfuJux7EO7YbYwzr9PuMBp4RFzRe/+BV6Uu4drzMxld/6rNm6PW+vvddcfwZx+rQ
         HmAQhCIReW9u6F42MiBR9enpL6uQcF/6JISd5XHK+q5o2Anp2EO0Ye1OCmdsAOMYTi
         o9w9V9T3p1hT19yCHUx6jybFCIpf6XNrBtWX+T/Q=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.14.259
Date:   Wed, 22 Dec 2021 10:02:53 +0100
Message-Id: <164016377288216@kroah.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <1640163772160218@kroah.com>
References: <1640163772160218@kroah.com>
MIME-Version: 1.0
...
index f77e1d686f87..1d22e50da86e 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 290254849f97..6301a8d2b87e 100644
--- a/arch/x86/Kconfig
+++ b/arch/x86/Kconfig
...
index 4b299efbd804..fdf7b5edd520 100644
...
index ef4e81d77446..d49f17748119 100644
...
index fe234578380a..548089aa9aba 100644
...
index 6f5888bd9194..98fd214f2c42 100644
...
index a37c951b0753..10fa0e095ec3 100644
...
index 64c4b88de844..565e1ac241aa 100644
...
index ef7dd70a40a1..56c7f2ebf573 100644
...
@@ -886,7 +904,7 @@ static int xennet_get_responses(struct netfront_queue *queue,
 	}
...
@@ -1074,7 +1093,9 @@ static int xennet_poll(struct napi_struct *napi, int budget)
...
@@ -1098,7 +1119,8 @@ static int xennet_poll(struct napi_struct *napi, int budget)
...
index 2c000b9b0a42..bbddf492da9f 100644
--- a/drivers/pci/msi.c
+++ b/drivers/pci/msi.c
...
@@ -847,7 +854,7 @@ static int msix_capability_init(struct pci_dev *dev, struct msix_entry *entries,
 	free_msi_irqs(dev);
...
index aba1a3396890..b553ae4a8863 100644
...
index 37bde5c8268d..a623e498a97b 100644
...
index bcebec17bdd5..b407f907d655 100644
...
index ee4c206150a8..c67d53beed85 100644
...
index 4e2a9852147b..b101a505c74b 100644
...
index 6faaa908544a..2b82316b844b 100644
--- a/kernel/audit.c
+++ b/kernel/audit.c
...
index 5b6f815a74ee..602b476627dd 100644
...
index 0c71137c5d41..43fd9cfa7b11 100644
--- a/net/ipv6/sit.c
+++ b/net/ipv6/sit.c
...
index ed57db9b6086..060d3ed5c191 100644
...
index d1fd9f7c867e..0563b4d34eae 100644
...
index d7a2580f0420..ff5995624146 100644
--- a/net/nfc/netlink.c
+++ b/net/nfc/netlink.c
...
index cdf63eccad11..ebc78cb3bc7d 100755
