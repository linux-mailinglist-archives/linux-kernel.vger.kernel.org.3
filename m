...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 777F5511986
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Apr 2022 16:55:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235417AbiD0NUr (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 Apr 2022 09:20:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40712 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235356AbiD0NUn (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 Apr 2022 09:20:43 -0400
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5B1C02CE19
        for <linux-kernel@vger.kernel.org>; Wed, 27 Apr 2022 06:17:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1651065438; x=1682601438;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=BSsDYpzVQae4DBM5vFUpTswdl+FhP4nFpx41XTu2GNY=;
  b=BOO2vw+2o2sAeqiX4PxN03gwebAO9mM3+dwA2Nj7NiNWGynLokUsB8DM
   sWxS+PQiZnf4dCQXAywZ0wGLHbI960RY0ugMO13ue3t+iyVzgjMFj44ZA
   gVhdyf42IDMO52d3rWlQ8cWM067FVkv1ITcVSx7IhJ5VC5CzFE1wY8Lg2
   qRxeklv+7ojKdq1rH03cTBrOvyYgftNWOzKKEDHI7tFdI20Ow2MQFSPLh
   Qj6MDkFHkmWQ1DXArXUPjEQUGai5bnv7Vh4GDlmwXydslrXQDJbsx/RAz
   Irg4A5Z1e/Q+LxNzD9wUUVjwssoB4ac+bkD5v+OYwMHMvNwRAOrKSVJJb
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10329"; a="266085078"
X-IronPort-AV: E=Sophos;i="5.90,293,1643702400"; 
   d="yaml'?scan'208";a="266085078"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Apr 2022 06:16:45 -0700
X-IronPort-AV: E=Sophos;i="5.90,293,1643702400"; 
   d="yaml'?scan'208";a="558923744"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Apr 2022 06:16:39 -0700
...
Content-Disposition: attachment; filename="config-5.18.0-rc1-00005-gae44f2177fa7"
...
export_top_env()
{
	...
	export submit_id='6267f70c0b9a93e5c22bd29b'
	export job_file='/lkp/jobs/scheduled/lkp-cfl-e1/reaim-performance-100%-300s-new_fserver-ucode=0xec-debian-10.4-x86_64-20200603.cgz-ae44f2177fa75c271734d5963972faecc3686c12-20220426-58818-1p0581o-8.yaml'
	export id='99c93070b37e605367d412cc0ff2c0d72f149645'
	export queuer_version='/lkp/xsang/.src-20220426-100132'
	...
	export avoid_nfs=1
	export commit='ae44f2177fa75c271734d5963972faecc3686c12'
	export ucode='0xec'
	export need_kconfig_hw='{"IGB"=>"y"}
SATA_AHCI'
	export bisect_dmesg=true
	export enqueue_time='2022-04-26 21:43:40 +0800'
	export _id='6267f70d0b9a93e5c22bd2a3'
	export _rt='/result/reaim/performance-100%-300s-new_fserver-ucode=0xec/lkp-cfl-e1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='f7afbeedd306d5824047d5a40888702e2b6f308c'
	...
	export result_root='/result/reaim/performance-100%-300s-new_fserver-ucode=0xec/lkp-cfl-e1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/8'
	export scheduler_version='/lkp/lkp/.src-20220425-212427'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/reaim/performance-100%-300s-new_fserver-ucode=0xec/lkp-cfl-e1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/8
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/vmlinuz-5.18.0-rc1-00005-gae44f2177fa7
branch=linux-review/Abel-Wu/introduece-sched-idle-balance/20220409-215303
job=/lkp/jobs/scheduled/lkp-cfl-e1/reaim-performance-100%-300s-new_fserver-ucode=0xec-debian-10.4-x86_64-20200603.cgz-ae44f2177fa75c271734d5963972faecc3686c12-20220426-58818-1p0581o-8.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=ae44f2177fa75c271734d5963972faecc3686c12
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/reaim_20210701.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/reaim-x86_64-7.0.1.13-1_20220411.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-22da5264abf4-1_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/vmlinuz-5.18.0-rc1-00005-gae44f2177fa7'
	export dequeue_time='2022-04-26 23:29:15 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-cfl-e1/reaim-performance-100%-300s-new_fserver-ucode=0xec-debian-10.4-x86_64-20200603.cgz-ae44f2177fa75c271734d5963972faecc3686c12-20220426-58818-1p0581o-8.cgz'
...
run_job()
{
	...
	run_test test='new_fserver' $LKP_SRC/tests/wrapper reaim
}
...
extract_stats()
{
	...
	env test='new_fserver' $LKP_SRC/stats/wrapper reaim
...
kconfig: x86_64-rhel-8.3
submit_id: 6267f70c0b9a93e5c22bd29b
job_file: "/lkp/jobs/scheduled/lkp-cfl-e1/reaim-performance-100%-300s-new_fserver-ucode=0xec-debian-10.4-x86_64-20200603.cgz-ae44f2177fa75c271734d5963972faecc3686c12-20220426-58818-1p0581o-4.yaml"
id: e553e4dbf10e00b8c4622c245ea2a94efe7f4d42
queuer_version: "/lkp/xsang/.src-20220426-100132"
:#! hosts/lkp-cfl-e1:
model: Coffee Lake
nr_node: 1
nr_cpu: 16
...
- SATA_AHCI
bisect_dmesg: true
enqueue_time: 2022-04-26 21:43:40.251878238 +08:00
_id: 6267f70d0b9a93e5c22bd29f
_rt: "/result/reaim/performance-100%-300s-new_fserver-ucode=0xec/lkp-cfl-e1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: f7afbeedd306d5824047d5a40888702e2b6f308c
base_commit: b2d229d4ddb17db541098b83524d901257e93845
branch: linux-review/Abel-Wu/introduece-sched-idle-balance/20220409-215303
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/reaim/performance-100%-300s-new_fserver-ucode=0xec/lkp-cfl-e1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/vmlinuz-5.18.0-rc1-00005-gae44f2177fa7
- branch=linux-review/Abel-Wu/introduece-sched-idle-balance/20220409-215303
- job=/lkp/jobs/scheduled/lkp-cfl-e1/reaim-performance-100%-300s-new_fserver-ucode=0xec-debian-10.4-x86_64-20200603.cgz-ae44f2177fa75c271734d5963972faecc3686c12-20220426-58818-1p0581o-4.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=ae44f2177fa75c271734d5963972faecc3686c12
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20220105.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/reaim_20210701.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/reaim-x86_64-7.0.1.13-1_20220411.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/turbostat_20220316.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/turbostat-x86_64-56e337f2cf13-1_20220316.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-22da5264abf4-1_20220424.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
ucode_initrd: "/osimage/ucode/intel-ucode-20220216.cgz"
lkp_initrd: "/osimage/user/lkp/lkp-x86_64.cgz"
site: inn
:#! /cephfs/db/releases/20220424093837/lkp-src/include/site/inn:
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/ae44f2177fa75c271734d5963972faecc3686c12/vmlinuz-5.18.0-rc1-00005-gae44f2177fa7"
dequeue_time: 2022-04-26 22:33:20.201448175 +08:00
job_state: finished
loadavg: 2.26 1.45 0.64 1/214 21062
start_time: '1650983681'
end_time: '1650983983'
...
./reaim -s16 -e16 -i16 -fworkfile.new_fserver -r1 -c./reaim.config -l/tmp/lkp/result/reaim_debug -j100
./reaim -s16 -e16 -i16 -fworkfile.new_fserver -r1 -c./reaim.config -l/tmp/lkp/result/reaim_debug -j100
./reaim -s16 -e16 -i16 -fworkfile.new_fserver -r1 -c./reaim.config -l/tmp/lkp/result/reaim_debug -j100
./reaim -s16 -e16 -i16 -fworkfile.new_fserver -r1 -c./reaim.config -l/tmp/lkp/result/reaim_debug -j100
./reaim -s16 -e16 -i16 -fworkfile.new_fserver -r1 -c./reaim.config -l/tmp/lkp/result/reaim_debug -j100
