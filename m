...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 090425B1D1B
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Sep 2022 14:34:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231891AbiIHMdc (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 8 Sep 2022 08:33:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41896 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230204AbiIHMdY (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 8 Sep 2022 08:33:24 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C712CA9C3F;
        Thu,  8 Sep 2022 05:33:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1662640395; x=1694176395;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Kd+L8e9NMCdwBOxiS2Ha0fFFqhufW0nkrt048kJENYA=;
  b=N2X57zZpEF5qrbcfznLUnDUGZGUc9OA/Jqjd0FepJKYDxHZ+I7PuHnmC
   BZihET1F0ItNyZWNKN5ccm74TpqLRodmyPRI21Ww2+/+kNk+IpQWeyncl
   XdPPjaW3fbD8Ghcaj6Irr/Uo+g1VOdikPjDMVK8/Xa2ATsOGMTz3gZir2
   IiXiJyzfaL3v9hRhNpFJg/CLJ5I1Tow8zgaAIXHFXvy8npLPXDQlKFLnR
   9Us+cMc69OLCkgupDgJUDSCkFOPmBx4Ht2u5e3BggSdXzfS1sI8pb/wpJ
   hjUEhIHzSa9PL629Ld+x6+GNDj0sZY7KlIMVg8sUMEDAl7VzKk1inTAmP
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10463"; a="295887966"
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="295887966"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Sep 2022 05:33:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,300,1654585200"; 
   d="scan'208";a="610678216"
Received: from lkp-server02.sh.intel.com (HELO 95dfd251caa2) ([10.239.97.151])
  by orsmga007.jf.intel.com with ESMTP; 08 Sep 2022 05:33:09 -0700
Received: from kbuild by 95dfd251caa2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oWGiS-0007kl-1N;
        Thu, 08 Sep 2022 12:33:08 +0000
Date:   Thu, 8 Sep 2022 20:32:38 +0800
...
Message-ID: <202209082022.6BPdyQn8-lkp@intel.com>
References: <20220908051046.465307-4-anshuman.khandual@arm.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="esVgfVVTEk7xj/xV"
...
vim +415 drivers/perf/arm_pmu.c

1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  387  
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  388  static int
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  389  validate_group(struct perf_event *event)
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  390  {
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  391  	struct perf_event *sibling, *leader = event->group_leader;
8be3f9a2385f91 arch/arm/kernel/perf_event.c Mark Rutland      2011-05-17  392  	struct pmu_hw_events fake_pmu;
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  393  
bce34d14428d35 arch/arm/kernel/perf_event.c Will Deacon       2011-11-17  394  	/*
bce34d14428d35 arch/arm/kernel/perf_event.c Will Deacon       2011-11-17  395  	 * Initialise the fake PMU. We only need to populate the
bce34d14428d35 arch/arm/kernel/perf_event.c Will Deacon       2011-11-17  396  	 * used_mask for the purposes of validation.
bce34d14428d35 arch/arm/kernel/perf_event.c Will Deacon       2011-11-17  397  	 */
a4560846eba608 arch/arm/kernel/perf_event.c Mark Rutland      2014-05-13  398  	memset(&fake_pmu.used_mask, 0, sizeof(fake_pmu.used_mask));
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  399  
e429817b401f09 arch/arm/kernel/perf_event.c Suzuki K. Poulose 2015-03-17  400  	if (!validate_event(event->pmu, &fake_pmu, leader))
aa2bc1ade59003 arch/arm/kernel/perf_event.c Peter Zijlstra    2011-11-09  401  		return -EINVAL;
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  402  
e5c23779f93d45 drivers/perf/arm_pmu.c       Rob Herring       2022-04-08  403  	if (event == leader)
e5c23779f93d45 drivers/perf/arm_pmu.c       Rob Herring       2022-04-08  404  		return 0;
e5c23779f93d45 drivers/perf/arm_pmu.c       Rob Herring       2022-04-08  405  
edb39592a5877b drivers/perf/arm_pmu.c       Peter Zijlstra    2018-03-15  406  	for_each_sibling_event(sibling, leader) {
e429817b401f09 arch/arm/kernel/perf_event.c Suzuki K. Poulose 2015-03-17  407  		if (!validate_event(event->pmu, &fake_pmu, sibling))
aa2bc1ade59003 arch/arm/kernel/perf_event.c Peter Zijlstra    2011-11-09  408  			return -EINVAL;
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  409  	}
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  410  
e429817b401f09 arch/arm/kernel/perf_event.c Suzuki K. Poulose 2015-03-17  411  	if (!validate_event(event->pmu, &fake_pmu, event))
aa2bc1ade59003 arch/arm/kernel/perf_event.c Peter Zijlstra    2011-11-09  412  		return -EINVAL;
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  413  
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  414  	return 0;
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02 @415  }
1b8873a0c6ec51 arch/arm/kernel/perf_event.c Jamie Iles        2010-02-02  416  
