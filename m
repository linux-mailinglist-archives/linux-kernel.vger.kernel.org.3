...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 56AD54D60C3
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Mar 2022 12:42:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348321AbiCKLnv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Mar 2022 06:43:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47594 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1348268AbiCKLnq (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Mar 2022 06:43:46 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4833D6E795;
        Fri, 11 Mar 2022 03:42:40 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 9E80B61C57;
        Fri, 11 Mar 2022 11:42:39 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 22911C340E9;
        Fri, 11 Mar 2022 11:42:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1646998959;
        bh=RoVqTIAW+rEsp230ua5GDnUGhx1oWZztnYl6oI0OSyw=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=ZlA5XF2eikVtLhE4ts3LV61nHzrZHvzGeqerT4gB69yZ70VqrqD0MVnYApwF9dndJ
         fgVm/QnZb7388Jak0rAfkwfoD8l+t93GWZknyQdFHS3yDRp1BJEehNwXfaQ5WjRvv3
         9aQNXQQQJeGRWX37rgL/VwhgoOiD39KOYuUoocdM=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.15.28
Date:   Fri, 11 Mar 2022 12:42:27 +0100
Message-Id: <164699894614185@kroah.com>
X-Mailer: git-send-email 2.35.1
In-Reply-To: <1646998946149237@kroah.com>
References: <1646998946149237@kroah.com>
MIME-Version: 1.0
...
index 8ff6dafafdf8..ed55ea20352b 100644
...
index ec1a5a63c1d0..b72ff17d600a 100644
...
index 6a422b34582a..ad64687080cf 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 11bb9d12485f..09c241280ed9 100644
...
index d8e28abd468c..a0654ab1074f 100644
...
index d9c99db50243..fde7ac271b14 100644
...
index 195dff58bafc..655c4fe0b4d0 100644
...
index 82aa990c4180..f43cdc1cfbae 100644
...
index 0758ea0717f9..b68d5cbbeca6 100644
...
index bfa58409a4d4..448a575db8e8 100644
...
index 27dd084c9a2a..bfbf0c4c7c5e 100644
...
index f8be56d5342b..fc6ee6c5972d 100644
...
index e4ad9db53af1..552891e626e5 100644
...
index b268082d67ed..394fc5998a4b 100644
...
index e2c20c036442..a33d7b8f3b93 100644
...
index 7553c98f379f..e71c9cfb46e8 100644
...
index bc6d5a970a13..34e38eb00f05 100644
...
index f6b1a88245db..184abd7c4206 100644
...
index f9c7e4e61b29..0b2f684cd8ca 100644
...
index ded2c66675f0..d88d3c143a73 100644
...
index 1d46e185f31e..7c18e429b449 100644
...
index fd85b51b9d50..9d0380631690 100644
...
index 49305c2e6dfd..b71c6cbb2309 100644
...
index d0ce5cfd3ac1..4423759f619c 100644
...
index ec2d5c8c6694..b3dd514f80a0 100644
...
index ecfca3bbcd96..13320a06e14b 100644
...
@@ -982,7 +1063,7 @@ static void __init spectre_v2_select_mitigation(void)
...
index ec9922cba30a..5385d26af6e4 100644
...
index 3efd34195983..1becbbb3be13 100644
--- a/drivers/block/xen-blkfront.c
+++ b/drivers/block/xen-blkfront.c
@@ -1290,7 +1290,8 @@ static void blkif_free_ring(struct blkfront_ring_info *rinfo)
...
@@ -1566,12 +1574,17 @@ static irqreturn_t blkif_interrupt(int irq, void *dev_id)
 		}
...
@@ -1678,8 +1691,7 @@ static int setup_blkring(struct xenbus_device *dev,
...
+	sring = alloc_pages_exact(ring_size, GFP_NOIO);
 	if (!sring) {
 		...
 		return -ENOMEM;
@@ -1689,7 +1701,7 @@ static int setup_blkring(struct xenbus_device *dev,
...
@@ -2529,11 +2541,10 @@ static void purge_persistent_grants(struct blkfront_info *info)
...
index 73d388cbcd69..2492a27467b4 100644
...
index 0204e314b482..17b8c8884087 100644
...
index d9049f2a78ca..15b690a0cecb 100644
--- a/include/linux/bpf.h
+++ b/include/linux/bpf.h
@@ -1666,6 +1666,12 @@ bool bpf_prog_has_kfunc_call(const struct bpf_prog *prog);
...
index d0ce5cfd3ac1..63d30dde20f9 100644
