...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 747C54D64C0
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Mar 2022 16:37:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244088AbiCKPiU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Mar 2022 10:38:20 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234339AbiCKPh5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Mar 2022 10:37:57 -0500
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.220.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 738461C65D0
        for <linux-kernel@vger.kernel.org>; Fri, 11 Mar 2022 07:36:49 -0800 (PST)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out1.suse.de (Postfix) with ESMTPS id 06E06210EA;
        Fri, 11 Mar 2022 15:36:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.cz; s=susede2_rsa;
        t=1647013008; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mUlkAmccAKOr+w4CjMWpy5SAqulb/vqjR70TnXTNFRI=;
        b=FekLVM5rbYkHV6ILx6AkbAgb0wWZk3aQRw+6m5srAg43C7qT3X45G0BteHqiLUxqNY+F7p
        Hr5l/vxBI1jpwhiWb9OlIlB8ZShJE6nOcq6XCtyd7xzRkisBi01PXMmCAViwAjin8x9AOY
        renItew8/lPBCAj3ut0V4AaV+2FrJnU=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
        s=susede2_ed25519; t=1647013008;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mUlkAmccAKOr+w4CjMWpy5SAqulb/vqjR70TnXTNFRI=;
        b=h/gW7iBzEb8FY9BFsIDB6JiBvRhVxYT/vQJQ1nLXgDmtck8hhXbMoBl06oioS+rPuEDldv
        TSZ0bLaYAnFlBkCg==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id D0D9513A8E;
        Fri, 11 Mar 2022 15:36:47 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id Qi5FMo9sK2KDFAAAMHmgww
        (envelope-from <vbabka@suse.cz>); Fri, 11 Mar 2022 15:36:47 +0000
Message-ID: <667d594b-bdad-4082-09d5-7b0587af2ae3@suse.cz>
Date:   Fri, 11 Mar 2022 16:36:47 +0100
MIME-Version: 1.0
...
In-Reply-To: <20220311145427.GA1227220@odroid>
...
memblock_alloc would zero the area anyway. There has to be a different
