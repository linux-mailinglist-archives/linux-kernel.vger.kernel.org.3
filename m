...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C5FA54F6E3D
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Apr 2022 01:04:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237594AbiDFXFn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Apr 2022 19:05:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41530 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237566AbiDFXFk (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Apr 2022 19:05:40 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id A61013EF2A
        for <linux-kernel@vger.kernel.org>; Wed,  6 Apr 2022 16:03:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1649286216;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=i3XGbwuo/log8wKWc91d6Ucgf5/hbLEF/i8CcW16wsw=;
        b=OlSxe8ZQBqj2u3f+4PFQqFOHsFjd8e5Ieh284oJ0Y/TJ+QPaOGtqJRKoLOUFj2OxDssdA3
        xDoIgRllnrD/LW+127HA8r/bf/b3NKMkh1Pyw++esqw6a4uP9BD7rHlE/iBUiXG/i96qV7
        E7mai9JmSjl9qjc/DH4eL/gszeLphLo=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-124-MAMRA1TcM4SBA1GQYOwskA-1; Wed, 06 Apr 2022 19:03:33 -0400
X-MC-Unique: MAMRA1TcM4SBA1GQYOwskA-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.rdu2.redhat.com [10.11.54.5])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 107913804A4D;
...
Subject: [PATCH 04/14] cifs: Change the I/O paths to use an iterator rather
 than a page list
