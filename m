...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6A61246AB11
	for <lists+linux-kernel@lfdr.de>; Mon,  6 Dec 2021 22:54:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1356104AbhLFV55 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 6 Dec 2021 16:57:57 -0500
Received: from ams.source.kernel.org ([145.40.68.75]:53520 "EHLO
        ams.source.kernel.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240577AbhLFV54 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 6 Dec 2021 16:57:56 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 2E247B815DA
        for <linux-kernel@vger.kernel.org>; Mon,  6 Dec 2021 21:54:25 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DED36C341C1;
        Mon,  6 Dec 2021 21:54:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1638827663;
        bh=duj+rUUqpqfdwIScVREeiiAWatJhGQWHzRohwjkp0Lo=;
        h=Date:From:To:Cc:Subject:Reply-To:References:In-Reply-To:From;
        b=
Received: by paulmck-ThinkPad-P17-Gen-1.home (Postfix, from userid 1000)
        id 9B01A5C14E6; Mon,  6 Dec 2021 13:54:23 -0800 (PST)
Date:   Mon, 6 Dec 2021 13:54:23 -0800
From:   "Paul E. McKenney" <paulmck@kernel.org>
To:     kernel test robot <oliver.sang@intel.com>
Cc:     Neeraj Upadhyay <neeraj.iitr10@gmail.com>,
        LKML <linux-kernel@vger.kernel.org>, lkp@lists.01.org,
        lkp@intel.com
Subject: Re: [rcutorture]  fbf28ca980:
 WARNING:at_kernel/rcu/rcutorture.c:#rcu_torture_fwd_prog_cr
Message-ID: <20211206215423.GJ641268@paulmck-ThinkPad-P17-Gen-1>
Reply-To: paulmck@kernel.org
References: <20211205150214.GA34140@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20211205150214.GA34140@xsang-OptiPlex-9020>
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

On Sun, Dec 05, 2021 at 11:02:14PM +0800, kernel test robot wrote:
> 
> 
> Greeting,
> 
...
This commit is obsolete and replaced by fbf28ca98076 ("rcutorture:
Combine n_max_cbs from all kthreads in a callback flood").  I saw this
same error last week, but fixed it elsewhere.  I believe that this commit
...
> 	export testbox='vm-snb-159'
> 	export tbox_group='vm-snb'
> 	export branch='paulmck-rcu/dev.2021.11.30a'
> 	export commit='fbf28ca980766d3182971851340d9e89acd3c8c9'
> 	export kconfig='x86_64-randconfig-r012-20211128'
> 	export repeat_to=68
> 	export nr_vm=160
> 	export submit_id='61aa53c5c30fce091f19ea6d'
> 	export job_file='/lkp/jobs/scheduled/vm-snb-159/boot-300-yocto-x86_64-minimal-20190520.cgz-fbf28ca980766d3182971851340d9e89acd3c8c9-20211204-133407-1bftfbi-52.yaml'
> 	export id='00f5e3f24d028e6ba6f036e9bf21c6a5f00501ca'
...
> 	export enqueue_time='2021-12-04 01:28:38 +0800'
> 	export _id='61aa53d7c30fce091f19ea90'
> 	export _rt='/result/boot/300/vm-snb/yocto-x86_64-minimal-20190520.cgz/x86_64-randconfig-r012-20211128/gcc-9/fbf28ca980766d3182971851340d9e89acd3c8c9'
> 	export user='lkp'
> 	export LKP_SERVER='internal-lkp-server'
> 	export result_root='/result/boot/300/vm-snb/yocto-x86_64-minimal-20190520.cgz/x86_64-randconfig-r012-20211128/gcc-9/fbf28ca980766d3182971851340d9e89acd3c8c9/65'
...
> user=lkp
> job=/lkp/jobs/scheduled/vm-snb-159/boot-300-yocto-x86_64-minimal-20190520.cgz-fbf28ca980766d3182971851340d9e89acd3c8c9-20211204-133407-1bftfbi-52.yaml
> ARCH=x86_64
> kconfig=x86_64-randconfig-r012-20211128
> branch=paulmck-rcu/dev.2021.11.30a
> commit=fbf28ca980766d3182971851340d9e89acd3c8c9
...
> max_uptime=600
> RESULT_ROOT=/result/boot/300/vm-snb/yocto-x86_64-minimal-20190520.cgz/x86_64-randconfig-r012-20211128/gcc-9/fbf28ca980766d3182971851340d9e89acd3c8c9/65
...
> vga=normal
> rw'
> 	export modules_initrd='/pkg/linux/x86_64-randconfig-r012-20211128/gcc-9/fbf28ca980766d3182971851340d9e89acd3c8c9/modules.cgz'
...
> 	export kernel='/pkg/linux/x86_64-randconfig-r012-20211128/gcc-9/fbf28ca980766d3182971851340d9e89acd3c8c9/vmlinuz-5.16.0-rc1-00108-gfbf28ca98076'
> 	export dequeue_time='2021-12-04 01:38:50 +0800'
> 	export job_initrd='/lkp/jobs/scheduled/vm-snb-159/boot-300-yocto-x86_64-minimal-20190520.cgz-fbf28ca980766d3182971851340d9e89acd3c8c9-20211204-133407-1bftfbi-52.cgz'
> 
> 	[ -n "$LKP_SRC" ] ||
