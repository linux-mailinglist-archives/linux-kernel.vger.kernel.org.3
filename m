...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6AE5352CCAB
	for <lists+linux-kernel@lfdr.de>; Thu, 19 May 2022 09:17:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234690AbiESHRK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 19 May 2022 03:17:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55274 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234454AbiESHQv (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 19 May 2022 03:16:51 -0400
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com [IPv6:2607:f8b0:4864:20::635])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 37B51689B4
        for <linux-kernel@vger.kernel.org>; Thu, 19 May 2022 00:16:47 -0700 (PDT)
Received: by mail-pl1-x635.google.com with SMTP id i17so4003579pla.10
        for <linux-kernel@vger.kernel.org>; Thu, 19 May 2022 00:16:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=UfgplJ2lyWiI/QRt1W/5gw0WSiWbBh1LG/pPQyTBRLI=;
        b=ZCLUXzRpZHuyUurYUDkwzEIKHWglSw/uNR1yxzsy2LRT5Jr6VLAaKrJTQzvwx3dF1g
         YT5oTlpmgK3KH1SA7OilwcaP0oac3qYBgZkvGcCzRoyEIFEn498B1HZx41BXg4QltBq9
         tMoLUhMHauPvoepntyhLS4O4sx5gJGyvYDIcU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=UfgplJ2lyWiI/QRt1W/5gw0WSiWbBh1LG/pPQyTBRLI=;
        b=
X-Gm-Message-State: AOAM533mW4PJC9Mr10Q5DzZfSUaTcGdvZEPGgkc92ZzZcopjqpLFsOrY
        +q947sHZp+NZfi6B4oGZhUTP6A==
X-Google-Smtp-Source: ABdhPJzoU6m82Np8KXUO8ODsI0WW5fDJHz7l6oxL+ADMg4uZc7q72U+57KicRPFJuCQQvPyNQtsRPw==
X-Received: by 2002:a17:902:db07:b0:15e:b669:42a2 with SMTP id m7-20020a170902db0700b0015eb66942a2mr3429043plx.80.1652944605779;
        Thu, 19 May 2022 00:16:45 -0700 (PDT)
Received: from wenstp920.tpe.corp.google.com ([2401:fa00:1:10:2338:2871:9320:bed0])
        by smtp.gmail.com with ESMTPSA id q2-20020a170902dac200b00160c970eeb7sm2972945plx.234.2022.05.19.00.16.42
...
Subject: [PATCH v3 3/5] clk: mediatek: Replace 'struct clk' with 'struct clk_hw'
Date:   Thu, 19 May 2022 15:16:08 +0800
Message-Id: <20220519071610.423372-4-wenst@chromium.org>
...
index 52bacce5dadd..cfcf740e4e68 100644
