...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C010C507E3A
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Apr 2022 03:35:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1358740AbiDTBi3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 19 Apr 2022 21:38:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42798 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236207AbiDTBiZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 19 Apr 2022 21:38:25 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 03F6A3121F
        for <linux-kernel@vger.kernel.org>; Tue, 19 Apr 2022 18:35:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1650418535; x=1681954535;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding;
  bh=KyLwe0OCUdzLG8zCTQgNnSkbkNOkBD6xWFfchZl8pWU=;
  b=W8qPpQKcV36AgrGmaqoVJMGddiLUdAJASUDlvJWEt926QcKOW1WcWg1G
   qfPPP8fPNfrt2z1pQdwfgj8B2/n2213cTsKfZrFlZ5DW8xiK9NCcOlaAy
   VsHUO3HeK52tG0H6dGkhVGiCmgS4FoDtCdP6NY93lFSFfkJXNvERvMzeO
   XjYi55/AZfHqMI7Wm/7xXWAHxXOazNR5Q7BNgktgRmjPyy6WFUBcKbnfZ
   P4z+y3X6lZ3jamj7ovirTSEdaEy46LOA904rgwbfBGd9pmGLgDgQfPscO
   SGIq/YIn8A5Yd9VCwNpthOWpK6p7NJuiM+dk0rlHLTSb1GXH6b6bvFpZB
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10322"; a="244496183"
X-IronPort-AV: E=Sophos;i="5.90,274,1643702400"; 
   d="yaml'?scan'208";a="244496183"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Apr 2022 18:35:35 -0700
X-IronPort-AV: E=Sophos;i="5.90,274,1643702400"; 
   d="yaml'?scan'208";a="529539653"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Apr 2022 18:35:29 -0700
Date:   Wed, 20 Apr 2022 09:35:26 +0800
...
Subject: [mm/page_alloc]  f26b3fa046:  netperf.Throughput_Mbps -18.0%
 regression
Message-ID: <20220420013526.GB14333@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.17.0-00103-gf26b3fa04611"
...
commit'
	...
	export submit_id='625c01bb097c7c2c34d1a91d'
	export job_file='/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-f26b3fa046116a7dedcaafe3-20220417-11316-1caheh5-4.yaml'
	export id='5b7aa0f434d9767d55b58ceaf2cf37d04cf92dcc'
	...
	export commit='f26b3fa046116a7dedcaafe30083402113941451'
	export ucode='0xd000331'
	export bisect_dmesg=true
	export enqueue_time='2022-04-17 20:02:03 +0800'
	export _id='625c01bb097c7c2c34d1a91e'
	export _rt='/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='f219d7c7d2779b3ee4e5b54d95f65d4398151659'
	export base_commit='ce522ba9ef7e2d9fb22a39eb3371c0c64e2a433e'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/3'
	export scheduler_version='/lkp/lkp/.src-20220415-153857'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/vmlinuz-5.17.0-00103-gf26b3fa04611
branch=linus/master
job=/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-f26b3fa046116a7dedcaafe3-20220417-11316-1caheh5-4.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/vmlinuz-5.17.0-00103-gf26b3fa04611'
	export dequeue_time='2022-04-17 20:13:57 +0800'
	export node_roles='server client'
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-f26b3fa046116a7dedcaafe3-20220417-11316-1caheh5-4.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 625bea3e097c7c291f99663c
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-f26b3fa046116a7dedcaafe3-20220417-10527-bubm4m-0.yaml"
id: a3131740ba4dfe2f521992f72161d9d4c4a86ff5
...
ucode: '0xd000331'
bisect_dmesg: true
enqueue_time: 2022-04-17 18:21:50.909938693 +08:00
_id: 625bea3e097c7c291f99663c
_rt: "/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
head_commit: f219d7c7d2779b3ee4e5b54d95f65d4398151659
base_commit: ce522ba9ef7e2d9fb22a39eb3371c0c64e2a433e
branch: linus/master
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/netperf/cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331/lkp-icl-2sp4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/vmlinuz-5.17.0-00103-gf26b3fa04611
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-icl-2sp4/netperf-cs-localhost-performance-ipv4-1-300s-UDP_STREAM-ucode=0xd000331-debian-10.4-x86_64-20200603.cgz-f26b3fa046116a7dedcaafe3-20220417-10527-bubm4m-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=f26b3fa046116a7dedcaafe30083402113941451
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/modules.cgz"
...
watchdog:
:#! runtime status:
last_kernel: 5.18.0-rc2-wt-ath-05980-g1d07dda38559
repeat_to: 3
schedule_notify_address:
:#! user overrides:
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/f26b3fa046116a7dedcaafe30083402113941451/vmlinuz-5.17.0-00103-gf26b3fa04611"
dequeue_time: 2022-04-17 18:36:19.813502229 +08:00
:#! /cephfs/db/releases/20220417143128/lkp-src/include/site/inn:
job_state: finished
loadavg: 1.94 1.37 0.63 1/968 15521
start_time: '1650191841'
end_time: '1650192142'
