...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3BC6B51D1EC
	for <lists+linux-kernel@lfdr.de>; Fri,  6 May 2022 09:04:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1387971AbiEFHHL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 May 2022 03:07:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55130 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1388074AbiEFHGy (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 May 2022 03:06:54 -0400
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5D7A44DF52
        for <linux-kernel@vger.kernel.org>; Fri,  6 May 2022 00:03:11 -0700 (PDT)
Received: from kwepemi100008.china.huawei.com (unknown [172.30.72.54])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4KvhKP188ZzGpTs;
        Fri,  6 May 2022 15:00:25 +0800 (CST)
Received: from kwepemm600013.china.huawei.com (7.193.23.68) by
 kwepemi100008.china.huawei.com (7.221.188.57) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.24; Fri, 6 May 2022 15:03:09 +0800
...
CC:     <linux-mtd@lists.infradead.org>, <linux-kernel@vger.kernel.org>,
        <yukuai3@huawei.com>
Subject: [PATCH v2 1/2] ubi: fastmap: Fix high cpu usage of ubi_bgt by making sure wl_pool not empty
Date:   Fri, 6 May 2022 15:17:03 +0800
Message-ID: <20220506071704.222501-2-chengzhihao1@huawei.com>
...
In 4b68bf9a69d22dd ("ubi: Select fastmap anchor PEBs considering wear level
...
---
 drivers/mtd/ubi/fastmap-wl.c | 63 +++++++++++++++++++++++-------------
...
index 28f55f9cf715..21ea5ca8270b 100644
--- a/drivers/mtd/ubi/fastmap-wl.c
+++ b/drivers/mtd/ubi/fastmap-wl.c
@@ -97,6 +97,27 @@ struct ubi_wl_entry *ubi_wl_get_fm_peb(struct ubi_device *ubi, int anchor)
 	return e;
 }
...
+
  ...
  * @ubi: UBI device description object
@@ -120,21 +141,17 @@ void ubi_refill_pools(struct ubi_device *ubi)
...
+			if (!has_enough_free_count(ubi))
 			...
 			e = wl_get_wle(ubi);
@@ -147,8 +164,7 @@ void ubi_refill_pools(struct ubi_device *ubi)
 			enough++;
...
@@ -286,20 +302,26 @@ static struct ubi_wl_entry *get_peb_for_wl(struct ubi_device *ubi)
...
+	/* No luck, trigger wear leveling to produce a new anchor PEB. */
 	if (ubi->wl_scheduled) {
 		spin_unlock(&ubi->wl_lock);
 		return 0;
@@ -381,11 +403,6 @@ static void ubi_fastmap_close(struct ubi_device *ubi)
 		ubi->fm_anchor = NULL;
 	}
