...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6608153423C
	for <lists+linux-kernel@lfdr.de>; Wed, 25 May 2022 19:34:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245708AbiEYRey (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 25 May 2022 13:34:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45028 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235031AbiEYRev (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 25 May 2022 13:34:51 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C107CAEE1E
        for <linux-kernel@vger.kernel.org>; Wed, 25 May 2022 10:34:47 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id F2931B81E83
        for <linux-kernel@vger.kernel.org>; Wed, 25 May 2022 17:34:45 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A0C72C385B8;
        Wed, 25 May 2022 17:34:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1653500084;
        bh=WzZTakcSe8wgkWM4kAg4Yst6cp1bAw4WF80kL8RZ+Mg=;
        h=Date:From:To:Cc:Subject:Reply-To:References:In-Reply-To:From;
        b=
Received: by paulmck-ThinkPad-P17-Gen-1.home (Postfix, from userid 1000)
        id 4EDF75C0378; Wed, 25 May 2022 10:34:44 -0700 (PDT)
Date:   Wed, 25 May 2022 10:34:44 -0700
From:   "Paul E. McKenney" <paulmck@kernel.org>
To:     peterz@infradead.org
Cc:     linux-kernel@vger.kernel.org
Subject: Re: objtool warning, branch, patch, and .config
Message-ID: <20220525173444.GA4010526@paulmck-ThinkPad-P17-Gen-1>
...
In-Reply-To: <20220525173332.GA4008581@paulmck-ThinkPad-P17-Gen-1>
...
>=20
> $ make -j32 kernel/rcu/{rcuscale,rcu_segcblist,rcutorture,refscale,srcutr=
ee,sync,tree,update}.o kernel/torture.o
> kernel/rcu/update.o: warning: objtool: rcu_tasks_trace_pertask() falls th=
rough to next function rcu_tasks_trace_postscan.cold()
> kernel/rcu/update.o: warning: objtool: rcu_tasks_trace_postscan() falls t=
hrough to next function rcu_early_boot_tests()
>=20
...
Configured with: ../src/configure -v --with-pkgversion=3D'Ubuntu 9.4.0-1ubu=
ntu1~20.04.1' --with-bugurl=3Dfile:///usr/share/doc/gcc-9/README.Bugs --ena=
ble-languages=3Dc,ada,c++,go,brig,d,fortran,objc,obj-c++,gm2 --prefix=3D/us=
r --with-gcc-major-version-only --program-suffix=3D-9 --program-prefix=3Dx8=
6_64-linux-gnu- --enable-shared --enable-linker-build-id --libexecdir=3D/us=
r/lib --without-included-gettext --enable-threads=3Dposix --libdir=3D/usr/l=
ib --enable-nls --enable-clocale=3Dgnu --enable-libstdcxx-debug --enable-li=
bstdcxx-time=3Dyes --with-default-libstdcxx-abi=3Dnew --enable-gnu-unique-o=
bject --disable-vtable-verify --enable-plugin --enable-default-pie --with-s=
ystem-zlib --with-target-system-zlib=3Dauto --enable-objc-gc=3Dauto --enabl=
e-multiarch --disable-werror --with-arch-32=3Di686 --with-abi=3Dm64 --with-=
multilib-list=3Dm32,m64,mx32 --enable-multilib --with-tune=3Dgeneric --enab=
le-offload-targets=3Dnvptx-none=3D/build/gcc-9-Av3uEd/gcc-9-9.4.0/debian/tm=
p-nvptx/usr,hsa --without-cuda-driver --enable-checking=3Drelease --build=
...
> @@ -1388,8 +1388,6 @@ static void trc_wait_for_one_reader(struct task_str=
uct *t,
> =20
...
>  		return;
> @@ -1398,8 +1396,6 @@ static void trc_wait_for_one_reader(struct task_str=
uct *t,
...
> #
> CONFIG_CC_VERSION_TEXT=3D"gcc (Ubuntu 9.4.0-1ubuntu1~20.04.1) 9.4.0"
> CONFIG_CC_IS_GCC=3Dy
> CONFIG_GCC_VERSION=3D90400
> CONFIG_CLANG_VERSION=3D0
> CONFIG_AS_IS_GNU=3Dy
> CONFIG_AS_VERSION=3D23400
...
> CONFIG_INITRAMFS_SOURCE=3D"/home/git/linux-rcu/tools/testing/selftests/rc=
utorture/initrd"
