...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9E37E5260F4
	for <lists+linux-kernel@lfdr.de>; Fri, 13 May 2022 13:27:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379890AbiEML10 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 13 May 2022 07:27:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42676 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232131AbiEML1Y (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 13 May 2022 07:27:24 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 61A6624962
        for <linux-kernel@vger.kernel.org>; Fri, 13 May 2022 04:27:22 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id E4C66B82E52
        for <linux-kernel@vger.kernel.org>; Fri, 13 May 2022 11:27:20 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 5D05BC34114
        for <linux-kernel@vger.kernel.org>; Fri, 13 May 2022 11:27:19 +0000 (UTC)
Authentication-Results: smtp.kernel.org;
        dkim=pass (1024-bit key) header.d=zx2c4.com header.i=@zx2c4.com header.b="UpS6nepS"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=zx2c4.com; s=20210105;
        t=1652441237;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=kqY5GAlXp/1RaQgf7Zf8rvCKDXDF1d3p2nMF5QorBPQ=;
        b=UpS6nepSJYBYm0s3fhX36vFfK98I3S1DF8LERL2zIs5UQzQ3pkt1+HbjdKPYdX09PEewQU
        M1WnFjNBwpO7j170N/FcllaBRyZ90p9dp+Jt8QTZ0d90OX7yy0mJDhUVsJWwS9A1JLjoPo
        vmLfQSrOj/T0SQcUtlUeLuBDRlImSok=
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id 155bc130 (TLSv1.3:AEAD-AES256-GCM-SHA384:256:NO);
        Fri, 13 May 2022 11:27:17 +0000 (UTC)
From:   "Jason A. Donenfeld" <Jason@zx2c4.com>
To:     linux-kernel@vger.kernel.org
Cc:     "Jason A. Donenfeld" <Jason@zx2c4.com>
Subject: [PATCH] random: make consistent use of buf and len
Date:   Fri, 13 May 2022 13:27:14 +0200
Message-Id: <20220513112714.311780-1-Jason@zx2c4.com>
MIME-Version: 1.0
...
---
 drivers/char/random.c  | 194 ++++++++++++++++++++---------------------
 include/linux/random.h |  12 +--
 2 files changed, 101 insertions(+), 105 deletions(-)

diff --git a/drivers/char/random.c b/drivers/char/random.c
index 6a9b09be433f..5e5f0c51e3b1 100644
...
@@ -404,24 +404,24 @@ static void crng_make_state(u32 chacha_state[CHACHA_STATE_WORDS],
...
@@ -429,7 +429,7 @@ static void _get_random_bytes(void *buf, size_t nbytes)
...
@@ -446,20 +446,20 @@ static void _get_random_bytes(void *buf, size_t nbytes)
...
+	if (!len)
 	...
 	/*
@@ -473,8 +473,8 @@ static ssize_t get_random_bytes_user(void __user *buf, size_t nbytes)
...
@@ -483,17 +483,17 @@ static ssize_t get_random_bytes_user(void __user *buf, size_t nbytes)
 		if (unlikely(chacha_state[12] == 0))
 			++chacha_state[13];
...
@@ -667,24 +667,24 @@ unsigned long randomize_page(unsigned long start, unsigned long range)
...
+SYSCALL_DEFINE3(getrandom, char __user *, ubuf, size_t, len, unsigned int, flags)
 {
 	if (flags & ~(GRND_NONBLOCK | GRND_RANDOM | GRND_INSECURE))
 		return -EINVAL;
@@ -1403,8 +1399,8 @@ SYSCALL_DEFINE3(getrandom, char __user *, buf, size_t, count, unsigned int,
...
+		len = INT_MAX;
 	...
 	if (!(flags & GRND_INSECURE) && !crng_ready()) {
 		int ret;
@@ -1415,7 +1411,7 @@ SYSCALL_DEFINE3(getrandom, char __user *, buf, size_t, count, unsigned int,
 		if (unlikely(ret))
 			return ret;
 	}
...
@@ -1424,21 +1420,21 @@ static __poll_t random_poll(struct file *file, poll_table *wait)
...
@@ -1447,19 +1443,19 @@ static int write_pool(const char __user *ubuf, size_t count)
 	return ret;
 }
...
@@ -1477,14 +1473,14 @@ static ssize_t urandom_read(struct file *file, char __user *buf, size_t nbytes,
...
+static ssize_t random_read(struct file *file, char __user *ubuf, size_t len,
 ...
 {
 	int ret;
@@ -1492,7 +1488,7 @@ static ssize_t random_read(struct file *file, char __user *buf, size_t nbytes,
...
@@ -1617,7 +1613,7 @@ static u8 sysctl_bootid[UUID_SIZE];
