...
Received: from out1.vger.email (unknown [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 90435533C2C
	for <lists+linux-kernel@lfdr.de>; Wed, 25 May 2022 14:01:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235880AbiEYMBZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 25 May 2022 08:01:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40246 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231447AbiEYMBW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 25 May 2022 08:01:22 -0400
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.153.233])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3B78EC0F;
        Wed, 25 May 2022 05:01:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1653480079; x=1685016079;
  h=from:to:cc:subject:date:message-id:mime-version:
   content-transfer-encoding;
  bh=cPGggKlsnvKxQM6RtTmfo+QA8NfzeHkeVC0iqk2sUw0=;
  b=lOFXAIYHm37ZS6yWkWViYv9jgYhWlC5Zvz96VI+5/8/Wg3PYqcM5l0jm
   YmKTXKJxchQDAgzQrVEc35/6Tl8FW2IRGGDBwHlDfUASXjKBt6s1ARXlP
   RKFata16kw5060KU+7fFsaG4qJ3QTk8fXpiHlFmWRuNCi6AbYQi5Spd2y
   e0Ixvspi0EncMGpBi6iEn+GIGlUvBM01Vz2n7Y1BaqBq3qdAFyOkkycKS
   RyjqHH9+uKqbUqCGAitcw1CeP0+kxXSSRJk+BPKfxH26fdbvxZb0F8S3g
   11YJ+gAtOKSGIETjdpCgRav3SN5sPh8ELlqjkGFnHZr9fIwin3FFe1Dm5
   g==;
X-IronPort-AV: E=Sophos;i="5.91,250,1647327600"; 
   d="scan'208";a="165619063"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa3.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 25 May 2022 05:01:17 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.17; Wed, 25 May 2022 05:01:17 -0700
Received: from wendy.microchip.com (10.10.115.15) by chn-vm-ex04.mchp-main.com
 (10.10.85.152) with Microsoft SMTP Server id 15.1.2375.17 via Frontend
 Transport; Wed, 25 May 2022 05:01:15 -0700
...
Subject: [PATCH v4] i2c: add support for microchip fpga i2c controllers
Date:   Wed, 25 May 2022 12:59:30 +0100
Message-ID: <20220525115929.369419-1-conor.dooley@microchip.com>
...
---
Changes from v3:
- update variables in struct doc comment & reordered them in the struct
...
- dropped gotos in irq handler, replaced both with flags.
