...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9F9475694EC
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Jul 2022 00:03:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234729AbiGFWCI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Jul 2022 18:02:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44926 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234694AbiGFWBc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Jul 2022 18:01:32 -0400
Received: from mail-yw1-x1149.google.com (mail-yw1-x1149.google.com [IPv6:2607:f8b0:4864:20::1149])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8ECFB2AC5E
        for <linux-kernel@vger.kernel.org>; Wed,  6 Jul 2022 15:01:11 -0700 (PDT)
Received: by mail-yw1-x1149.google.com with SMTP id 00721157ae682-31c9d560435so63752347b3.21
        for <linux-kernel@vger.kernel.org>; Wed, 06 Jul 2022 15:01:11 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gpspQZzCiCtLDF1mE2Rbzp3OUWg7vlq70C4xLE3ya+E=;
        b=
X-Gm-Message-State: AJIora/8XhjGhlrANe0SeqH1x9MnDb17F918kZX8nGmBUriLx7bzIiYZ
        bCF+lCIEesdlMs3bwaIiUlLAuX89PM4=
X-Google-Smtp-Source: AGRyM1tcS0bhkovBqaAMGcBTFG0LXet+IyIY3UhCyBJaxouYWPrdgSATtWZUnD1044Cxo6jW3UsFPLIHGBk=
...
--- a/mm/vmscan.c
+++ b/mm/vmscan.c
@@ -5209,6 +5209,7 @@ static ssize_t show_min_ttl(struct kobject *kobj, str=
...
attr,
 ...
 {
@@ -5242,6 +5243,7 @@ static ssize_t show_enabled(struct kobject *kobj, str=
uct kobj_attribute *attr, c
...
attr,
 			     const char *buf, size_t len)
 {
@@ -5389,6 +5391,7 @@ static void lru_gen_seq_show_full(struct seq_file *m,=
...
+/* see Documentation/admin-guide/mm/multigen_lru.rst for details */
 ...
 {
 	unsigned long seq;
@@ -5547,6 +5550,7 @@ static int run_cmd(char cmd, int memcg_id, int nid, u=
nsigned long seq,
 	return err;
 }
=20
