...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6F18453A503
	for <lists+linux-kernel@lfdr.de>; Wed,  1 Jun 2022 14:30:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1352870AbiFAMag (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 1 Jun 2022 08:30:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41714 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1352847AbiFAMaR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 1 Jun 2022 08:30:17 -0400
Received: from out3-smtp.messagingengine.com (out3-smtp.messagingengine.com [66.111.4.27])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 82B5162A35;
        Wed,  1 Jun 2022 05:30:13 -0700 (PDT)
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.nyi.internal (Postfix) with ESMTP id E525A5C02F8;
        Wed,  1 Jun 2022 08:30:12 -0400 (EDT)
Received: from imap44 ([10.202.2.94])
  by compute4.internal (MEProxy); Wed, 01 Jun 2022 08:30:12 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=flygoat.com; h=
        cc:cc:content-transfer-encoding:content-type:date:date:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to; s=fm2; t=1654086612; x=
        1654173012; bh=mcZ6+UC/cuQKJS4rLzZOU8zx12GPElo6+LdJnB0ZUtQ=; b=S
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:cc:content-transfer-encoding
        :content-type:date:date:feedback-id:feedback-id:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to:x-me-proxy:x-me-proxy
        :x-me-sender:x-me-sender:x-sasl-enc; s=fm1; t=1654086612; x=
        1654173012; bh=mcZ6+UC/cuQKJS4rLzZOU8zx12GPElo6+LdJnB0ZUtQ=; b=F
        
X-ME-Sender: <xms:01uXYqoPa5R8hEtPWLSVAVeRTe1sMkyeS7GsVqr_Pa4YvhprXGY4qg>
    <xme:01uXYoqDVobbSUyRjsuOiducmujrErX8ysreB2dkuyX0Ou7UoR7CQwO4j6tMV7Kjj
    T7a8YVLzrgc3iFCT94>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgedvfedrledtgdehudcutefuodetggdotefrodftvf
    ...
    eqnecuggftrfgrthhtvghrnhepgeehjeekleeijeffieeujeekueetfeduieeileefvedu
    vdeugeevhfduieeuveeunecuffhomhgrihhnpehgvghnvgigrdhssgenucevlhhushhtvg
    hrufhiiigvpedtnecurfgrrhgrmhepmhgrihhlfhhrohhmpehjihgrgihunhdrhigrnhhg
    sehflhihghhorghtrdgtohhm
X-ME-Proxy: <xmx:01uXYvNVnNOHw_eShKvghzWPdODTCxUpFkf_Cj1usSPpO-MXX_PnMA>
    <xmx:01uXYp5WsMkEUfaBNmUUl-tOoi4CJIRBzzLJXjDXOX4BCrsSAF_aRQ>
    <xmx:01uXYp6Z0me0X0_9_eYlB5Ceopnx_sNzwaaCDBqPd1y-040oxVnoTw>
    <xmx:1FuXYtrXjXLd3Ag7AUbyCb5jRwj-jBxYmrmZQV1ipAH1kHQwX6BvbA>
Feedback-ID: ifd894703:Fastmail
Received: by mailuser.nyi.internal (Postfix, from userid 501)
        id BC2B636A006D; Wed,  1 Jun 2022 08:30:11 -0400 (EDT)
X-Mailer: MessagingEngine.com Webmail Interface
User-Agent: Cyrus-JMAP/3.7.0-alpha0-591-gfe6c3a2700-fm-20220427.001-gfe6c3a27
Mime-Version: 1.0
Message-Id: <e7d83f4b-c408-46c2-b94c-ea312173a687@www.fastmail.com>
In-Reply-To: <20220601100005.2989022-13-chenhuacai@loongson.cn>
References: <20220601100005.2989022-1-chenhuacai@loongson.cn>
 <20220601100005.2989022-13-chenhuacai@loongson.cn>
Date:   Wed, 01 Jun 2022 13:29:51 +0100
...
Subject: Re: [PATCH V12 12/24] LoongArch: Add exception/interrupt handling
...
>  arch/loongarch/kernel/irq.c               |  77 +++
...
>
> diff --git a/arch/loongarch/include/asm/branch.h=20
...
> +
> +#endif /* _ASM_BRANCH_H */
> diff --git a/arch/loongarch/include/asm/bug.h=20
...
> +
> +#endif /* __ASM_BUG_H */
> diff --git a/arch/loongarch/include/asm/entry-common.h=20
...
> +{
> +	return !(((unsigned long)(current->stack) ^ current_stack_pointer) &=20
> ~(THREAD_SIZE - 1));
> +}
> +
> +#endif
...
> diff --git a/arch/loongarch/include/asm/hw_irq.h=20
...
> +
> +/*
> + * interrupt-retrigger: NOP for now. This may not be appropriate for=20
> all
> + * machines, we'll see ...
> + */
> +
> +#endif /* __ASM_HW_IRQ_H */
> diff --git a/arch/loongarch/include/asm/irq.h=20
> b/arch/loongarch/include/asm/irq.h
> new file mode 100644
> index 000000000000..f3f1baf7027c
> --- /dev/null
> +++ b/arch/loongarch/include/asm/irq.h
> @@ -0,0 +1,130 @@
> +/* SPDX-License-Identifier: GPL-2.0 */
...
> +
> +/*
> + * The highest address on the IRQ stack contains a dummy frame which =
is
...
> + *       ------------
> + *
> + * task sp holds a copy of the task stack pointer where the struct=20
> pt_regs
...
> +{
> +	unsigned long low =3D per_cpu(irq_stack, cpu);
> +	unsigned long high =3D low + IRQ_STACK_SIZE;
> +
...
> +void arch_trigger_cpumask_backtrace(const struct cpumask *mask, bool=20
> exclude_self);
> +
...
> +
> +#endif /* _ASM_IRQ_H */
> diff --git a/arch/loongarch/include/asm/irq_regs.h=20
...
> +
> +	old_regs =3D get_irq_regs();
> +	current_thread_info()->regs =3D new_regs;
> +
> +	return old_regs;
> +}
> +
> +#endif /* __ASM_IRQ_REGS_H */
> diff --git a/arch/loongarch/include/asm/irqflags.h=20
...
> diff --git a/arch/loongarch/include/asm/kdebug.h=20
...
> new file mode 100644
> index 000000000000..44151b878d00
> --- /dev/null
> +++ b/arch/loongarch/include/asm/stackframe.h
> @@ -0,0 +1,212 @@
> +/* SPDX-License-Identifier: GPL-2.0 */
...
> +	.endm
> +
> +	.macro cfi_st reg offset=3D0 docfi=3D0
> +	cfi_rel_offset \reg, \offset, \docfi
> +	LONG_S	\reg, sp, \offset
> +	.endm
> +
> +	.macro cfi_restore reg offset=3D0 docfi=3D0
> +	.if \docfi
> +	.cfi_restore \reg
> +	.endif
> +	.endm
> +
> +	.macro cfi_ld reg offset=3D0 docfi=3D0
...
> +	.endm
> +
> +	.macro	RESTORE_STATIC docfi=3D0
...
> +	.endm
> +
> +	.macro	RESTORE_ALL_AND_RET docfi=3D0
...
> diff --git a/arch/loongarch/include/asm/stacktrace.h=20
...
> +    STR_LONG_S   " $r" __stringify(r)", %1,=20
> "STR_LONGSIZE"*"__stringify(r)"\n\t"
> +
...
> +		: "r" (regs->regs)
> +		: "memory");
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_BADV) : "=3Dr"=20
> (regs->csr_badvaddr));
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_CRMD) : "=3Dr"=20
> (regs->csr_crmd));
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_PRMD) : "=3Dr"=20
> (regs->csr_prmd));
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_EUEN) : "=3Dr"=20
> (regs->csr_euen));
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_ECFG) : "=3Dr"=20
> (regs->csr_ecfg));
> +	__asm__ __volatile__(CSRRD_ONE_REG(LOONGARCH_CSR_ESTAT) : "=3Dr"=20
> (regs->csr_estat));
> +}
> +
> +#endif /* _ASM_STACKTRACE_H */
> diff --git a/arch/loongarch/include/uapi/asm/break.h=20
...
> diff --git a/arch/loongarch/kernel/access-helper.h=20
...
> +{
> +	return user ? get_user(*i, (u32 __user *)p) : get_kernel_nofault(*i,=20
> p);
> +}
> +
> +static inline int __get_addr(unsigned long *a, unsigned long *p, bool=20
> user)
> +{
> +	return user ? get_user(*a, (unsigned long __user *)p) :=20
> get_kernel_nofault(*a, p);
> +}
> diff --git a/arch/loongarch/kernel/genex.S=20
...
> + * Copyright (C) 2001, 2012 MIPS Technologies, Inc.  All rights=20
> reserved.
> + */
> +#include <asm/asm.h>
> +#include <asm/asmmacro.h>
...
> new file mode 100644
> index 000000000000..9bd07edf0bce
> --- /dev/null
...
> +		page =3D alloc_pages_node(cpu_to_node(i), GFP_KERNEL, order);
> +
> +		per_cpu(irq_stack, i) =3D (unsigned long)page_address(page);
> +		pr_debug("CPU%d IRQ stack at 0x%lx - 0x%lx\n", i,
> +			per_cpu(irq_stack, i), per_cpu(irq_stack, i) + IRQ_STACK_SIZE);
> +	}
> +
> +	set_csr_ecfg(ECFGF_IP0 | ECFGF_IP1 | ECFGF_IP2 | ECFGF_IPI |=20
> ECFGF_PMC);
> +}
> diff --git a/arch/loongarch/kernel/traps.c=20
> b/arch/loongarch/kernel/traps.c
> new file mode 100644
> index 000000000000..8be071b265b3
> --- /dev/null
> +++ b/arch/loongarch/kernel/traps.c
> @@ -0,0 +1,725 @@
> +// SPDX-License-Identifier: GPL-2.0
...
> +
> +static void show_backtrace(struct task_struct *task, const struct=20
> pt_regs *regs,
> +			   const char *loglvl, bool user)
> +{
> +	unsigned long addr;
> +	unsigned long *sp =3D (unsigned long *)(regs->regs[3] & ~3);
> +
...
> +	unsigned long *sp =3D (unsigned long *)regs->regs[3];
> +
> +	printk("%sStack :", loglvl);
> +	i =3D 0;
> +	while ((unsigned long) sp & (PAGE_SIZE - 1)) {
> +		if (i && ((i % (64 / field)) =3D=3D 0)) {
> +			pr_cont("\n");
> +			printk("%s       ", loglvl);
> +		}
> +		if (i > 39) {
...
> +}
> +
> +void show_stack(struct task_struct *task, unsigned long *sp, const=20
> char *loglvl)
> +{
> +	struct pt_regs regs;
> +
...
> +		regs.csr_era =3D 0;
> +		regs.regs[1] =3D 0;
> +		regs.regs[3] =3D (unsigned long)sp;
> +	} else {
> +		if (!task || task =3D=3D current)
> +			prepare_frametrace(&regs);
> +		else {
> +			regs.csr_era =3D task->thread.reg01;
> +			regs.regs[1] =3D 0;
> +			regs.regs[3] =3D task->thread.reg03;
...
> +	pr_cont("\n");
> +
> +	exccode =3D ((regs->csr_estat) & CSR_ESTAT_EXC) >> CSR_ESTAT_EXC_SHI=
FT;
> +	excsubcode =3D ((regs->csr_estat) & CSR_ESTAT_ESUBCODE) >>=20
> CSR_ESTAT_ESUBCODE_SHIFT;
> +	printk("ExcCode : %x (SubCode %x)\n", exccode, excsubcode);
> +
> +	if (exccode >=3D EXCCODE_TLBL && exccode <=3D EXCCODE_ALE)
...
> +	__show_regs(regs);
> +	print_modules();
> +	printk("Process %s (pid: %d, threadinfo=3D%p, task=3D%p)\n",
...
> +		si_code =3D FPE_FLTINV;
> +	else if (fcsr & FPU_CSR_DIV_X)
> +		si_code =3D FPE_FLTDIV;
> +	else if (fcsr & FPU_CSR_OVF_X)
> +		si_code =3D FPE_FLTOVF;
> +	else if (fcsr & FPU_CSR_UDF_X)
> +		si_code =3D FPE_FLTUND;
> +	else if (fcsr & FPU_CSR_INE_X)
> +		si_code =3D FPE_FLTRES;
> +
> +	force_sig_fault(SIGFPE, si_code, fault_addr);
> +}
> +
> +int process_fpemu_return(int sig, void __user *fault_addr, unsigned=20
> long fcsr)
> +{
> +	int si_code;
> +
...
> + */
> +asmlinkage void noinstr do_fpe(struct pt_regs *regs, unsigned long=20
> fcsr)
> +{
> +	int sig;
...
> +
> +	if (notify_die(DIE_FP, "FP exception", regs, 0,=20
> current->thread.trap_nr,
> +		       SIGFPE) =3D=3D NOTIFY_STOP)
> +		goto out;
> +
...
> +
> +	sig =3D SIGFPE;
> +	fault_addr =3D (void __user *) regs->csr_era;
> +
...
> +	force_sig_fault(SIGBUS, BUS_ADRERR, (void __user=20
> *)regs->csr_badvaddr);
> +
> +	irqentry_exit(regs, state);
> +}
...
> +	force_sig_fault(SIGBUS, BUS_ADRALN, (void __user=20
> *)regs->csr_badvaddr);
> +
> +	irqentry_exit(regs, state);
> +}
...
> +			       current->thread.trap_nr, SIGTRAP) =3D=3D NOTIFY_STOP)
> +			goto out;
> +		else
> +			break;
...
> +	unsigned int __user *era =3D (unsigned int __user *)exception_era(re=
gs);
> +	unsigned long old_era =3D regs->csr_era;
> +	unsigned long old_ra =3D regs->regs[1];
> +	irqentry_state_t state =3D irqentry_enter(regs);
> +
> +	local_irq_enable();
> +	current->thread.trap_nr =3D read_csr_excode();
...
> +		status =3D SIGSEGV;
> +		current->thread.error_code =3D 1;
> +	}
> +
> +	if (status < 0)
> +		status =3D SIGILL;
...
> +		regs->csr_era =3D old_era;		/* Undo skip-over.  */
> +		regs->regs[1] =3D old_ra;
> +		force_sig(status);
> +	}
> +
> +out:
...
> +	 */
> +	pr_err("Caught reserved exception %u on pid:%d [%s] - should not=20
> happen\n",
...
> +	pr_err("csr_merrera =3D=3D %016llx\n", csr_read64(LOONGARCH_CSR_MERR=
ERA));
...
> +}
> +
> +asmlinkage void noinstr do_vint(struct pt_regs *regs, unsigned long s=
p)
> +{
> +	register int cpu;
...
> +	else {
> +		stack =3D per_cpu(irq_stack, cpu) + IRQ_STACK_START;
> +
> +		/* Save task's sp on IRQ stack for unwinding */
> +		*(unsigned long *)stack =3D sp;
> +
> +		__asm__ __volatile__(
> +		"move	$s0, $sp		\n" /* Preserve sp */
> +		"move	$sp, %[stk]		\n" /* Switch stack */
...
> +
> +long exception_handlers[VECSIZE * 128 / sizeof(long)]=20
> __aligned(SZ_64K);
> +
> +static void configure_exception_vector(void)
> +{
> +	eentry    =3D (unsigned long)exception_handlers;
> +	tlbrentry =3D (unsigned long)exception_handlers + 80*VECSIZE;
> +
...
> +}
> +
> +static const char panic_null_cerr[] =3D
> +	"Trying to set NULL cache error exception handler\n";
> +
> +/*
> + * Install uncached CPU exception handler.
> + * This is suitable only for the cache error exception which is the=20
> only
> + * exception handler that is being run uncached.
> + */
> +void set_merr_handler(unsigned long offset, void *addr, unsigned long=20
> size)
> +{
> +	unsigned long uncached_eentry =3D TO_UNCACHE(__pa(eentry));
> +
> +	if (!addr)
...
> +	for (i =3D EXCCODE_INT_START; i < EXCCODE_INT_END; i++)
