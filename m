...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5BAF049A919
	for <lists+linux-kernel@lfdr.de>; Tue, 25 Jan 2022 05:19:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1322081AbiAYDUl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 24 Jan 2022 22:20:41 -0500
Received: from lgeamrelo13.lge.com ([156.147.23.53]:47056 "EHLO
        lgeamrelo11.lge.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1318657AbiAYDG6 (ORCPT
...
Subject: [RFC 02/14] dept: Implement Dept(Dependency Tracker)
Date:   Tue, 25 Jan 2022 11:36:32 +0900
Message-Id: <1643078204-12663-3-git-send-email-byungchul.park@lge.com>
...
@@ -1035,6 +1036,8 @@ struct task_struct {
...
@@ -197,6 +198,7 @@ struct task_struct init_task
...
index 1f236ed..cb4c026 100644
--- a/kernel/exit.c
+++ b/kernel/exit.c
@@ -857,6 +857,7 @@ void __noreturn do_exit(long code)
...
+#include <linux/dept.h>
 ...
 #include <linux/uaccess.h>
@@ -2052,6 +2053,7 @@ static __latent_entropy struct task_struct *copy_process(
...
index a4fa44a..7911f32c 100644
--- a/kernel/module.c
+++ b/kernel/module.c
@@ -2258,6 +2258,7 @@ static void free_module(struct module *mod)
...
@@ -4019,6 +4020,7 @@ static int load_module(struct load_info *info, const char __user *uargs,
  free_module:
 	/* Free lock-classes; relies on the preceding sync_rcu() */
 	lockdep_free_key_range(mod->core_layout.base, mod->core_layout.size);
+	dept_free_range(mod->core_layout.base, mod->core_layout.size);
...
index c789b39..51cb690 100644
--- a/lib/Kconfig.debug
+++ b/lib/Kconfig.debug
@@ -1144,6 +1144,26 @@ config DEBUG_PREEMPT
